...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/tabelasdeprecositens"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/tabelasdeprecositens/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/tabelasdeprecositens/verificacao-integridade"
