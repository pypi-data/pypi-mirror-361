...
class GeometricBrownianMotion(ito_process.ItoProcess):
    ...
    def __init__(self, mean, volatility, dtype=None, name=None):
        ...
        with tf.name_scope(self._name):
            ...
            (self._volatility, self._volatility_is_constant) = (
                pw.convert_to_tensor_or_func(
                    volatility, dtype=self._dtype, name="volatility"
                )
            )
    ...
    def _sample_paths(
        ...
        log_increments = (
            (mean_integral - volatility_sq_integral / 2)
