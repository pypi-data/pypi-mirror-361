...
class Capsule2(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Capsule2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Capsule2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "cylinder_height": obj.get("cylinder_height")
        })
        return _obj
