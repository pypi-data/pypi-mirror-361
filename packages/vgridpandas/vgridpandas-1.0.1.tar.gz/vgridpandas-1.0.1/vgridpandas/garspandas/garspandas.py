...
class GARSPandas:
    ...
    def gars2geo(self, gars_column: str = None) -> GeoDataFrame:
        ...
        if gars_column is not None:
            # gars gars_ids are in the specified column
            if gars_column not in self._df.columns:
    ...
    def garsbin(
        ...
        """
        Bin points into gars cells and compute statistics, optionally grouped by a category column.
