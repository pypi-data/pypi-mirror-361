...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/mudancastrabalhadores"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/mudancastrabalhadores/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/mudancastrabalhadores/verificacao-integridade"
