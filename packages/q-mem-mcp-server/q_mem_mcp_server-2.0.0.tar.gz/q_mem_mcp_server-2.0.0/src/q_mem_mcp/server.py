...
from .conversation_summarizer import get_summarizer
    ...
    try:
        if name == "show_usage":
            ...
            try:
                ...
                if conversations:
                    # 요약 기능을 사용하여 모든 대화 포맷팅
                    summarizer = get_summarizer()
                    conversation_context = summarizer.format_conversations_with_context(conversations)
