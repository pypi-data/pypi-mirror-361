...
ITEMS_ANY_OF_SCHEMAS = ["DatasetListType", "DatasetObjectType", "DatasetScalarType"]
...
class Items(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = Items.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Items with anyOf schemas: DatasetListType, DatasetObjectType, DatasetScalarType. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Items with anyOf schemas: DatasetListType, DatasetObjectType, DatasetScalarType. Details: " + ", ".join(error_messages))
        else:
            return instance
...
Items.model_rebuild(raise_errors=False)
