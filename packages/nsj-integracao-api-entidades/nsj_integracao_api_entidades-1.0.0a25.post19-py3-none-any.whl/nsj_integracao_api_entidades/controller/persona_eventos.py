...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/eventos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/eventos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/eventos/verificacao-integridade"
