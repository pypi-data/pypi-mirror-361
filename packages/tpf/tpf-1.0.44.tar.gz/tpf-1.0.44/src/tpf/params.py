...
if iswin():
    ...
    IMG_CIFAR = "/wks/aiwks/datasets/images"
    img_path1 = "/wks/aiwks/datasets/images/001"
    csv_path1 = "/wks/aiwks/datasets/text/a.cvs"
    dataset_path1 = "/wks/aiwks/datasets"
    DATA_ROOT="/opt/wks/aiwks/datasets"
