...
def KinStateJntTrafoDataParamStart(builder): builder.StartObject(12)
def Start(builder):
...
def KinStateJntTrafoDataParamAddAddInfo(builder, addInfo): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(addInfo), 0)
def AddAddInfo(builder, addInfo):
    return KinStateJntTrafoDataParamAddAddInfo(builder, addInfo)
def KinStateJntTrafoDataParamStartAddInfoVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def StartAddInfoVector(builder, numElems):
    return KinStateJntTrafoDataParamStartAddInfoVector(builder, numElems)
...
class KinStateJntTrafoDataParamT(object):
    ...
    def _UnPack(self, kinStateJntTrafoDataParam):
        ...
        if not kinStateJntTrafoDataParam.AddInfoIsNone():
            self.addInfo = []
            for i in range(kinStateJntTrafoDataParam.AddInfoLength()):
                if kinStateJntTrafoDataParam.AddInfo(i) is None:
                    self.addInfo.append(None)
                else:
                    kVPCfgSingleItem_ = motion.core.fbtypes.KVPCfgSingleItem.KVPCfgSingleItemT.InitFromObj(kinStateJntTrafoDataParam.AddInfo(i))
    ...
    def Pack(self, builder):
        ...
        if self.addInfo is not None:
            ...
            KinStateJntTrafoDataParamStartAddInfoVector(builder, len(self.addInfo))
        ...
        if self.addInfo is not None:
            KinStateJntTrafoDataParamAddAddInfo(builder, addInfo)
