...
class TestDefaultApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_add_asset_permission(self) -> None:
    ...
    async def test_create_asset_metadata(self) -> None:
    ...
    async def test_delete_asset(self) -> None:
    ...
    async def test_download_asset_contents(self) -> None:
    ...
    async def test_get_asset_metadata(self) -> None:
    ...
    async def test_list_user_assets(self) -> None:
    ...
    async def test_upload_asset_contents(self) -> None:
