...
from .service_providers.minimax_official.adapter import MinimaxImageToVideoLiveAdapter
...
service = BaseAPIService(
    title="Minimax I2V-01 Live API",
    description="API for Minimax I2V-01 Live image-to-video generation model",
    version="1.0.0",
    ...
    f"{model_path}/image-to-video": [
        {
            ...
            "adapter": MinimaxImageToVideoLiveAdapter,
