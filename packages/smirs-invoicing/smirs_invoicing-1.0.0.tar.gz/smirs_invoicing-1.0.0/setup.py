...
setup(
  name = 'smirs-invoicing',         #* Your package will have this name
  ...
  author = 'Samir Haidari',                   # Your name
  author_email = 'samirhaidari400@gmail.com',  # Your email
  url = 'https://example.com',              # Homepage of your library (e.g. github or your website)
  keywords = ['invoice', 'excel', 'pdf', 'smir'],   # Keywords users can search on pypi.org
