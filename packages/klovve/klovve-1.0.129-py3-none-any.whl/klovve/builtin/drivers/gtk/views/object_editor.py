...
class ObjectEditorRoot(klovve.builtin.drivers.gtk.ViewMaterialization[klovve.views.ObjectEditorRoot]):
    ...
    class _MyLocationBar(klovve.ui.ComposedView):
        ...
        def __handle_location_selected(self, event: klovve.views.LocationBar.LocationSelectedEvent):
    ...
    def create_native(self):
        ...
        location_bar = ObjectEditorRoot._MyLocationBar()
    ...
    def __handle_location_selected(self, gtk_scrolled: Gtk.ScrolledWindow, location_bar: _MyLocationBar,
    ...
    def __handle_scrolled(self, gtk_scrolled: Gtk.ScrolledWindow, location_bar: _MyLocationBar) -> None:
...
class _GtkObjectEditor(Gtk.Stack):
    ...
    def title(self, _: str) -> None:
        ...
        for nodeheader in [self.__node_header_collapsed, self.__node_header_expanded]:
            nodeheader.text = _
