...
class FlowStateAssignedToChat(AssignedAssetToChat):
    ...
    @staticmethod
    def from_link(link: LinkItem, execution_context: ExecutionContext, description: str, last_incoming_message_id: Optional[str] = None) -> FlowStateAssignedToChat:
