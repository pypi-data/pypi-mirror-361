...
from .config import TTS_VOICES, TTS_MODELS, TTS_BASE_URLS, OPENAI_API_KEY, AZURE_OPENAI_API_KEY
...
def _get_api_key_for_provider(provider_type: str) -> str:
    """Get the appropriate API key for a provider type."""
    if provider_type == "openai":
        return OPENAI_API_KEY or "dummy-key-for-local"
    elif provider_type == "azure":
        return AZURE_OPENAI_API_KEY or OPENAI_API_KEY or "dummy-key-for-local"
    else:
        return OPENAI_API_KEY or "dummy-key-for-local"
    ...
    if voice:
        ...
        for url in TTS_BASE_URLS:
            ...
            if voice in endpoint_info.voices:
                ...
                api_key = _get_api_key_for_provider(endpoint_info.provider_type)
