...
import pandas as pd
from .schemas.employment_relationship import EmploymentRelationshipSchema

# Entity type constant
ENTITY_TYPE = "hr2d__Arbeidsrelatie__c"


class EmploymentRelationship:
    """
    Handles employment relationship operations for HR2Day API.
    EmploymentRelationship holds information about employment relationships in the Salesforce system.
    """

    def __init__(self, hr2day_instance):
        """
        Initialize the EmploymentRelationship class.
    ...
    def get(self,
        ...
        """
        Get employment relationship data from Salesforce.
        ...
        Args:
            ...
            skip (int, optional): Number of records to skip (OFFSET clause). Max 2000. Defaults to None.
                            Example: 0
            validate (bool, optional): Whether to validate the data against the EmploymentRelationshipSchema. Defaults to False.

        Returns:
            pd.DataFrame: DataFrame containing employment relationship data
        ...
        return self.hr2day.get(
            ...
            limit=limit,
            offset=skip,
            schema=EmploymentRelationshipSchema
        ) 