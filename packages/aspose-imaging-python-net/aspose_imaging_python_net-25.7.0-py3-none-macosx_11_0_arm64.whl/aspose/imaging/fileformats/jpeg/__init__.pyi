...
class JFIFData:
    ...
    def density_units(self, value : aspose.imaging.fileformats.jpeg.JfifDensityUnits):
        ...
...
class JpegImage(aspose.imaging.RasterCachedImage):
    ...
    def __init__(self, path: str):
        '''The  class initiates effortlessly by invoking its
    ...
    def __init__(self, stream: io.RawIOBase):
        '''Initialize a JPEG image object with the  class using a
    ...
    def __init__(self, raster_image: aspose.imaging.RasterImage):
        '''Initialize a new instance of the  class with a raster image
    ...
    def __init__(self, width: int, height: int):
        '''Create a new instance of the  class with the specified width
    ...
    @overload
    def __init__(self, jpeg_options: aspose.imaging.imageoptions.JpegOptions, width: int, height: int):
        '''Initialize a new  object with the provided JPEG options.
    ...
    def get_original_options(self) -> aspose.imaging.ImageOptionsBase:
        '''Gets the original image options of this  instance.
    ...
    def set_resolution(self, dpi_x: float, dpi_y: float):
        '''Establishes the resolution for the specified , ensuring
    ...
    @staticmethod
    def create_from_stream(stream: io.RawIOBase) -> aspose.imaging.fileformats.jpeg.JpegImage:
        '''Initializes a new instance of the  class.
    ...
    def destination_rgb_color_profile(self, value : aspose.imaging.sources.StreamSource):
        ...
    ...
    def destination_cmyk_color_profile(self, value : aspose.imaging.sources.StreamSource):
        ...
    ...
    def ignore_embedded_color_profile(self, value : bool):
        ...
