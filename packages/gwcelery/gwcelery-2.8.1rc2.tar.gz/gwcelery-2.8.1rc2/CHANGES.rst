...
2.8.1rc2 "Wood Booger" (2025-07-09)
-----------------------------------

-   Bump ligo-followup-advocate to v1.3.5. This is to be compatible with Aframe
    events.

-   Remove p-astro task.

-   Increment trials factor for AFrame on every deployment except production.

-   Support listening to multiple VOEvent addresses.

-   Turn off gwskynet for Aframe events.

2.8.0 "Wood Booger" (2025-06-18)
--------------------------------

-   Enable public alerts on production.

-   Constrain igwn-auth-utils >= 1.4.0.

-   Update poetry to v2.1.3 in CI deployment job.

-   Disable bilby parameter estimation for trigger chirp mass below 0.66Msun,
    as it does not have settings available for this mass range.

-   Add SVOM to production configuration file.

-   Upload coarse grained chirp mass plots for CBC events.

-   Constrain ligo-followup-advocate == 1.3.3.

-   Constrain ligo.skymap >= 2.4.0.

-   Migrate from ligo.lw and ligo.segments to igwn.ligolw and igwn.segments.

-   Fix bug in filtering Fermi notices, where the check would always fail if
    any classification was given.
...
-   Upload coarse grained chirp mass information for CBC events.
