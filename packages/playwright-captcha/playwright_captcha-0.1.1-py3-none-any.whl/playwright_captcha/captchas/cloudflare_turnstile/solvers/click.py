...
async def solve_cloudflare_turnstile_click(framework: FrameworkType,
                                           page: Page,
                                           captcha_container: Union[Page, Frame, ElementHandle],
                                           **kwargs):
    """
    Solve Cloudflare Turnstile captcha using click-based method
    ...
    logger.debug('Solving Cloudflare Turnstile captcha using click...')

    validate_required_params([], kwargs)

    # solve the captcha using the appropriate solver function
    await solve_cloudflare_by_click(framework=framework,
                                    page=page,
                                    captcha_container=captcha_container,
                                    challenge_type='turnstile',
                                    **kwargs)

    logger.debug(f'Solved Cloudflare Turnstile captcha')
