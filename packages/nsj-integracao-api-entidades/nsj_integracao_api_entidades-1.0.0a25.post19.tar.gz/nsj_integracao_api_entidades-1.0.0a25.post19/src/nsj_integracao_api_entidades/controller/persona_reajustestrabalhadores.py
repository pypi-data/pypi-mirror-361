...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/reajustestrabalhadores"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/reajustestrabalhadores/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/reajustestrabalhadores/verificacao-integridade"
