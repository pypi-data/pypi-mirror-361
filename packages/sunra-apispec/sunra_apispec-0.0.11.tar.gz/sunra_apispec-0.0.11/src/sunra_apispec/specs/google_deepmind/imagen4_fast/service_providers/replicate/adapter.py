...
from .schema import ReplicateImagen4FastInput


class ReplicateTextToImageAdapter(IReplicateAdapter):
    """Adapter for text-to-image generation using Imagen4-Fast model on Replicate."""
    ...
    def convert_input(self, data) -> dict:
        ...
        replicate_input = ReplicateImagen4FastInput(
    ...
    def get_request_url(self) -> str:
        ...
        return "https://api.replicate.com/v1/models/google/imagen-4-fast/predictions"
