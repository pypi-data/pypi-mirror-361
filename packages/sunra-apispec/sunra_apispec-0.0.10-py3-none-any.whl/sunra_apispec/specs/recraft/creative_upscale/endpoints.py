...
service = BaseAPIService(
    title="Creative Upscale API",
    description="This API provides access to the Creative Upscale model, allowing you to enhance image resolution and quality through asynchronous processing.",
    version="1.0.0",
