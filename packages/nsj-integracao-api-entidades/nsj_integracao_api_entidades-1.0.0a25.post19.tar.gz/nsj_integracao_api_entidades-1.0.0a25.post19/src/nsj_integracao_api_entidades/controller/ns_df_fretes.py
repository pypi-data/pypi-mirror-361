...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/df_fretes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/df_fretes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/df_fretes/verificacao-integridade"
