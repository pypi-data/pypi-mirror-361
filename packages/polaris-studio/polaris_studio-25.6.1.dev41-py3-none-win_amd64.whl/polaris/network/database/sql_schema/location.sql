...
create TABLE IF NOT EXISTS "Location" (
    ...
    "popsyn_region"    INTEGER NOT NULL DEFAULT 0,      --@ Foreign key reference to the PopSyn_Region table denoting the collection of locations considered during population synthesis.
    "county"           INTEGER                   ,      --@ County code for the location. Used by the freight model and to compute aggregate statistics
