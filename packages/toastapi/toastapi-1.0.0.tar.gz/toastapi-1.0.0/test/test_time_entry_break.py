...
from toasttab.models.time_entry_break import TimeEntryBreak

class TestTimeEntryBreak(unittest.TestCase):
    """TimeEntryBreak unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeEntryBreak:
        """Test TimeEntryBreak
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeEntryBreak`
        """
        model = TimeEntryBreak()
        if include_optional:
            return TimeEntryBreak(
                guid = '',
                break_type = toasttab.models.toast_reference.ToastReference(
                    guid = '', 
                    entity_type = '', ),
                paid = True,
