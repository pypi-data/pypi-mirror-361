...
class TextToSpeechInput(BaseModel):
    """Input schema for ElevenLabs Turbo V2.5 text-to-speech generation."""
...
class TurboV25Output(BaseModel):
    """Output schema for ElevenLabs Turbo V2.5 text-to-speech generation."""
    audio: SunraFile
