...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/anexosmodulos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/anexosmodulos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/anexosmodulos/verificacao-integridade"
