...
class Settings(object):
    ...
    # Settings
    def MaxBrowseSort(self):
        o = flatbuffers.number_types.UOffsetTFlags.py_type(self._tab.Offset(10))
        if o != 0:
            return self._tab.Get(flatbuffers.number_types.Uint32Flags, o + self._tab.Pos)
        return 10000

def SettingsStart(builder): builder.StartObject(4)
def Start(builder):
...
def SettingsAddMaxBrowseSort(builder, maxBrowseSort): builder.PrependUint32Slot(3, maxBrowseSort, 10000)
def AddMaxBrowseSort(builder, maxBrowseSort):
    return SettingsAddMaxBrowseSort(builder, maxBrowseSort)
...
class SettingsT(object):
    ...
    def __init__(self):
        ...
        self.maxBrowseSort = 10000  # type: int
    ...
    def __eq__(self, other):
        return type(self) == type(other) and \
            ...
            self.maxFlatbufferToJson == other.maxFlatbufferToJson and \
            self.maxBrowseSort == other.maxBrowseSort
    ...
    def _UnPack(self, settings):
        ...
        self.maxBrowseSort = settings.MaxBrowseSort()
    ...
    def Pack(self, builder):
        ...
        SettingsAddMaxBrowseSort(builder, self.maxBrowseSort)
