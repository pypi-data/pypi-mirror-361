...
class ConnectorCheckResult(BaseModel):
    ...
    """ # noqa: E501
    connection_check_outcome: ConnectorCheckOutcome = Field(description="Result of the connector check.")
    failure_reason: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["connection_check_outcome", "failure_reason"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connection_check_outcome": obj.get("connection_check_outcome"),
