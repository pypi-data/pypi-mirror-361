...
from toasttab.models.restaurant_modifier_group_references import RestaurantModifierGroupReferences

class TestRestaurantModifierGroupReferences(unittest.TestCase):
    """RestaurantModifierGroupReferences unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestaurantModifierGroupReferences:
        """Test RestaurantModifierGroupReferences
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestaurantModifierGroupReferences`
        """
        model = RestaurantModifierGroupReferences()
        if include_optional:
            return RestaurantModifierGroupReferences(
                identifier = 56
            )
        else:
            return RestaurantModifierGroupReferences(
    ...
    def testRestaurantModifierGroupReferences(self):
        """Test RestaurantModifierGroupReferences"""
