...
setup(
    ...
    url='https://github.com/yourusername/crawl-data-app',
    classifiers=[
    ...
    project_urls={
        'Bug Reports': 'https://github.com/yourusername/crawl-data-app/issues',
        'Source': 'https://github.com/yourusername/crawl-data-app',
    },
)
