...
ENTITY_TYPE = "hr2d__Job__c"


class Job:
    """
    Handles job operations for HR2Day API.
    Job holds information about jobs/positions in the Salesforce system.
    """
    ...
    def get(self,
        ...
        Args:
            ...
            skip (int, optional): Number of records to skip (OFFSET clause). Max 2000. Defaults to None.
                            Example: 0
            validate (bool, optional): Whether to validate the data against the JobSchema. Defaults to False.
