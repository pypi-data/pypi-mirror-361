...
class NewAction:
	keys: List[str] = ["account", "allowedAutoRetryAttempts", "autoRetryInterval", "concurrentJobsLimit", "description", "externalIds", "name", "pluginClass", "pluginUuid", "redoAction", "runRuleExpression", "supportsAutoRetry", "timeout", "type", "undoAction", "visibility"]

	def __init__(self, account: dict, allowedAutoRetryAttempts: str, autoRetryInterval: str, concurrentJobsLimit: int, description: str, externalIds: List[int], name: str, pluginClass: str, pluginUuid: str, redoAction: dict, runRuleExpression: str, supportsAutoRetry: bool, timeout: int, type: str, undoAction: dict, visibility: List[dict]):
		self.accountId = account.get('id') if account else None
...
class ActionUpdate:
	keys: List[str] = ["account", "allowedAutoRetryAttempts", "autoRetryInterval", "concurrentJobsLimit", "description", "externalIds", "name", "redoAction", "runRuleExpression", "supportsAutoRetry", "timeout", "undoAction", "visibility"]

	def __init__(self, account: dict, allowedAutoRetryAttempts: str, autoRetryInterval: str, concurrentJobsLimit: int, description: str, externalIds: List[int], name: str, redoAction: int, runRuleExpression: str, supportsAutoRetry: bool, timeout: int, undoAction: int, visibility: List[dict]):
		self.accountId = account.get('id') if account else None
		self.allowedAutoRetryAttempts = allowedAutoRetryAttempts
		self.autoRetryInterval = autoRetryInterval
		self.concurrentJobsLimit = concurrentJobsLimit
