...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/figurastributarias"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/figurastributarias/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/figurastributarias/verificacao-integridade"
