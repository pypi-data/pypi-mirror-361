...
from ...sunra_schema import ImageToVideoInput, Wan21I2V14B480POutput, Wan21I2V14B480PVideoFile
...
class ReplicateImageToVideoAdapter(IReplicateAdapter):
    ...
    def get_request_url(self) -> str:
        return "https://api.replicate.com/v1/models/wavespeedai/wan-2.1-i2v-480p/predictions"
