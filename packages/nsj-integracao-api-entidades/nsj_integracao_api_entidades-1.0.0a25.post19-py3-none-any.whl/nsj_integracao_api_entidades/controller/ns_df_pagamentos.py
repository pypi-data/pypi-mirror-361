...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/df_pagamentos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/df_pagamentos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/df_pagamentos/verificacao-integridade"
