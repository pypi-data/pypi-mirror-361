...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/centroscustos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/centroscustos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/centroscustos/verificacao-integridade"
