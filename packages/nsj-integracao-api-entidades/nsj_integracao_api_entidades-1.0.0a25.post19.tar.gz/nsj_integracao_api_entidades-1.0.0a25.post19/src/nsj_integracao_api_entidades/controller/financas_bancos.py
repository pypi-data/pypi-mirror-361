...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/bancos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/bancos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/bancos/verificacao-integridade"
