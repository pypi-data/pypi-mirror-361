...
class MessageReferenceRequest(BaseModel):
    ...
    fail_if_not_exists: Optional[StrictBool] = None
    type: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["guild_id", "channel_id", "message_id", "fail_if_not_exists", "type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if fail_if_not_exists (nullable) is None
        # and model_fields_set contains the field
        if self.fail_if_not_exists is None and "fail_if_not_exists" in self.model_fields_set:
            _dict['fail_if_not_exists'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fail_if_not_exists": obj.get("fail_if_not_exists"),
            "type": obj.get("type")
        })
        return _obj
