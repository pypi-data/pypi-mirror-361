...
class OnboardingPromptResponse(BaseModel):
    ...
    single_select: StrictBool
    required: StrictBool
    in_onboarding: StrictBool
    type: StrictInt
    __properties: ClassVar[List[str]] = ["id", "title", "options", "single_select", "required", "in_onboarding", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "title": obj.get("title"),
            "options": [OnboardingPromptOptionResponse.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None,
