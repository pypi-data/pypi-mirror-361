...
def _delete_by_id(floating_rate_index_id: str) -> bool:
    """
    Delete a FloatingRateIndex that exists in the platform.
    ...
    try:
        ...
        check_and_raise(Client().floating_rate_index_resource.delete(floating_rate_index_id=floating_rate_index_id))
...
def _load_by_id(floating_rate_index_id: str, fields: Optional[str] = None) -> FloatingRateIndex:
    """
    Access a FloatingRateIndex existing in the platform (read).
    ...
    try:
        ...
        response = check_and_raise(
            Client().floating_rate_index_resource.read(floating_rate_index_id=floating_rate_index_id, fields=fields)
        )
        ...
        logger.error(f"Error opening FloatingRateIndex: {err}")
        check_exception_and_raise(err)
...
def search(
    *,
    ...
    try:
        ...
        response = check_and_raise(
            Client().floating_rate_indices_resource.list(
