...
class AccessCodeDetails(BaseModel):
    """
    AccessCodeDetails
    """ # noqa: E501
    access_code: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="accessCode")
    ...
    __properties: ClassVar[List[str]] = ["accessCode", "phoneNumber", "onBehalfOf"]
