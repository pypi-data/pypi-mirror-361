...
class EstimateTaxV1TaxEstimatePostRequestTypedDict(TypedDict):
    ...
    transaction_estimate_request: TransactionEstimateRequestTypedDict
    simulate_nexus_met_param: NotRequired[bool]
...
class EstimateTaxV1TaxEstimatePostRequest(BaseModel):
    ...
    transaction_estimate_request: Annotated[
        TransactionEstimateRequest,
        FieldMetadata(request=RequestMetadata(media_type="application/json")),
    ]

    simulate_nexus_met_param: Annotated[
        Optional[bool],
        pydantic.Field(
            deprecated="warning: ** DEPRECATED ** - This will be removed in a future release, please migrate away from it as soon as possible.",
            alias="simulate_nexus_met",
        ),
    ...
    def serialize_model(self, handler):
        optional_fields = ["simulate_nexus_met_param"]
