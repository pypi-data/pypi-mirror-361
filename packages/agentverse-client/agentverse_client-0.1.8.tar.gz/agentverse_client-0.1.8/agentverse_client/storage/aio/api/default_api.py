...
from agentverse_client.storage.aio.api_client import ApiClient, RequestSerialized
from agentverse_client.storage.aio.api_response import ApiResponse
from agentverse_client.storage.aio.rest import RESTResponseType
...
class DefaultApi:
    ...
    @validate_call
    async def add_asset_permission(
        self,
        asset_id: StrictStr,
    ...
    @validate_call
    async def add_asset_permission_with_http_info(
        self,
        asset_id: StrictStr,
        new_permission: NewPermission,
        _request_timeout: Union[
    ...
    @validate_call
    async def add_asset_permission_without_preload_content(
        self,
        asset_id: StrictStr,
        new_permission: NewPermission,
        _request_timeout: Union[
    ...
    def _add_asset_permission_serialize(
        self,
        asset_id,
        new_permission,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/storage/assets/{asset_id}/permissions/',
    ...
    @validate_call
    async def create_asset_metadata_with_http_info(
        self,
        new_asset: NewAsset,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def create_asset_metadata_without_preload_content(
        self,
        new_asset: NewAsset,
        _request_timeout: Union[
            None,
    ...
    def _create_asset_metadata_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/storage/assets/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def delete_asset_with_http_info(
        self,
        asset_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def delete_asset_without_preload_content(
        self,
        asset_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _delete_asset_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/storage/assets/{asset_id}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def delete_asset_permission_with_http_info(
        self,
        asset_id: StrictStr,
        agent_address: Annotated[Optional[StrictStr], Field(description="The agent's address")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def delete_asset_permission_without_preload_content(
        self,
        asset_id: StrictStr,
        agent_address: Annotated[Optional[StrictStr], Field(description="The agent's address")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def download_asset_contents(
        self,
        asset_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._download_asset_contents_serialize(
            asset_id=asset_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def download_asset_contents_with_http_info(
        self,
        asset_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def download_asset_contents_without_preload_content(
        self,
        asset_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _download_asset_contents_serialize(
        self,
        asset_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/storage/assets/{asset_id}/contents/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_asset_metadata_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/storage/assets/{identifier}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def list_asset_permissions(
        ...
        _param = self._list_asset_permissions_serialize(
            asset_id=asset_id,
            agent_address=agent_address,
            offset=offset,
            limit=limit,
    ...
    @validate_call
    async def list_asset_permissions_with_http_info(
        self,
        asset_id: StrictStr,
        agent_address: Optional[StrictStr] = None,
        offset: Optional[StrictInt] = None,
    ...
    @validate_call
    async def list_asset_permissions_without_preload_content(
        self,
        asset_id: StrictStr,
        agent_address: Optional[StrictStr] = None,
        offset: Optional[StrictInt] = None,
    ...
    def _list_asset_permissions_serialize(
        self,
        asset_id,
        agent_address,
        offset,
    ...
    @validate_call
    async def list_user_assets_with_http_info(
        self,
        offset: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def list_user_assets_without_preload_content(
        self,
        offset: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
        _request_timeout: Union[
    ...
    def _list_user_assets_serialize(
        self,
        offset,
        limit,
        _request_auth,
    ...
    @validate_call
    async def upload_asset_contents(
        self,
        asset_id: StrictStr,
        ...
        :param asset_id: (required)
        :type asset_id: str
        :param asset_content: (required)
        :type asset_content: AssetContent
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._upload_asset_contents_serialize(
            asset_id=asset_id,
    ...
    @validate_call
    async def upload_asset_contents_with_http_info(
        self,
        asset_id: StrictStr,
        asset_content: AssetContent,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UploadAssetResponse]:
        """Upload Asset Contents
    ...
    @validate_call
    async def upload_asset_contents_without_preload_content(
        self,
        asset_id: StrictStr,
        asset_content: AssetContent,
        _request_timeout: Union[
    ...
    def _upload_asset_contents_serialize(
        self,
        asset_id,
        asset_content,
        _request_auth,
