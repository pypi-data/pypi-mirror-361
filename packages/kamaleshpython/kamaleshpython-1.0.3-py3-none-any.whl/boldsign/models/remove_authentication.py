...
class RemoveAuthentication(BaseModel):
    """
    RemoveAuthentication
    """ # noqa: E501
    email_id: Optional[StrictStr] = Field(default=None, alias="emailId")
    z_order: Optional[StrictInt] = Field(default=None, alias="zOrder")
    ...
    __properties: ClassVar[List[str]] = ["emailId", "zOrder", "phoneNumber", "onBehalfOf"]
