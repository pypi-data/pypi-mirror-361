...
# Generated on 2025-07-10T08:45:58.232974                                                            #
######################################################################################################
...
class ResourceConfigDict(dict, metaclass=typing._TypedDictMeta):
    def __init__(self, cpu: typing.Optional[str], memory: typing.Optional[str], gpu: typing.Optional[str], disk: typing.Optional[str]):
        ...
    ...

class AuthConfigDict(dict, metaclass=typing._TypedDictMeta):
    def __init__(self, type: typing.Optional[str], public: typing.Optional[bool]):
        ...
    ...

class ReplicaConfigDict(dict, metaclass=typing._TypedDictMeta):
    def __init__(self, fixed: typing.Optional[int], min: typing.Optional[int], max: typing.Optional[int]):
        ...
    ...

class DependencyConfigDict(dict, metaclass=typing._TypedDictMeta):
    def __init__(self, from_requirements_file: typing.Optional[str], from_pyproject_toml: typing.Optional[str], python: typing.Optional[str], pypi: typing.Optional[dict], conda: typing.Optional[dict]):
        ...
    ...

class PackageConfigDict(dict, metaclass=typing._TypedDictMeta):
    def __init__(self, src_path: typing.Optional[str], suffixes: typing.Optional[list]):
        ...
    ...
