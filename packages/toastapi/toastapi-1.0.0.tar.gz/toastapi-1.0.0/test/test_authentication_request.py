...
from toasttab.models.authentication_request import AuthenticationRequest
    ...
    def make_instance(self, include_optional) -> AuthenticationRequest:
        ...
        if include_optional:
            return AuthenticationRequest(
                client_id = 'VKuhk4NaLedOcjZpJM8grvdrsFi3MlcM',
                client_secret = 'eS960aiKdvgbSDcLUCk68HR2CJKwwHNO2HKfgxjCWxoj27KIp6jFAi2XOOc_oCuv',
