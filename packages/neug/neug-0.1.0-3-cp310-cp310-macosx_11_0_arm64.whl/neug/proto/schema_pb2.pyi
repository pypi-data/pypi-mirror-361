...
class ColumnMeta(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["data_type", b"data_type", "key", b"key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["data_type", b"data_type", "is_primary_key", b"is_primary_key", "key", b"key"]) -> None: ...
...
class EntityMeta(google.protobuf.message.Message):
    ...
    @property
    def columns(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ColumnMeta]: ...
    def __init__(
        self,
        *,
    ...
    def ClearField(self, field_name: typing.Literal["columns", b"columns", "label", b"label"]) -> None: ...
...
class RelationMeta(google.protobuf.message.Message):
    ...
    class LabelPair(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["dst", b"dst", "src", b"src"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["dst", b"dst", "src", b"src"]) -> None: ...
    ...
    def label(self) -> global___LabelMeta: ...
    @property
    def entity_pairs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___RelationMeta.LabelPair]: ...
    @property
    def columns(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ColumnMeta]: ...
    def __init__(
        self,
        *,
        label: global___LabelMeta | None = ...,
        entity_pairs: collections.abc.Iterable[global___RelationMeta.LabelPair] | None = ...,
        columns: collections.abc.Iterable[global___ColumnMeta] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["label", b"label"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["columns", b"columns", "entity_pairs", b"entity_pairs", "label", b"label"]) -> None: ...
...
class Schema(google.protobuf.message.Message):
    ...
    @property
    def entities(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___EntityMeta]:
        """the entities (vertices)"""

    @property
    def relations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___RelationMeta]:
        """the relations (edges)"""
    ...
    def ClearField(self, field_name: typing.Literal["entities", b"entities", "is_column_id", b"is_column_id", "is_table_id", b"is_table_id", "relations", b"relations"]) -> None: ...
