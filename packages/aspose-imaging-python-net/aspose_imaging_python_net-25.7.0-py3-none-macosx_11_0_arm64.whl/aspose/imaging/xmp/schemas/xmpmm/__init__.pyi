...
class XmpMediaManagementPackage(aspose.imaging.xmp.XmpPackage):
    ...
    @overload
    def set_document_id(self, guid: Guid):
        ...
    
    @overload
    def set_document_id(self, guid: str):
    ...
    @overload
    def set_instance_id(self, guid: Guid):
        ...
    
    @overload
    def set_instance_id(self, guid: str):
        '''Sets instance id.
    ...
    @overload
    def set_original_document_id(self, guid: Guid):
        ...
    
    @overload
    def set_original_document_id(self, guid: str):
    ...
    def set_derived_from(self, resource_ref: aspose.imaging.xmp.types.complex.resourceref.ResourceRef):
        '''Sets the derived from.
        
        :param resource_ref: The resource reference.'''
        ...
    
    def set_document_id_as_guid(self, guid: Guid):
        ...
    
    def set_instance_id_as_guid(self, guid: Guid):
        ...
    
    def set_original_document_id_as_guid(self, guid: Guid):
        ...
