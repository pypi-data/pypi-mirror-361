...
def createdb(database_name: str) -> bool:
    ...
    Args:
        ...
        username: Usuario para la conexión administrativa
        password: Contraseña para la conexión administrativa  
        host: Host del servidor de BD
        port: Puerto del servidor de BD
    ...
    try:
        ...
        with pm.db.adminengine.connect() as conn:
            # Usar autocommit para CREATE DATABASE (necesario en algunos motores)
