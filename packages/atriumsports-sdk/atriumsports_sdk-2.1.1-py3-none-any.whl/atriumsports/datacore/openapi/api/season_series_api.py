...
class SeasonSeriesApi:
    ...
    def season_series_list(
        ...
        series_type: Annotated[
            ...
            Field(
                description="The type of series. Multiple allowed (comma-delimited). >- `BEST_OF` Best of >- `HEAD_TO_HEAD` Head to Head >- `HOME_AND_AWAY` Home and Away >- `KNOCKOUT` Knockout >- `TOURNAMENT` Tournament "
            ),
        ] = None,
        sort_by: Annotated[
        ...
        :param series_type: The type of series. Multiple allowed (comma-delimited). >- `BEST_OF` Best of >- `HEAD_TO_HEAD` Head to Head >- `HOME_AND_AWAY` Home and Away >- `KNOCKOUT` Knockout >- `TOURNAMENT` Tournament
