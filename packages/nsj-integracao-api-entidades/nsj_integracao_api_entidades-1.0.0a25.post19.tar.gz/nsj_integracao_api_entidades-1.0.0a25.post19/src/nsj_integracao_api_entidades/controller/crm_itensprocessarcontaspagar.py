...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/itensprocessarcontaspagar"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/itensprocessarcontaspagar/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/itensprocessarcontaspagar/verificacao-integridade"
