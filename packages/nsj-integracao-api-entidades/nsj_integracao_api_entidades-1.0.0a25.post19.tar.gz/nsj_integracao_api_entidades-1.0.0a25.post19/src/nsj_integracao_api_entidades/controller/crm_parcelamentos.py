...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/parcelamentos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/parcelamentos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/parcelamentos/verificacao-integridade"
