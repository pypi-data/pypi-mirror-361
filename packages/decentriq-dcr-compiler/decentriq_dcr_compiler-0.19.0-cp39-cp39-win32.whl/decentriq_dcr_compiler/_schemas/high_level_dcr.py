...
class DataLabCompute17(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    v2: DataLabComputeV2
...
class DataLabCompute14(
    RootModel[Union[DataLabCompute, DataLabCompute16, DataLabCompute17]]
):
    root: Union[DataLabCompute, DataLabCompute16, DataLabCompute17]


class DataLabComputeOrUnknown(RootModel[Optional[DataLabCompute14]]):
    root: Optional[DataLabCompute14]
...
class DataScienceDataRoomV15(DataScienceDataRoomV01):
    pass
...
class DataScienceDataRoomV16(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class DataScienceDataRoomV1(
    RootModel[Union[DataScienceDataRoomV15, DataScienceDataRoomV16]]
):
    root: Union[DataScienceDataRoomV15, DataScienceDataRoomV16]
