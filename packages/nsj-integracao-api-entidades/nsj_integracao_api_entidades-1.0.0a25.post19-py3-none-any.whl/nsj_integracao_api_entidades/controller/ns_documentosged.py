...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/documentosged"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/documentosged/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/documentosged/verificacao-integridade"
