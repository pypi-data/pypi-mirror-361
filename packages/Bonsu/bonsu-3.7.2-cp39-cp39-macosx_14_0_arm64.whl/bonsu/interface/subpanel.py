...
class SubPanel_View_Array(wx.ScrolledWindow):
	...
	def __init__(self,parent,ancestor):
		...
		self.sboxs1 = wx.StaticBoxSizer(self.sbox1,wx.VERTICAL)
		self.hbox1 = wx.BoxSizer(wx.HORIZONTAL)
		self.contour = SpinnerObject(self,"Isosurf.: ",MAX_INT,MIN_INT,1,100,75,80)
		self.contour.SetToolTip("Isosurface value")
		self.hbox1.Add(self.contour,0, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		self.hbox1.Add((5, -1))
		self.opacity = SpinnerObject(self,"Opacity: ",1.0,0.0,0.1,0.5,75,80)
		self.opacity.SetToolTip("Opacity of isosurface")
		self.hbox1.Add(self.opacity,0, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		self.sboxs1.Add(self.hbox1,0, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		self.feature_angle = SpinnerObject(self,"FA: ",180,0,1,90,75,40)
		...
		vbox.Add((-1, 10))
		self.sbox3 = wx.StaticBox(self, label="Origin of cut plane ", style=wx.BORDER_DEFAULT)
		self.sboxs3 = wx.StaticBoxSizer(self.sbox3,wx.VERTICAL)
		self.hbox3 = wx.BoxSizer(wx.HORIZONTAL)
		self.ox = SpinnerObject(self,"x: ",MAX_INT_16,MIN_INT_16,1,10,35,80)
		self.oy = SpinnerObject(self,"y: ",MAX_INT_16,MIN_INT_16,1,10,35,80)
		self.oz = SpinnerObject(self,"z: ",MAX_INT_16,MIN_INT_16,1,10,35,80)
		...
		self.sboxs3.Add((-1, 5))
		vbox.Add(self.sboxs3, 0,  flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		self.sbox4 = wx.StaticBox(self, label="Normal to cut plane ", style=wx.BORDER_DEFAULT)
		self.sboxs4 = wx.StaticBoxSizer(self.sbox4,wx.VERTICAL)
		self.hbox4 = wx.BoxSizer(wx.HORIZONTAL)
		self.nx = SpinnerObject(self,"x: ",MAX_INT_16,MIN_INT_16,0.1,1,35,80)
		self.ny = SpinnerObject(self,"y: ",MAX_INT_16,MIN_INT_16,0.1,0,35,80)
		self.nz = SpinnerObject(self,"z: ",MAX_INT_16,MIN_INT_16,0.1,0,35,80)
		...
		self.sboxs4.Add(self.hbox4 ,0, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP|wx.BOTTOM, border=2)
		self.sboxs4.Add((-1, 5))
		vbox.Add((-1, 5))
		vbox.Add(self.sboxs4, 0,  flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		vbox.Add((-1, 5))
		...
		self.sbox5 = wx.StaticBox(self, label="Spacing between array points ", style=wx.BORDER_DEFAULT)
		self.sboxs5 = wx.StaticBoxSizer(self.sbox5,wx.VERTICAL)
		self.hbox5 = wx.BoxSizer(wx.HORIZONTAL)
		self.sx = SpinnerObject(self,"x: ",MAX_INT_16,MIN_INT_16,0.1,1,35,80)
		self.sy = SpinnerObject(self,"y: ",MAX_INT_16,MIN_INT_16,0.1,1,35,80)
		self.sz = SpinnerObject(self,"z: ",MAX_INT_16,MIN_INT_16,0.1,1,35,80)
		...
		self.sboxs5.Add(self.hbox5 ,0, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP|wx.BOTTOM, border=2)
		self.sboxs5.Add((-1, 5))
		vbox.Add(self.sboxs5, 0,  flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		vbox.Add((-1, 5))
...
class SubPanel_View_DualArray(wx.ScrolledWindow):
	treeitem = {'name':  'View Dual-Array' , 'type': 'operpreview'}
	def sequence(self, selff, pipelineitem):
		pass
	def __init__(self,parent,ancestor):
		pi = 3.141593
		...
		title = wx.StaticText(self, label="View Numpy array")
		vbox.Add(title ,0, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		self.input_1_filename = TextPanelObject(self, "Input 1 file: ", "",100,'*.npy')
		vbox.Add(self.input_1_filename, 0,  flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		self.input_2_filename = TextPanelObject(self, "Input 2 file: ", "",100,'*.npy')
		vbox.Add(self.input_2_filename, 0,  flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		vbox.Add((-1, 5))
		self.rbampphase = wx.RadioBox(self, label="Input 1 Type ", choices=['Amplitude','Phase', 'Amplitude and Phase', 'Amplitude with Phase', 'Amplitude (cut plane)','Amplitude Clipped Phase', 'Amplitude q-Colour'],  majorDimension=2, style=wx.RA_SPECIFY_COLS)
		vbox.Add(self.rbampphase,0, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		self.Bind(wx.EVT_RADIOBOX, self.OnRadioSelect, self.rbampphase)
		vbox.Add((-1, 5))
		self.sbox1 = wx.StaticBox(self, label="Input 1 Amplitude ", style=wx.BORDER_DEFAULT)
		self.sboxs1 = wx.StaticBoxSizer(self.sbox1,wx.VERTICAL)
		self.hbox1 = wx.BoxSizer(wx.HORIZONTAL)
		self.contour = SpinnerObject(self,"Isosurf.: ",MAX_INT,MIN_INT,1,100,75,80)
		self.contour.SetToolTip("Isosurface value")
		...
		vbox.Add(self.sboxs1,0, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		vbox.Add((-1, 5))
		self.sbox2 = wx.StaticBox(self, label="Input 1 Phase ", style=wx.BORDER_DEFAULT)
		self.sboxs2 = wx.StaticBoxSizer(self.sbox2,wx.VERTICAL)
		self.hbox2 = wx.BoxSizer(wx.HORIZONTAL)
		self.phasemax = SpinnerObject(self,"Max: ",pi,0.0,0.01,pi,55,80)
		self.hbox2.Add(self.phasemax, 0,  flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		self.hbox2.Add((5, -1))
		self.phasemin = SpinnerObject(self,"Min: ",0.0,-pi,0.01,-pi,55,80)
		self.hbox2.Add(self.phasemin, 0,  flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		self.sboxs2.Add(self.hbox2, 0,  flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		self.sboxs2.Add((-1, 5))
		vbox.Add(self.sboxs2, 0,  flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		...
		vbox.Add(self.hbox7 ,0, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP|wx.BOTTOM, border=2)
		vbox.Add((-1, 5))
		self.sbox8 = wx.StaticBox(self, label="Input 2 Amplitude ", style=wx.BORDER_DEFAULT)
		self.sboxs8 = wx.StaticBoxSizer(self.sbox8,wx.VERTICAL)
		self.hbox8 = wx.BoxSizer(wx.HORIZONTAL)
		self.contour_support = SpinnerObject(self,"Isosurf.: ",MAX_INT,MIN_INT,1,100,75,80)
		self.contour_support.SetToolTip("Isosurface value")
		self.hbox8.Add(self.contour_support,0, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		self.hbox8.Add((5, -1))
		self.opacity_support = SpinnerObject(self,"Opacity: ",1.0,0.0,0.1,0.5,75,80)
		self.opacity_support.SetToolTip("Opacity of isosurface")
		self.hbox8.Add(self.opacity_support,0, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		self.sboxs8.Add(self.hbox8,0, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		self.feature_angle_support = SpinnerObject(self,"FA: ",180,0,1,90,75,40)
		self.feature_angle_support.SetToolTip("Feature Angle of rendered objects.")
		self.sboxs8.Add(self.feature_angle_support,0, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		self.sboxs8.Add((-1, 5))
		vbox.Add(self.sboxs8,0, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=2)
		vbox.Add((-1, 5))
		self.hbox6 = wx.BoxSizer(wx.HORIZONTAL)
		self.chkbox_axes = wx.CheckBox(self, -1, 'View axes', size=(200, 20))
		self.chkbox_axes.SetValue(False)
		...
		self.OnRadioSelect(None)
	def SeqParser(self,event):
		Sequence_View_DualArray(self, self.ancestor)
		self.ancestor.GetPage(4).data_poll_timer.Start(1000)
	def OnPlaneSpin(self,event):
		nx = float(self.nx.value.GetValue())
		ny = float(self.ny.value.GetValue())
