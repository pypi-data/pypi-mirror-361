...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/perfiltrib_fed"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/perfiltrib_fed/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/perfiltrib_fed/verificacao-integridade"
