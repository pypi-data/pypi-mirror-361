...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/ra_historicos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/ra_historicos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/ra_historicos/verificacao-integridade"
