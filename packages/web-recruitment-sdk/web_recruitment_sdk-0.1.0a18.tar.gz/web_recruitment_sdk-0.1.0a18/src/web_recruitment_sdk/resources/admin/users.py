...
from ...types.admin import user_list_params, user_invite_params
from ..._base_client import make_request_options
from ...types.admin.user_with_account import UserWithAccount
...
class UsersResource(SyncAPIResource):
    ...
    def delete(
        ...
        *,
        ...
        """
        Delete a user from Authress and the database.
    ...
    def invite(
        ...
        *,
        ...
        """
        Create and invite a user to the platform and send them magic link to their email
        using Authress invite id.

        Args:
          role_ids: The list of role names in Authress

          site_ids: Sites the user will have access to
