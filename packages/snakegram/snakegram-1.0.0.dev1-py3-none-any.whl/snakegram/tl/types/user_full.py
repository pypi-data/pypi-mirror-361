...
if TYPE_CHECKING:
    ...
    from .premium_gift_option import TypePremiumGiftOption
...
class UserFull(TLObject, family='TypeUserFull'):
    ...
    def __init__(
        ...
        premium_gifts: Optional[List['TypePremiumGiftOption']] = None,
        ...
        Args:
            ...
            theme_emoticon (Optional[str], optional): Emoji associated with chat theme
            ...
            premium_gifts (Optional[List['TypePremiumGiftOption']], optional): Telegram Premium subscriptions gift options
    ...
    def to_bytes(self, boxed: bool=True):
        with Writer(b'\xbc[\x97M' if boxed else b'') as writer:
            with writer.flag() as flags:
                ...
                with writer.flag() as flags2:
                    ...
                    if flags(self.theme_emoticon, 15):
                    ...
                    if flags(self.premium_gifts, 19):
                        writer.vector(
                            self.premium_gifts,
