    ...
    Provider(
        ...
        models=[
            ModelInfo(
                ...
                prices=ModelPrice(input_mtok=Decimal('130'), output_mtok=Decimal('130')),
            ),
            ModelInfo(
                id='accounts/fireworks/models/SSD-1B-ControlNet',
                match=ClauseEquals(equals='accounts/fireworks/models/SSD-1B-ControlNet'),
                prices=ModelPrice(input_mtok=Decimal('200'), output_mtok=Decimal('200')),
            ),
            ModelInfo(
    ...
    Provider(
        ...
        models=[
            ...
            ModelInfo(
                ...
                prices=ModelPrice(requests_kcount=Decimal('12'), input_mtok=Decimal('1'), output_mtok=Decimal('1')),
            ),
            ModelInfo(
                id='sonar-deep-research',
                match=ClauseEquals(equals='sonar-deep-research'),
            ...
            ModelInfo(
                ...
                prices=ModelPrice(requests_kcount=Decimal('14'), input_mtok=Decimal('3'), output_mtok=Decimal('15')),
            ),
            ModelInfo(
                id='sonar-reasoning',
                match=ClauseEquals(equals='sonar-reasoning'),
                ...
                prices=ModelPrice(requests_kcount=Decimal('12'), input_mtok=Decimal('1'), output_mtok=Decimal('5')),
            ),
            ModelInfo(
                id='sonar-reasoning-pro',
                match=ClauseEquals(equals='sonar-reasoning-pro'),
                ...
                prices=ModelPrice(requests_kcount=Decimal('14'), input_mtok=Decimal('2'), output_mtok=Decimal('8')),
            ),
        ],
    ),
    Provider(
