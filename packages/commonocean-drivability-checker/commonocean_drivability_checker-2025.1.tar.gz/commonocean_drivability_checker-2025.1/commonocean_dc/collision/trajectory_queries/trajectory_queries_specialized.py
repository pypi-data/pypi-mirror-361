...
def trajectories_collision_static_obstacles_grid(trajectories: list, static_obstacles: pycrcc.ShapeGroup, num_cells=32,
    ...
    """
    return trajectories_collision_static_obstacles_grid_cr(trajectories, static_obstacles, num_cells, auto_orientation, optimize_triangles, enable_verification, return_debug_info)
...
def trajectories_collision_static_obstacles_fcl(trajectories: list, static_obstacles: pycrcc.ShapeGroup,
    ...
    return trajectories_collision_static_obstacles_fcl_cr(trajectories, static_obstacles, broadphase_type, num_cells, num_buckets, enable_verification, return_debug_info)
...
def trajectories_collision_static_obstacles_box2d(trajectories: list, static_obstacles: pycrcc.ShapeGroup,
    ...
    Please refer to the tutorial example waters_compliance_checking for usage example.
    """
    return trajectories_collision_static_obstacles_box2d_cr(trajectories, static_obstacles, enable_verification, return_debug_info)
...
def trajectories_enclosure_polygons_static_grid(trajectories: list, sg_polygons: pycrcc.ShapeGroup, num_cells=32,
    ...
    It is necessary to buffer the lane polygons in the preprocessing step before calling this function such that there is no gap between neighboring waters.
    ...
    Please refer to the tutorial example waters_compliance_checking for usage example.
    """
    return trajectories_enclosure_polygons_static_grid_cr(trajectories, sg_polygons, num_cells, enable_verification, return_debug_info)
...
def trajectories_collision_dynamic_obstacles_fcl(trajectories: list, dynamic_obstacles: list, broadphase_type=0,
    ...
    return trajectories_collision_dynamic_obstacles_fcl_cr(trajectories, dynamic_obstacles, broadphase_type, num_cells, num_buckets, enable_verification, return_debug_info)
...
def trajectories_collision_dynamic_obstacles_box2d(trajectories: list, dynamic_obstacles: list,
    ...
    Please refer to the tutorial example waters_compliance_checking for usage example.
    """
    return trajectories_collision_dynamic_obstacles_box2d_cr(trajectories, dynamic_obstacles, enable_verification, return_debug_info)
...
def trajectories_collision_dynamic_obstacles_grid(trajectories, dynamic_obstacles, num_cells=32,
    ...
    return trajectories_collision_dynamic_obstacles_grid_cr(trajectories, dynamic_obstacles, num_cells, enable_verification, return_debug_info)
