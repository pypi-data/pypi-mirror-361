...
from ...sunra_schema import TextToImageInput, HiDreamI1FastOutput
from .schema import ReplicateInput


class ReplicateTextToImageAdapter(IReplicateAdapter):
    """Adapter for text-to-image generation using HiDream I1 Fast model on Replicate."""
    ...
    def convert_input(self, data) -> dict:
        ...
        return {
            ...
            "version": "prunaai/hidream-l1-fast:17c237d753218fed0ed477cb553902b6b75735f48c128537ab829096ef3d3645"
        }
