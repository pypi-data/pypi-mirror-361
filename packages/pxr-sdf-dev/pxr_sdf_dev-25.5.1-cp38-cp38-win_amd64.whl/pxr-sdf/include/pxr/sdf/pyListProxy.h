...
#ifndef PXR_SDF_PY_LIST_PROXY_H
#define PXR_SDF_PY_LIST_PROXY_H
...
private:
    ...
    static pxr::boost::python::list _GetItemSlice(const Type& x,
                                             const pxr::boost::python::slice& index)
    {
        using namespace pxr::boost::python;
    ...
    static void _SetItemSlice(Type& x, const pxr::boost::python::slice& index,
    ...
    static void _DelItemSlice(Type& x, const pxr::boost::python::slice& index)
    {
        using namespace pxr::boost::python;
