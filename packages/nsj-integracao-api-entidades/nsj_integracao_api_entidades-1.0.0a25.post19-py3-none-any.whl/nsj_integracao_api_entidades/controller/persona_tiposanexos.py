...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/tiposanexos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/tiposanexos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/tiposanexos/verificacao-integridade"
