...
from toasttab.models.restaurant import Restaurant
    ...
    def make_instance(self, include_optional) -> Restaurant:
        ...
        if include_optional:
            return Restaurant(
                ...
                menus = [
                    toasttab.models.menu.Menu(
                        name = '', 
                        guid = '', 
                        description = '', 
                        menu_groups = [
                            toasttab.models.menu_group.MenuGroup(
                                name = '', 
                                guid = '', 
                                menu_items = [
                                    toasttab.models.menu_item.MenuItem(
                                        name = '', 
                                        guid = '', 
                                        price = 1.337, )
                                    ], )
                ...
                modifier_group_references = {
                    'key' : toasttab.models.modifier_group.ModifierGroup(
                        name = '', 
                        guid = '', 
                        reference_id = 56, 
                ...
                modifier_option_references = {
                    'key' : toasttab.models.modifier_option.ModifierOption(
                        name = '', 
                        guid = '', 
                        reference_id = 56, 
                        price = 1.337, )
                ...
                pre_modifier_group_references = {
                    'key' : toasttab.models.pre_modifier_group.PreModifierGroup(
                        name = '', 
                        guid = '', 
                        reference_id = 56, 
                        pre_modifiers = [
