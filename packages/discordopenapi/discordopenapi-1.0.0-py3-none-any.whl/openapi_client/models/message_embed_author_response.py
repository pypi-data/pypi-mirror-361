...
class MessageEmbedAuthorResponse(BaseModel):
    ...
    proxy_icon_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "url", "icon_url", "proxy_icon_url"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if proxy_icon_url (nullable) is None
        # and model_fields_set contains the field
        if self.proxy_icon_url is None and "proxy_icon_url" in self.model_fields_set:
            _dict['proxy_icon_url'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "proxy_icon_url": obj.get("proxy_icon_url")
        })
        return _obj
