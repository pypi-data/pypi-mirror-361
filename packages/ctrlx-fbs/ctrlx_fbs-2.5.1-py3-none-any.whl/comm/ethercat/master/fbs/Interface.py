...
def InterfaceStart(builder): builder.StartObject(5)
def Start(builder):
...
def InterfaceAddReference(builder, reference): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(reference), 0)
def AddReference(builder, reference):
    return InterfaceAddReference(builder, reference)
...
class InterfaceT(object):
    ...
    def __eq__(self, other):
        return type(self) == type(other) and \
            ...
            self.capabilityList == other.capabilityList and \
    ...
    def _UnPack(self, interface):
        ...
        self.reference = interface.Reference()
    ...
    def Pack(self, builder):
        ...
        if self.reference is not None:
            InterfaceAddReference(builder, reference)
