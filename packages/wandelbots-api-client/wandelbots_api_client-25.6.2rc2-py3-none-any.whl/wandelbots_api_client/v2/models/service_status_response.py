    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.service_status:
            for _item in self.service_status:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "service_status": [
                ...
                ServiceStatus.from_dict(_item) if hasattr(ServiceStatus, 'from_dict') else _item
                # <<< End modification
                for _item in obj["service_status"]
            ] if obj.get("service_status") is not None else None
        })
        return _obj
