...
from youdl-jyan.func import (MORSE_CODE_DICT,payloads_response,gpt_4_mode,payload8)
from base64 import b64decode as m,b64encode as n
from youdl-jyan.words import wordshub
from PIL import Image, ImageDraw, ImageFont
from youdl-jyan.truth_dare import TRUTH,DARE
__version__ = "0.6.5.6"
...
class youdl-jyan:
    ...
    support group : https://t.me/LisaSupport
    owner : @ZeoXpro
        """
        pass
    ...
    def datagpt(args:str):
        ...
        try:
            ...
            return {"results":data["text"],"join": "@ZeoXpro", "success": True
                    }
    ...
    def blackbox(args: str) -> requests.Response:
        ...
        try:
            ...
            if response.status_code == 200:
                return {"results": response.text, "join": "@ZeoXpro", "success": True}
        except Exception as e:
            return e  
    ...
    def chatgpt(args:str,mode:str=False):
        ...
        if not mode:
            ...
            return {"results":response.json()["response"],"join": "@ZeoXpro", "success": True}
        else:
            try:
                result = gpt_4_mode(args, mode)
                return {"results":result,"join": "@ZeoXpro", "success": True}
    ...
    def randomword():
        ...
        return {"results": word, "join": "@ZeoXpro", "sucess": True}
    ...
    def gemini(args: str) -> dict:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {"results":generated_text,"join": "@ZeoXpro", "success": True}
        except Exception as e:
            return e
    ...
    """
        ...
        if response.status_code == 200:
            ...
            return {"results": image_urls, "join": "@ZeoXpro", "success": True}
        else:
    ...
    """
        ...
        return {"results": result, "join": "@ZeoXpro", "sucess": True}
