...
class SQLChunker(LanguageChunker, PatternDetectionMixin, SecurityAnalysisMixin):
    ...
    def _get_tree_sitter_language(self) -> Any:
        ...
        # tree-sitter-sql package not available on PyPI
        # Migrated from tree-sitter-languages but no individual package exists
        raise ImportError(
            "tree-sitter-sql package is not available on PyPI. "
            "SQL chunking is currently disabled after tree-sitter-languages migration."
        )
