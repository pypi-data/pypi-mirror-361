...
from nkunyim_iam.auth.consts import default_json_headers
from nkunyim_iam.auth.jose import jwt
from nkunyim_iam.auth.oauth2.rfc6749.authorization_server import AuthorizationServer
from nkunyim_iam.auth.oauth2.rfc6749.authorization_server import OAuth2Request
from nkunyim_iam.auth.oauth2.rfc6749.resource_protector import ResourceProtector
...
class UserInfoEndpoint:
    ...
    It is also needed to pass a :class:`~nkunyim_iam.auth.oauth2.rfc6749.ResourceProtector` instance
    with a registered :class:`~nkunyim_iam.auth.oauth2.rfc6749.TokenValidator` at initialization,
    ...
    def generate_user_info(self, user, scope: str) -> UserInfo:
        """
        Generate a :class:`~nkunyim_iam.auth.oidc.core.UserInfo` object for an user::
