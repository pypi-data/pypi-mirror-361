...
def full_upload(file_path, version_name, project_name, use_latest=True, compare_version_id='') -> int:
    ...
    report_id = upload_binary(file_path, version_name, compare_version_id, project_id, platform)
    if not report_id:
