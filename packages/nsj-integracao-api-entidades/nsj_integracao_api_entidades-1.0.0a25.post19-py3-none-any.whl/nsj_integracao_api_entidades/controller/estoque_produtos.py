...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/produtos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/produtos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/produtos/verificacao-integridade"
