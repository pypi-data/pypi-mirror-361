...
class ImageTo3DInput(BaseModel):
    """Input schema for Hunyuan3D V2.1 image-to-3D generation."""
...
class ImageTo3DOutput(BaseModel):
    """Output schema for Hunyuan3D V2.1 image-to-3D generation."""
    model: SunraFile
    model_archive: SunraFile = Field(
        ...,
