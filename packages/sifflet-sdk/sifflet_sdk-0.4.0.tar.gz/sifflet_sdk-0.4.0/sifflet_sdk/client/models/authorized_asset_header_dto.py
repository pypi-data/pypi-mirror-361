...
class AuthorizedAssetHeaderDto(BaseModel):
    """
    ...
    urn: StrictStr
    external_link: Optional[StrictStr] = Field(default=None, alias="externalLink")
    tabs: List[StrictStr]
    ...
    def tabs_validate_enum(cls, value):
        """Validates the enum"""
        for i in value:
            if i not in set(["OVERVIEW", "DBT", "DBT_RUNS", "LINEAGE", "SCHEMA", "TASK", "MONITORS", "INCIDENTS"]):
                raise ValueError(
                    "each list item must be one of ('OVERVIEW', 'DBT', 'DBT_RUNS', 'LINEAGE', 'SCHEMA', 'TASK', 'MONITORS', 'INCIDENTS')"
                )
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthorizedAssetHeaderDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthorizedAssetHeaderDto from a dict"""
        if obj is None:
            return None
