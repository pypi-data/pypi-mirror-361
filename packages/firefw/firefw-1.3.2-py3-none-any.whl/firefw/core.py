...
class Value:
    ...
    def is_bound(self):
        """Return turn when this Value is bound to an object.

        Note that this method may return false even when the Value is bound to
        an object to reduce reference counts to the object. See GT #2664.
        """
        return self.__bound_to is not None
