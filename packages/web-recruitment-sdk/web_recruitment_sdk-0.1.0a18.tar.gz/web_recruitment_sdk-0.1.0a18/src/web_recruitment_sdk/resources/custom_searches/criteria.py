...
from ...types.custom_searches import CriteriaStatus, criterion_create_params, criterion_update_params
...
class CriteriaResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        summary: str,
        type: CriteriaType,
        body_custom_search_id: Optional[int] | NotGiven = NOT_GIVEN,
        ...
        """
        Create Custom Search Criterion V2
        ...
        """
        return self._post(
            f"/v2/custom-searches/{path_custom_search_id}/criteria",
    ...
    def update(
        ...
        *,
        ...
        """
        Update Custom Search Criterion V2
        ...
        """
        return self._put(
            f"/v2/custom-searches/{path_custom_search_id}/criteria/{criterion_id}",
            body=maybe_transform(
                {
                    "summary": summary,
                    "type": type,
    ...
    def delete(
        ...
        *,
        ...
        """
        Delete Custom Search Criterion V2
        ...
        return self._delete(
            f"/v2/custom-searches/{custom_search_id}/criteria/{criterion_id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
