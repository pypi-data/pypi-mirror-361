...
function Me(e, n, t, r) {
  ...
  Xt(e, t, r), (!(R & 2) || e !== J) && (e === J && (!(R & 2) && (sl |= t), X === 4 && be(e, b)), pe(e, r), t === 1 && R === 0 && !(n.mode & 1) && (rt = W() + 500, ll && vn()));
}
function pe(e, n) {
...
function $a(e, n) {
  ...
  if (n !== 0) {
    ...
    if (n === 6) be(e, r);
      ...
      if (l = e.current.alternate, !(r & 30) && !ud(l) && (n = Jr(e, r), n === 2 && (u = ou(e), u !== 0 && (r = u, n = Ou(e, u))), n === 1)) throw t = Kt, Cn(e, 0), be(e, r), pe(e, W()), t;
...
function _d({
  ...
  return /* @__PURE__ */ Q.createElement("div", { className: "checkbox-container" }, /* @__PURE__ */ Q.createElement("label", { className: "checkbox-label" }, /* @__PURE__ */ Q.createElement(
    "input",
    {
      type: "checkbox",
      checked: e,
  ...
  ), /* @__PURE__ */ Q.createElement("span", null, n), t && /* @__PURE__ */ Q.createElement(xd, { tooltip: t })));
}
function Nd() {
  const [e, n] = Hl("value"), [t] = Hl("ui_label"), [r] = Hl("ui_tooltip");
