...
def optimize( fit:fitting, mode, name='', alg='backtracking', project_c0=True, project_all=False,
              step_size_0=1e-5, tol=1e-3, minstep=1e-2, itermax=3000):
    ...
    direction = - gam * grad
    step_size, _ = line_search(fit.loss,fit.C,direction,step_size_0,
