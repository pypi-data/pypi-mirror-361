...
class ResourceListPermission(BaseModel):
    """
    ResourceListPermission
    """ # noqa: E501
    records: List[Permission] = Field(description="List of records.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [Permission.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
