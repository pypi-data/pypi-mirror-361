...
class UpdateGuildChannelRequestPartial(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "flags": obj.get("flags"),
            "available_tags": [UpdateThreadTagRequest.from_dict(_item) for _item in obj["available_tags"]] if obj.get("available_tags") is not None else None
        })
        return _obj
