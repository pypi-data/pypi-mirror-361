...
from toasttab.models.pre_modifier import PreModifier
...
class TestPreModifier(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PreModifier:
        """Test PreModifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreModifier`
        """
        model = PreModifier()
        if include_optional:
            return PreModifier(
