...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/conjuntos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/conjuntos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/conjuntos/verificacao-integridade"
