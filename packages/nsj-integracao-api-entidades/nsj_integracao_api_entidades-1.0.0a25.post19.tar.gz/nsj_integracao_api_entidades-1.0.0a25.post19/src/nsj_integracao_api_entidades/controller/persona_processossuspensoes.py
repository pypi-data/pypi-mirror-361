...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/processossuspensoes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/processossuspensoes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/processossuspensoes/verificacao-integridade"
