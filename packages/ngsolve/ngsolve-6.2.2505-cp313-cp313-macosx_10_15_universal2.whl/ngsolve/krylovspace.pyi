...
class GMResSolver(LinearSolver):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('restart', 'iterations', 'norm', 'innerproduct')
...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('atol', 'sol', 'residuals', 'mat', 'clear_output', 'printrates', 'plt', 'callback', 'plotrates', 'maxiter', 'display', 'tol', 'callback_sol', '_final_residual', 'fig', 'ax', 'pre', 'its', 'iterations', 'ress')
