...
def process_list_with_dask(input_list: list, func: Callable, num_splits: int, cluster:CLUSTER_TYPE = 'DISTRIBUTED', priority:int = 1, kwargs: Optional[dict] = None,) -> None:
    """
