...
# pm test tests.test_min2
"""Test some things that happen when a database object is deleted.
...
class QuickTest(RemoteAuthTestCase):
    ...
    def test_controllables(self):
        ...
        self.assertEqual(ExcerptType.objects.count(), 8)
        ...
        s = rt.shows(rt.models.notes.Notes, column_names="id owner")
        # print(s)
        self.assertEqual(
            s, """\
==== ==================
...
""")
        ...
        # s = ar.to_rst(column_names="id owner")
        s = rt.shows(rt.models.excerpts.Excerpts, column_names="id owner")
        # print(s)
        self.assertEqual(
            s, """\
==== =================
...
""")
    ...
    def test_dupable(self):
        ...
        bernard4 = create(Person,
                          first_name="Bernard-Marie",
                          last_name="Bodard")
