...
from wandelbots_api_client.models.validation_error2_loc_inner import ValidationError2LocInner
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "loc": [
                ...
                ValidationError2LocInner.from_dict(_item) if hasattr(ValidationError2LocInner, 'from_dict') else _item
                # <<< End modification
