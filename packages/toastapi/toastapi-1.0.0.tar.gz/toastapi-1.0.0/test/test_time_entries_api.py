...
from toasttab.api.time_entries_api import TimeEntriesApi


class TestTimeEntriesApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_time_entries_get(self) -> None:
    ...
    async def test_time_entries_time_entry_id_get(self) -> None:
