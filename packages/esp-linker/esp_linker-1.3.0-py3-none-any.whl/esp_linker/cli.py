...
def main_cli():
    ...
    if len(sys.argv) > 1:
        ...
        if command == "discover":
            ...
            print("   esp-linker flash --port COM3")
            print("   esp-linker flash --baud 115200")
            print("   esp-linker detect")
            print("   esp-linker discover")
            sys.exit(1)
    else:
        print("[*] ESP-Linker Command Line Interface")
        print("=" * 50)
        ...
        print("   esp-linker devices discover")
        print("   esp-linker dashboard")
        print("   esp-linker detect --json")
        print("   esp-linker discover --timeout 60")
        print("\n[*] Quick start:")
        print("   1. esp-linker flash          # Flash firmware")
        print("   2. esp-linker setup-wifi     # Configure WiFi")
        print("   3. esp-linker devices discover # Find and manage devices")
        print("   4. esp-linker dashboard      # Launch web interface")
        print("   5. Use Python library!")
        sys.exit(1)
