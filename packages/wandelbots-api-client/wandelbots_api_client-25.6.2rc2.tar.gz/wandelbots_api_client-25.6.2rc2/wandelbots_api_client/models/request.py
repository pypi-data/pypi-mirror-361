...
class Request(BaseModel):
    ...
    # data type: str
    anyof_schema_1_validator: Optional[StrictStr] = Field(default=None, description="Wandelscript code string which describes a Program as text/plain")
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Request with anyOf schemas: CodeWithArguments, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Request with anyOf schemas: CodeWithArguments, str. Details: " + ", ".join(error_messages))
        else:
            return instance
