...
class ListProgramMetadataResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListProgramMetadataResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListProgramMetadataResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "programs": [
                ...
                ProgramMetadata.from_dict(_item) if hasattr(ProgramMetadata, 'from_dict') else _item
                # <<< End modification
                for _item in obj["programs"]
            ] if obj.get("programs") is not None else None
        })
        return _obj
