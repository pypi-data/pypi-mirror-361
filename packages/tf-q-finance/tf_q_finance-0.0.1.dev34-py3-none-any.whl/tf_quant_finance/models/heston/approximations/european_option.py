    ...
    **kwargs,
    ...
    with tf.compat.v1.name_scope(name, default_name="eu_option_price"):
        ...
        if discount_factors is None:
            discount_factors = tf.exp(
                -discount_rates * expiries
        ...
        def char_fun(u):
            ...
            c = (a / volvol_real**2) * (
                (mean_reversion_real - s - d) * expiries_real - m
            )
        ...
        if is_call_options is None:
            ...
            undiscount_prices = tf.where(
                is_call_options, undiscounted_call_prices, undiscounted_put_prices
            )
