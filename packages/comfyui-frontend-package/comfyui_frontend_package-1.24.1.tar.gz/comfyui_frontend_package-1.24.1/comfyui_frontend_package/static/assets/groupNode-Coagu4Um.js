...
import { bN as ExecutableNodeDTO, bO as ComfyDialog, bp as $el, L as LiteGraph, bP as DraggableList, b as app, aF as useToastStore, bQ as getComboSpecComboOptions, an as _, bR as getInputSpecType, bS as isIntInputSpec, bT as isFloatInputSpec, bU as isComboInputSpec, M as LGraphNode, by as applyTextReplacements, bV as GET_CONFIG, bx as ComfyWidgets, bW as CONFIG, bX as addValueControlWidgets, n as useChainCallback, bY as isPrimitiveNode, aY as useDialogService, H as t, bZ as serialise, b_ as GROUP, p as useNodeDefStore, b$ as useWidgetStore, bw as deserialiseAndCreate, aA as api, c0 as SubgraphNode } from "./index-xxnHOCaZ.js";
...
class PrimitiveNode extends LGraphNode {
  ...
  applyToGraph(extraLinks = []) {
    ...
    if (v && this.properties[replacePropertyName]) {
      v = applyTextReplacements(app.graph.nodes, v);
    }
...
class GroupNodeHandler {
  ...
  constructor(node) {
    ...
    node.onDrawForeground = function(ctx) {
      ...
      if (
        // @ts-expect-error fixme ts strict error
        +app.runningNodeId === this.id && this.runningInternalNodeId !== null
      ) {
...
//# sourceMappingURL=groupNode-Coagu4Um.js.map
