...
def AxsStateFlexProfileExecutionAddSingleExecutionDone(builder, singleExecutionDone): builder.PrependBoolSlot(3, singleExecutionDone, 0)
def AddSingleExecutionDone(builder, singleExecutionDone):
    return AxsStateFlexProfileExecutionAddSingleExecutionDone(builder, singleExecutionDone)
...
class AxsStateFlexProfileExecutionT(object):
    ...
    def _UnPack(self, axsStateFlexProfileExecution):
        ...
        self.singleExecutionDone = axsStateFlexProfileExecution.SingleExecutionDone()
    ...
    def Pack(self, builder):
        ...
        AxsStateFlexProfileExecutionAddSingleExecutionDone(builder, self.singleExecutionDone)
