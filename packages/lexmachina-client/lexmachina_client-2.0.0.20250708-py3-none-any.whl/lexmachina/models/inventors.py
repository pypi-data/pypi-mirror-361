...
class Inventors(BaseModel):
    """
    Inventors
    """ # noqa: E501
    inventors: List[StrictStr]
    original_assignee: List[Any] = Field(alias="originalAssignee")
    filing_date: date = Field(alias="filingDate")
    issue_date: date = Field(alias="issueDate")
    __properties: ClassVar[List[str]] = ["inventors", "originalAssignee", "filingDate", "issueDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventors": obj.get("inventors"),
            "originalAssignee": obj.get("originalAssignee"),
