...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/reajustessindicatos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/reajustessindicatos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/reajustessindicatos/verificacao-integridade"
