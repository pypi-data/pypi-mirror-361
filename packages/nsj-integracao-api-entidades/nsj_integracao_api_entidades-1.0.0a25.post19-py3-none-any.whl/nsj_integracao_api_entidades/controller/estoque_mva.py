...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/mva"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/mva/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/mva/verificacao-integridade"
