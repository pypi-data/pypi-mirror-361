...
class ConfigurationArchiveStatusCreating(BaseModel):
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['creating']):
            raise ValueError("must be one of enum values ('creating')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigurationArchiveStatusCreating from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigurationArchiveStatusCreating from a dict"""
        if obj is None:
            return None
