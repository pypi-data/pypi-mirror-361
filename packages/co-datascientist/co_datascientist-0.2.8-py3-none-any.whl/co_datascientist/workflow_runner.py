...
class _WorkflowRunner:
    ...
    async def _run_sequential_mode(self, response, python_path: str, 
                                  project_absolute_path: str, spinner=None, poll_interval: int = 3):
            ...
            if iteration_count % poll_interval == 0:
                try:
                    ...
                    if best_kpi is not None and spinner:
                        spinner.write(f"🚀 Current best KPI in population: {best_kpi}")
                    ...
                    logging.warning(f"Failed fetching population best KPI: {e}")
    ...
    async def _save_population_best_checkpoint(self, best_cv, best_kpi: float, project_absolute_path: str):
        ...
        try:
            ...
            meta = {
                ...
                "name": best_cv.name,
                "kpi": best_kpi,
                "stdout": best_cv.result.stdout if best_cv.result else None,
            }
