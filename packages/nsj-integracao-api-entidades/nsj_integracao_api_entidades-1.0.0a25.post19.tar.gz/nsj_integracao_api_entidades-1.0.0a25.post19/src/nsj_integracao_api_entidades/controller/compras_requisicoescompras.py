...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/requisicoescompras"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/requisicoescompras/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/requisicoescompras/verificacao-integridade"
