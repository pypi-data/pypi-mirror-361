...
class IAccountDoc(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_docId", "_id", "publicKey", "accountNumber", "pubKeyType", "bitbadgesAddress", "ethAddress", "solAddress", "btcAddress", "thorAddress", "sequence", "balance"]
