...
class DowntimeParams(_message.Message):
    ...
    def __init__(self, durations: _Optional[_Iterable[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]]] = ...) -> None: ...
...
class SynchronyParams(_message.Message):
    ...
    def __init__(self, next_block_delay: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ...) -> None: ...
