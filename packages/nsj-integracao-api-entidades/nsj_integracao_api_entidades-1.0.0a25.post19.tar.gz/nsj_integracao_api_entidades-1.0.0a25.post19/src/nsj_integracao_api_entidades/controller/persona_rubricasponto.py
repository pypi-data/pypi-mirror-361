...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/rubricasponto"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/rubricasponto/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/rubricasponto/verificacao-integridade"
