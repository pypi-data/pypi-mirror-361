...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/conjuntosclientes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/conjuntosclientes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/conjuntosclientes/verificacao-integridade"
