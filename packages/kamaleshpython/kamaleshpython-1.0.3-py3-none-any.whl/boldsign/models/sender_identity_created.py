...
class SenderIdentityCreated(BaseModel):
    """
    SenderIdentityCreated
    """ # noqa: E501
    sender_identity_id: Optional[StrictStr] = Field(default=None, alias="senderIdentityId")
    __properties: ClassVar[List[str]] = ["senderIdentityId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "senderIdentityId": obj.get("senderIdentityId")
        })
        return _obj
