...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/negociacoesvalores"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/negociacoesvalores/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/negociacoesvalores/verificacao-integridade"
