...
def main(ctx, reset_openai_key: bool):
    ...
    logging.info(f"settings: {settings.dict()}")
...
@click.option('--python-path', required=False, type=click.Path(), default="python", show_default=True, help='Path to the python interpreter to use')
