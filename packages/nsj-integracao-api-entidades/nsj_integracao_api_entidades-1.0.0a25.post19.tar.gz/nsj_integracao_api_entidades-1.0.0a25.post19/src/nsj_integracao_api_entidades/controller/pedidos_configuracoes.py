...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/configuracoes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/configuracoes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/configuracoes/verificacao-integridade"
