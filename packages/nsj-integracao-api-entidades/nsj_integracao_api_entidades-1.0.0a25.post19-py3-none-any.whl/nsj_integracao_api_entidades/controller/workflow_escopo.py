...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/escopo"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/escopo/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/escopo/verificacao-integridade"
