...
class _ConflictActionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ConflictAction.ValueType], builtins.type):
...
class EdgeType(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["dst_type_name", b"dst_type_name", "src_type_name", b"src_type_name", "type_name", b"type_name"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["dst_type_name", b"dst_type_name", "src_type_name", b"src_type_name", "type_name", b"type_name"]) -> None: ...
...
class PropertyDef(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["default_value", b"default_value", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["default_value", b"default_value", "name", b"name", "type", b"type"]) -> None: ...
...
class CreateVertexSchema(google.protobuf.message.Message):
    ...
    @property
    def properties(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PropertyDef]: ...
    @property
    def primary_key(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]: ...
    def __init__(
        self,
        *,
    ...
    def ClearField(self, field_name: typing.Literal["conflict_action", b"conflict_action", "primary_key", b"primary_key", "properties", b"properties", "vertex_type", b"vertex_type"]) -> None: ...
...
class CreateEdgeSchema(google.protobuf.message.Message):
    ...
    class _MultiplicityEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[CreateEdgeSchema._Multiplicity.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def ClearField(self, field_name: typing.Literal["conflict_action", b"conflict_action", "edge_type", b"edge_type", "multiplicity", b"multiplicity", "primary_key", b"primary_key", "properties", b"properties"]) -> None: ...
...
class DropVertexSchema(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["vertex_type", b"vertex_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["conflict_action", b"conflict_action", "vertex_type", b"vertex_type"]) -> None: ...
...
class DropEdgeSchema(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["edge_type", b"edge_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["conflict_action", b"conflict_action", "edge_type", b"edge_type"]) -> None: ...
...
class AddVertexPropertySchema(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["vertex_type", b"vertex_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["conflict_action", b"conflict_action", "properties", b"properties", "vertex_type", b"vertex_type"]) -> None: ...
...
class AddEdgePropertySchema(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["edge_type", b"edge_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["conflict_action", b"conflict_action", "edge_type", b"edge_type", "properties", b"properties"]) -> None: ...
...
class RenameVertexPropertySchema(google.protobuf.message.Message):
    ...
    def vertex_type(self) -> common_pb2.NameOrId: ...
    @property
    def mappings(self) -> google.protobuf.internal.containers.ScalarMap[builtins.str, builtins.str]:
    ...
    def HasField(self, field_name: typing.Literal["vertex_type", b"vertex_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["conflict_action", b"conflict_action", "mappings", b"mappings", "vertex_type", b"vertex_type"]) -> None: ...
...
class RenameEdgePropertySchema(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["edge_type", b"edge_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["conflict_action", b"conflict_action", "edge_type", b"edge_type", "mappings", b"mappings"]) -> None: ...
...
class RenameVertexTypeSchema(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["new_type", b"new_type", "old_type", b"old_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["conflict_action", b"conflict_action", "new_type", b"new_type", "old_type", b"old_type"]) -> None: ...
...
class DDLPlan(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["add_edge_property_schema", b"add_edge_property_schema", "add_vertex_property_schema", b"add_vertex_property_schema", "create_edge_schema", b"create_edge_schema", "create_vertex_schema", b"create_vertex_schema", "drop_edge_property_schema", b"drop_edge_property_schema", "drop_edge_schema", b"drop_edge_schema", "drop_vertex_property_schema", b"drop_vertex_property_schema", "drop_vertex_schema", b"drop_vertex_schema", "plan", b"plan", "rename_edge_property_schema", b"rename_edge_property_schema", "rename_edge_type_schema", b"rename_edge_type_schema", "rename_vertex_property_schema", b"rename_vertex_property_schema", "rename_vertex_type_schema", b"rename_vertex_type_schema"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["add_edge_property_schema", b"add_edge_property_schema", "add_vertex_property_schema", b"add_vertex_property_schema", "create_edge_schema", b"create_edge_schema", "create_vertex_schema", b"create_vertex_schema", "drop_edge_property_schema", b"drop_edge_property_schema", "drop_edge_schema", b"drop_edge_schema", "drop_vertex_property_schema", b"drop_vertex_property_schema", "drop_vertex_schema", b"drop_vertex_schema", "plan", b"plan", "rename_edge_property_schema", b"rename_edge_property_schema", "rename_edge_type_schema", b"rename_edge_type_schema", "rename_vertex_property_schema", b"rename_vertex_property_schema", "rename_vertex_type_schema", b"rename_vertex_type_schema"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["plan", b"plan"]) -> typing.Literal["create_vertex_schema", "create_edge_schema", "drop_vertex_schema", "drop_edge_schema", "add_vertex_property_schema", "add_edge_property_schema", "drop_vertex_property_schema", "drop_edge_property_schema", "rename_vertex_property_schema", "rename_edge_property_schema", "rename_vertex_type_schema", "rename_edge_type_schema"] | None: ...
