...
from .exceptions import PatternError, OptimizationError
...
class PromptOptimizer:
    ...
    def optimize_prompt(self, raw_prompt: str, pattern_name: str, overrides: dict, dry_run: bool = False) -> str:
        ...
        if not pattern:
            raise PatternError(f"Pattern '{pattern_name}' not found.")
        ...
        try:
            ...
            self.performance_monitor.record_function_call('optimize_prompt', duration)