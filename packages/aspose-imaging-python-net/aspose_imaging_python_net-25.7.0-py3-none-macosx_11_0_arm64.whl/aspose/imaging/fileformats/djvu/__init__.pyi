...
class DjvuImage(aspose.imaging.RasterCachedMultipageImage):
    ...
    def __init__(self, stream: io.RawIOBase):
        ...
        class using a Stream parameter. Perfect for
    ...
    def __init__(self, stream: io.RawIOBase, load_options: aspose.imaging.LoadOptions):
        ...
        initializes a new  class instance using a Stream and
    ...
    @overload
    @staticmethod
    def load_document(stream: io.RawIOBase) -> aspose.imaging.fileformats.djvu.DjvuImage:
    ...
    @overload
    @staticmethod
    def load_document(stream: io.RawIOBase, load_options: aspose.imaging.LoadOptions) -> aspose.imaging.fileformats.djvu.DjvuImage:
    ...
    def adjust_contrast(self, contrast: float):
        '''Enhance  contrast to improve visual clarity and
    ...
    @active_page.setter
    def active_page(self, value : aspose.imaging.fileformats.djvu.DjvuPage):
        ...
...
class DjvuPage(aspose.imaging.RasterCachedImage):
    ...
    def thumbnail_image(self, value : aspose.imaging.fileformats.djvu.DjvuRaster):
        ...
