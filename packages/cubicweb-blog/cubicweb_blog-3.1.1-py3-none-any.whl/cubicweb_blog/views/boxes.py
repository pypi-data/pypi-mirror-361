...
from cubicweb_web import component, tags
...
class LatestBlogsBox(component.CtxComponent):
    ...
    __select__ = component.CtxComponent.__select__ & none_rset() & match_view("index")
    ...
    def render_body(self, w):
        ...
        rss_label = '{} <img src="{}" alt="{}"/>'.format(
            self._cw._("subscribe"),
            rss_icon,
            self._cw._("rss icon"),
        )
...
class LatestBlogsBlogBox(LatestBlogsBox):
    ...
    __select__ = (
        component.CtxComponent.__select__ & one_line_rset() & is_instance("Blog")
    )
