...
class ConversationMessage(UniversalBaseModel):
    ...
    conversation_message_topic_index: typing_extensions.Annotated[
        typing.Optional[float], FieldMetadata(alias="conversationMessageTopicIndex")
    ] = None
    call: typing.Optional["Call"] = None
    conversation_message_topic: typing_extensions.Annotated[
        typing.Optional["ConversationMessageTopic"], FieldMetadata(alias="conversationMessageTopic")
    ] = None
...
update_forward_refs(ConversationMessage)
