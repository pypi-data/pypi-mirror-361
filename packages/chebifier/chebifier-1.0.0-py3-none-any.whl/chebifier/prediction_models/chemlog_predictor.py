...
from chemlog.alg_classification.charge_classifier import AlgChargeClassifier, get_charge_category
from chemlog.alg_classification.peptide_size_classifier import AlgPeptideSizeClassifier, get_n_amino_acid_residues
...
from chemlog.alg_classification.substructure_classifier import AlgSubstructureClassifier, is_emericellamide, is_diketopiperazine
    ...
    def explain_smiles(self, smiles) -> dict:
        ...
        for chebi_id, internal_name in [(64372, "emericellamide"), (65061, "2,5-diketopiperazines")]:
            if f"{internal_name}_atoms" in info:
                highlight_blocks += self.build_explain_blocks_atom_allocations(info[f"{internal_name}_atoms"], internal_name)
