...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/conjuntosprodutos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/conjuntosprodutos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/conjuntosprodutos/verificacao-integridade"
