...
from ..embeddings import EmbeddingProvider, TfidfEmbedder, VLLMEmbedder, LazyEmbedder
...
class ThothStorage:
    ...
    def __init__(
        ...
        # Use lazy embedder to avoid startup delays
        self.embedder = LazyEmbedder(use_vllm=use_vllm, vllm_model=vllm_model)
        logger.info("Using lazy embedder (will initialize on first use)")
