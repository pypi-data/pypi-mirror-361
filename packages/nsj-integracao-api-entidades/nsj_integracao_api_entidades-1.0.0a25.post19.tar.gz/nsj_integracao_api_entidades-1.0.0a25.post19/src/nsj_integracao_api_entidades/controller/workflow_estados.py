...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/estados"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/estados/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/estados/verificacao-integridade"
