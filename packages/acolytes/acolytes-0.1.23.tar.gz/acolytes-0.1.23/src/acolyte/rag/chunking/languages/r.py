...
class RChunker(LanguageChunker, PatternDetectionMixin, SecurityAnalysisMixin):
    ...
    def _get_tree_sitter_language(self) -> Any:
        ...
        # tree-sitter-r package not available on PyPI
        # Migrated from tree-sitter-languages but no individual package exists
        raise ImportError(
            "tree-sitter-r package is not available on PyPI. "
            "R chunking is currently disabled after tree-sitter-languages migration."
        )
