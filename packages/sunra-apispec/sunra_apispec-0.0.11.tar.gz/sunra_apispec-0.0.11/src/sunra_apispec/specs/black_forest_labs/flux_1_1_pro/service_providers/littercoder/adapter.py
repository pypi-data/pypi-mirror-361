...
from .schema import LittercoderFluxV11ProInput, OutputFormat
...
class LittercoderFluxV11ProTextToImageAdapter(ILittercoderAdapter):
    """Adapter for FLUX 1.1 Pro text-to-image generation using BFL Official API."""
    
    def convert_input(self, data) -> dict:
        """Convert Sunra TextToImageInput to Littercoder format."""
        input_model = TextToImageInput.model_validate(data)
        
        littercoder_input = LittercoderFluxV11ProInput(
    ...
    def get_request_endpoint(self) -> str:
        """Get the request endpoint for FLUX 1.1 Pro."""
        return "/flux/v1/flux-pro-1.1"
    
    def get_status_endpoint(self, task_id: str) -> str:
        """Get the status endpoint for FLUX 1.1 Pro."""
...
class LittercoderFluxV11ProImageToImageAdapter(ILittercoderAdapter):
    """Adapter for FLUX 1.1 Pro text-to-image generation using BFL Official API."""
    
    def convert_input(self, data) -> dict:
        """Convert Sunra ImageToImageInput to Littercoder format."""
