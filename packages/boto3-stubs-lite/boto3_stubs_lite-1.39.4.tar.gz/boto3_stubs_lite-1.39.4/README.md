...
Type annotations for [boto3 1.39.4](https://pypi.org/project/boto3/) compatible
...
1. Run mypy-boto3-builder in your package root directory:
   `uvx --with 'boto3==1.39.4' mypy-boto3-builder`
...
- `boto3-stubs-lite[full]` - Type annotations for all 409 services in one
  package (recommended).
- `boto3-stubs-lite[all]` - Type annotations for all 409 services in separate
  packages.
