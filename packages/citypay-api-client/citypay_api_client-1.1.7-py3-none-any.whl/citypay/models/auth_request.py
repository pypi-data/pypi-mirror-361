...
class AuthRequest(BaseModel):
    ...
    cp_card_token: Optional[StrictStr] = Field(default=None, description="The card token previously stored and created by the /tokenise route.")
    ...
    payment_intent_id: Optional[StrictStr] = Field(default=None, description="A payment intent id previously registered that this transaction is linked to.")
    ...
    threeds_token: Optional[StrictStr] = Field(default=None, description="The threedsecure token generated by a call to /areq which may or may not be challenged.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tag": obj.get("tag"),
            "threeds_token": obj.get("threeds_token"),
