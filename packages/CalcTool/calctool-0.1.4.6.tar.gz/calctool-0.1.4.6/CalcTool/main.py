        ...
        for i in range(len(checked_tag)*10):
            ...
            if item in [r"\frac", r"\cfrac"]:
                try:
                    ...
                    raise SyntaxError(r"missing argument for \frac" if item == r"\frac" else r"missing argument for \cfrac") from None
    ...
    def Calculate(tag):
        ...
        for i in range(len(tag)):
            ...
            # 无需替换
                ...
                elif tag[i-1][1] in ["function", "alphabet"]:
                    raise SyntaxError(f"wrong character '{item}'")
                else:
