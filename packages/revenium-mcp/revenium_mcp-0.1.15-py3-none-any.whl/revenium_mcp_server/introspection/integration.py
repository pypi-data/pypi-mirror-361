...
class IntrospectionIntegration:
    ...
    async def _register_enhanced_tools(self) -> None:
        ...
        try:
            ...
            from ..tools_decomposed.metering_field_validation import (
                MeteringFieldValidationManagement,
            )

            await self._register_tool_with_ucm(
                MeteringFieldValidationManagement,
                "Metering Field Validation",
            ...
            try:
                from ..tools_decomposed.slack_configuration_management import (
                ...
                logger.warning(
                    f"Could not register slack_configuration_management for introspection: {e}"
                )
    ...
    async def get_server_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "available_actions": ["list_tools", "get_tool_metadata", "get_all_metadata"],
        }
