...
def list_models(
    provider: Annotated[Optional[Provider], typer.Option("--provider", "-p", help="List models for specific provider")] = None,
):
    """List available models for all providers or a specific provider."""
    
    if provider:
        # List models for specific provider
        models = Models.get_all_models(provider.value)
        
        table = Table(title=f"{provider.value.title()} Models")
        ...
        console.print(table)
        console.print(f"\n[green]Total: {len(models)} models[/green]")
        ...
        for provider_name, model_list in all_models.items():
            ...
            console.print(table)
            console.print(f"[green]{len(model_list)} models[/green]\n")
