...
from finetune.GRPO.reward import dataset
...
def hive_reward_train(
        ...
        hive_reward_folder_path: str = typer.Option('', help="Path to the hive-reward dataset folder."),
        ...
        alpaca_dataset_path: str = typer.Option("", help="Path to the alpaca dataset for training."),
        ...
        remote_url: str = typer.Option('', help="Remote URL of evaluator."),
        remote_batch_size: int = typer.Option(500, help="Batch size of prompts fetched from remote URL."),
    ...
    T = HiveTrainer(
        dataset=dataset.get_dataset_by_args(**locals()),
