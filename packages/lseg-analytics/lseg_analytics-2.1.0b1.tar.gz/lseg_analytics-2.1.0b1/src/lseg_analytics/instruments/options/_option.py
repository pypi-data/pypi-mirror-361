    ...
    def _create(self, location: Location) -> None:
        ...
        try:
            ...
            response = check_and_raise(
                Client().options_resource.create(
                    location=location,
            ...
            logger.error(f"Error creating Option: {err}")
            raise err

    def _overwrite(self) -> None:
        """
        Overwrite a Option that exists in the platform.
    ...
    def solve(
        ...
        *,
        ...
        try:
            ...
            logger.error(f"Error solve for option with id. {err}")
    ...
    def value(
        ...
        *,
        ...
        try:
            ...
            logger.error(f"Error value for option with id. {err}")
            check_exception_and_raise(err)
