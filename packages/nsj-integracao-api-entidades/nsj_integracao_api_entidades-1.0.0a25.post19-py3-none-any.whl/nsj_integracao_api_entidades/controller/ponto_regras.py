...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ponto/regras"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ponto/regras/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ponto/regras/verificacao-integridade"
