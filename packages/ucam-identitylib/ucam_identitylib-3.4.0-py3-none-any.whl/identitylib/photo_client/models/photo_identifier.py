...
class PhotoIdentifier(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PhotoIdentifier from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PhotoIdentifier from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "relatedIdentifiers": [V1Beta1PhotoIdentifierSummary.from_dict(_item) for _item in obj["relatedIdentifiers"]] if obj.get("relatedIdentifiers") is not None else None,
