...
class TestPeriodicAgent(unittest.TestCase):
    """PeriodicAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PeriodicAgent:
        """Test PeriodicAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PeriodicAgent`
        """
        model = PeriodicAgent()
        if include_optional:
