...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/tipos_objecoes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/tipos_objecoes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/tipos_objecoes/verificacao-integridade"
