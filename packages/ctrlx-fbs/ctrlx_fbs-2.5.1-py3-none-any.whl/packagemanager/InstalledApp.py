...
def InstalledAppStart(builder): builder.StartObject(15)
def Start(builder):
...
def InstalledAppAddImpactsRealtime(builder, impactsRealtime): builder.PrependBoolSlot(12, impactsRealtime, 0)
def AddImpactsRealtime(builder, impactsRealtime):
    return InstalledAppAddImpactsRealtime(builder, impactsRealtime)
def InstalledAppAddEnabled(builder, enabled): builder.PrependBoolSlot(13, enabled, 0)
def AddEnabled(builder, enabled):
    return InstalledAppAddEnabled(builder, enabled)
def InstalledAppAddRelease(builder, release): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(release), 0)
...
class InstalledAppT(object):
    ...
    def __init__(self):
        ...
        self.impactsRealtime = False  # type: bool
    ...
    def __eq__(self, other):
        return type(self) == type(other) and \
            ...
            self.impactsRealtime == other.impactsRealtime and \
    ...
    def _UnPack(self, installedApp):
        ...
        self.impactsRealtime = installedApp.ImpactsRealtime()
    ...
    def Pack(self, builder):
        ...
        InstalledAppAddImpactsRealtime(builder, self.impactsRealtime)
