...
async def handle_call_tool(
    ...
    if name in ["create-video-bar-chart-from-two-axis-data", "create-video-line-chart-from-two-axis-data"] and arguments:
        ...
        try:
            ...
            chart_type = "bar" if name == "create-video-bar-chart-from-two-axis-data" else "line"
