...
class ProviderRequest(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["sandbox", "bamboohr", "breathe", "cezanne", "charliehr", "deel", "deputy", "hailyhr", "hibob", "humaans", "iris cascade", "moorepay", "nmbrs", "parolla.ie", "payfit", "personio.de", "planday", "sagehr", "saplinghr", "staffology", "xero uk", "brain payroll", "brightpay connect", "buk", "employment hero", "epe", "factorialhr", "fourthhr", "gusto", "itrent", "justworks", "kontek.se", "onpay", "oysterhr", "paycircle", "pento.io", "peoplehr", "quickbooks online", "remote.com", "runa", "sageone", "shape payroll", "simplepay.ie", "talenox", "unity", "zoho", "zucchetti", ]  # noqa: E501
