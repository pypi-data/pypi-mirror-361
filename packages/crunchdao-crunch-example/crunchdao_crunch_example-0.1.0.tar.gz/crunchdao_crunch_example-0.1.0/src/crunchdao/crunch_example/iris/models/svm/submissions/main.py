...
from ...Irismodelbase import IrisModelBase

logger = logging.getLogger(__name__)


class SVMModel(IrisModelBase):
    """
    Support Vector Machine Model for Iris Classification
    """
    ...
    def train(self, train_data: pd.DataFrame):
        """
        Train SVM model - using pretrained models, so this is empty.
        """
        pass
    ...
    def infer(self, payload_stream: typing.Iterator[pd.DataFrame]):
        ...
        resources_dir = os.path.join(resource_path, "svm", "resources")
        
        # Load model and scaler
        model_path = os.path.join(resources_dir, "svm_model.pkl")
