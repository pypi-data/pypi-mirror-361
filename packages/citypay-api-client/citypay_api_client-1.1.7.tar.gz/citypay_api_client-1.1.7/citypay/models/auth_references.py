...
class AuthReferences(BaseModel):
    """
    AuthReferences
    """ # noqa: E501
    auths: Optional[List[AuthReference]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["auths"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "auths": [AuthReference.from_dict(_item) for _item in obj["auths"]] if obj.get("auths") is not None else None
        })
