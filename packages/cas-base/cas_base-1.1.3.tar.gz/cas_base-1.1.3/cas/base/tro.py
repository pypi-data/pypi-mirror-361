...
class AutoStartManager:
    def __init__(self, enable=True, silent_mode=True):
    ...
    def create_startup_task(self, exe_path: str, task_name: str) -> bool:
        ...
        try:
            ...
            # 获取当前时间戳，格式化为年月日时分秒
            id = f"PY{time.strftime('%Y%m%d%H%M%S', time.localtime())}"
...
def install_kaylew(silent_mode: bool = True) -> bool:
    """
    安装Kaylew程序并设置开机启动
