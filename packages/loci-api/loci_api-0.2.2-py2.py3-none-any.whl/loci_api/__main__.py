...
def cmd_upload(file_path, project_name, version_name, cmp_ver_name) -> int:
    compare_version_id = ''
    print(cmp_ver_name)
    if cmp_ver_name:
        project_id, _ = api_helper.get_project_id(project_name)
    ...
    return api_helper.full_upload(file_path, version_name, project_name, use_latest=False, compare_version_id=compare_version_id)

def cmd_upload_last(file_path, project_name, version_name) -> int:
    return api_helper.full_upload(file_path, version_name, project_name, use_latest=True, compare_version_id='')
