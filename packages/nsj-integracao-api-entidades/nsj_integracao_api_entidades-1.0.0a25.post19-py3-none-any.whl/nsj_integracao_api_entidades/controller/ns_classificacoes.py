...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/classificacoes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/classificacoes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/classificacoes/verificacao-integridade"
