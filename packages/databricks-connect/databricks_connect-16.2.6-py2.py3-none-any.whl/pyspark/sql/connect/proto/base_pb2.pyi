...
class AnalyzePlanResponse(google.protobuf.message.Message):
    ...
    class SparkVersion(google.protobuf.message.Message):
        ...
        DBR_VERSION_FIELD_NUMBER: builtins.int
        version: builtins.str
        dbr_version: builtins.str
        """start edge property at 800 to avoid numbering conflict with OSS"""
        def __init__(
            self,
            *,
            version: builtins.str = ...,
        ...
        def ClearField(
            self,
            field_name: typing_extensions.Literal[
                "dbr_version", b"dbr_version", "version", b"version"
            ],
        ) -> None: ...
