...
class SenderIdentityList(BaseModel):
    ...
    SenderIdentityList
    """ # noqa: E501
    result: Optional[List[SenderIdentityViewModel]] = None
    page_details: Optional[PageDetails] = Field(default=None, alias="pageDetails")
    __properties: ClassVar[List[str]] = ["result", "pageDetails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": [SenderIdentityViewModel.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
