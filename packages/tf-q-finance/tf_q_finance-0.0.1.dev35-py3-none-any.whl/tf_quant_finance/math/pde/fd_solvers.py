...
from tf_quant_finance.math.pde.steppers.oscillation_damped_crank_nicolson import (
...
def _solve(
    ...
    with tf.compat.v1.name_scope(
        ...
        time_step_fn, est_max_steps = _get_time_steps_info(
            start_time, end_time, num_steps, time_step, time_direction_fn
        )
        ...
        (_, final_time, final_coords, final_values, steps_performed) = tf.while_loop(
            loop_cond,
            loop_body,
            initial_args,
