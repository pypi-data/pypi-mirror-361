...
class OrmWorkload(object):
    ...
    def __init__(self, autoscaler_config=None, created_dt=None, distributed_number=None, edges=None, endpoints=None, env_vars=None, exit_code=None, experiment_id=None, final_cost=None, id=None, is_transfered=None, kernel_cluster_select_policies=None, kubernetes_service_account=None, last_alive_updated=None, last_charged=None, model_service_revision_id=None, organization_id=None, run_argument=None, run_exec_id=None, start_command=None, status=None, status_last_updated=None, status_reason=None, type=None, updated_dt=None, use_log_manager=None, volume_mounts=None, wait_kill_reason=None, workload_kernel_cluster=None, workload_kernel_cluster_node=None, workload_kernel_image=None, workload_kernel_resource_spec=None, workspace_id=None, local_vars_configuration=None):  # noqa: E501
