...
class ITCDocumentList(BaseModel):
    """
    ITCDocumentList
    """ # noqa: E501
    entries: List[ITCDocument]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [ITCDocument.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
