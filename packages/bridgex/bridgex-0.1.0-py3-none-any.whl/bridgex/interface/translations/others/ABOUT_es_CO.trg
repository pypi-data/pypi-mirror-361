...
<div class="main">
    ...
    <pre>&copy;2025 <a href="https://github.com/Dev2Forge">Dev2Forge</a> - <a href="https://github.com/Dev2Forge/bridgex/blob/main/LICENSE">MIT</a></pre>
        ...
        <div id="content-about">
            <p>
            Bridgex ofrece una interfaz gráfica sencilla para convertir automáticamente documentos al formato Markdown.
          </p>
    ...
    ".zip", ".mhtml",".htm", ".epub", ".html"</pre>
        <p><strong>¡Y Muchas Más!</strong></p>
          <p>
            Al cargar un archivo, Bridgex extrae texto plano y lo transforma en Markdown manteniendo la estructura siempre que sea posible.
    ...
    <div>
        ...
        <pre class="center">Soporte <a href="mailto:bridgex@dev2forge.software">bridgex@dev2forge.software</a></pre>
    </div>
</div>