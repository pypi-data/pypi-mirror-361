...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/configuracaoacessoapi"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/configuracaoacessoapi/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/configuracaoacessoapi/verificacao-integridade"
