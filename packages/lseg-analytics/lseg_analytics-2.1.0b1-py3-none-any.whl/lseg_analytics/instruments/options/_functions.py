    ...
    *,
    ...
    try:
        ...
        response = check_and_raise(
            Client().options_resource.create_asian_otc_option_from_template(
                fields=fields,
        ...
        logger.error(f"Error create_asian_otc_option_from_template {err}")
...
def create_double_barrier_otc_option_from_template(
    *,
    ...
    try:
        ...
        response = check_and_raise(
            Client().options_resource.create_double_barrier_otc_option_from_template(
                fields=fields,
                template_reference=template_reference,
                overrides=overrides,
            )
        ...
        logger.error(f"Error create_double_barrier_otc_option_from_template {err}")
        check_exception_and_raise(err)
...
def create_double_binary_otc_option_from_template(
    *,
    ...
    try:
        ...
        response = check_and_raise(
            Client().options_resource.create_double_binary_otc_option_from_template(
                fields=fields,
                template_reference=template_reference,
                overrides=overrides,
            )
        ...
        logger.error(f"Error create_double_binary_otc_option_from_template {err}")
        check_exception_and_raise(err)
...
def create_single_barrier_otc_option_from_template(
    *,
    ...
    try:
        ...
        response = check_and_raise(
            Client().options_resource.create_single_barrier_otc_option_from_template(
                fields=fields,
                template_reference=template_reference,
                overrides=overrides,
            )
        ...
        logger.error(f"Error create_single_barrier_otc_option_from_template {err}")
        check_exception_and_raise(err)
...
def create_single_binary_otc_option_from_template(
    *,
    ...
    try:
        ...
        response = check_and_raise(
            Client().options_resource.create_single_binary_otc_option_from_template(
                fields=fields,
                template_reference=template_reference,
                overrides=overrides,
            )
        ...
        logger.error(f"Error create_single_binary_otc_option_from_template {err}")
        check_exception_and_raise(err)
...
def create_vanilla_otc_option_from_template(
    *,
    ...
    try:
        ...
        response = check_and_raise(
            Client().options_resource.create_vanilla_otc_option_from_template(
                fields=fields,
                template_reference=template_reference,
                overrides=overrides,
            )
        ...
        logger.error(f"Error create_vanilla_otc_option_from_template {err}")
        check_exception_and_raise(err)


def _delete_by_id(instrument_id: str) -> bool:
    """
    Delete a Option that exists in the platform.
    ...
    try:
        ...
        check_and_raise(Client().option_resource.delete(instrument_id=instrument_id))
...
def _load_by_id(instrument_id: str, fields: Optional[str] = None) -> Option:
    """
    Access a Option existing in the platform (read).
    ...
    try:
        ...
        response = check_and_raise(Client().option_resource.read(instrument_id=instrument_id, fields=fields))
        ...
        logger.error(f"Error opening Option: {err}")
        check_exception_and_raise(err)
