...
class LimitsOverride(BaseModel):
    ...
    """ # noqa: E501
    joint_velocity_limits: Optional[List[Union[StrictFloat, StrictInt]]] = Field(default=None, description="Maximum joint velocity in [rad/s] for each joint. Either leave this field empty or set a value for each joint. ")
    joint_acceleration_limits: Optional[List[Union[StrictFloat, StrictInt]]] = Field(default=None, description="Maximum joint acceleration in [rad/s^2] for each joint. Either leave this field empty or set a value for each joint. ")
