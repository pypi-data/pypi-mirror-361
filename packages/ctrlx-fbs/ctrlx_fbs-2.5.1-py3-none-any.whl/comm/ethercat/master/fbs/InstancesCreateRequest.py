...
def InstancesCreateRequestStart(builder): builder.StartObject(5)
def Start(builder):
...
def InstancesCreateRequestAddTaskConfig(builder, taskConfig): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(taskConfig), 0)
def AddTaskConfig(builder, taskConfig):
    return InstancesCreateRequestAddTaskConfig(builder, taskConfig)
...
class InstancesCreateRequestT(object):
    ...
    def __init__(self):
        ...
        self.taskConfig = None  # type: Optional[comm.ethercat.master.fbs.TaskConfiguration.TaskConfigurationT]
    ...
    def __eq__(self, other):
        return type(self) == type(other) and \
            ...
            self.taskConfig == other.taskConfig
    ...
    def _UnPack(self, instancesCreateRequest):
        ...
        if instancesCreateRequest.TaskConfig() is not None:
            self.taskConfig = comm.ethercat.master.fbs.TaskConfiguration.TaskConfigurationT.InitFromObj(instancesCreateRequest.TaskConfig())
    ...
    def Pack(self, builder):
        ...
        if self.taskConfig is not None:
            taskConfig = self.taskConfig.Pack(builder)
        ...
        if self.taskConfig is not None:
            InstancesCreateRequestAddTaskConfig(builder, taskConfig)
