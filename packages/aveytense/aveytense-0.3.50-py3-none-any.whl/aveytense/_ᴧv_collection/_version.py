...
_qualifier_type = __.Literal["alpha", "beta", "candidate", "final"]
_version_tuple_content = (0, 3, 50, "final", 0) # >= 0.3.48
...
_current_version_info_type1 = _tuple[__.Literal[0]]
_current_version_info_type2 = _tuple[__.Unpack[_current_version_info_type1], __.Literal[3]]
_current_version_info_type3 = _tuple[__.Unpack[_current_version_info_type2], __.Literal[50]]
_current_version_info_type4 = _tuple[__.Unpack[_current_version_info_type3], __.Literal["final"]]
_current_version_info_type5 = _tuple[__.Unpack[_current_version_info_type4], __.Literal[0]]
...
"""
@lifetime ≥ 0.3.26b3 \\
https://aveyzan.xyz/tense#tense.constants.VERSION

Returns currently used version of AveyTense
"""

VERSION_TYPE = __.Literal["0.3.50"]
"""
@lifetime ≥ 0.3.47
"""
...
"""
@lifetime >= 0.3.26b3 \\
https://aveyzan.xyz/aveytense#aveytense.constants.VERSION_INFO
"""
