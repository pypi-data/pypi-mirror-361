...
class BrandingRecords(BaseModel):
    """
    BrandingRecords
    """ # noqa: E501
    result: Optional[List[ViewBrandDetails]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": [ViewBrandDetails.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None
        })
        return _obj
