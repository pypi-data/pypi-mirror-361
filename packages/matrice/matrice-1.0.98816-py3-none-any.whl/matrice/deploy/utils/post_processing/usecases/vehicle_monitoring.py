...
class VehicleMonitoringUseCase(BaseProcessor):
    ...
    def _generate_tracking_stats(self, counting_summary: Dict, insights: List[str], summary: dict, config: VehicleMonitoringConfig, frame_number: Optional[int] = None, stream_info: Optional[Dict[str, Any]] = None) -> List[Dict]:
