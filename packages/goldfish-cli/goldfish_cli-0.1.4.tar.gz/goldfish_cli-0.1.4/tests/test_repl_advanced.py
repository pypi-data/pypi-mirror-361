...
class TestREPLAdvanced:
    ...
    @patch('goldfish_cli.repl.console')
    @patch('goldfish_cli.repl.Confirm')
    def test_capture_text_with_entities_save_yes(self, mock_confirm, mock_console):
    ...
    @patch('goldfish_cli.repl.console')
    @patch('goldfish_cli.repl.Confirm')
    def test_capture_text_with_entities_save_no(self, mock_confirm, mock_console):
    ...
    def test_show_notes_with_notes(self, mock_console, mock_session_class):
        ...
        with patch('goldfish_cli.repl.Table') as mock_table:
    ...
    def test_show_entities(self, mock_console, mock_session_class):
        ...
        with patch('goldfish_cli.repl.dashboard') as mock_dashboard:
