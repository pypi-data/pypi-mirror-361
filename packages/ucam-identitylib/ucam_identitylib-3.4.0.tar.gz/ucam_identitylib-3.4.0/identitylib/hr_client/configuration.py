...
class Configuration:
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.apps.cam.ac.uk/university-human-resources/v1alpha2" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("identitylib.hr_client")
