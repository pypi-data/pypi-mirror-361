...
import pandas as pd
from .schemas.wage_component_definition import WageComponentDefinitionSchema

# Entity type constant
ENTITY_TYPE = "hr2d__Looncomponent__c"


class WageComponentDefinition:
    """
    Handles wage component definition operations for HR2Day API.
    WageComponentDefinition holds information about wage component definitions in the Salesforce system.
    """

    def __init__(self, hr2day_instance):
        """
        Initialize the WageComponentDefinition class.
    ...
    def get(self,
        ...
        """
        Get wage component definition data from Salesforce.
        ...
        Args:
            ...
            related (Dict[str, List[str]], optional): Dictionary of related fields to select.
                                                    Example: {"Account": ["Name"]} will include account name.
            ...
            validate (bool, optional): Whether to validate the data against the WageComponentDefinitionSchema. Defaults to False.

        Returns:
            pd.DataFrame: DataFrame containing wage component definition data
        ...
        return self.hr2day.get(
            ...
            limit=limit,
            offset=skip,
            schema=WageComponentDefinitionSchema
        ) 