...
class AuthApi:
    ...
    async def request_challenge(
        ...
        :param challenge_request: (required)
        :type challenge_request: ChallengeRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._request_challenge_serialize(
    ...
    @validate_call
    async def request_challenge_with_http_info(
        self,
        challenge_request: ChallengeRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def request_challenge_without_preload_content(
        self,
        challenge_request: ChallengeRequest,
        _request_timeout: Union[
            None,
    ...
    def _request_challenge_serialize(
        self,
        challenge_request,
        _request_auth,
        _content_type,
        ...
        if challenge_request is not None:
            _body_params = challenge_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/auth/challenge',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def submit_proof(
        ...
        :param proof_request: (required)
        :type proof_request: ProofRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._submit_proof_serialize(
    ...
    @validate_call
    async def submit_proof_with_http_info(
        self,
        proof_request: ProofRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def submit_proof_without_preload_content(
        self,
        proof_request: ProofRequest,
        _request_timeout: Union[
            None,
