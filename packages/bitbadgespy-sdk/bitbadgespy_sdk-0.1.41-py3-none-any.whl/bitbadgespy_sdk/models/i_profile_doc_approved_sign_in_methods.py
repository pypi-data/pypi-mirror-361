...
class IProfileDocApprovedSignInMethods(BaseModel):
    ...
    """ # noqa: E501
    discord: Optional[IUpdateAccountInfoPayloadApprovedSignInMethodsDiscord] = None
    github: Optional[IUpdateAccountInfoPayloadApprovedSignInMethodsGithub] = None
    google: Optional[IUpdateAccountInfoPayloadApprovedSignInMethodsGithub] = None
    twitter: Optional[IUpdateAccountInfoPayloadApprovedSignInMethodsGithub] = None
    facebook: Optional[IUpdateAccountInfoPayloadApprovedSignInMethodsGithub] = None
    addresses: Optional[List[IUpdateAccountInfoPayloadApprovedSignInMethodsAddressesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "discord": IUpdateAccountInfoPayloadApprovedSignInMethodsDiscord.from_dict(obj["discord"]) if obj.get("discord") is not None else None,
            "github": IUpdateAccountInfoPayloadApprovedSignInMethodsGithub.from_dict(obj["github"]) if obj.get("github") is not None else None,
            "google": IUpdateAccountInfoPayloadApprovedSignInMethodsGithub.from_dict(obj["google"]) if obj.get("google") is not None else None,
            "twitter": IUpdateAccountInfoPayloadApprovedSignInMethodsGithub.from_dict(obj["twitter"]) if obj.get("twitter") is not None else None,
            "facebook": IUpdateAccountInfoPayloadApprovedSignInMethodsGithub.from_dict(obj["facebook"]) if obj.get("facebook") is not None else None,
            "addresses": [IUpdateAccountInfoPayloadApprovedSignInMethodsAddressesInner.from_dict(_item) for _item in obj["addresses"]] if obj.get("addresses") is not None else None,
