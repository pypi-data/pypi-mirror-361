...
def from_protos(
    ...
    for am_option_proto in proto_list:
        ...
        expiry_date = [expiry_date.year, expiry_date.month, expiry_date.day]
        ...
        calendar = business_days.holiday_from_proto_value(am_option_proto.bank_holidays)
...
def tensor_repr(am_option_data: Dict[str, Any], dtype: Optional[types.Dtype] = None):
    ...
    res["is_call_option"] = tf.convert_to_tensor(
        am_option_data["is_call_option"], dtype=tf.bool, name="is_call_options"
    )
