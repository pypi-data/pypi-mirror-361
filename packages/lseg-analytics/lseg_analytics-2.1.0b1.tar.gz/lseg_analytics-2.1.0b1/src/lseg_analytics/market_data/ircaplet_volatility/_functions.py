...
def calculate(
    *,
    universe: Optional[List[CapletsStrippingSurfaceRequestItem]] = None,
    ...
    try:
        ...
        response = check_and_raise(Client().ircaplet_volatility.calculate(fields=fields, universe=universe))
