...
from toasttab.models.applied_discount import AppliedDiscount

class TestAppliedDiscount(unittest.TestCase):
    """AppliedDiscount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppliedDiscount:
        """Test AppliedDiscount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppliedDiscount`
        """
