...
class ApiAutoPolicyWaiverExclusionRequestDTO(BaseModel):
    """
    ...
    match_strategy: Optional[StrictStr] = Field(default=None, alias="matchStrategy")
    ...
    __properties: ClassVar[List[str]] = ["applicationPublicId", "autoPolicyWaiverId", "matchStrategy", "ownerId", "policyViolationId", "scanId"]

    @field_validator('match_strategy')
    def match_strategy_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiAutoPolicyWaiverExclusionRequestDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiAutoPolicyWaiverExclusionRequestDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "matchStrategy": obj.get("matchStrategy"),
