...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/locaisdeuso"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/locaisdeuso/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/locaisdeuso/verificacao-integridade"
