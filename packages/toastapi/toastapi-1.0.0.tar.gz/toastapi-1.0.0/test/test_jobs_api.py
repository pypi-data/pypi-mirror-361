...
from toasttab.api.jobs_api import JobsApi
...
class TestJobsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_jobs_get(self) -> None:
    ...
    async def test_jobs_job_id_external_id_post(self) -> None:
        """Test case for jobs_job_id_external_id_post

        Add an external identifier
        """
        pass

    async def test_jobs_job_id_external_id_put(self) -> None:
        """Test case for jobs_job_id_external_id_put

        Add or replace an external identifier
        """
        pass

    async def test_jobs_job_id_get(self) -> None:
