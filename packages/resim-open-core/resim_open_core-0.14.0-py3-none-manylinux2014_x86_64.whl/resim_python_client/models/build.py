...
class Build:
    """ 
        Attributes:
            ...
            description (str): [DEPRECATED] This field was previously used to set the build's name. If both 'description'
                and 'name' are provided, 'name' will take precedence. In a future version, this field will be repurposed to
                store the build's description.
            image_uri (str):
            long_description (str): [DEPRECATED] This field is temporarily being used to set the build's description. In a
                future version, the `description` field will be used instead.
            name (str): The name of the build. This replaces the previous usage of 'description'.
            org_id (str):
            project_id (str):
            system_id (str):
            user_id (str):
