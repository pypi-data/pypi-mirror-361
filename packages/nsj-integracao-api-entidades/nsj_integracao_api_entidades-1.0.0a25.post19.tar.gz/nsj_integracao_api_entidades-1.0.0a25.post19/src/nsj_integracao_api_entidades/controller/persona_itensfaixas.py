...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/itensfaixas"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/itensfaixas/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/itensfaixas/verificacao-integridade"
