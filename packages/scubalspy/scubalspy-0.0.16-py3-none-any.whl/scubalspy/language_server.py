"""
This file contains the main interface and the public API for scubalspy. 
...
from .scubalspy_config import Language, ScubalspyConfig
from .scubalspy_exceptions import ScubalspyException
from .scubalspy_logger import ScubalspyLogger
from .scubalspy_utils import FileUtils, PathUtils, TextUtils
...
class LanguageServer:
    ...
    @classmethod
    def create(cls, config: ScubalspyConfig, logger: ScubalspyLogger, repository_root_path: str) -> "LanguageServer":
        """
        ...
        :param config: The Scubalspy configuration.
        ...
        if config.code_language == Language.PYTHON:
            ...
            raise ScubalspyException(f"Language {config.code_language} is not supported")
    ...
    def insert_text_at_position(
        ...
        return scubalspy_types.Position(line=new_l, character=new_c)

    def delete_text_between_positions(
        self,
        relative_file_path: str,
        start: scubalspy_types.Position,
        end: scubalspy_types.Position,
    ) -> str:
        """
    ...
    async def request_definition(
        ...
        :return List[scubalspy_types.Location]: A list of locations where the symbol is defined
        """
    ...
    async def request_references(
        ...
        :return List[scubalspy_types.Location]: A list of locations where the symbol is referenced
        """
    ...
    async def request_completions(
    ...
    ) -> List[scubalspy_types.CompletionItem]:
        """
        ...
        :return List[scubalspy_types.CompletionItem]: A list of completions
        """
        with self.open_file(relative_file_path):
            ...
            completions_list: List[scubalspy_types.CompletionItem] = []
            ...
            for item in items:
                ...
                completion_item = scubalspy_types.CompletionItem(**completion_item)
    ...
    async def request_document_symbols(self, relative_file_path: str) -> Tuple[List[scubalspy_types.UnifiedSymbolInformation], Union[List[scubalspy_types.TreeRepr], None]]:
        """
        ...
        :return Tuple[List[scubalspy_types.UnifiedSymbolInformation], Union[List[scubalspy_types.TreeRepr], None]]: A list of symbols in the file, and the tree representation of the symbols
        """
        with self.open_file(relative_file_path):
        ...
        for item in response:
            ...
            if LSPConstants.CHILDREN in item:
                ...
                def visit_tree_nodes_and_build_tree_repr(tree: LSPTypes.DocumentSymbol) -> List[scubalspy_types.UnifiedSymbolInformation]:
                    l: List[scubalspy_types.UnifiedSymbolInformation] = []
                    children = tree['children'] if 'children' in tree else []
                    if 'children' in tree:
                        del tree['children']
                    l.append(scubalspy_types.UnifiedSymbolInformation(**tree))
                ...
                ret.append(scubalspy_types.UnifiedSymbolInformation(**item))

        return ret, l_tree
    
    async def request_hover(self, relative_file_path: str, line: int, column: int) -> Union[scubalspy_types.Hover, None]:
        """
        ...
        return scubalspy_types.Hover(**response)

    async def request_workspace_symbol(self, query: str) -> Union[List[scubalspy_types.UnifiedSymbolInformation], None]:
        """
        ...
        :return Union[List[scubalspy_types.UnifiedSymbolInformation], None]: A list of matching symbols
        """
...
class SyncLanguageServer:
    ...
    @classmethod
    def create(
        cls, config: ScubalspyConfig, logger: ScubalspyLogger, repository_root_path: str, timeout: Optional[int] = None
    ) -> "SyncLanguageServer":
        """
        Creates a language specific LanguageServer instance based on the given configuration, and appropriate settings for the programming language.
    ...
    def request_definition(self, file_path: str, line: int, column: int) -> List[scubalspy_types.Location]:
        """
        Raise a [textDocument/definition](https://microsoft.github.io/language-server-protocol/specifications/lsp/3.17/specification/#textDocument_definition) request to the Language Server
        for the symbol at the given line and column in the given file. Wait for the response and return the result.
    ...
    def request_references(self, file_path: str, line: int, column: int) -> List[scubalspy_types.Location]:
        """
        Raise a [textDocument/references](https://microsoft.github.io/language-server-protocol/specifications/lsp/3.17/specification/#textDocument_references) request to the Language Server
        to find references to the symbol at the given line and column in the given file. Wait for the response and return the result.
    ...
    def request_document_symbols(self, relative_file_path: str) -> Tuple[List[scubalspy_types.UnifiedSymbolInformation], Union[List[scubalspy_types.TreeRepr], None]]:
        """
        Raise a [textDocument/documentSymbol](https://microsoft.github.io/language-server-protocol/specifications/lsp/3.17/specification/#textDocument_documentSymbol) request to the Language Server
        to find symbols in the given file. Wait for the response and return the result.
    ...
    def request_hover(self, relative_file_path: str, line: int, column: int) -> Union[scubalspy_types.Hover, None]:
        """
        Raise a [textDocument/hover](https://microsoft.github.io/language-server-protocol/specifications/lsp/3.17/specification/#textDocument_hover) request to the Language Server
        to find the hover information at the given line and column in the given file. Wait for the response and return the result.
    ...
    def request_workspace_symbol(self, query: str) -> Union[List[scubalspy_types.UnifiedSymbolInformation], None]:
        """
        Raise a [workspace/symbol](https://microsoft.github.io/language-server-protocol/specifications/lsp/3.17/specification/#workspace_symbol) request to the Language Server
        to find symbols across the whole workspace. Wait for the response and return the result.
