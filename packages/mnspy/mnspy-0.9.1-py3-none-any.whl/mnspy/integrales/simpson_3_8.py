...
class Simpson38(Integral):
    """Clase para la implementación de la integral por el método de Simpson 3/8
    ...
    def _calcular(self):
        """Calcula la integral por el método de Simpson 3/8, el resultado queda guardado en el
        atributo integral
        ...
        for i in range(self._n - 1):
            ...
            if (i % 3) == 2:
                ...
                s += 3 * self._f(x)
        s += self._f(self._b)
        self.integral = 3 * (self._b - self._a) * s / 8 / self._n
