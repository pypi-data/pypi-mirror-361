...
class FxForward(ResourceBase):
    ...
    def _create(self, location: Location) -> None:
        ...
        try:
            ...
            logger.error(f"Error creating FxForward: {err}")
            raise err

    def _overwrite(self) -> None:
        """
        Overwrite a FxForward that exists in the platform.
    ...
    def price(
        ...
        *,
        ...
        try:
            ...
            logger.error(f"Error price for fxForward with id. {err}")
    ...
    def value(
        ...
        *,
        ...
        try:
            ...
            logger.error(f"Error value for fxForward with id. {err}")
            check_exception_and_raise(err)
