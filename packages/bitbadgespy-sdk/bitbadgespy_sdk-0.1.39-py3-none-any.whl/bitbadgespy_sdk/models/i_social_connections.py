...
class ISocialConnections(BaseModel):
    ...
    google: Optional[ISocialConnectionsGoogle] = None
    github: Optional[ISocialConnectionsGoogle] = None
    twitch: Optional[ISocialConnectionsGoogle] = None
    strava: Optional[ISocialConnectionsGoogle] = None
    reddit: Optional[ISocialConnectionsGoogle] = None
    meetup: Optional[ISocialConnectionsGoogle] = None
    bluesky: Optional[ISocialConnectionsGoogle] = None
    mailchimp: Optional[ISocialConnectionsGoogle] = None
    facebook: Optional[ISocialConnectionsGoogle] = None
    google_calendar: Optional[ISocialConnectionsGoogle] = Field(default=None, alias="googleCalendar")
    youtube: Optional[ISocialConnectionsGoogle] = None
    linked_in: Optional[ISocialConnectionsGoogle] = Field(default=None, alias="linkedIn")
    shopify: Optional[ISocialConnectionsGoogle] = None
    telegram: Optional[ISocialConnectionsGoogle] = None
    farcaster: Optional[ISocialConnectionsGoogle] = None
    slack: Optional[ISocialConnectionsGoogle] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "google": ISocialConnectionsGoogle.from_dict(obj["google"]) if obj.get("google") is not None else None,
            "github": ISocialConnectionsGoogle.from_dict(obj["github"]) if obj.get("github") is not None else None,
            "twitch": ISocialConnectionsGoogle.from_dict(obj["twitch"]) if obj.get("twitch") is not None else None,
            "strava": ISocialConnectionsGoogle.from_dict(obj["strava"]) if obj.get("strava") is not None else None,
            "reddit": ISocialConnectionsGoogle.from_dict(obj["reddit"]) if obj.get("reddit") is not None else None,
            "meetup": ISocialConnectionsGoogle.from_dict(obj["meetup"]) if obj.get("meetup") is not None else None,
            "bluesky": ISocialConnectionsGoogle.from_dict(obj["bluesky"]) if obj.get("bluesky") is not None else None,
            "mailchimp": ISocialConnectionsGoogle.from_dict(obj["mailchimp"]) if obj.get("mailchimp") is not None else None,
            "facebook": ISocialConnectionsGoogle.from_dict(obj["facebook"]) if obj.get("facebook") is not None else None,
            "googleCalendar": ISocialConnectionsGoogle.from_dict(obj["googleCalendar"]) if obj.get("googleCalendar") is not None else None,
            "youtube": ISocialConnectionsGoogle.from_dict(obj["youtube"]) if obj.get("youtube") is not None else None,
            "linkedIn": ISocialConnectionsGoogle.from_dict(obj["linkedIn"]) if obj.get("linkedIn") is not None else None,
            "shopify": ISocialConnectionsGoogle.from_dict(obj["shopify"]) if obj.get("shopify") is not None else None,
            "telegram": ISocialConnectionsGoogle.from_dict(obj["telegram"]) if obj.get("telegram") is not None else None,
            "farcaster": ISocialConnectionsGoogle.from_dict(obj["farcaster"]) if obj.get("farcaster") is not None else None,
            "slack": ISocialConnectionsGoogle.from_dict(obj["slack"]) if obj.get("slack") is not None else None
        })
