...
from ....types.system.patients import (
    ...
    bulk_update_profile_embeddings_params,
)
...
class BulkResource(SyncAPIResource):
    ...
    def update_profile_embeddings(
        ...
        tenant_db_name: str,
        *,
        body: Iterable[bulk_update_profile_embeddings_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        if not tenant_db_name:
            raise ValueError(f"Expected a non-empty value for `tenant_db_name` but received {tenant_db_name!r}")
        return self._put(
            f"/system/{tenant_db_name}/patients/bulk/patient_profile_embeddings",
            body=maybe_transform(body, Iterable[bulk_update_profile_embeddings_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BulkInsertResult,
...
class AsyncBulkResource(AsyncAPIResource):
    ...
    async def update_profile_embeddings(
        ...
        *,
        ...
        return await self._put(
            f"/system/{tenant_db_name}/patients/bulk/patient_profile_embeddings",
            body=await async_maybe_transform(body, Iterable[bulk_update_profile_embeddings_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BulkInsertResult,
...
class BulkResourceWithRawResponse:
    def __init__(self, bulk: BulkResource) -> None:
        ...
        self.update_profile_embeddings = to_raw_response_wrapper(
            bulk.update_profile_embeddings,
        )
...
class AsyncBulkResourceWithRawResponse:
    def __init__(self, bulk: AsyncBulkResource) -> None:
        ...
        self.update_profile_embeddings = async_to_raw_response_wrapper(
            bulk.update_profile_embeddings,
        )
...
class BulkResourceWithStreamingResponse:
    def __init__(self, bulk: BulkResource) -> None:
        ...
        self.update_profile_embeddings = to_streamed_response_wrapper(
            bulk.update_profile_embeddings,
        )
...
class AsyncBulkResourceWithStreamingResponse:
    def __init__(self, bulk: AsyncBulkResource) -> None:
        ...
        self.update_profile_embeddings = async_to_streamed_response_wrapper(
            bulk.update_profile_embeddings,
        )
