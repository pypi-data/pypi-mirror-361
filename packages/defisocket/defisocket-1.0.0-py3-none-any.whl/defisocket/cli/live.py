...
import os
import logging
from defisocket.stream import LiveStream, Substream
...
if __name__ == '__main__':
    ...
    async def main():
        ...
        if args.command == 'create':
            ...
            stream = LiveStream(name=args.name, server_address=DEFISOCKET_URL)
            if listen:
                timeout = args.timeout
                res = await stream.start_and_listen(substream=substream, timeout=timeout)
            else:
