...
class ImpulseInputBlock(BaseModel):
    ...
    __properties = ["id", "type", "name", "title", "windowSizeMs", "windowIncreaseMs", "frequencyHz", "classificationWindowIncreaseMs", "padZeros", "imageWidth", "imageHeight", "resizeMode", "resizeMethod", "cropAnchor", "createdBy", "createdAt", "datasetSubset"]
