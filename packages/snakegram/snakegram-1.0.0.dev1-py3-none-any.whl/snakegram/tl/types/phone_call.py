...
class PhoneCallWaiting(TLObject, family='TypePhoneCall'):
    ...
    def to_bytes(self, boxed: bool=True):
        with Writer(b'X(\xd4\xee' if boxed else b'') as writer:
            with writer.flag() as flags:
                ...
                if flags(self.conference_call, 8):
                    writer.object(
    ...
    def from_reader(cls, reader: 'Reader'):
        ...
        return cls(
            ...
            conference_call=conference_call_
        )
...
class PhoneCallRequested(TLObject, family='TypePhoneCall'):
    ...
    def to_bytes(self, boxed: bool=True):
        with Writer(b'c\x1c6E' if boxed else b'') as writer:
            with writer.flag() as flags:
                flags(self.video, 6)
                writer.long(self.id)
                writer.long(self.access_hash)
...
class PhoneCallAccepted(TLObject, family='TypePhoneCall'):
    ...
    def to_bytes(self, boxed: bool=True):
        with Writer(b'\x81q\xfd"' if boxed else b'') as writer:
            with writer.flag() as flags:
                flags(self.video, 6)
                writer.long(self.id)
                writer.long(self.access_hash)
...
class PhoneCall(TLObject, family='TypePhoneCall'):
    ...
    def to_bytes(self, boxed: bool=True):
        with Writer(b'\x0c\x94\xa5;' if boxed else b'') as writer:
            with writer.flag() as flags:
...
class PhoneCallDiscarded(TLObject, family='TypePhoneCall'):
    ...
    def to_bytes(self, boxed: bool=True):
        with Writer(b'\x03U\xd2\xf9' if boxed else b'') as writer:
            with writer.flag() as flags:
