...
class RIUFSC():
    ...
    def help(self):
        ...
        print('-'*100)
        print('get_testing_object -> entrega um objeto TestRIUFSC para realização de testes com todo kit de ferramentas utilizado\nna construção/organização do dataset. Esse objeto tem funções próprias, veja o notebook de testes disponibilizado no repositório.')
        print('-'*100)
        print('\n\n')
