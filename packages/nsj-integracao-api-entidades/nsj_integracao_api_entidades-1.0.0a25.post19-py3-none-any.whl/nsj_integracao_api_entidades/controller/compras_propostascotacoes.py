...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/propostascotacoes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/propostascotacoes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/propostascotacoes/verificacao-integridade"
