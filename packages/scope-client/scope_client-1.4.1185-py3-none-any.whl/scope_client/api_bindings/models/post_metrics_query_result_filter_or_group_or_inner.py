...
POSTMETRICSQUERYRESULTFILTERORGROUPORINNER_ANY_OF_SCHEMAS = ["PostMetricsQueryResultFilter", "PostMetricsQueryResultFilterAndGroup", "PostMetricsQueryResultFilterOrGroup"]

class PostMetricsQueryResultFilterOrGroupOrInner(BaseModel):
    """
    PostMetricsQueryResultFilterOrGroupOrInner
    """

    # data type: PostMetricsQueryResultFilterOrGroup
    anyof_schema_1_validator: Optional[PostMetricsQueryResultFilterOrGroup] = None
    # data type: PostMetricsQueryResultFilterAndGroup
    anyof_schema_2_validator: Optional[PostMetricsQueryResultFilterAndGroup] = None
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = PostMetricsQueryResultFilterOrGroupOrInner.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in PostMetricsQueryResultFilterOrGroupOrInner with anyOf schemas: PostMetricsQueryResultFilter, PostMetricsQueryResultFilterAndGroup, PostMetricsQueryResultFilterOrGroup. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PostMetricsQueryResultFilterOrGroupOrInner with anyOf schemas: PostMetricsQueryResultFilter, PostMetricsQueryResultFilterAndGroup, PostMetricsQueryResultFilterOrGroup. Details: " + ", ".join(error_messages))
        else:
            return instance
...
PostMetricsQueryResultFilterOrGroupOrInner.model_rebuild(raise_errors=False)
