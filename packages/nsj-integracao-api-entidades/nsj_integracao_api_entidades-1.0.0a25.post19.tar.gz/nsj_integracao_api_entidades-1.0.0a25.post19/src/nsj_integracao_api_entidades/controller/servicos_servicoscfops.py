...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/servicoscfops"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/servicoscfops/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/servicoscfops/verificacao-integridade"
