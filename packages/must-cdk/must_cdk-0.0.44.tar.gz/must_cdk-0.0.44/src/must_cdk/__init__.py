...
class CloudFrontToOrigins(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: -
        :param id: -
        :param cache_behaviors: Cache behaviors for specific path patterns. For hybrid distributions, this is automatically configured to: - Route /api/* to first HTTP origin - Route everything else to first S3 origin You can override or add additional behaviors here
...
class CloudFrontToOriginsProps:
    ...
    def cache_behaviors(self) -> typing.Optional[typing.List[CacheBehaviorConfig]]:
        ...
        - Route /api/* to first HTTP origin
