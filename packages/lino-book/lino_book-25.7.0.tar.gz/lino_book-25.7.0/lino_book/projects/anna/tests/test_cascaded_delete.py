...
class Tests(RemoteAuthTestCase):
    ...
    def test01(self):
        ...
        s = rt.shows(rt.models.skills.AssignableWorkersByTicket, note1)
        # print(s)
...
""", s)
        ...
        s = rt.shows(rt.models.skills.AssignableWorkersByTicket, note2)
        # print(s)
        self.assertEquivalent(
            """
==========
...
""", s)
        ...
        try:
            ...
            self.assertEqual(
                str(e), "Cannot delete Skill Special work "
        ...
        try:
            ...
            self.assertEqual(
                str(e), "Cannot delete Skill General work "
                "because 1 Skill offers refer to it.")
