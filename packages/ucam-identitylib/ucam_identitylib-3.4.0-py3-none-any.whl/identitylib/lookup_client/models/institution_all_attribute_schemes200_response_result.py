...
class InstitutionAllAttributeSchemes200ResponseResult(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstitutionAllAttributeSchemes200ResponseResult from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in attribute_schemes (list)
        _items = []
        if self.attribute_schemes:
            for _item in self.attribute_schemes:
                if _item:
                    _items.append(_item.to_dict())
            _dict['attributeSchemes'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstitutionAllAttributeSchemes200ResponseResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "attributeSchemes": [AttributeScheme.from_dict(_item) for _item in obj["attributeSchemes"]] if obj.get("attributeSchemes") is not None else None
        })
        return _obj
