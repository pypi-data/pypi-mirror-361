...
class EvionClient:
    ...
    def __init__(
        ...
        self.base_url = base_url or "https://evion.ai"  # Your actual domain
    ...
    def _make_request(self, method: str, endpoint: str, **kwargs) -> requests.Response:
        ...
        try:
            ...
            raise NetworkError("Failed to connect to the API")
    ...
    def predict(
        ...
        response = self._make_request('POST', '/api/process-image', files=files)
