...
def create_jsonapi_headers_dependency(
    request: Request,
) -> None:
    """Validate the JSON:API headers for FastAPI."""
    validate_jsonapi_content_type(request)
    validate_jsonapi_accept_header(request)



def create_jsonapi_querydependency(
