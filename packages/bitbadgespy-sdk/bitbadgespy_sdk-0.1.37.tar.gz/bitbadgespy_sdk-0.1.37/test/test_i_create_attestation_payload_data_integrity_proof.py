...
class TestICreateAttestationPayloadDataIntegrityProof(unittest.TestCase):
    """ICreateAttestationPayloadDataIntegrityProof unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateAttestationPayloadDataIntegrityProof:
        """Test ICreateAttestationPayloadDataIntegrityProof
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateAttestationPayloadDataIntegrityProof`
        """
        model = ICreateAttestationPayloadDataIntegrityProof()
        if include_optional:
            return ICreateAttestationPayloadDataIntegrityProof(
                signature = '',
                signer = '',
                public_key = '',
                is_derived = True
    ...
    def testICreateAttestationPayloadDataIntegrityProof(self):
        """Test ICreateAttestationPayloadDataIntegrityProof"""
