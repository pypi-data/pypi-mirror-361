...
class JobLogs(BaseModel):
    ...
    JobLogs
    """ # noqa: E501
    logs: List[JobLog] = Field(description="List of log statements pertaining to the job execution.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "logs": [JobLog.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None
        })
        return _obj
