...
class Moderator(UniversalBaseModel):
    id: str
    name: str
    description: typing.Optional[str] = None
    visibility: ModeratorVisibility
    config: ModeratorConfig
    vendor: ModeratorVendor = "vapi"
    vendor_id: typing_extensions.Annotated[str, FieldMetadata(alias="vendorId")]
    vendor_data: typing_extensions.Annotated[typing.Optional[typing.Any], FieldMetadata(alias="vendorData")] = None
    ...
    parent_moderator_id: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="parentModeratorId")] = (
        None
    )
    ...
    parent_moderator: typing_extensions.Annotated[
        typing.Optional["Moderator"], FieldMetadata(alias="parentModerator")
    ] = None
    child_moderators: typing_extensions.Annotated[
        typing.Optional[typing.List["Moderator"]], FieldMetadata(alias="childModerators")
    ] = None
