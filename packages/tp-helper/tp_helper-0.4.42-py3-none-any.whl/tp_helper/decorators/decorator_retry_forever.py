...
def retry_forever(
    ...
    backoff: float = 1.2,
    max_delay: int = 60,
    discord_desc: str = None,
    discord_every: int = 10
):
        ...
        async def wrapper(self, *args: Any, **kwargs: Any) -> Any:
            ...
            while True:
                try:
                    ...
                    if discord_desc is not None and retry_count % discord_every == 0:
                        try:
                            await self.discord.send_error_notification(e, discord_desc)
