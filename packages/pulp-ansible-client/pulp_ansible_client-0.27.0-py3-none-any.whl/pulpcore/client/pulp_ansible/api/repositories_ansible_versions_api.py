...
class RepositoriesAnsibleVersionsApi:
    ...
    def delete(
        self,
        ansible_ansible_repository_version_href: StrictStr,
        ...
        :param ansible_ansible_repository_version_href: (required)
        :type ansible_ansible_repository_version_href: str
        ...
        _param = self._delete_serialize(
            ansible_ansible_repository_version_href=ansible_ansible_repository_version_href,
    ...
    def _delete_serialize(
        ...
        if ansible_ansible_repository_version_href is not None:
            _path_params['ansible_ansible_repository_version_href'] = ansible_ansible_repository_version_href
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='{ansible_ansible_repository_version_href}',
    ...
    def list(
        self,
        ansible_ansible_repository_href: StrictStr,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        ...
        _param = self._list_serialize(
            ansible_ansible_repository_href=ansible_ansible_repository_href,
            x_task_diagnostics=x_task_diagnostics,
            content=content,
    ...
    def _list_serialize(
        ...
        # process the path parameters
        if ansible_ansible_repository_href is not None:
            _path_params['ansible_ansible_repository_href'] = ansible_ansible_repository_href
        # process the query parameters
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{ansible_ansible_repository_href}versions/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rebuild_metadata(
        ...
        :param ansible_ansible_repository_version_href: (required)
        :type ansible_ansible_repository_version_href: str
        :param ansible_repository_rebuild: (required)
        :type ansible_repository_rebuild: AnsibleRepositoryRebuild
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._rebuild_metadata_serialize(
            ansible_ansible_repository_version_href=ansible_ansible_repository_version_href,
            ansible_repository_rebuild=ansible_repository_rebuild,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def rebuild_metadata_with_http_info(
        self,
        ansible_ansible_repository_version_href: StrictStr,
        ansible_repository_rebuild: AnsibleRepositoryRebuild,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
    ...
    @validate_call
    def rebuild_metadata_without_preload_content(
        self,
        ansible_ansible_repository_version_href: StrictStr,
        ansible_repository_rebuild: AnsibleRepositoryRebuild,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
    ...
    def _rebuild_metadata_serialize(
        self,
        ansible_ansible_repository_version_href,
        ...
        # process the form parameters
        # process the body parameter
        if ansible_repository_rebuild is not None:
            _body_params = ansible_repository_rebuild
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_ansible_repository_version_href}rebuild_metadata/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _repair_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_ansible_repository_version_href}repair/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
