"use strict";
(self["webpackChunkjupyterlab_bxplorer"] = self["webpackChunkjupyterlab_bxplorer"] || []).push([["lib_index_js"],{
...
/* harmony import */ var _Chatlas__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Chatlas */ "./lib/components/Chatlas.js");
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Box__WEBPACK_IMPORTED_MODULE_2__["default"], { sx: { width: '100%' } },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Box__WEBPACK_IMPORTED_MODULE_2__["default"], { sx: { borderBottom: 1, borderColor: 'divider' } },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Tabs__WEBPACK_IMPORTED_MODULE_3__["default"], { value: value, onChange: handleChange, "aria-label": "basic tabs example" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material_Tab__WEBPACK_IMPORTED_MODULE_4__["default"], { label: "Chatlas", ...a11yProps(4) }))),
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_CustomTabPanel__WEBPACK_IMPORTED_MODULE_5__["default"], { value: value, index: 4 },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Chatlas__WEBPACK_IMPORTED_MODULE_8__["default"], { atlasId: props.atlasId })))));
};
...
const Chatlas = ({ atlasId, fullScreen = true, voiceEnabled = false }) => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        ...
        (_a = containerRef.current) === null || _a === void 0 ? void 0 : _a.appendChild(customEl);
        return () => {
            var _a;
            document.body.removeChild(script);
            (_a = containerRef.current) === null || _a === void 0 ? void 0 : _a.removeChild(customEl);
        };
    }, [atlasId, fullScreen, voiceEnabled]);
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { ref: containerRef, style: { width: '100%', height: '97%' } }));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Chatlas);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Box, { sx: {
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Box, { sx: {
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Box, { sx: {
                    ...
                    overflowY: 'auto',
                    p: 1
                } }, loading ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Box, { sx: {
                    display: 'flex',
...
const FMViewComponent = (props, ref) => {
    ...
    const contextMenuClickHandler = async (args) => {
        if (args.item && args.item.text === 'Add to favorites') {
            ...
            const selectedItems = args.data ||
                (fileManagerRef.current &&
                    fileManagerRef.current.selectedItems);
            const depth = currentPath.split('/').filter((seg) => seg).length;
            if ((clientType === 'private' && depth !== 0) ||
    ...
    const onFileLoad = (args) => {
        ...
        icons.forEach((icon) => {
            ...
            else if ((clientType === 'private' && depth === 0) ||
        ...
        if (args.action === 'read') {
            (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.showDialog)({
                ...
                body: (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "An error occurred while trying to access the dataset or bucket."),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null,
                        "Please open an issue at",
                        ' ',
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { href: "https://github.com/Navteca/jupyterlab-bxplorer/issues", target: "_blank", rel: "noopener" }, "https://github.com/Navteca/jupyterlab-bxplorer/issues"),
                        ' ',
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "control-section", style: { height: '100%', width: '100%' } },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_syncfusion_ej2_react_filemanager__WEBPACK_IMPORTED_MODULE_1__.FileManagerComponent, { ref: fileManagerRef, id: "file", ajaxSettings: ajaxSettings, beforeSend: onBeforeSend.bind(undefined), toolbarSettings: {
            ...
            }, fileLoad: onFileLoad, beforePopupOpen: onBeforePopupOpen, failure: onFailure, view: "Details", allowMultiSelection: false, height: "100%", ...{ menuClick: contextMenuClickHandler } },
...
const FileManagerPanelComponent = (props) => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: { width: '100%', minWidth: '400px', height: '100vh' } },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_contexts_DownloadHistoryContext__WEBPACK_IMPORTED_MODULE_1__.DownloadHistoryProvider, null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_BasicTabs__WEBPACK_IMPORTED_MODULE_2__["default"], { downloadsFolder: props.downloadsFolder, atlasId: props.atlasId }))));
};
...
async function activate(app, settingRegistry) {
    ...
    if (settingRegistry) {
        await settingRegistry
            ...
            .then(settings => {
            downloadsFolder =
                settings.get('download-folder').composite || '';
        })
            .catch(reason => {
            console.error('Failed to load settings for jupyterlab-bxplorer.', reason);
        });
    }
    const leftSideBarContent = new _widgets_FileManagerPanelWidget__WEBPACK_IMPORTED_MODULE_4__.FileManagerPanelWidget(downloadsFolder, atlasId);
...
class FileManagerPanelWidget extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ReactWidget {
    constructor(downloadsFolder, atlasId) {
        super();
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { style: {
            ...
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_FileManagerPanelComponent__WEBPACK_IMPORTED_MODULE_2__["default"], { downloadsFolder: this.downloadsFolder, atlasId: this.atlasId })));
    }
    /**
...
//# sourceMappingURL=lib_index_js.1c5b36f3e417f93585d2.js.map