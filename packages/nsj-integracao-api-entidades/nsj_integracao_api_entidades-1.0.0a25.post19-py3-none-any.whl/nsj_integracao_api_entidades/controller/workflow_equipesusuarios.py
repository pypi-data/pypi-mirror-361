...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/equipesusuarios"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/equipesusuarios/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/equipesusuarios/verificacao-integridade"
