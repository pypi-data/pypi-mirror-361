...
AgentInputPartUnion = Union[TextInputPart, ImageUrlInputPart, FileDataInputPart]
...
class AgentInterface(abc.ABC):
    ...
    async def get_current_model(self, session_id: str) -> Optional[str]:
        """
        Returns the name of the AI model currently being used for the given session.
        
        This method is optional - agents can override it to provide model information.
        If not overridden, returns None, indicating model information is not available.
        
        Args:
            session_id: The session identifier to get model information for.
        
        Returns:
            The name of the AI model being used, or None if not available.
        """
        return None
...
# Streaming functionality removed as per PRD requirements 
#TODO: Add streaming functionality under some form