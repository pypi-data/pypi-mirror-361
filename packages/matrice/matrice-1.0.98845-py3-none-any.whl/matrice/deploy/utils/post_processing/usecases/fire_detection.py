...
class FireSmokeUseCase(BaseProcessor):
    ...
    def _generate_tracking_stats(
        ...
        # Generate human-readable tracking text
    ...
    def _generate_human_text_for_tracking(
        ...
        # Look back at recent 150-frame window
        ...
        if recent_fire_detected and recent_smoke_detected:
            since_lines.append("    - alert for fire and smoke")
        elif recent_fire_detected:
            since_lines.append("    - alert for fire")
        elif recent_smoke_detected:
