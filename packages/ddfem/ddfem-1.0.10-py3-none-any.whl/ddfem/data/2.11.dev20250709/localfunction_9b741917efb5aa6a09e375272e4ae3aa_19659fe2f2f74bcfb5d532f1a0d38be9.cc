#ifndef GUARD_9b741917efb5aa6a09e375272e4ae3aa
#define GUARD_9b741917efb5aa6a09e375272e4ae3aa
...
namespace UFLLocalFunctions_9b741917efb5aa6a09e375272e4ae3aa
{
  ...
  : public Dune::Fem::BindableGridFunctionWithSpace<GridPart,Dune::Dim<1>>
{
  ...
  void evaluate ( const Point &x, typename FunctionSpaceType::RangeType &result ) const
  {
    ...
    const auto tmp16 = -0.1 + (tmp8 > 0.0 ? tmp15 : tmp8);
  ...
  void jacobian ( const Point &x, typename FunctionSpaceType::JacobianRangeType &result ) const
  {
    ...
    const auto tmp41 = tmp40 * tmp9;
    const auto tmp42 = tmp41 + tmp41;
    const auto tmp43 = tmp42 / tmp27;
    const auto tmp44 = 3 * (tmp8 > 0.0 ? tmp43 : tmp39);
  ...
  void hessian ( const Point &x, typename FunctionSpaceType::HessianRangeType &result ) const
  {
    ...
    const auto tmp38 = 3 * (tmp8 > 0.0 ? tmp37 : 0.0);
    const auto tmp39 = tmp38 / tmp0;
    const auto tmp40 = tmp39 * tmp25;
    const auto tmp41 = (tmp7 > tmp4 ? 1 : 0.0) * (tmp5 == 0.0 ? 0.0 : (tmp5 < 0.0 ? -1 : 1));
    const auto tmp42 = 3 * (tmp8 > 0.0 ? tmp30 : tmp41);
    ...
    const auto tmp60 = (tmp4 > 0.0 ? 1 : 0.0) * (tmp2 == 0.0 ? 0.0 : (tmp2 < 0.0 ? -1 : 1));
    const auto tmp61 = tmp60 * tmp9;
    ...
    const auto tmp68 = 3 * (tmp8 > 0.0 ? tmp67 : 0.0);
    const auto tmp69 = tmp68 / tmp0;
    const auto tmp70 = tmp69 * tmp25;
    const auto tmp71 = -1 * (tmp7 > tmp4 ? 1 : 0.0);
    const auto tmp72 = 1.0 + tmp71;
    const auto tmp73 = tmp72 * (tmp2 == 0.0 ? 0.0 : (tmp2 < 0.0 ? -1 : 1));
    const auto tmp74 = 3 * (tmp8 > 0.0 ? tmp63 : tmp73);
    ...
    const auto tmp93 = 3 * (tmp8 > 0.0 ? tmp92 : 0.0);
    ...
    const auto tmp106 = 3 * (tmp8 > 0.0 ? tmp105 : 0.0);
...
PYBIND11_MODULE( localfunction_9b741917efb5aa6a09e375272e4ae3aa_19659fe2f2f74bcfb5d532f1a0d38be9, module )
{
  typedef UFLLocalFunctions_9b741917efb5aa6a09e375272e4ae3aa::UFLLocalFunction< typename Dune::FemPy::GridPart< Dune::YaspGrid< 2, Dune::EquidistantOffsetCoordinates< double, 2 > >::LeafGridView > > LocalFunctionType;
  if constexpr( LocalFunctionType::gridPartValid )
  {
      auto cls = Dune::Python::insertClass<LocalFunctionType>(module,"UFLLocalFunction",Dune::Python::GenerateTypeName("UFLLocalFunctions_9b741917efb5aa6a09e375272e4ae3aa::UFLLocalFunction< typename Dune::FemPy::GridPart< Dune::YaspGrid< 2, Dune::EquidistantOffsetCoordinates< double, 2 > >::LeafGridView > >"), Dune::Python::IncludeFiles({"python/dune/generated/localfunction_9b741917efb5aa6a09e375272e4ae3aa_19659fe2f2f74bcfb5d532f1a0d38be9.cc"})).first;
