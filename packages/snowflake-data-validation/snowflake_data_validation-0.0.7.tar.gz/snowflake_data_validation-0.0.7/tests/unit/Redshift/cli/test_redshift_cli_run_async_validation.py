...
class TestRedshiftCLIRunAsyncValidation:
    ...
    def test_run_async_validation_success(self, mock_managed_env, mock_orchestrator_class, mock_create_env):
        ...
        mock_create_env.assert_called_once_with("test_config.yaml", ExecutionMode.ASYNC_VALIDATION)
    ...
    @patch('snowflake.snowflake_data_validation.redshift.redshift_cli._create_environment_from_config')
    def test_run_async_validation_file_not_found_error(self, mock_create_env):
    ...
    @patch('snowflake.snowflake_data_validation.redshift.redshift_cli._create_environment_from_config')
    def test_run_async_validation_generic_exception(self, mock_create_env):
