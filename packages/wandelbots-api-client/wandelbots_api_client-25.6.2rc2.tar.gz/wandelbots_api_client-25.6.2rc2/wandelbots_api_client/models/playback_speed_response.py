...
class PlaybackSpeedResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "playback_speed_response": PlaybackSpeedResponsePlaybackSpeedResponse.from_dict(obj["playback_speed_response"]) if obj.get("playback_speed_response") is not None else None
        })
        return _obj
