...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/ordensservicos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/ordensservicos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/ordensservicos/verificacao-integridade"
