...
class AttorneySearchResults(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["totalCount", "page", "nextPage", "attorneys"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attorneys": [AttorneyResult.from_dict(_item) for _item in obj["attorneys"]] if obj.get("attorneys") is not None else None
        })
        return _obj
