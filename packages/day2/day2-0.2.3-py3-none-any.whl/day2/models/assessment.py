...
class RunAssessmentInput(BaseModel):
    ...
    Attributes:
        ...
        pillar_id: Optional ID of the pillar.
...
class GenerateAssessmentReportInput(BaseModel):
    ...
    Attributes:
        ...
        pillar_ids: List of pillar IDs to filter findings.
        severity: List of severity levels to filter findings.
        status: List of statuses to filter findings.
