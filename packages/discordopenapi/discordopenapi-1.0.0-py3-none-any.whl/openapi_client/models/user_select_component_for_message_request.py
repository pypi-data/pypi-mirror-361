...
class UserSelectComponentForMessageRequest(BaseModel):
    ...
    default_values: Optional[Annotated[List[UserSelectDefaultValue], Field(max_length=25)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "default_values": [UserSelectDefaultValue.from_dict(_item) for _item in obj["default_values"]] if obj.get("default_values") is not None else None
        })
        return _obj
