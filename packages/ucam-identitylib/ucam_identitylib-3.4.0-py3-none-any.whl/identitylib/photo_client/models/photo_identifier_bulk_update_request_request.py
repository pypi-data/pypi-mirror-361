...
class PhotoIdentifierBulkUpdateRequestRequest(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PhotoIdentifierBulkUpdateRequestRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PhotoIdentifierBulkUpdateRequestRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "updates": [PhotoIdentifierBulkUpdateUpdateRequest.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
