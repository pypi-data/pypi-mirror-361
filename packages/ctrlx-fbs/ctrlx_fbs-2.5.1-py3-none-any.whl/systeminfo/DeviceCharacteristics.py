...
class DeviceCharacteristics(object):
    ...
    def Watchdog(self):
        ...
        if o != 0:
            x = self._tab.Indirect(o + self._tab.Pos)
            from systeminfo.Watchdog import Watchdog
            obj = Watchdog()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None

def DeviceCharacteristicsStart(builder): builder.StartObject(7)
def Start(builder):
...
def DeviceCharacteristicsAddWatchdog(builder, watchdog): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(watchdog), 0)
def AddWatchdog(builder, watchdog):
    return DeviceCharacteristicsAddWatchdog(builder, watchdog)
...
class DeviceCharacteristicsT(object):
    ...
    def __init__(self):
        ...
        self.watchdog = None  # type: Optional[systeminfo.Watchdog.WatchdogT]
    ...
    def _UnPack(self, deviceCharacteristics):
        ...
        if deviceCharacteristics.Watchdog() is not None:
            self.watchdog = systeminfo.Watchdog.WatchdogT.InitFromObj(deviceCharacteristics.Watchdog())
    ...
    def Pack(self, builder):
        ...
        if self.watchdog is not None:
            DeviceCharacteristicsAddWatchdog(builder, watchdog)
