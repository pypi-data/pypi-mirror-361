...
class ResourceListDataPlaneAssociation(BaseModel):
    """
    ResourceListDataPlaneAssociation
    """ # noqa: E501
    records: List[DataPlaneAssociation] = Field(description="List of records.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [DataPlaneAssociation.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
