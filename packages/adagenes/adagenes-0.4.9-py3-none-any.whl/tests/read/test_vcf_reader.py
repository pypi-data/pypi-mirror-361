...
class TestVCFReader(unittest.TestCase):
    ...
    def test_read_cnvs(self):
        ...
        self.assertEqual(bframe.data["chr1:258946A><DEL>"]["type"], "g", "")
        self.assertEqual(bframe.data["chr1:258946A><DEL>"]["mutation_type"], "cnv", "")
        self.assertEqual(bframe.data["chr1:258946A><DEL>"]["mdesc"],"cnv_del","")
