...
from typing_extensions import Annotated
from wandelbots_api_client.models.create_device_request_inner import CreateDeviceRequestInner
...
class DeviceConfigurationApi:
    ...
    async def create_device(
        self,
        cell: Annotated[StrictStr, Field(description="Unique identifier addressing a cell in all API calls. ")],
        create_device_request_inner: List[CreateDeviceRequestInner],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param cell: Unique identifier addressing a cell in all API calls.  (required)
        :type cell: str
        :param create_device_request_inner: (required)
        :type create_device_request_inner: List[CreateDeviceRequestInner]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_device_serialize(
            cell=cell,
            create_device_request_inner=create_device_request_inner,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _create_device_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if create_device_request_inner is not None:
            _body_params = create_device_request_inner
