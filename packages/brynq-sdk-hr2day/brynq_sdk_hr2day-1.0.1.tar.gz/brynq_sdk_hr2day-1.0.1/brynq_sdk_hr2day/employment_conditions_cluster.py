...
import pandas as pd
from .schemas.employment_conditions_cluster import EmploymentConditionsClusterSchema
    ...
    def get(self,
        ...
        Args:
            ...
            skip (int, optional): Number of records to skip (OFFSET clause). Max 2000. Defaults to None.
                            Example: 0
            validate (bool, optional): Whether to validate the data against the EmploymentConditionsClusterSchema. Defaults to False.

        Returns:
            pd.DataFrame: DataFrame containing employment conditions cluster data
        ...
        return self.hr2day.get(
            ...
            limit=limit,
            offset=skip,
            schema=EmploymentConditionsClusterSchema
        ) 