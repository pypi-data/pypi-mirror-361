...
示例:
  ultra-pass-sidecar config
  ultra-pass-sidecar health
  ultra-pass-sidecar services
  ultra-pass-sidecar --config custom.yml config
""")
...
def main():
    ...
    parser.add_argument(
        "--version", 
        action="version", 
        version="ultra-pass-sidecar 1.0.0"
    )
    parser.add_argument(
        "--config", 
        type=str, 
