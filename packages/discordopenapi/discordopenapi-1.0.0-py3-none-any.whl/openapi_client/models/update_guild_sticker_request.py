...
class UpdateGuildStickerRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=2, strict=True, max_length=30)]] = None
    tags: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=200)]] = None
    description: Optional[Annotated[str, Field(strict=True, max_length=100)]] = None
    __properties: ClassVar[List[str]] = ["name", "tags", "description"]
