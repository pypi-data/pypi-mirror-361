...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/configuracoes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/configuracoes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/configuracoes/verificacao-integridade"
