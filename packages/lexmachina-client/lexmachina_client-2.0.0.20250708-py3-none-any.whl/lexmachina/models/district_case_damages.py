...
class DistrictCaseDamages(BaseModel):
    """
    DistrictCaseDamages
    """ # noqa: E501
    name: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["name", "type", "judgmentSource", "awardedToPartyIds", "awardedAgainstPartyIds", "amount", "awarded", "negated", "reinstated", "docketEntryId", "negatedDocketEntryId", "reinstatedDocketEntryId"]
