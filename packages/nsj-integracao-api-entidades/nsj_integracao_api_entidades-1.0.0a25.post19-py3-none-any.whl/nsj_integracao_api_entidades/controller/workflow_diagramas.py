...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/diagramas"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/diagramas/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/diagramas/verificacao-integridade"
