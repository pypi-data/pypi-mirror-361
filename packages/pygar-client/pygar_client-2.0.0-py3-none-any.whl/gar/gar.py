...
class GARClient:
    ...
    def __init__(
        ...
        self.encoder = json.Encoder(enc_hook=enum_to_name)
    ...
    def subscribe(
        ...
        key_id_list = [self.get_and_possibly_introduce_key_id(x) for x in key_names]
