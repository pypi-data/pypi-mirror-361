...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/classificadores"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/classificadores/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/classificadores/verificacao-integridade"
