...
class CodeExecutorAgent(BaseAgent, BaseAgentHistoryMixin):
    ...
    def _keyword_based_analysis(self, user_message: str) -> Dict[str, Any]:
        ...
        write_code_keywords = ['write code', 'create code', 'generate code', 'make code',
                               'code to', 'write a function', 'create a function',
                               'write python', 'can you write', 'please write',
                               'function to', 'script to', 'program to']
        ...
        if "```python" in user_message:
            ...
            if any(word in content_lower for word in ['multiply', 'add', 'calculate', 'function', 'algorithm']):
    ...
    async def _route_request(self, intent_analysis: Dict[str, Any], user_message: str,
        ...
        asking_for_previous_code = any(phrase in message_lower for phrase in [
            'show me that code', 'show that code', 'show the code',
            'that code again', 'code again', 'previous code',
            'show me the code', 'display the code', 'see the code',
            'show me that', 'that again'
        ])
    ...
    async def _handle_code_writing_request(self, user_message: str, language: str = "python") -> str:
    ...
    def _extract_task_from_message(self, message: str) -> str:
        ...
        prefixes = ['write code to', 'create code to', 'generate code to', 'make code to',
                    'code to', 'write a function to', 'create a function to',
                    'write python to', 'can you write', 'please write']
