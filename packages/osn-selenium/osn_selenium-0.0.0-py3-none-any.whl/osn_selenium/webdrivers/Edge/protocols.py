...
from osn_selenium.webdrivers.Edge.flags import EdgeFlagsManager
from typing import (
	Optional,
	Protocol,
	TYPE_CHECKING,
...
if TYPE_CHECKING:
	from osn_selenium.webdrivers.Edge.webdriver import EdgeWebDriver, EdgeFlags


@runtime_checkable
class TrioEdgeWebDriverWrapperProtocol(TrioBlinkWebDriverWrapperProtocol, Protocol):
	"""
	Wraps EdgeWebDriver methods for asynchronous execution using Trio.
	...
	_webdriver: "EdgeWebDriver"
	_webdriver_flags_manager: "EdgeFlagsManager"
	_driver: Optional[webdriver.Edge]
