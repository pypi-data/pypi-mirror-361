...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/regrasdepagamento"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/regrasdepagamento/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/regrasdepagamento/verificacao-integridade"
