...
class ProjectGenerator:
    ...
    def _get_allowed_folders(self) -> Set[str]:
    ...
    def _walk_template(self) -> Generator[Path, None, None]:
    ...
    def _filter_directories(self, current_path: Path, dirs: List[str]) -> None:
    ...
    def _check_nested_conditions(self, parts: tuple[str, ...]) -> bool:
        match parts:
            ...
            case ["app", "admin", *_]:
                return "admin" in self.allowed_folders
        return True
    ...
    def _process_files(self, files: List[FileInfo]) -> None:
