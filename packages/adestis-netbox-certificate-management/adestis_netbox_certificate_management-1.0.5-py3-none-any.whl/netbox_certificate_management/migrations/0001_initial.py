    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authority_key_identifier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='authority_certificates', to='netbox_certificate_management.certificate')),
                ...
                ('issuer_parent_certificate', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='issued_certificates', to='netbox_certificate_management.certificate')),
                ('predecessor_certificate', models.ManyToManyField(blank=True, related_name='certificate', to='netbox_certificate_management.certificate')),
                ('successor_certificates', models.ManyToManyField(blank=True, related_name='certificate', to='netbox_certificate_management.certificate')),
