...
from vgridpandas.mgrspandas.mgrsgeom import cell2boundary, validate_mgrs_resolution
                ...
                try:
                    if pd.isna(m_ids):
                        ...
                        if len(m_ids) == 0:
                            ...
                            cell_geometries = [cell2boundary(m_id) for m_id in m_ids]
                            geometries.append(MultiPolygon(cell_geometries))
                    else:
                        # Handle single id
                        geometries.append(cell2boundary(m_ids))
