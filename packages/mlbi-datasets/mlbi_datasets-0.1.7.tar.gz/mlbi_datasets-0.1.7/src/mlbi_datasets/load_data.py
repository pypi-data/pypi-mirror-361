...
'''
def load_scoda_processed_anndata( tissue = None ):
...
def load_scoda_processed_sample_data( file_id_or_tissue_name = None ):

    file_type = 'tar.gz'
    tissue_lst = ['NSCLC', 'CRC', 'BRCA', 'PDAC', 'Colitis-mm', 'Colitis-mm-full', 'Colitis-hs' ] 
    tissue_lst = tissue_lst + ['Lung', 'Breast', 'Pancreas', 'Colon', 'Intestine']
