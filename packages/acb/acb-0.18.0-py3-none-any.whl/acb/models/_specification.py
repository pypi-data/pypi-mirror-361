...
from acb.models._query import QueryCondition, QueryOperator, QuerySpec
...
class NotSpecification(Specification[T]):
    ...
    def _invert_condition(self, condition: QueryCondition) -> QueryCondition:
        ...
        inverted_operator = operator_inversions.get(
            condition.operator,
            condition.operator,
        )
        return QueryCondition(condition.field, inverted_operator, condition.value)
...
class RangeSpecification(Specification[T]):
    ...
    def to_query_spec(self) -> QuerySpec:
        ...
        spec.filter.conditions.append(min_condition)
        spec.filter.conditions.append(max_condition)
        spec.filter.logical_operator = LogicalOperator.AND
...
class SpecificationBuilder:
    ...
    @staticmethod
    def list(field: str, values: list[Any], include: bool = True) -> ListSpecification:
...
def list_spec(field: str, values: list[Any], include: bool = True) -> ListSpecification:
