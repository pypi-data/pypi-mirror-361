...
class NewAction:
	keys: List[str] = ["account", "allowedAutoRetryAttempts", "autoRetryInterval", "completeOnFailure", "concurrentJobsLimit", "description", "externalIds", "name", "pluginClass", "pluginUuid", "priority", "redoAction", "runRuleExpression", "supportsAutoRetry", "timeout", "type", "undoAction", "useLatestAvailableVersion", "visibility"]

	def __init__(self, account: dict, allowedAutoRetryAttempts: str, autoRetryInterval: str, completeOnFailure: bool, concurrentJobsLimit: int, description: str, externalIds: List[int], name: str, pluginClass: str, pluginUuid: str, priority: str, redoAction: dict, runRuleExpression: str, supportsAutoRetry: bool, timeout: int, type: str, undoAction: dict, useLatestAvailableVersion: bool, visibility: List[dict]):
		self.accountId = account.get('id') if account else None
		self.allowedAutoRetryAttempts = allowedAutoRetryAttempts
		self.autoRetryInterval = autoRetryInterval
		self.completeOnFailure = completeOnFailure
...
class ActionUpdate:
	keys: List[str] = ["account", "allowedAutoRetryAttempts", "autoRetryInterval", "completeOnFailure", "concurrentJobsLimit", "description", "externalIds", "name", "priority", "redoAction", "runRuleExpression", "supportsAutoRetry", "timeout", "undoAction", "useLatestAvailableVersion", "visibility"]

	def __init__(self, account: dict, allowedAutoRetryAttempts: str, autoRetryInterval: str, completeOnFailure: bool, concurrentJobsLimit: int, description: str, externalIds: List[int], name: str, priority: str, redoAction: int, runRuleExpression: str, supportsAutoRetry: bool, timeout: int, undoAction: int, useLatestAvailableVersion: bool, visibility: List[dict]):
		self.accountId = account.get('id') if account else None
		self.allowedAutoRetryAttempts = allowedAutoRetryAttempts
		self.autoRetryInterval = autoRetryInterval
		self.completeOnFailure = completeOnFailure
...
class NewJob:
	keys: List[str] = ["account", "actionConfig", "action", "actionUuid", "asset", "assetUuid", "completeOnFailure", "contextExpression", "dateVariables", "event", "jobConfiguration", "mioObject", "mioObjectUuid", "objectVariables", "priority", "releaseLockOnFailure", "scheduleDate", "scheduleJob", "stringVariables", "user", "workspace"]

	def __init__(self, account: dict, actionConfig: dict, action: dict, actionUuid: str, asset: dict, assetUuid: str, completeOnFailure: bool, contextExpression: str, dateVariables: dict, event: dict, jobConfiguration: str, mioObject: dict, mioObjectUuid: str, objectVariables: dict, priority: str, releaseLockOnFailure: bool, scheduleDate: str, scheduleJob: bool, stringVariables: dict, user: dict, workspace: dict):
		self.accountId = account.get('id') if account else None
