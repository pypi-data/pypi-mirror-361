...
class GroupCall(TLObject, family='TypeGroupCall'):
    ...
    def __init__(
        ...
        conference_from_call: Optional[int] = None
    ):
        ...
        Args:
            ...
            conference_from_call (Optional[int], optional): ...
        """
        ...
        self.conference_from_call = conference_from_call

    def to_bytes(self, boxed: bool=True):
        with Writer(b'\xe3\xd3\xf8\xcd' if boxed else b'') as writer:
            with writer.flag() as flags:
                ...
                if flags(self.conference_from_call, 14):
                    writer.long(self.conference_from_call)
    ...
    def from_reader(cls, reader: 'Reader'):
        ...
        return cls(
            ...
            conference_from_call=conference_from_call_
        )
