...
class HS80(AbstractConstrainedMinimisation):
    """Problem 80 from the Hock-Schittkowski test collection.
    ...
    def expected_result(self):
        return jnp.array([-1.717143, 1.595709, 1.827247, -0.7636413, -0.7636450])
