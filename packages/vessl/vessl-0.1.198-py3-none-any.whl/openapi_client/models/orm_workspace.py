...
class OrmWorkspace(object):
    ...
    def __init__(self, created_dt=None, edges=None, end_dt=None, id=None, idle_shutdown_minutes=None, immutable_slug=None, init_script=None, last_backup_succeeded=None, max_running_hours=None, name=None, ports=None, updated_dt=None, volume_v2_mounts=None, workspace_backup_volume=None, workspace_created_by=None, workspace_organization=None, local_vars_configuration=None):  # noqa: E501
