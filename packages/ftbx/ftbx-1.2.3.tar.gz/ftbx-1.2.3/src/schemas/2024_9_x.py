...
class CreateCollectionRequest:
	keys: List[str] = ["acl", "fql", "metadata", "metadataDefinitionEntity", "name", "parentUuid", "sharing", "type", "variant"]

	def __init__(self, acl: None, fql: str, metadata: dict, metadataDefinitionEntity: dict, name: str, parentUuid: str, sharing: dict, type: str, variant: dict):
		self.acl = acl
		self.fql = fql
...
class UpdateCollection:
	keys: List[str] = ["acl", "fql", "metadataDefinitionEntity", "name", "parentUuid", "sharing", "type", "variant"]

	def __init__(self, acl: None, fql: str, metadataDefinitionEntity: dict, name: str, parentUuid: str, sharing: dict, type: str, variant: dict):
		self.acl = acl
		self.fql = fql
		self.metadataDefinitionEntityId = metadataDefinitionEntity.get('id') if metadataDefinitionEntity else None
		self.name = name
...
class NewVariant:
	keys: List[str] = ["defaultMetadataDefinition", "defaultVariant", "external", "metadataDefinition", "name", "objectType", "staticMetadatas", "statusFlow", "timeline", "visibility"]

	def __init__(self, defaultMetadataDefinition: int, defaultVariant: bool, external: bool, metadataDefinition: List[dict], name: str, objectType: dict, staticMetadatas: List[int], statusFlow: dict, timeline: List[dict], visibility: List[dict]):
		...
		self.statusFlowId = statusFlow.get('id') if statusFlow else None
		self.timelineIds = [v['id'] for v in timeline]
		self.visibilityIds = [v['id'] for v in visibility]


class VariantUpdate:
	keys: List[str] = ["defaultMetadataDefinition", "defaultVariant", "external", "metadataDefinition", "name", "staticMetadatas", "statusFlow", "timeline", "visibility"]

	def __init__(self, defaultMetadataDefinition: int, defaultVariant: bool, external: bool, metadataDefinition: List[dict], name: str, staticMetadatas: List[int], statusFlow: dict, timeline: List[dict], visibility: List[dict]):
		self.defaultMetadataDefinition = defaultMetadataDefinition
		self.defaultVariant = defaultVariant
		self.external = external
		self.metadataDefinitionIds = [v['id'] for v in metadataDefinition]
