...
class UpdateCustomMetadataRequestDto(BaseModel):
    """
    UpdateCustomMetadataRequestDto
    """  # noqa: E501

    authorized_assets: List[StrictStr] = Field(alias="authorizedAssets")
    entries: List[UpdateCustomMetadataEntryRequest]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateCustomMetadataRequestDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateCustomMetadataRequestDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "entries": (
                    [UpdateCustomMetadataEntryRequest.from_dict(_item) for _item in obj["entries"]]
