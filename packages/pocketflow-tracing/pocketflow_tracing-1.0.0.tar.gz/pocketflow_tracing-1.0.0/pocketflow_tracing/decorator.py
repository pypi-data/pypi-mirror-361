...
def _trace_flow_class(flow_class, config, flow_name, session_id, user_id):
    ...
    def _create_traced_method(self, original_method, node_id, node_name, phase):
    ...
    def _create_traced_async_method(self, original_method, node_id, node_name, phase):
    ...
    flow_class._patch_nodes = _patch_nodes
    flow_class._patch_node = _patch_node
    flow_class._create_traced_method = _create_traced_method
    flow_class._create_traced_async_method = _create_traced_async_method
