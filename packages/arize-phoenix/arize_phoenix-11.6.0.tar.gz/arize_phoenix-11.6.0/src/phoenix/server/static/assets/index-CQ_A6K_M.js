import{G as e,j as o,cD as h,ez as x,eA as z,eB as w,l as r,b$ as P,eC as a,r as k,o as S,eD as L}from"./vendor-DRWIRkSJ.js";import{G as C,H as R}from"./vendor-arizeai-DUhQaeau.js";import{L as j,g as E,r as I,h as D,i as A,F as T,j as F,P as _,k as G,M as t,l as M,D as O,n as N,E as q,o as B,p as V,q as W,s as $,t as d,v as H,w as J,x as K,y as U,z as Q,B as X,C as Y,G as Z,H as oo,I as ao,J as lo,K as ro,N as co,O as go,Q as eo,U as bo,V as no,W as m,X as p,Y as u,Z as io,_ as so,$ as to,a0 as mo,a1 as f,a2 as v,a3 as po,a4 as uo,a5 as fo,a6 as vo,a7 as yo,a8 as ho,a9 as xo,aa as zo,ab as wo,ac as Po,ad as ko,ae as So,af as Lo,ag as Co,ah as Ro,ai as jo,aj as Eo,ak as Io,al as Do,am as Ao,an as To,ao as Fo,ap as _o,aq as Go,ar as Mo,as as Oo,at as No,au as qo,av as Bo,aw as Vo,ax as n,ay as Wo,az as $o,aA as Ho,aB as Jo,aC as Ko,aD as Uo,aE as Qo}from"./pages-CCsLkNZY.js";import{f9 as Xo,cJ as Yo,S as Zo,fa as oa,fb as aa}from"./components-mOUBHJ12.js";import"./vendor-three-C5WAXd5r.js";import"./vendor-codemirror-D_6Q6Auv.js";import"./vendor-shiki-k1qj_XjP.js";import"./vendor-recharts-BNBwj7vz.js";(function(){const b=document.createElement("link").relList;if(b&&b.supports&&b.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))s(c);new MutationObserver(c=>{for(const g of c)if(g.type==="childList")for(const i of g.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function y(c){const g={};return c.integrity&&(g.integrity=c.integrity),c.referrerPolicy&&(g.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?g.credentials="include":c.crossOrigin==="anonymous"?g.credentials="omit":g.credentials="same-origin",g}function s(c){if(c.ep)return;c.ep=!0;const g=y(c);fetch(c.href,g)}})();const la=e`
  :root {
...
`;function da(){const{theme:l="dark"}=C();return o(h,{styles:e(ca,ra,l==="dark"?ga:ea,ba(l),la,na,ia,sa,ta)})}const ma=x(z(r(a,{path:"/",errorElement:o(n,{}),children:[o(a,{path:"/v1/*",element:o(P,{to:"/",replace:!0})}),o(a,{path:"/login",element:o(j,{})}),o(a,{path:"/logout",element:o(E,{})}),o(a,{path:"/reset-password",element:o(D,{}),loader:I}),o(a,{path:"/reset-password-with-token",element:o(A,{})}),o(a,{path:"/forgot-password",element:o(T,{})}),o(a,{element:o(Jo,{}),loader:F,children:r(a,{element:o(Ho,{}),children:[o(a,{path:"/profile",handle:{crumb:()=>"profile"},element:o(_,{})}),o(a,{index:!0,loader:G}),r(a,{path:"/model",handle:{crumb:()=>"model"},element:o(B,{}),children:[o(a,{index:!0,element:o(t,{})}),o(a,{element:o(t,{}),children:o(a,{path:"dimensions",children:o(a,{path:":dimensionId",element:o(O,{}),loader:M})})}),o(a,{path:"embeddings",children:o(a,{path:":embeddingDimensionId",element:o(q,{}),loader:N,handle:{crumb:l=>l.embedding.name}})})]}),r(a,{path:"/projects",handle:{crumb:()=>"projects"},element:o(ao,{}),children:[o(a,{index:!0,element:o(V,{})}),r(a,{path:":projectId",loader:W,handle:{crumb:l=>l.project.name},element:o(oo,{}),children:[o(a,{index:!0,element:o($,{})}),r(a,{element:o(Z,{}),children:[o(a,{path:"traces",element:o(H,{}),children:o(a,{path:":traceId",element:o(d,{})})}),o(a,{path:"spans",element:o(J,{}),children:o(a,{path:":traceId",element:o(d,{})})}),o(a,{path:"sessions",element:o(Q,{}),children:o(a,{path:":sessionId",element:o(U,{}),loader:K})}),o(a,{path:"config",element:o(X,{})}),o(a,{path:"metrics",element:o(Y,{})})]})]})]}),r(a,{path:"/dashboards",handle:{crumb:()=>"dashboards"},element:o(bo,{}),children:[o(a,{index:!0,element:o(ro,{}),loader:lo}),o(a,{path:"projects/:projectId",element:o(go,{}),loader:co,handle:{crumb:l=>l.project.name}}),o(a,{path:":dashboardId",handle:{crumb:()=>"dashboard"},element:o(eo,{})})]}),r(a,{path:"/datasets",handle:{crumb:()=>"datasets"},children:[o(a,{index:!0,element:o(no,{})}),r(a,{path:":datasetId",loader:m,handle:{crumb:l=>l.dataset.name},children:[r(a,{element:o(mo,{}),loader:m,children:[o(a,{index:!0,element:o(u,{}),loader:p}),o(a,{path:"experiments",element:o(u,{}),loader:p}),o(a,{path:"examples",element:o(to,{}),loader:io,children:o(a,{path:":exampleId",element:o(so,{})})})]}),r(a,{path:"compare",handle:{crumb:()=>"compare"},children:[o(a,{index:!0,loader:f,element:o(v,{})}),o(a,{path:":baselineExperimentId",handle:{crumb:l=>{var b;return((b=l==null?void 0:l.baselineExperiment)==null?void 0:b.name)??""}},loader:f,element:o(v,{})})]})]})]}),r(a,{path:"/playground",handle:{crumb:()=>"Playground"},children:[o(a,{index:!0,element:o(po,{})}),o(a,{path:"spans/:spanId",element:o(fo,{}),loader:uo,handle:{crumb:l=>l.span.__typename==="Span"?`span ${l.span.spanId}`:"span unknown"}})]}),r(a,{path:"/prompts",handle:{crumb:()=>"prompts"},children:[o(a,{index:!0,element:o(yo,{}),loader:vo}),r(a,{path:":promptId",loader:ho,shouldRevalidate:()=>!0,handle:{crumb:l=>l.prompt.__typename==="Prompt"?l.prompt.name:"unknown"},children:[r(a,{element:o(Co,{}),children:[o(a,{index:!0,element:o(xo,{})}),o(a,{path:"versions",loader:zo,element:o(ko,{}),children:o(a,{path:":versionId",loader:wo,element:o(Po,{})})}),o(a,{path:"config",element:o(Lo,{}),loader:So})]}),o(a,{path:"playground",element:o(jo,{}),loader:Ro,handle:{crumb:()=>"playground"}})]})]}),o(a,{path:"/apis",element:o(Eo,{}),handle:{crumb:()=>"APIs"}}),o(a,{path:"/support",element:o(Io,{}),handle:{crumb:()=>"support"}}),r(a,{path:"/settings",element:o(Bo,{}),handle:{crumb:()=>"settings"},children:[o(a,{path:"general",loader:Do,element:o(Ao,{}),handle:{crumb:()=>"general"}}),o(a,{path:"providers",loader:To,element:o(Fo,{}),handle:{crumb:()=>"providers"}}),o(a,{path:"models",loader:_o,element:o(Go,{}),handle:{crumb:()=>"models"}}),o(a,{path:"annotations",loader:Mo,element:o(Oo,{}),handle:{crumb:()=>"annotations"}}),o(a,{path:"data",element:o(qo,{}),handle:{crumb:()=>"data retention"},loader:No})]}),o(a,{path:"/redirects/spans/:span_otel_id",loader:Vo,errorElement:o(n,{})}),o(a,{path:"/redirects/traces/:trace_otel_id",loader:Wo,errorElement:o(n,{})}),o(a,{path:"/redirects/sessions/:session_otel_id",loader:$o,errorElement:o(n,{})})]})})]})),{basename:window.Config.basename});function pa(){return o(w,{router:ma})}function ua(){return o(Ko,{children:o(Xo,{children:o(fa,{})})})}function fa(){const{theme:l}=Yo();return o(R,{theme:l,mountGlobalStyles:!1,children:r(S.RelayEnvironmentProvider,{environment:Zo,children:[o(da,{}),o(Uo,{children:o(oa,{children:o(Qo,{children:o(k.Suspense,{children:o(aa,{children:o(pa,{})})})})})})]})})}const va=document.getElementById("root"),ya=L.createRoot(va);ya.render(o(ua,{}));
