...
class HostingQuotaSetEvent(BaseModel):
    """
    Event to set quotas for the specified Agentverse hosting user
    """ # noqa: E501
    user_id: StrictStr
    quotas: HostingQuotas
    expiry: datetime
    __properties: ClassVar[List[str]] = ["user_id", "quotas", "expiry"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "quotas": HostingQuotas.from_dict(obj["quotas"]) if obj.get("quotas") is not None else None,
