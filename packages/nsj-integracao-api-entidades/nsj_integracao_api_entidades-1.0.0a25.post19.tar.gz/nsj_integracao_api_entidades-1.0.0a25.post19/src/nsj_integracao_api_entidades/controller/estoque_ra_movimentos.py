...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/ra_movimentos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/ra_movimentos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/ra_movimentos/verificacao-integridade"
