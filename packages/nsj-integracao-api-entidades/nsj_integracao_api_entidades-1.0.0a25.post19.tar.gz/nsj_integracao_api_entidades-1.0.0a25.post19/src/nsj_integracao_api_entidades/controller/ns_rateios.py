...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/rateios"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/rateios/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/rateios/verificacao-integridade"
