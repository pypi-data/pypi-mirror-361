from nkunyim_iam.auth.common.errors import ContinueIteration
from nkunyim_iam.auth.consts import default_json_headers
from nkunyim_iam.auth.jose.errors import ExpiredTokenError
from nkunyim_iam.auth.jose.errors import InvalidClaimError
from nkunyim_iam.auth.oauth2.rfc6750.errors import InvalidTokenError
from nkunyim_iam.auth.oauth2.rfc9068.token_validator import JWTBearerTokenValidator
...
class JWTIntrospectionEndpoint(IntrospectionEndpoint):
    ...
    :class:`~nkunyim_iam.auth.oauth2.rfc7662.IntrospectionEndpoint` and implements the machinery
    ...
    :param \\*\\*kwargs: Other parameters are inherited from
        :class:`~nkunyim_iam.auth.oauth2.rfc7662.introspection.IntrospectionEndpoint`.
