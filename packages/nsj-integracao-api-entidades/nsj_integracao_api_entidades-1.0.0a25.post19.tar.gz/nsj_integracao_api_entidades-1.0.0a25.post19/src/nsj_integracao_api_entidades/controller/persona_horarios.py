...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/horarios"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/horarios/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/horarios/verificacao-integridade"
