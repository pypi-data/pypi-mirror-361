...
class CmxImage(aspose.imaging.VectorMultipageImage):
    ...
    def __init__(self, stream_container: aspose.imaging.StreamContainer, load_options: aspose.imaging.LoadOptions):
        '''Start working with the  class seamlessly by initializing
...
class CmxImagePage(aspose.imaging.VectorImage):
    ...
    @overload
    def __init__(self, cmx_page: aspose.imaging.fileformats.cmx.objectmodel.CmxPage, container: aspose.imaging.Image):
    ...
    @overload
    def __init__(self, cmx_page: aspose.imaging.fileformats.cmx.objectmodel.CmxPage):
        '''Initializes a new instance of the  class.
...
class ICmxImage(aspose.imaging.interfaces.IObjectWithSizeF):
