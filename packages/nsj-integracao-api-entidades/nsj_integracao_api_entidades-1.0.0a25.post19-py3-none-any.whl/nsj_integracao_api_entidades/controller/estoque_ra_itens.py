...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/ra_itens"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/ra_itens/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/ra_itens/verificacao-integridade"
