...
class KinematicServiceCapabilities(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KinematicServiceCapabilities from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KinematicServiceCapabilities from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "calculate_joint_position": obj.get("calculate_joint_position"),
            "calculate_all_joint_positions": obj.get("calculate_all_joint_positions"),
            "calculate_tcp_pose": obj.get("calculate_tcp_pose")
        })
        return _obj
