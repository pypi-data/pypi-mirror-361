...
def _HardwaresResourceV1_get_get(
...
def _HardwaresResourceV1_post_post(
...
def _HardwareResourceV1_get__string_name__get(
...
def _HardwareResourceV1_put__string_name__put(
...
def _HardwareResourceV1_delete__string_name__delete(
    name: str, api_config_override: Optional[APIConfig] = None
) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
