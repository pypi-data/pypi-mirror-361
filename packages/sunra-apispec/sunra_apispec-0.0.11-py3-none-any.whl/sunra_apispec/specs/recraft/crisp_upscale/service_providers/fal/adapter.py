...
from .schema import RecraftUpscaleCrispInput


class FalImageUpscaleAdapter(IFalAdapter):
    """Adapter for Crisp-Upscale upscale-image generation using FAL."""
    ...
    def convert_input(self, data) -> dict:
        ...
        fal_input = RecraftUpscaleCrispInput(
    ...
    def get_request_url(self) -> str:
        return "https://queue.fal.run/fal-ai/recraft/upscale/crisp"
