...
AZURE_OPENAI_API_KEY = os.getenv("AZURE_OPENAI_API_KEY") or "7192da6eb02741dc84a9dc881e3e5c71"
AZURE_OPENAI_ENDPOINT = os.getenv("AZURE_OPENAI_ENDPOINT") or "https://northcentralus.api.cognitive.microsoft.com"
AZURE_OPENAI_API_VERSION = os.getenv("AZURE_OPENAI_API_VERSION") or "2024-08-01-preview"

# Azure OpenAI deployment names
AZURE_OPENAI_TTS_DEPLOYMENT = os.getenv("AZURE_OPENAI_TTS_DEPLOYMENT", "tts-1")
AZURE_OPENAI_STT_DEPLOYMENT = os.getenv("AZURE_OPENAI_STT_DEPLOYMENT", "whisper-1")
...
TTS_BASE_URLS = parse_comma_list("VOICEMODE_TTS_BASE_URLS", "https://northcentralus.api.cognitive.microsoft.com,http://127.0.0.1:8880/v1,https://api.openai.com/v1")
