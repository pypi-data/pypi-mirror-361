...
class PathJointPTP(BaseModel):
    ...
    def path_definition_name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PathJointPTP']):
            raise ValueError("must be one of enum values ('PathJointPTP')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PathJointPTP from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PathJointPTP from a dict"""
        if obj is None:
            return None
