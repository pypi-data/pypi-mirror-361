...
class CreateContactResponse(BaseModel):
    ...
    """ # noqa: E501
    created_contacts: Optional[List[ContactCreated]] = Field(default=None, alias="createdContacts")
    __properties: ClassVar[List[str]] = ["createdContacts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "createdContacts": [ContactCreated.from_dict(_item) for _item in obj["createdContacts"]] if obj.get("createdContacts") is not None else None
        })
        return _obj
    ...
    def openapi_types(cls) -> Dict[str, str]:
        return {
            "created_contacts": "(List[ContactCreated],)",
        }
