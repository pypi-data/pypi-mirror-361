#!/usr/bin/env python
#
# cube_solver documentation build configuration file, created by
...
version = src.cube_solver.__version__
# The full version, including alpha/beta/rc tags.
release = src.cube_solver.__version__
...
htmlhelp_basename = 'cube_solverdoc'
...
latex_documents = [
    (master_doc, 'cube_solver.tex',
     'Cube Solver Documentation',
     'Dave Barragan', 'manual'),
]
