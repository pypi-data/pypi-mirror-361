...
class ExportPdf(operation.Operation):
    ...
    def _get_domain_display_name(self, entities, com_endereco=False):
        ...
        if com_endereco:
            ...
            if address != '':
                domain_display_name = "<br>".join([
                    domain_display_name, address, address2, ''
                ])
    ...
    def _gerar_html(self, entities, columns):
        ...
        domain_display_name = self._get_domain_display_name(entities)
    ...
    def pre(self, **kwargs):
        ...
        # caso seja passado um style_pagination então o backend irá aplicar ele,
        # caso não seja passado então será aplicado o RETRATO como padrão
