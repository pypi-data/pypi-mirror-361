...
setup(
  ...
  author = 'Audrius Pasvensaks',                   # Your name
  author_email = 'apasvensaks@outlook.com',  # Your email
  url = 'https://github.com/apasvenskas/Python-Package',              # Homepage of your library (e.g. github or your website)
