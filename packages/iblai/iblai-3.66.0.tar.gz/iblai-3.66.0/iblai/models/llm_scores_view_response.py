...
class LLMScoresViewResponse(BaseModel):
    """
    ...
    observation_id: StrictStr = Field(alias="observationId")
    timestamp: datetime
    comment: StrictStr
    __properties: ClassVar[List[str]] = ["id", "traceId", "name", "value", "observationId", "timestamp", "comment"]
