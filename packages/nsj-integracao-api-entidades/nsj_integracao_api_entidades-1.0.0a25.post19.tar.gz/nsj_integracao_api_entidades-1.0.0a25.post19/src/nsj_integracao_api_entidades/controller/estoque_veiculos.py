...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/veiculos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/veiculos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/veiculos/verificacao-integridade"
