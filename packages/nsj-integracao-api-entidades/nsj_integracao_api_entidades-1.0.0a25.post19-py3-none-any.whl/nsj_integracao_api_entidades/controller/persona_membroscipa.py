...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/membroscipa"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/membroscipa/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/membroscipa/verificacao-integridade"
