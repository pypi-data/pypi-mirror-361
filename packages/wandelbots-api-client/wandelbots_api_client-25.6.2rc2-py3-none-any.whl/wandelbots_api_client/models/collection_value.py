...
COLLECTIONVALUE_ANY_OF_SCHEMAS = ["ArrayInput", "Capture", "PointCloud", "PyjectoryDatatypesSerializerOrientation", "PyjectoryDatatypesSerializerPose", "PyjectoryDatatypesSerializerPosition", "bytearray", "float", "int", "str"]
...
class CollectionValue(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = CollectionValue.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in CollectionValue with anyOf schemas: ArrayInput, Capture, PointCloud, PyjectoryDatatypesSerializerOrientation, PyjectoryDatatypesSerializerPose, PyjectoryDatatypesSerializerPosition, bytearray, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into CollectionValue with anyOf schemas: ArrayInput, Capture, PointCloud, PyjectoryDatatypesSerializerOrientation, PyjectoryDatatypesSerializerPose, PyjectoryDatatypesSerializerPosition, bytearray, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return instance
...
CollectionValue.model_rebuild(raise_errors=False)
