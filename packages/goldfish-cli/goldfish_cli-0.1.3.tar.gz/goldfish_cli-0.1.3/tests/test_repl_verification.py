...
class TestREPLVerification:
    ...
    def test_save_capture_with_suggestions_verify_yes(self, mock_confirm, mock_console, mock_suggestion_service, mock_session_class):
        ...
        mock_console.print.assert_any_call("✅ Captured! (Note #456)")
        mock_console.print.assert_any_call("📋 2 entities need verification\n")
    ...
    @patch('goldfish_cli.repl.SuggestionService')
    @patch('goldfish_cli.repl.console')
    @patch('goldfish_cli.repl.Prompt')
    ...
    def test_verify_suggestions_multiple_suggestions_summary(self, mock_prompt, mock_console, mock_suggestion_service):
        ...
        mock_console.print.assert_any_call("📊 Verification complete: 1 new, 0 linked, 1 rejected")

    @patch('goldfish_cli.repl.console')
    @patch('goldfish_cli.repl.Prompt')
    @patch('goldfish_cli.repl.Table')
