...
class ApiAutoPolicyWaiverDTO(BaseModel):
    """
    ...
    path_forward: Optional[StrictBool] = Field(default=None, alias="pathForward")
    public_id: Optional[StrictStr] = Field(default=None, alias="publicId")
    reachability: Optional[StrictBool] = None
    ...
    __properties: ClassVar[List[str]] = ["autoPolicyWaiverId", "createTime", "creatorId", "creatorName", "ownerId", "ownerName", "ownerType", "pathForward", "publicId", "reachability", "scopesOperatorAny", "threatLevel"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiAutoPolicyWaiverDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiAutoPolicyWaiverDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pathForward": obj.get("pathForward"),
