...
class BotBusinessConnection(TLObject, family='TypeBotBusinessConnection'):
    ...
    def __init__(
        ...
        Args:
            ...
            can_reply (bool, optional): Whether the bot can reply on behalf of the user to messages it receives through the business connection
    ...
    def to_bytes(self, boxed: bool=True):
        with Writer(b'\xb43d\x89' if boxed else b'') as writer:
