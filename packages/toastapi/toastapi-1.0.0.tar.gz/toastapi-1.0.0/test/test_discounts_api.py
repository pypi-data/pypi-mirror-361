...
from toasttab.api.discounts_api import DiscountsApi


class TestDiscountsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_applicable_discounts_post(self) -> None:
        """Test case for applicable_discounts_post

        Get applicable discounts
        """
        pass

    async def test_orders_checks_applied_discounts_post(self) -> None:
        """Test case for orders_checks_applied_discounts_post

        Add check-level discounts
        """
        pass

    async def test_orders_checks_selections_applied_discounts_post(self) -> None:
        """Test case for orders_checks_selections_applied_discounts_post
