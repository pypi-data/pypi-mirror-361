...
// common.track.VirtualTrackDict
export type VirtualTrackJson = {
    title: string,
    type: string,
};
...
export type ControlServerPlaying = {
    ...
    virtual_track: VirtualTrackJson | null,
    queue: Array<QueuedTrackJson> | null,
    playlists: Array<string> | null,
};
