...
class GraphBuilder:
    ...
    async def _process_function(self, chunk: Chunk, file_path: str) -> None:
        ...
        # Add USES relationship (file uses function)
        await self.graph.add_edge(file_path, func_path, "USES")
    ...
    async def _process_class(self, chunk: Chunk, file_path: str) -> None:
        ...
        # Add USES relationship (file uses class)
        await self.graph.add_edge(file_path, class_path, "USES")
        self.metrics.increment("rag.graph_builder.edges_created")
