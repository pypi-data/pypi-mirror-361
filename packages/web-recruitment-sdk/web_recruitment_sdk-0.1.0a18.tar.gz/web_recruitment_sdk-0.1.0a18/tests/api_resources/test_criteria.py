...
class TestCriteria:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_retrieve_matching_progress(self, client: WebRecruitmentSDK) -> None:
        criterion = client.criteria.retrieve_matching_progress(
            criterion_id=0,
        )
        assert_matches_type(CriterionRetrieveMatchingProgressResponse, criterion, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_method_retrieve_matching_progress_with_all_params(self, client: WebRecruitmentSDK) -> None:
        criterion = client.criteria.retrieve_matching_progress(
            criterion_id=0,
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_retrieve_matching_progress(self, client: WebRecruitmentSDK) -> None:
        response = client.criteria.with_raw_response.retrieve_matching_progress(
            criterion_id=0,
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_retrieve_matching_progress(self, client: WebRecruitmentSDK) -> None:
        with client.criteria.with_streaming_response.retrieve_matching_progress(
            criterion_id=0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncCriteria:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_retrieve_matching_progress(self, async_client: AsyncWebRecruitmentSDK) -> None:
        criterion = await async_client.criteria.retrieve_matching_progress(
            criterion_id=0,
        )
        assert_matches_type(CriterionRetrieveMatchingProgressResponse, criterion, path=["response"])
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_retrieve_matching_progress_with_all_params(
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_retrieve_matching_progress(self, async_client: AsyncWebRecruitmentSDK) -> None:
        response = await async_client.criteria.with_raw_response.retrieve_matching_progress(
            criterion_id=0,
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_retrieve_matching_progress(self, async_client: AsyncWebRecruitmentSDK) -> None:
        async with async_client.criteria.with_streaming_response.retrieve_matching_progress(
            criterion_id=0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
