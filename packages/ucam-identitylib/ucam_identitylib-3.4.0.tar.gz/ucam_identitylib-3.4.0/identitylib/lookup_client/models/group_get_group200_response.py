...
class GroupGetGroup200Response(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupGetGroup200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupGetGroup200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "result": GroupGetGroup200ResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
