...
class BENNETT5(AbstractNonlinearEquations):
    ...
    def residual(self, y, args) -> Float[Array, "154"]:
        """Residual function for the nonlinear equations."""
        b1, b2, b3 = y

        # X data - truncated for brevity, showing pattern
        x_data = jnp.array(
            [
                7.447168e0,
                8.102586e0,
        ...
        model = b1 * jnp.power(b2 + x_data, -1.0 / b3)
