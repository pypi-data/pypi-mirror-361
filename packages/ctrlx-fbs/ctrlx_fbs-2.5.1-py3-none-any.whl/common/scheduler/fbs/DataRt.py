...
def DataRtStart(builder): builder.StartObject(3)
def Start(builder):
...
def DataRtAddCalculatedStartTime(builder, calculatedStartTime): builder.PrependUint64Slot(2, calculatedStartTime, 0)
def AddCalculatedStartTime(builder, calculatedStartTime):
    return DataRtAddCalculatedStartTime(builder, calculatedStartTime)
...
class DataRtT(object):
    ...
    def _UnPack(self, dataRt):
        ...
        self.calculatedStartTime = dataRt.CalculatedStartTime()
    ...
    def Pack(self, builder):
        ...
        DataRtAddCalculatedStartTime(builder, self.calculatedStartTime)
