...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/midiasorigem"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/midiasorigem/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/midiasorigem/verificacao-integridade"
