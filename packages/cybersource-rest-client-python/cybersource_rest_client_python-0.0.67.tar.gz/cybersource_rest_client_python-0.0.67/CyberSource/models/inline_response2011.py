...
class InlineResponse2011(object):
    ...
    def __init__(self, id=None, submit_time_utc=None, status=None, payment_account_information=None, issuer_information=None, payout_information=None):
        """
        ...
        if payout_information is not None:
          self.payout_information = payout_information
    ...
    def payout_information(self):
        """
        Gets the payout_information of this InlineResponse2011.

        :return: The payout_information of this InlineResponse2011.
        :rtype: InlineResponse2011PayoutInformation
        """
        return self._payout_information

    @payout_information.setter
    def payout_information(self, payout_information):
        """
        Sets the payout_information of this InlineResponse2011.

        :param payout_information: The payout_information of this InlineResponse2011.
        :type: InlineResponse2011PayoutInformation
        """

        self._payout_information = payout_information
