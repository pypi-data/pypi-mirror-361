...
DEFAULT_CONFIG = {
        common.SETTING_GROUP_GENERAL: {
            ...
            common.SETTING_RESET_TERMINAL: 'yes',
            common.SETTING_SAFE_SAVE: 'yes',
            common.SETTING_SEARCH_CASE_SENSITIVE: common.SETTING_SEARCH_CASE_YES,
            ...
            common.SETTING_DONE_IS: common.DONE_OPTION_MARK,
            common.SETTING_NOTE_SUFFIX: common.DEFAULT_NOTE_SUFFIX,
            common.SETTING_NOTE_NAMING: common.NOTE_NAMING_USER,
            common.SETTING_AUTO_TEMPLATE_CASING: common.SETTING_SEARCH_CASE_YES,
            common.SETTING_SORT_ORDER: common.DEFAULT_SORT_ORDER,
            common.SETTING_BUSINESS_DAYS: common.DEFAULT_BUSINESS_DAYS,
        },
