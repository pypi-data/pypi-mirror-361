...
def list_versions(model_id: str, page=1, size=10, sort=None, filter=None, search=None, ids=None):
    ...
    try:
        ...
        click.secho(f"❌ Failed to list model versions: {e}", fg="red")
...
def get_model_version(model_id: str, version_id: str):
    ...
    try:
        ...
        click.secho(f"❌ Failed to get model version: {e}", fg="red")
...
def get_version(version_id: str):
    ...
    try:
        ...
        click.secho(f"❌ Failed to get version: {e}", fg="red")
...
def delete_model_version(model_id: str, version_id: str):
    ...
    try:
        ...
        click.secho(f"❌ Failed to delete model version: {e}", fg="red")
...
def update_model_version(model_id: str, version_id: str, version_data: dict):
    ...
    try:
        ...
        click.secho(f"❌ Failed to update model version: {e}", fg="red")
...
def promote_version(version_id: str, promotion_data: dict):
    ...
    try:
        ...
        click.secho(f"❌ Failed to promote model version: {e}", fg="red") 