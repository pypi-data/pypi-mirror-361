...
from bosa_core.helpers.cache.interface import CacheService as CacheService
...
class RedisCacheService(CacheService):
    ...
    client: Incomplete
    def __init__(self, *, host: str | None = None, port: int | None = None, db: int = 0, password: str | None = None, tls_enabled: bool = False) -> None:
