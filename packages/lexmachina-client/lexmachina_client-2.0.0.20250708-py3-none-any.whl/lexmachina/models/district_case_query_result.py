...
class DistrictCaseQueryResult(BaseModel):
    """
    DistrictCaseQueryResult
    """ # noqa: E501
    cases: List[DistrictCaseReference]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cases": [DistrictCaseReference.from_dict(_item) for _item in obj["cases"]] if obj.get("cases") is not None else None
        })
        return _obj
