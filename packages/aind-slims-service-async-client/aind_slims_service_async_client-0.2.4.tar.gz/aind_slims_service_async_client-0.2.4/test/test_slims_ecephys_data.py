    ...
    def make_instance(self, include_optional) -> SlimsEcephysData:
        ...
        if include_optional:
            return SlimsEcephysData(
                ...
                reward_spouts = [
                    aind_slims_service_async_client.models.ecephys_reward_spouts.EcephysRewardSpouts(
                        spout_side = '', 
                        starting_position = '', 
                ...
                stream_modules = [
                    aind_slims_service_async_client.models.ecephys_stream_module.EcephysStreamModule(
                        implant_hole = 56, 
                        assembly_name = '', 
                        probe_name = '', 
