...
(set_juicing_oil_recovery, set_microbial_oil_recovery, set_bagasse_oil_recovery, 
 ...
 set_ethanol_price, set_biodiesel_price, set_RIN_D3_price,
 set_RIN_D4_price, set_RIN_D5_price,
 ...
 set_income_tax,
    ...
    MockFeature('Price', 'USD/RIN', 'RIN D3'),
    MockFeature('Price', 'USD/RIN', 'RIN D4'),
    MockFeature('Price', 'USD/RIN', 'RIN D5'),
