...
from .service_providers.fal.adapter import FalTextToImageAdapter
...
service = BaseAPIService(
    title="Recraft V2 API",
    description="API for Recraft V2 image generation model - A high-quality text-to-image generation model with various artistic styles and customization options.",
    version="1.0.0",
