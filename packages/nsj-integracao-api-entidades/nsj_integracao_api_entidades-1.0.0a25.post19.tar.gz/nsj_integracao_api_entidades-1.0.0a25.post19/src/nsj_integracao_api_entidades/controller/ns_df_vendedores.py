...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/df_vendedores"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/df_vendedores/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/df_vendedores/verificacao-integridade"
