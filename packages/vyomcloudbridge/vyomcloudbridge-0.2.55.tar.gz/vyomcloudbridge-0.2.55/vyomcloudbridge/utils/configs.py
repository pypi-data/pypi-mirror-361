...
from vyomcloudbridge.constants.constants import machine_config_file
    ...
    def get_machine_config() -> Dict[str, Any]:
        ...
        if os.path.exists(machine_config_file):
            ...
            try:
                ...
                logger.warning(f"Failed to get ssh_port from {machine_config_file}")
            except Exception as e:
                machine_detail["ssh_port"] = 0
                logger.warning(f"Failed to parse ssh_port from {machine_config_file}")
            ...
            try:
                ...
                logger.warning(f"Failed to get ssh_enabled from {machine_config_file}")
            except Exception as e:
                machine_detail["ssh_enabled"] = False
            ...
            try:
                ...
                logger.warning(f"Failed to get ssh_key from {machine_config_file}")
