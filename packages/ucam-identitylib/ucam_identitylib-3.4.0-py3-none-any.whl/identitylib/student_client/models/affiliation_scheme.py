...
class AffiliationScheme(str, Enum):
    ...
    ACADEMIC_MINUS_PLAN_DOT_V1_DOT_STUDENT_MINUS_RECORDS_DOT_UNIVERSITY_DOT_IDENTIFIERS_DOT_CAM_DOT_AC_DOT_UK = 'academic-plan.v1.student-records.university.identifiers.cam.ac.uk'
