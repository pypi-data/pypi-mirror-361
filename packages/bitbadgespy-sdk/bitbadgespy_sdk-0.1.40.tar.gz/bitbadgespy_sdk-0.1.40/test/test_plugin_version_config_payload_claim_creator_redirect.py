...
class TestPluginVersionConfigPayloadClaimCreatorRedirect(unittest.TestCase):
    """PluginVersionConfigPayloadClaimCreatorRedirect unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PluginVersionConfigPayloadClaimCreatorRedirect:
        """Test PluginVersionConfigPayloadClaimCreatorRedirect
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PluginVersionConfigPayloadClaimCreatorRedirect`
        """
        model = PluginVersionConfigPayloadClaimCreatorRedirect()
        if include_optional:
            return PluginVersionConfigPayloadClaimCreatorRedirect(
                tool_uri = '',
                tutorial_uri = '',
                tester_uri = ''
            )
    ...
    def testPluginVersionConfigPayloadClaimCreatorRedirect(self):
        """Test PluginVersionConfigPayloadClaimCreatorRedirect"""
