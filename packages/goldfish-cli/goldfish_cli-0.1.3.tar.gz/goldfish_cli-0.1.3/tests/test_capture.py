...
class TestCaptureCommands:
    ...
    @patch('goldfish_cli.capture.create_db_and_tables')
    @patch('goldfish_cli.capture.Session')
    @patch('goldfish_cli.capture._get_or_create_quick_capture_file')
    @patch('goldfish_cli.capture.EntityRecognitionEngine')
    @patch('goldfish_cli.capture.SuggestionService')
    @patch('goldfish_cli.capture.console')
    ...
    def test_process_and_store_with_many_suggestions(self, mock_console, mock_suggestion_service, mock_session_class, mock_create_db):
        ...
        with patch('goldfish_cli.capture._get_or_create_quick_capture_file') as mock_get_file:
            mock_get_file.return_value = mock_source_file
            
            # Mock Note creation
            with patch('goldfish_cli.capture.Note') as mock_note_class:
    ...
    def test_get_or_create_quick_capture_file_existing(self, mock_session_class, mock_create_db):
        ...
        from goldfish_cli.capture import _get_or_create_quick_capture_file
