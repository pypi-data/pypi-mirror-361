...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/romaneios_entregas"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/romaneios_entregas/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/romaneios_entregas/verificacao-integridade"
