...
def KinStateJntTrafoDataSingleStart(builder): builder.StartObject(14)
def Start(builder):
...
def KinStateJntTrafoDataSingleAddAddInfo(builder, addInfo): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(addInfo), 0)
def AddAddInfo(builder, addInfo):
    return KinStateJntTrafoDataSingleAddAddInfo(builder, addInfo)
def KinStateJntTrafoDataSingleStartAddInfoVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def StartAddInfoVector(builder, numElems):
    return KinStateJntTrafoDataSingleStartAddInfoVector(builder, numElems)
...
class KinStateJntTrafoDataSingleT(object):
    ...
    def __eq__(self, other):
        return type(self) == type(other) and \
            ...
            self.oriCapability == other.oriCapability and \
    ...
    def _UnPack(self, kinStateJntTrafoDataSingle):
        ...
        if not kinStateJntTrafoDataSingle.AddInfoIsNone():
            self.addInfo = []
            for i in range(kinStateJntTrafoDataSingle.AddInfoLength()):
                if kinStateJntTrafoDataSingle.AddInfo(i) is None:
                    self.addInfo.append(None)
                else:
                    kVPCfgSingleItem_ = motion.core.fbtypes.KVPCfgSingleItem.KVPCfgSingleItemT.InitFromObj(kinStateJntTrafoDataSingle.AddInfo(i))
    ...
    def Pack(self, builder):
        ...
        if self.addInfo is not None:
            ...
            KinStateJntTrafoDataSingleStartAddInfoVector(builder, len(self.addInfo))
        ...
        if self.addInfo is not None:
            KinStateJntTrafoDataSingleAddAddInfo(builder, addInfo)
