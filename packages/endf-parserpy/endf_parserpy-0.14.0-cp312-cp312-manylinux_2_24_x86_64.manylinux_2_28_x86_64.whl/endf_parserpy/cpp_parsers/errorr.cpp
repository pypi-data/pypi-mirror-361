...
// MD5 hash of file content below this line: 6f6b31329cc5f6c9658369ce5415c93b
...
// MD5 hash of the following function definition: 69b69d5c528bb69da030128fe6698a83
py::dict parse_mf1mt451_istream(
  ...
  if ((! (aux_NG_read == true))) {
    ...
    // assign expression to variable NG
    var_NG_0d_int_Scalar = (cpp_int_val+(-1));
    aux_NG_read = true;
    validate_vartype_consistency("NG", SCALAR_INT, aux_last_type_read_for_NG);
    aux_last_type_read_for_NG = SCALAR_INT;
  } else {
...
// MD5 hash of ENDF recipe underlying the following function: 1aa496513dcfa0260b0a6404b7a0ea5a
// MD5 hash of the following function definition: 04a29456d69e56f3547c28d949c27073
