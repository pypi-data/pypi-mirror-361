...
from phoebe_bird._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Phoebe | AsyncPhoebe) -> int:
...
class TestPhoebe:
    client = Phoebe(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "phoebe_bird/_legacy_response.py",
                        "phoebe_bird/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "phoebe_bird/_compat.py",
    ...
    def test_client_timeout_option(self) -> None:
        client = Phoebe(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_multipart_repeating_array(self, client: Phoebe) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Phoebe(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(PHOEBE_BASE_URL="http://localhost:5000/from/env"):
            client = Phoebe(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Phoebe(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Phoebe(
    ...
    def test_base_url_trailing_slash(self, client: Phoebe) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Phoebe) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Phoebe) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Phoebe(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Phoebe(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Phoebe(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Phoebe) -> None:
        respx_mock.get("/ref/hotspot/info/locId").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            client.ref.hotspot.info.with_streaming_response.retrieve("locId").__enter__()

        assert _get_open_connections(self.client) == 0

    @mock.patch("phoebe_bird._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Phoebe) -> None:
...
class TestAsyncPhoebe:
    client = AsyncPhoebe(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncPhoebe) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(PHOEBE_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncPhoebe(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncPhoebe) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncPhoebe) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncPhoebe) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncPhoebe(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncPhoebe(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("phoebe_bird._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncPhoebe) -> None:
        respx_mock.get("/ref/hotspot/info/locId").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            await async_client.ref.hotspot.info.with_streaming_response.retrieve("locId").__aenter__()

        assert _get_open_connections(self.client) == 0

    @mock.patch("phoebe_bird._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    async def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncPhoebe) -> None:
        respx_mock.get("/ref/hotspot/info/locId").mock(return_value=httpx.Response(500))
