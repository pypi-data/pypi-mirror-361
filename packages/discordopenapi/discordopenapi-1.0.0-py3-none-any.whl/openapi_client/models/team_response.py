...
class TeamResponse(BaseModel):
    ...
    name: StrictStr
    owner_user_id: Annotated[str, Field(strict=True)]
    members: List[TeamMemberResponse]
    __properties: ClassVar[List[str]] = ["id", "icon", "name", "owner_user_id", "members"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "members": [TeamMemberResponse.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None
        })
        return _obj
