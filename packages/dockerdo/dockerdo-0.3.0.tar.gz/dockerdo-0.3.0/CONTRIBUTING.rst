...
Report bugs at https://github.com/waino/dockerdo/issues
...
dockerdo could always use more documentation, whether as part of
...
https://github.com/waino/dockerdo/issues
...
Ready to contribute? Here's how to set up `dockerdo` for local
development. Please note this documentation assumes you already have
`virtualenv` and `Git` installed and ready to go.

1. Fork the `dockerdo` repo on GitHub.
2. Clone your fork locally:

   .. code-block:: bash

    $ cd path_for_the_repo
    $ git clone git@github.com:YOUR_NAME/dockerdo.git
...
3. Install your local copy into a virtualenv.
   ...
   .. code-block:: bash
        ...
        $ virtualenv dockerdo-env
        $ source dockerdo-env/bin/activate
        $ pip install flit
