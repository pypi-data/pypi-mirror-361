...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/tabelasdeprecos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/tabelasdeprecos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/tabelasdeprecos/verificacao-integridade"
