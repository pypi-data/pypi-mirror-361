...
from .service_providers.bfl_official.adapter import BFLFluxV1FillImageToImageProAdapter
from .service_providers.littercoder.adapter import LittercoderFluxV1FillProImageToImageAdapter
...
service = BaseAPIService(
    ...
    description="API for Black Forest Labs FLUX.1-Fill-Pro image generation model",
    version="1.0.0",
    ...
    f"{model_path}/image-to-image": [
        {
            ...
            "adapter": BFLFluxV1FillImageToImageProAdapter,
            "request_type": RequestType.ASYNC,
        },
        {
            "service_provider": ServiceProviderEnum.LITTERCODER.value,
            "adapter": LittercoderFluxV1FillProImageToImageAdapter,
            "request_type": RequestType.ASYNC,
        }
    ],
}
