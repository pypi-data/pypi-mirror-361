...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/proximoscontatos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/proximoscontatos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/proximoscontatos/verificacao-integridade"
