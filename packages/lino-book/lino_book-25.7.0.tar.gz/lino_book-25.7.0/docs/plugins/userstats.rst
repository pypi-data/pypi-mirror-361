.. doctest docs/plugins/userstats.rst
.. _specs.userstats:
...
Implements functionality for getting statistics about users.
...
statistical data about the :term:`site users <site user>`.  For the moment this
shows nothing more and nothing less than the **number of active users for every
month**.
