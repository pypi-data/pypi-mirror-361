...
class Loan(ResourceBase):
    ...
    def _create(self, location: Location) -> None:
        ...
        try:
            ...
            logger.error(f"Error creating Loan: {err}")
            raise err

    def _overwrite(self) -> None:
        """
        Overwrite a Loan that exists in the platform.
    ...
    def price(
        ...
        *,
        ...
        try:
            ...
            logger.error(f"Error price for loan with id. {err}")
    ...
    def value(
        ...
        *,
        ...
        try:
            ...
            logger.error(f"Error value for loan with id. {err}")
            check_exception_and_raise(err)
