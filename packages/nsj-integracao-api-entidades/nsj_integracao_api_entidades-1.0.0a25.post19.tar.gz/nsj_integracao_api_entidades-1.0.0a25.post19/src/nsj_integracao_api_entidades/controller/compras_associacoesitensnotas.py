...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/associacoesitensnotas"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/associacoesitensnotas/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/associacoesitensnotas/verificacao-integridade"
