...
class CapableInterfaces(object):
    ...
    def InterfaceList(self, j):
        ...
        if o != 0:
            ...
            from comm.profinet.device.fbs.Interface import Interface
            obj = Interface()
...
import comm.profinet.device.fbs.Interface
try:
...
class CapableInterfacesT(object):
    ...
    # CapableInterfacesT
    def __init__(self):
        self.interfaceList = None  # type: List[comm.profinet.device.fbs.Interface.InterfaceT]
        ...
        if not capableInterfaces.InterfaceListIsNone():
            ...
            for i in range(capableInterfaces.InterfaceListLength()):
                if capableInterfaces.InterfaceList(i) is None:
                    ...
                    interface_ = comm.profinet.device.fbs.Interface.InterfaceT.InitFromObj(capableInterfaces.InterfaceList(i))
