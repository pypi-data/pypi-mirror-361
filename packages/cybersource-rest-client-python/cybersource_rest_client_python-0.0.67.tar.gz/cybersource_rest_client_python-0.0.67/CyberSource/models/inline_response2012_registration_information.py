...
class InlineResponse2012RegistrationInformation(object):
    """
    ...
    def __init__(self, boarding_package_id=None, mode=None, sales_rep_id=None):
        """
        InlineResponse2012RegistrationInformation - a model defined in Swagger
        """
    ...
    def boarding_package_id(self, boarding_package_id):
        """
        Sets the boarding_package_id of this InlineResponse2012RegistrationInformation.
    ...
    def mode(self, mode):
        """
        Sets the mode of this InlineResponse2012RegistrationInformation.
        In case mode is not provided the API will use COMPLETE as default Possible Values:   - 'COMPLETE'   - 'PARTIAL' 
    ...
    def sales_rep_id(self, sales_rep_id):
        """
        Sets the sales_rep_id of this InlineResponse2012RegistrationInformation.
