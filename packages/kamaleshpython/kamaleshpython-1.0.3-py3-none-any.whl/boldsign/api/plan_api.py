...
class PlanApi:
    ...
    def api_credits_count(
        ...
        _param = self._api_credits_count_serialize(
    ...
    @validate_call
    def api_credits_count_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def api_credits_count_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _api_credits_count_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/plan/apiCreditsCount',
