...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/pessoasparcelamentos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/pessoasparcelamentos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/pessoasparcelamentos/verificacao-integridade"
