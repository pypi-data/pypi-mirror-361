...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/funcoes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/funcoes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/funcoes/verificacao-integridade"
