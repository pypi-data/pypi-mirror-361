...
class PageLeaf(BaseModel):
    """
    PageLeaf
    """ # noqa: E501
    items: List[TortoiseContribPydanticCreatorRelayDbModelsDbApiKeyLeaf]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [TortoiseContribPydanticCreatorRelayDbModelsDbApiKeyLeaf.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
            "size": obj.get("size"),
            "pages": obj.get("pages")
