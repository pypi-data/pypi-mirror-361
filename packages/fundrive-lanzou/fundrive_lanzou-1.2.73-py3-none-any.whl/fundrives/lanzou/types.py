...
FileInFolder = namedtuple(
    "FileInFolder", ["name", "time", "size", "type", "url", "pwd"], defaults=("",) * 6
)
FolderDetail = namedtuple(
    "FolderDetail",
...
ShareItem = namedtuple(
    "ShareItem", ["item", "all", "count", "parent"], defaults=("", None, 1, [])
)
