...
class MailingApi:
    ...
    async def subscribe_to_newsletter(
        ...
        _param = self._subscribe_to_newsletter_serialize(
            email=email,
    ...
    @validate_call
    async def subscribe_to_newsletter_with_http_info(
        self,
        email: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def subscribe_to_newsletter_without_preload_content(
        self,
        email: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _subscribe_to_newsletter_serialize(
        self,
        email,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/hosting/mailing-list/subscribe',
