...
class StartMovementResponse(BaseModel):
    ...
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['START_RECEIVED']):
            raise ValueError("must be one of enum values ('START_RECEIVED')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartMovementResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartMovementResponse from a dict"""
        if obj is None:
            return None
