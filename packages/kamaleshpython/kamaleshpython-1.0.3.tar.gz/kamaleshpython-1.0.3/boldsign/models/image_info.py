...
class ImageInfo(BaseModel):
    ...
    allowed_file_extensions: Optional[StrictStr] = Field(alias="allowedFileExtensions")
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["title", "allowedFileExtensions", "description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "title": obj.get("title"),
            "allowedFileExtensions": obj.get("allowedFileExtensions"),
