...
class TestPaymentIntentRequestModel(unittest.TestCase):
    """PaymentIntentRequestModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentIntentRequestModel:
        """Test PaymentIntentRequestModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentIntentRequestModel`
        """
        model = PaymentIntentRequestModel()
        if include_optional:
    ...
    def testPaymentIntentRequestModel(self):
        """Test PaymentIntentRequestModel"""
