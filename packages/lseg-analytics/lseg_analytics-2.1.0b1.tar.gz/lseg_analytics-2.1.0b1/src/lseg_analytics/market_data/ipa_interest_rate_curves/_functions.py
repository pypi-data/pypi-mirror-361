...
def calculate(*, universe: Optional[List[ZcCurveRequestItem]] = None, fields: Optional[str] = None) -> ZcCurvesResponse:
    ...
    try:
        ...
        response = check_and_raise(Client().ipa_interest_rate_curves.calculate(fields=fields, universe=universe))
    ...
    *,
    ...
    try:
        ...
        response = check_and_raise(
            Client().ipa_interest_rate_curves.calculate_by_id(
...
def create(
    *,
    ...
    try:
        ...
        response = check_and_raise(
            Client().ipa_interest_rate_curves.create(
...
def delete(*, curve_id: str) -> bool:
    """
    Delete a InterestRateCurveDefinition that exists in the platform.
    ...
    try:
        ...
        check_and_raise(Client().ipa_interest_rate_curves.delete(curve_id=curve_id))
...
def overwrite(
    *,
    ...
    """
    Overwrite a InterestRateCurveDefinition that exists in the platform.
    ...
    try:
        ...
        response = check_and_raise(
            Client().ipa_interest_rate_curves.overwrite(
                body=InterestRateCurveCreateRequest(
                    curve_definition=curve_definition,
                    overrides=overrides,
                    segments=segments,
...
def read(*, curve_id: str, fields: Optional[str] = None) -> IPAInterestRateCurveResponse:
    """
    Access a InterestRateCurveDefinition existing in the platform (read).
    ...
    try:
        ...
        response = check_and_raise(Client().ipa_interest_rate_curves.read(curve_id=curve_id, fields=fields))
...
def search(
    *,
    ...
    try:
        ...
        response = check_and_raise(Client().ipa_interest_rate_curves.search(fields=fields, universe=universe))
