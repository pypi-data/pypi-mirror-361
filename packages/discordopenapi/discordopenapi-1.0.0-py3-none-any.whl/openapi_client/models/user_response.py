...
class UserResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "username", "avatar", "discriminator", "public_flags", "flags", "bot", "system", "banner", "accent_color", "global_name", "avatar_decoration_data", "collectibles", "primary_guild"]
