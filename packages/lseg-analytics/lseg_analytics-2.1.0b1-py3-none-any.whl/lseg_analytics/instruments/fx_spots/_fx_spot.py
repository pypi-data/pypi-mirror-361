...
class FxSpot(ResourceBase):
    ...
    def _create(self, location: Location) -> None:
        ...
        try:
            ...
            logger.error(f"Error creating FxSpot: {err}")
            raise err

    def _overwrite(self) -> None:
        """
        Overwrite a FxSpot that exists in the platform.
    ...
    def price(
        ...
        *,
        ...
        try:
            ...
            logger.error(f"Error price for fxSpot with id. {err}")
    ...
    def value(
        ...
        *,
        ...
        try:
            ...
            logger.error(f"Error value for fxSpot with id. {err}")
            check_exception_and_raise(err)
