...
class GifImage(aspose.imaging.RasterCachedMultipageImage):
    ...
    @overload
    def __init__(self, first_frame: aspose.imaging.fileformats.gif.blocks.GifFrameBlock, global_palette: aspose.imaging.IColorPalette, is_palette_sorted: bool, palette_color_resolution: byte, palette_background_color_index: byte, aspect_ratio: byte, has_trailer: bool):
    ...
    @property
    def palette_color_resolution_bits(self) -> byte:
        ...
    
    @palette_color_resolution_bits.setter
    def palette_color_resolution_bits(self, value : byte):
        ...
