...
class DDHTests(RemoteAuthTestCase):
    ...
    def test01(self):
        ...
        InvoicesByJournal = rt.models.vat.InvoicesByJournal
        ...
        u = User(username='robin', user_type=UserTypes.admin, language="en")
        u.save()
        ...
        msg = "Kann Partner Doe John nicht löschen weil 1 Hauptbuchrechnungen darauf verweisen."
