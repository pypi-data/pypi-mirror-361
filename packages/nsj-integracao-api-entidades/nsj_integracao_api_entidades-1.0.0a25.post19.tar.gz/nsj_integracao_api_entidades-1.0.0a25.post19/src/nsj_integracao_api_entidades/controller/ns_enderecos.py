...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/enderecos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/enderecos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/enderecos/verificacao-integridade"
