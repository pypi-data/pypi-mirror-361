...
<!-- prettier-ignore -->
[![PyPI version](https://img.shields.io/pypi/v/web_recruitment_sdk.svg?label=pypi%20(stable))](https://pypi.org/project/web_recruitment_sdk/)
...
> [!NOTE]
> Once this package is [published to PyPI](https://www.stainless.com/docs/guides/publish), this will become: `pip install --pre web_recruitment_sdk`
...
client = WebRecruitmentSDK(
    ...
    # or 'development' | 'staging'; defaults to "development".
...
```sh
# install from the production repo
pip install 'web_recruitment_sdk[aiohttp] @ git+ssh://git@github.com/TriallyAI/web-recruitment-sdk.git'
```
...
import os
import asyncio
from web_recruitment_sdk import DefaultAioHttpClient
from web_recruitment_sdk import AsyncWebRecruitmentSDK
...
response = client.outreach.trigger_call(
    call_data={
