...
class TiffDataType:
    ...
    def get_additional_data_size(self, size_of_tag_value: byte) -> int:
...
class TiffFrame(aspose.imaging.RasterCachedImage):
    ...
    @property
    def path_resources(self) -> List[aspose.imaging.fileformats.tiff.pathresources.PathResource]:
        ...
    
    @path_resources.setter
    def path_resources(self, value : List[aspose.imaging.fileformats.tiff.pathresources.PathResource]):
        ...
