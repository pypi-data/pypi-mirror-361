...
class ResponseModelServiceInfo(object):
    ...
    def __init__(self, active_rollout=None, alive_revision_numbers=None, created_by=None, created_dt=None, description=None, docs_enabled=None, gateway_config=None, id=None, kernel_cluster=None, kernel_cluster_id=None, kernel_cluster_name=None, last_updated_by=None, name=None, running_replicas=None, secret=None, serverless=None, status=None, total_replicas=None, type=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
