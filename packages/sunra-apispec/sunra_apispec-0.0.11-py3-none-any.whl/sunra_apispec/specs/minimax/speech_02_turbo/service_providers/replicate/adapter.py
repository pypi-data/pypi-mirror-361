...
class MinimaxTextToAudioAdapter(IReplicateAdapter):
    """Adapter for text-to-audio generation using MiniMax speech-02-turbo model."""
    ...
    def convert_output(self, data, processURLMiddleware: Callable[[str], SunraFile]) -> dict:
        ...
        if isinstance(data, dict):
            ...
            return MinimaxSpeech02TurboOutput(
                audio=audio,
    ...
    def get_request_url(self) -> str:
        ...
        return f"https://api.replicate.com/v1/models/minimax/speech-02-turbo/predictions"
