...
def convert_exception(
    ...
    sql_state = info.metadata.get("sqlState", default=SparkConnectGrpcException.CLIENT_UNEXPECTED_MISSING_SQL_STATE) # EDGE
...
class SparkConnectGrpcException(SparkConnectException):
    ...
    # BEGIN-EDGE
    CLIENT_INTERNAL_ERROR = "XXKCI"
    CLIENT_UNEXPECTED_MISSING_SQL_STATE = "XXKCM"
    # END-EDGE
