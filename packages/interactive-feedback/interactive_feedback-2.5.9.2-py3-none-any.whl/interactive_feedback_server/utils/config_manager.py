...
def _get_config_file_path() -> str:
    ...
    is_uvx_environment = (
        ("uv" in current_file_path and ("cache" in current_file_path or "archive" in current_file_path)) or
        ("AppData" in current_file_path and "uv" in current_file_path) or
        ("archive-v0" in current_file_path)
    )
