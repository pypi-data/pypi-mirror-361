...
def AxsIpoValuesStart(builder): builder.StartObject(10)
def Start(builder):
...
def AxsIpoValuesAddIpoTrqUnit(builder, ipoTrqUnit): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(ipoTrqUnit), 0)
def AddIpoTrqUnit(builder, ipoTrqUnit):
    return AxsIpoValuesAddIpoTrqUnit(builder, ipoTrqUnit)
def AxsIpoValuesAddIpoTrq(builder, ipoTrq): builder.PrependFloat64Slot(9, ipoTrq, 0.0)
def AddIpoTrq(builder, ipoTrq):
    return AxsIpoValuesAddIpoTrq(builder, ipoTrq)
...
class AxsIpoValuesT(object):
    ...
    def __init__(self):
        ...
        self.ipoTrqUnit = None  # type: str
        self.ipoTrq = 0.0  # type: float
    ...
    def __eq__(self, other):
        return type(self) == type(other) and \
            ...
            self.ipoJrkUnit == other.ipoJrkUnit and \
            self.ipoTrqUnit == other.ipoTrqUnit and \
            self.ipoTrq == other.ipoTrq
    ...
    def _UnPack(self, axsIpoValues):
        ...
        self.ipoTrqUnit = axsIpoValues.IpoTrqUnit()
        self.ipoTrq = axsIpoValues.IpoTrq()
    ...
    def Pack(self, builder):
        ...
        if self.ipoTrqUnit is not None:
            ipoTrqUnit = builder.CreateString(self.ipoTrqUnit)
        ...
        if self.ipoTrqUnit is not None:
            AxsIpoValuesAddIpoTrqUnit(builder, ipoTrqUnit)
        AxsIpoValuesAddIpoTrq(builder, self.ipoTrq)
