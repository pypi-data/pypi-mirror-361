...
def Sequence_View_DualArray(self, ancestor):
	def ViewDataAmp(self, ancestor, data1, data2, r, g, b):
		self.ancestor.GetPage(0).queue_info.put("Preparing array visualisation...")
		self.ancestor.GetPage(0).queue_info.put("Array Size: " + str(data1.shape))
		max = numpy.array( numpy.unravel_index(data1.argmax(), data1.shape) )
		self.ancestor.GetPage(0).queue_info.put("Array Maximum Coordinates: " + str(max))
		self.ancestor.GetPage(0).queue_info.put("Array Maximum: %1.6e" %(numpy.abs(data1[max[0]][max[1]][max[2]])))
		panelvisual = ancestor.GetPage(1)
		contour = float(self.contour.value.GetValue())
		maxval = numpy.abs(data1).max()
		if contour > maxval: contour = CNTR_CLIP*maxval;
		contour_support = float(self.contour_support.value.GetValue())
		maxval = numpy.abs(data2).max()
		if contour_support > maxval: contour_support = CNTR_CLIP*maxval;
		opacity_support = float(self.opacity_support.value.GetValue())
		feature_angle = float(self.feature_angle.value.GetValue())
		feature_angle_support = float(self.feature_angle_support.value.GetValue())
		sx = float(self.sx.value.GetValue())
		sy = float(self.sy.value.GetValue())
		sz = float(self.sz.value.GetValue())
		panelvisual.flat_data = (numpy.abs(data1)).transpose(2,1,0).flatten();
		panelvisual.vtk_data_array = numpy_support.numpy_to_vtk(panelvisual.flat_data)
		points = panelvisual.image_amp_real.GetPointData()
		points.SetScalars(panelvisual.vtk_data_array)
		panelvisual.image_amp_real.SetDimensions(data1.shape)
		panelvisual.image_amp_real.SetSpacing(sx,sy,sz)
		panelvisual.image_amp_real.ComputeBounds()
		panelvisual.image_amp_real.Modified()
		panelvisual.image_probe = panelvisual.image_amp_real
		...
		panelvisual.scalebar_amp_real.SetLookupTable(panelvisual.lut_amp_real)
		panelvisual.scalebar_amp_real.Modified()
		panelvisual.flat_data2 = (numpy.abs(data2)).transpose(2,1,0).flatten();
		panelvisual.vtk_data_array2 = numpy_support.numpy_to_vtk(panelvisual.flat_data2)
		panelvisual.image_amp2.GetPointData().SetScalars(panelvisual.vtk_data_array2)
		panelvisual.image_amp2.SetDimensions(data2.shape)
		panelvisual.image_amp2.SetSpacing(sx,sy,sz)
		panelvisual.image_amp2.ComputeBounds()
		panelvisual.image_amp2.Modified()
		panelvisual.lut_amp2.SetNumberOfTableValues(256)
		panelvisual.lut_amp2.SetScaleToLinear()
		panelvisual.lut_amp2.SetTableRange(panelvisual.image_amp2.GetPointData().GetScalars().GetRange())
		lutsource2 = self.ancestor.GetPage(0).cms[self.ancestor.GetPage(0).cmls[5][0]][1]
		if self.ancestor.GetPage(0).cmls[5][1] == 0:
			for k in range(256):
				panelvisual.lut_amp2.SetTableValue(k, lutsource2[k][0], lutsource2[k][1], lutsource2[k][2], 1)
		else:
			for k in range(256):
				panelvisual.lut_amp2.SetTableValue(255-k, lutsource2[k][0], lutsource2[k][1], lutsource2[k][2], 1)
		panelvisual.lut_amp2.SetRamp(0)
		panelvisual.lut_amp2.Build()
		panelvisual.filter_amp_real.SetInputData(panelvisual.image_amp_real)
		panelvisual.filter_amp_real.ComputeNormalsOn()
		panelvisual.filter_amp_real.ComputeScalarsOn()
		panelvisual.filter_amp_real.SetNumberOfContours(1)
		...
		panelvisual.filter_amp_real.Modified()
		panelvisual.filter_amp_real.Update()
		panelvisual.filter_amp2.SetInputData(panelvisual.image_amp2)
		panelvisual.filter_amp2.ComputeNormalsOn()
		panelvisual.filter_amp2.ComputeScalarsOn()
		panelvisual.filter_amp2.SetNumberOfContours(1)
		panelvisual.filter_amp2.SetValue( 0, contour_support)
		panelvisual.filter_amp2.Modified()
		panelvisual.filter_amp2.Update()
		panelvisual.smooth_filter_real.SetInputConnection(panelvisual.filter_amp_real.GetOutputPort())
		panelvisual.smooth_filter_real.SetNumberOfIterations(15)
		panelvisual.smooth_filter_real.SetRelaxationFactor(0.1)
		panelvisual.smooth_filter_real.FeatureEdgeSmoothingOff()
		panelvisual.smooth_filter_real.BoundarySmoothingOn()
		panelvisual.smooth_filter_real.Update()
		panelvisual.smooth_filter_support.SetInputConnection(panelvisual.filter_amp2.GetOutputPort())
		...
		panelvisual.mapper_support.SetLookupTable(panelvisual.lut_amp2)
		panelvisual.mapper_support.SetScalarRange(panelvisual.image_amp2.GetPointData().GetScalars().GetRange())
		...
		panelvisual.actor_support.GetProperty().SetOpacity(opacity_support)
		...
		if(self.chkbox_axes.GetValue() == True):
			...
			panelvisual.axis.Modified()
			panelvisual.renderer_amp_real.AddViewProp( panelvisual.axis )
	def ViewDataPhase(self, ancestor, data1, data2, r, g, b):
		self.ancestor.GetPage(0).queue_info.put("Preparing array visualisation")
		self.ancestor.GetPage(0).queue_info.put("Array Size: " + str(data1.shape))
		panelvisual = ancestor.GetPage(1)
		phasemax = float(self.phasemax.value.GetValue())
		...
		opacity_support = float(self.opacity_support.value.GetValue())
		feature_angle_support = float(self.feature_angle_support.value.GetValue())
		panelvisual.flat_data= (numpy.angle(data1)).transpose(2,1,0).flatten();
		panelvisual.vtk_data_array = numpy_support.numpy_to_vtk(panelvisual.flat_data)
		points = panelvisual.image_phase_real.GetPointData()
		points.SetScalars(panelvisual.vtk_data_array)
		panelvisual.image_phase_real.SetDimensions(data1.shape)
		panelvisual.image_phase_real.SetSpacing(sx,sy,sz)
		panelvisual.image_phase_real.ComputeBounds()
		panelvisual.image_phase_real.Modified()
		panelvisual.image_probe = panelvisual.image_phase_real
		...
		panelvisual.renWin.GetRenderWindow().Modified()
		panelvisual.renderer_phase_real.AddActor(panelvisual.actor_phase_real)
		panelvisual.renderer_phase_real.AddActor(panelvisual.actor_support)
		panelvisual.renderer_phase_real.AddActor2D(panelvisual.scalebar_phase_real)
		panelvisual.renderer_phase_real.AddActor2D(panelvisual.textActor)
		panelvisual.renderer_phase_real.SetBackground(r, g, b)
		panelvisual.renWin.GetRenderWindow().AddRenderer(panelvisual.renderer_amp_real)
		...
		if(self.chkbox_axes.GetValue() == True):
			...
			panelvisual.axis.Modified()
			panelvisual.renderer_phase_real.AddViewProp( panelvisual.axis )
	def ViewDataAmpPhase(self, ancestor, data1, data2, r, g, b):
		self.ancestor.GetPage(0).queue_info.put("Preparing array visualisation")
		self.ancestor.GetPage(0).queue_info.put("Array Size: " + str(data1.shape))
		panelvisual = ancestor.GetPage(1)
		contour = float(self.contour.value.GetValue())
		...
		panelvisual.lut_amp_real.SetRamp(0)
		panelvisual.lut_amp_real.Build()
		flat_data_phase = (numpy.angle(data1)).transpose(2,1,0).flatten();
		vtk_data_array_phase = numpy_support.numpy_to_vtk(flat_data_phase)
		panelvisual.image_phase_real.GetPointData().SetScalars(vtk_data_array_phase)
		panelvisual.image_phase_real.SetDimensions(data1.shape)
		panelvisual.image_phase_real.SetSpacing(sx,sy,sz)
		...
		if(self.chkbox_axes.GetValue() == True):
			...
			panelvisual.axis.Modified()
			panelvisual.renderer_phase_real.AddViewProp( panelvisual.axis )
	def ViewDataAmpWPhase(self, ancestor, data1, data2, r, g, b):
		self.ancestor.GetPage(0).queue_info.put("Preparing array visualisation...")
		self.ancestor.GetPage(0).queue_info.put("Array Size: " + str(data1.shape))
		max = numpy.array( numpy.unravel_index(data1.argmax(), data1.shape) )
		self.ancestor.GetPage(0).queue_info.put("Array Maximum Coordinates: " + str(max))
		...
		sz = float(self.sz.value.GetValue())
		feature_angle = float(self.feature_angle.value.GetValue())
		panelvisual.flat_data_phase= (numpy.angle(data1)).transpose(2,1,0).flatten();
		panelvisual.vtk_data_array_phase = numpy_support.numpy_to_vtk(panelvisual.flat_data_phase)
		panelvisual.vtk_data_array_phase.SetName("mapscalar")
		panelvisual.image_phase_real.GetPointData().SetScalars(panelvisual.vtk_data_array_phase)
		panelvisual.image_phase_real.SetDimensions(data1.shape)
		...
		if(self.chkbox_axes.GetValue() == True):
			...
			panelvisual.axis.Modified()
			panelvisual.renderer_amp_real.AddViewProp( panelvisual.axis )
	def ViewAmpPlane(self, ancestor, data1, data2, r, g, b):
		self.ancestor.GetPage(0).queue_info.put("Preparing array visualisation")
		self.ancestor.GetPage(0).queue_info.put("Array Size: " + str(data1.shape))
		max = numpy.array( numpy.unravel_index(data1.argmax(), data1.shape) )
		self.ancestor.GetPage(0).queue_info.put("Array Maximum Coordinates: " + str(max))
		...
		if(self.chkbox_axes.GetValue() == True):
			...
			panelvisual.axis.Modified()
			panelvisual.renderer_amp_real.AddViewProp( panelvisual.axis )
	def ViewDataAmpClippedPhase(self, ancestor, data1, data2, r, g, b):
		self.ancestor.GetPage(0).queue_info.put("Preparing array visualisation")
		self.ancestor.GetPage(0).queue_info.put("Array Size: " + str(data1.shape))
		max = numpy.array( numpy.unravel_index(data1.argmax(), data1.shape) )
		self.ancestor.GetPage(0).queue_info.put("Array Maximum Coordinates: " + str(max))
		...
		if(self.chkbox_axes.GetValue() == True):
			...
			panelvisual.axis.Modified()
			panelvisual.renderer_amp_real.AddViewProp( panelvisual.axis )
	def ViewDataAmpQColour(self, ancestor, data1, data2, r, g, b):
		self.ancestor.GetPage(0).queue_info.put("Preparing array visualisation...")
		self.ancestor.GetPage(0).queue_info.put("Array Size: " + str(data1.shape))
		max = numpy.array( numpy.unravel_index(data1.argmax(), data1.shape) )
		self.ancestor.GetPage(0).queue_info.put("Array Maximum Coordinates: " + str(max))
		...
		sz = float(self.sz.value.GetValue())
		feature_angle = float(self.feature_angle.value.GetValue())
		idi,idj,idk = numpy.unravel_index(numpy.arange(data1.size), data1.shape)
		idimax,idjmax,idkmax = numpy.unravel_index(data1.argmax(), data1.shape)
		idi -= idimax
		idj -= idjmax
		idk -= idkmax
		qcolourdata = numpy.sqrt( idi*idi + idj*idj + idk*idk ).reshape(data1.shape)
		panelvisual.flat_data_phase = qcolourdata.transpose(2,1,0).flatten();
		panelvisual.vtk_data_array_phase = numpy_support.numpy_to_vtk(panelvisual.flat_data_phase)
		panelvisual.vtk_data_array_phase.SetName("mapscalar")
		panelvisual.image_phase_real.GetPointData().SetScalars(panelvisual.vtk_data_array_phase)
		...
		if(self.chkbox_axes.GetValue() == True):
			...
			panelvisual.axis.Modified()
			panelvisual.renderer_amp_real.AddViewProp( panelvisual.axis )
	input_file1  = self.input_1_filename.objectpath.GetValue()
	input_file2  = self.input_2_filename.objectpath.GetValue()
	panelvisual = self.ancestor.GetPage(1)
	r = float(panelvisual.r)/255.0
	g = float(panelvisual.g)/255.0
	b = float(panelvisual.b)/255.0
	try:
		panelvisual.data = LoadArray(self.ancestor.GetPage(0), input_file1)
		panelvisual.data_max = numpy.abs(panelvisual.data).max()
		panelvisual.data2 = LoadArray(self.ancestor.GetPage(0), input_file2)
		panelvisual.data_max2 = numpy.abs(panelvisual.data2).max()
	except:
		msg = "Could not load array."
		dlg = wx.MessageDialog(self, msg, "Sequence View Array", wx.OK)
		dlg.ShowModal()
		...
		if panelvisual.data.shape[2] == 1 or panelvisual.data2.shape[2] == 1 :
			pass
		else:
			if (self.rbampphase.GetStringSelection() == 'Amplitude'):
				ViewDataAmp(self, ancestor , panelvisual.data, panelvisual.data2, r, g, b)
			if (self.rbampphase.GetStringSelection() == 'Phase'):
				ViewDataPhase(self, ancestor , panelvisual.data, panelvisual.data2, r, g, b)
			if (self.rbampphase.GetStringSelection() == 'Amplitude and Phase'):
				ViewDataAmpPhase(self, ancestor , panelvisual.data, panelvisual.data2, r, g, b)
			if (self.rbampphase.GetStringSelection() == 'Amplitude with Phase'):
				ViewDataAmpWPhase(self, ancestor , panelvisual.data, panelvisual.data2, r, g, b)
			if (self.rbampphase.GetStringSelection() == 'Amplitude (cut plane)'):
				ViewAmpPlane(self, ancestor , panelvisual.data, panelvisual.data2, r, g, b)
			if (self.rbampphase.GetStringSelection() == 'Amplitude Clipped Phase'):
				ViewDataAmpClippedPhase(self, ancestor , panelvisual.data, panelvisual.data2, r, g, b)
			if (self.rbampphase.GetStringSelection() == 'Amplitude q-Colour'):
				ViewDataAmpQColour(self, ancestor , panelvisual.data, panelvisual.data2, r, g, b)
		panelvisual.datarangelist = []
		panelvisual.ReleaseVisualButtons(gotovisual=True)
		panelvisual.RefreshSceneFull()
def Sequence_View_Support(self, ancestor):
	def ViewDataSupport(self, ancestor, data, inputdata, r, g, b):
		...
		panelvisual.image_phase_real.Modified()
		panelvisual.image_probe = panelvisual.image_phase_real
		panelvisual.lut_support.SetNumberOfTableValues(256)
		panelvisual.lut_support.SetScaleToLinear()
		panelvisual.lut_support.SetTableRange(panelvisual.image_phase_real.GetPointData().GetScalars().GetRange())
		lutsource = self.ancestor.GetPage(0).cms[self.ancestor.GetPage(0).cmls[4][0]][1]
		if self.ancestor.GetPage(0).cmls[4][1] == 0:
			for k in range(256):
				panelvisual.lut_support.SetTableValue(k, lutsource[k][0], lutsource[k][1], lutsource[k][2], 1)
		else:
			for k in range(256):
				panelvisual.lut_support.SetTableValue(255-k, lutsource[k][0], lutsource[k][1], lutsource[k][2], 1)
		panelvisual.lut_support.SetRamp(0)
		panelvisual.lut_support.Build()
		...
		panelvisual.strips_amp_real.SetInputConnection(panelvisual.triangles_amp_real.GetOutputPort())
		panelvisual.mapper_support.SetInputConnection(panelvisual.strips_support.GetOutputPort())
		panelvisual.mapper_support.SetLookupTable(panelvisual.lut_support)
...
def Sequence_Transform(\
	...
	if self.pipeline_started == True:
		...
		def Transform(self):
			...
			dQdphi= [-math.sin(phi)*math.sin(twotheta), math.cos(phi) - 1.0, -math.sin(phi)*math.cos(twotheta)]
