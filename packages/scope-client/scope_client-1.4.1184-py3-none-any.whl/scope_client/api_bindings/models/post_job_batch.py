...
class PostJobBatch(BaseModel):
    """
    PostJobBatch
    """ # noqa: E501
    jobs: List[PostJob] = Field(description="List of jobs to create.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobs": [PostJob.from_dict(_item) for _item in obj["jobs"]] if obj.get("jobs") is not None else None
        })
        return _obj
