...
class PatchDataset(BaseModel):
    ...
    dataset_locator: Optional[PatchDatasetLocator] = None
    model_problem_type: Optional[ModelProblemType] = None
    __properties: ClassVar[List[str]] = ["name", "dataset_locator", "model_problem_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "dataset_locator": PatchDatasetLocator.from_dict(obj["dataset_locator"]) if obj.get("dataset_locator") is not None else None,
