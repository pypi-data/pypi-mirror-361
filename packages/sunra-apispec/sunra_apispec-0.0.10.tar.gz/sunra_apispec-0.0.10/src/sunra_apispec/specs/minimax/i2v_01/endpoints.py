...
from .service_providers.minimax_official.adapter import MinimaxImageToVideoAdapter
...
service = BaseAPIService(
    title="Minimax I2V-01 API",
    description="API for Minimax I2V-01 image-to-video generation model",
    version="1.0.0",
