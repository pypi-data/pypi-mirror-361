...
class MessageComponentInteractionMetadataResponse(BaseModel):
    ...
    interacted_message_id: Annotated[str, Field(strict=True)]
    __properties: ClassVar[List[str]] = ["id", "type", "user", "authorizing_integration_owners", "original_response_message_id", "interacted_message_id"]
    ...
    @field_validator('interacted_message_id')
    def interacted_message_id_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^(0|[1-9][0-9]*)$", value):
            raise ValueError(r"must validate the regular expression /^(0|[1-9][0-9]*)$/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "interacted_message_id": obj.get("interacted_message_id")
        })
        return _obj
