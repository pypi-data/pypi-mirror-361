...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/titulos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/titulos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/titulos/verificacao-integridade"
