...
class Storage(object):
    ...
    # Storage
    def FilesystemSize(self):
        o = flatbuffers.number_types.UOffsetTFlags.py_type(self._tab.Offset(22))
        if o != 0:
            return self._tab.Get(flatbuffers.number_types.Uint64Flags, o + self._tab.Pos)
        return 0

def StorageStart(builder): builder.StartObject(10)
def Start(builder):
...
def StorageAddFilesystemSize(builder, filesystemSize): builder.PrependUint64Slot(9, filesystemSize, 0)
def AddFilesystemSize(builder, filesystemSize):
    return StorageAddFilesystemSize(builder, filesystemSize)
...
class StorageT(object):
    ...
    def __init__(self):
        ...
        self.filesystemSize = 0  # type: int
    ...
    def __eq__(self, other):
        return type(self) == type(other) and \
            ...
            self.filesystemSize == other.filesystemSize
    ...
    def _UnPack(self, storage):
        ...
        self.filesystemSize = storage.FilesystemSize()
    ...
    def Pack(self, builder):
        ...
        StorageAddFilesystemSize(builder, self.filesystemSize)
