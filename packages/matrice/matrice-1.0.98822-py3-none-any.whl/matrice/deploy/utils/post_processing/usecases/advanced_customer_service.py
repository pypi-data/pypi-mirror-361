...
class AdvancedCustomerServiceUseCase(BaseProcessor):
    ...
    def _compile_analytics_results(self, current_time: float) -> Dict[str, Any]:
        ...
        # Compose a summary and insights similar to people_counting.py
        ...
        predictions = []
        # Optionally, include predictions for the chunk (could be improved to be per-frame)
        # Here, just output the last predictions if available
        ...
        tracking_stats = [{
            ...
            "all_results_for_tracking": {
                ...
                "stream_key": getattr(self, 'stream_key', None)
            },
