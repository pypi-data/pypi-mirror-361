...
ENTITY_TYPE = "hr2d__Location__c"


class Location:
    """
    Handles location operations for HR2Day API.
    Location holds information about locations in the Salesforce system.
    """
    ...
    def get(self,
        ...
        """
        Get location data from Salesforce.
        ...
        Args:
            ...
            validate (bool, optional): Whether to validate the data against the LocationSchema. Defaults to False.
