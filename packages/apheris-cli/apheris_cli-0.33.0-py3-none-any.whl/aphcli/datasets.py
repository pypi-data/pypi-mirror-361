...
def policy(
    ...
    try:
        ...
        if err.status_code == 403:
            ...
            # before https://github.com/apheris/django-backend/pull/1206, there were a couple of typos
            # in this message, so we accept both the past and current messages
            p = r"No Asset Policy was found that grants? access (?:for|to) the dataset"
