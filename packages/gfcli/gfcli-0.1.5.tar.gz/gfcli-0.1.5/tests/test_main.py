...
from gfcli.main import _register_subcommands, cli
...
class TestMainCLI:
    ...
    def test_cli_with_no_args_interactive_mode(self):
        ...
        with patch('gfcli.repl.GoldfishREPL') as mock_repl_class:
            mock_repl = Mock()
    ...
    def test_cli_main_entry_point(self):
        ...
        with patch('gfcli.main.cli') as mock_cli:
            with patch('gfcli.main.__name__', '__main__'):
    ...
    def test_main_entry_point_execution(self):
        ...
        # Test the main entry point by running the module directly
        result = subprocess.run(
            [sys.executable, '-m', 'gfcli.main', '--help'],
            capture_output=True,
            text=True,
            cwd='/home/linxi/gits/goldfish/goldfish-cli'
        )
