...
class ResourceListDataPlane(BaseModel):
    """
    ResourceListDataPlane
    """ # noqa: E501
    records: List[DataPlane] = Field(description="List of records.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [DataPlane.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
