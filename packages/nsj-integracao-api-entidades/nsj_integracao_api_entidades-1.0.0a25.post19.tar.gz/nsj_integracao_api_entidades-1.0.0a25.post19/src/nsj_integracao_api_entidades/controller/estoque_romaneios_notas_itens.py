...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/romaneios_notas_itens"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/romaneios_notas_itens/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/romaneios_notas_itens/verificacao-integridade"
