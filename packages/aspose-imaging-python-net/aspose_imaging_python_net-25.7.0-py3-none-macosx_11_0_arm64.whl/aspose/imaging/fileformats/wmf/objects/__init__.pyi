...
class WmfBitmap16(aspose.imaging.fileformats.emf.MetaObject):
    ...
    @property
    def planes(self) -> byte:
        '''Gets the planes.'''
        ...
    
    @planes.setter
    def planes(self, value : byte):
        '''Sets the planes.'''
        ...
    
    @property
    def bits_pixel(self) -> byte:
        ...
    
    @bits_pixel.setter
    def bits_pixel(self, value : byte):
        ...
...
class WmfExtTextOut(WmfPointObject):
    ...
    @property
    def extended_byte(self) -> byte:
        ...
    
    @extended_byte.setter
    def extended_byte(self, value : byte):
        ...
...
class WmfPitchAndFamily:
    ...
    @overload
    def __init__(self, byte_data: byte):
    ...
    @property
    def byte_data(self) -> byte:
        ...
    
    @byte_data.setter
    def byte_data(self, value : byte):
        ...
