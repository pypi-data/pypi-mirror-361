...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/tiposservicos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/tiposservicos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/tiposservicos/verificacao-integridade"
