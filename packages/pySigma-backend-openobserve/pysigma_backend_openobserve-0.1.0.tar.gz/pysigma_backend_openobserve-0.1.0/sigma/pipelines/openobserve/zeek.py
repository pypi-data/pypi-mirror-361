"""pySigma pipeline for zeek on openobserve"""

# pylint: disable=too-many-lines,line-too-long,missing-function-docstring
# adapted from
# https://github.com/SigmaHQ/pySigma-backend-elasticsearch/blob/main/sigma/pipelines/elasticsearch/zeek.py
...
openobserve_zeek_category_service_mapping = {
    "accounting": "journald",
    "firewall": "conn",
    "dns": "dns",
    "proxy": "http",
...
def openobserve_zeek() -> ProcessingPipeline:
    return ProcessingPipeline(
        name="OpenObserve for Zeek using opentelemetry-collector-contrib and json logs",
        priority=20,
        allowed_backends=("openobserve"),
        items=[
            ProcessingItem(
            ...
            for category, service in openobserve_zeek_category_service_mapping.items()
        ]
        + [
            ProcessingItem(
            ...
            ProcessingItem(  # Field mappings
                identifier="zeek_openobserve_field_mapping",
                ...
                transformation=FieldMappingTransformation(
                    {
                        ...
                        "DestinationAddress": "id_resp_h",
                        "DestinationHostname": [
                            "host",
                            "query",
                            "server_name",
                        ],
                        "DestinationIp": "id_resp_h",
                        "DestinationIP": "id_resp_h",
                        "DestinationPort": "id_resp_p",
                        "dst-ip": "id_resp_h",
                        "dstip": "id_resp_h",
                        "dstport": "id_resp_p",
                        "Host": [
                        ...
                        "source": "id_orig_h",
                        "SourceAddr": "id_orig_h",
                        "SourceAddress": "id_orig_h",
                        "SourceIP": "id_orig_h",
                        "SourceIp": "id_orig_h",
                        "SourceNetworkAddress": "id_orig_h",
                        "SourcePort": "id_orig_p",
                        "srcip": "id_orig_h",
                        "Status": "status_code",
                        "status": "status_code",
                        "url": "uri",
