...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/pessoas"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/pessoas/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/pessoas/verificacao-integridade"
