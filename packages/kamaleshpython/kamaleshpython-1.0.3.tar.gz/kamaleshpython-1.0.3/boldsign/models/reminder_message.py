...
class ReminderMessage(BaseModel):
    ...
    reminder_phone_numbers: Optional[List[PhoneNumber]] = Field(default=None, alias="reminderPhoneNumbers")
    __properties: ClassVar[List[str]] = ["message", "onBehalfOf", "reminderPhoneNumbers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reminderPhoneNumbers": [PhoneNumber.from_dict(_item) for _item in obj["reminderPhoneNumbers"]] if obj.get("reminderPhoneNumbers") is not None else None
        })
        return _obj
    ...
    def openapi_types(cls) -> Dict[str, str]:
        return {
            "message": "(str,)",
            "on_behalf_of": "(str,)",
            "reminder_phone_numbers": "(List[PhoneNumber],)",
        }
