...
class JsonBodyInputSchema(BaseModel):
    ...
    default_value: Optional[IMetadataAttributesInnerValue] = Field(default=None, alias="defaultValue")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultValue": IMetadataAttributesInnerValue.from_dict(obj["defaultValue"]) if obj.get("defaultValue") is not None else None,
