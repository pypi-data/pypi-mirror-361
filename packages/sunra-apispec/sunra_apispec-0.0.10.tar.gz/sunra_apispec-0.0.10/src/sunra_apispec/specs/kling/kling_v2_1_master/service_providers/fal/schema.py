...
class KlingVideoV21MasterTextToVideoInput(BaseModel):
    """Input schema for Kling V2.1 Master Text-to-Video generation via FAL."""
...
class KlingVideoV21MasterImageToVideoInput(BaseModel):
    """Input schema for Kling V2.1 Master Image-to-Video generation via FAL."""
    prompt: str = Field(..., max_length=2500, description="Text prompt for video generation")
...
class KlingVideoV21MasterTextToVideoOutput(BaseModel):
    """Output schema for Kling V2.1 Master Text-to-Video generation via FAL."""
    video: File = Field(..., description="The generated video")


class KlingVideoV21MasterImageToVideoOutput(BaseModel):
    """Output schema for Kling V2.1 Master Image-to-Video generation via FAL."""
    video: File = Field(..., description="The generated video") 