...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/admissoespreliminares"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/admissoespreliminares/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/admissoespreliminares/verificacao-integridade"
