...
class RemittanceReportResponse(BaseModel):
    """
    RemittanceReportResponse
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="The count of items returned in this page.")
    data: List[RemittedClientData]
    ...
    __properties: ClassVar[List[str]] = ["count", "data", "maxResults", "nextToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "data": [RemittedClientData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
