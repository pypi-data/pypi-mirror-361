...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/niveiscargos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/niveiscargos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/niveiscargos/verificacao-integridade"
