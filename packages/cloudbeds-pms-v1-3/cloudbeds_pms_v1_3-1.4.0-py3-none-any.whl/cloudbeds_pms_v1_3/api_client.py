...
from cloudbeds_pms_v1_3.api_response import ApiResponse, T as ApiResponseT
import cloudbeds_pms_v1_3.models
from cloudbeds_pms_v1_3 import rest
from cloudbeds_pms_v1_3.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(cloudbeds_pms_v1_3.models, klass)
