...
class TestMentorSearchResponse(unittest.TestCase):
    """MentorSearchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MentorSearchResponse:
        """Test MentorSearchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MentorSearchResponse`
        """
        ...
        if include_optional:
            return MentorSearchResponse(
                ...
                total_pages = 56,
                facets = {
                    'key' : iblai.models.mentor_facet.MentorFacet(
                        total = 56, 
                        terms = {
                            'key' : null
                            }, 
    ...
    def testMentorSearchResponse(self):
        """Test MentorSearchResponse"""
