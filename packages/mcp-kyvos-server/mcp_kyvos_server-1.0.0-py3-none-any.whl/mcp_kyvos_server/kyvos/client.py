...
class KyvosClient:
    ...
    async def list_semantic_models_all(self, auth_token: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        logger.info(InfoLogs.KYVOS_API_REQUEST_URL.format(tool=Tools.LIST_SEMANTIC_MODELS_ALL, url=url))
        logger.info(InfoLogs.KYVOS_API_REQUEST_PAYLOAD.format(tool=Tools.LIST_SEMANTIC_MODELS_ALL, payload=params))
        ...
        try:
            async with httpx.AsyncClient(timeout=None,verify=ctx) as client:
                ...
                logger.info(InfoLogs.KYVOS_API_RESPONSE.format(tool=Tools.LIST_SEMANTIC_MODELS_ALL, response=data))
    ...
    async def list_semantic_models(self, folder_name_or_id: Optional[str] = None, auth_token: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        logger.info(InfoLogs.KYVOS_API_REQUEST_URL.format(tool=Tools.LIST_SEMANTIC_MODELS, url=url))
        ...
        try:
            async with httpx.AsyncClient(timeout=None,verify=ctx) as client:
                ...
                logger.info(InfoLogs.KYVOS_API_RESPONSE.format(tool=Tools.LIST_SEMANTIC_MODELS, response=data))
    ...
    async def list_semantic_model_columns(self, table_name: str, folder_name: Optional[str] = None, auth_token: Optional[str] = None) -> Dict[str, Any]:
        ...
        logger.info(InfoLogs.KYVOS_API_REQUEST_URL.format(tool=Tools.LIST_SEMANTIC_MODEL_COLUMNS, url=url))
        logger.info(InfoLogs.KYVOS_API_REQUEST_PAYLOAD.format(tool=Tools.LIST_SEMANTIC_MODEL_COLUMNS, payload=params))
        ...
        try:
            async with httpx.AsyncClient(timeout= None,verify=ctx) as client:
                ...
                logger.info(InfoLogs.KYVOS_API_RESPONSE.format(tool=Tools.LIST_SEMANTIC_MODEL_COLUMNS, response=data))
    ...
    async def execute_query(self, query: str, auth_token: Optional[str] = None) -> Dict[str, Any]:
        ...
        logger.info(InfoLogs.KYVOS_API_REQUEST_URL.format(tool=Tools.EXECUTE_QUERY, url=url))
        logger.info(InfoLogs.KYVOS_API_REQUEST_PAYLOAD.format(tool=Tools.EXECUTE_QUERY, payload=data))
        ...
        try:
            async with httpx.AsyncClient(timeout=None,verify=ctx) as client:
                ...
                try:
                    ...
                    logger.info(InfoLogs.KYVOS_API_RESPONSE.format(tool=Tools.EXECUTE_QUERY, response=result))
