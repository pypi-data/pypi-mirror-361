...
if IS_ENGINE_PYSPARK or ENGINE_PYSPARK_OVERRIDE:
    ...
    _convertible_modules = ("pyspark.sql.types", "pyspark.sql.datasource", "pyspark.sql.udtf")
    _target_modules = ("_engine_pyspark.sql.types", "_engine_pyspark.sql.datasource", "_engine_pyspark.sql.udtf")
