...
chatIdMapping = {
    ...
    EnumProcesso.BLIP_LINK: chatIdAtendimento,
    EnumProcesso.BLIP_CONSULTA: chatIdAtendimento,
...
baseFolderMapping = {
    ...
    (EnumBanco.HAPPY_PORT, EnumProcesso.INTEGRACAO): 27,
    ...
    (EnumBanco.HAPPY_PORT, EnumProcesso.CONFIRMACAO_CREDITO): 27,
