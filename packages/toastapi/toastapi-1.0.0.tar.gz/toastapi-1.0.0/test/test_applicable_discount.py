...
from toasttab.models.applicable_discount import ApplicableDiscount

class TestApplicableDiscount(unittest.TestCase):
    """ApplicableDiscount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicableDiscount:
        """Test ApplicableDiscount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicableDiscount`
        """
        model = ApplicableDiscount()
        if include_optional:
            return ApplicableDiscount(
                discount = toasttab.models.toast_reference.ToastReference(
                    guid = '', 
                    entity_type = '', ),
                applicable_checks = [
                    toasttab.models.external_reference.ExternalReference()
                    ],
                applicable_selections = [
                    toasttab.models.external_reference.ExternalReference()
                    ]
            )
        else:
    ...
    def testApplicableDiscount(self):
        """Test ApplicableDiscount"""
