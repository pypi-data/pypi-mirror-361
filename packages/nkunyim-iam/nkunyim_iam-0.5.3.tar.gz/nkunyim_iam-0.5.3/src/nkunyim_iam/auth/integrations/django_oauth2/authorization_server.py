...
from nkunyim_iam.auth.common.encoding import json_dumps
from nkunyim_iam.auth.common.security import generate_token as _generate_token
from nkunyim_iam.auth.oauth2 import AuthorizationServer as _AuthorizationServer
from nkunyim_iam.auth.oauth2.rfc6750 import BearerTokenGenerator
...
class AuthorizationServer(_AuthorizationServer):
    """Django implementation of :class:`nkunyim_iam.auth.oauth2.rfc6749.AuthorizationServer`.
    Initialize it with client model and token model::

        from nkunyim_iam.auth.integrations.django_oauth2 import AuthorizationServer
