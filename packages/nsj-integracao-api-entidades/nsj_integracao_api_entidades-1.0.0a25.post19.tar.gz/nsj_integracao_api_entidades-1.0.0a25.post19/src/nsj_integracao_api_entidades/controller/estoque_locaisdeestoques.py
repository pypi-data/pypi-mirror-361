...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/locaisdeestoques"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/locaisdeestoques/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/locaisdeestoques/verificacao-integridade"
