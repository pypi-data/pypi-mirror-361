...
class PlanTrajectoryResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlanTrajectoryResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlanTrajectoryResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "response": PlanTrajectoryResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
