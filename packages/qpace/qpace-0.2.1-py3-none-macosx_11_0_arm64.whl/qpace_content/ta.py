...
`accdist() -> float`
    """
    return _lib.Incr_fn_accdist_c0ded7(ctx=ctx, ).collect()
...
`accdist() -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_accdist_c0ded7(ctx, )
...
`cum(series<float> src) -> float`
    """
    return _lib.Incr_fn_cum_cfc716(ctx=ctx, ).collect(_7852_src=src)
...
`cum(series<float> src) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_cum_cfc716(ctx, )
        self.locals = CumLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_7852_src=src)
...
`change(series<float> src) -> series<float>`
    """
    return _lib.Incr_fn_change_2305f9(ctx=ctx, ).collect(_7854_src=src)
...
`change(series<float> src) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_change_2305f9(ctx, )
        self.locals = ChangeLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_7854_src=src)
...
`barssince(series<bool> condition) -> int`
    """
    return _lib.Incr_fn_barssince_d2aace(ctx=ctx, ).collect(_7856_condition=condition)
...
`barssince(series<bool> condition) -> int`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_barssince_d2aace(ctx, )
        self.locals = BarssinceLocals(self.inner)

    def next(self, condition: bool) -> Optional[int]:
        return self.inner.next(_7856_condition=condition)
...
`roc(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_roc_9901f8(ctx=ctx, ).collect(_7858_src=src, _7859_length=length)
...
`crossover(series<float> source1, series<float> source2) -> bool`
    """
    return _lib.Incr_fn_crossover_d04d0c(ctx=ctx, ).collect(_7861_source1=source1, _7862_source2=source2)
...
`crossover(series<float> source1, series<float> source2) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_crossover_d04d0c(ctx, )
        self.locals = CrossoverLocals(self.inner)

    def next(self, source1: float, source2: float) -> Optional[bool]:
        return self.inner.next(_7861_source1=source1, _7862_source2=source2)
...
`crossunder(series<float> source1, series<float> source2) -> bool`
    """
    return _lib.Incr_fn_crossunder_d67bf2(ctx=ctx, ).collect(_7864_source1=source1, _7865_source2=source2)
...
`crossunder(series<float> source1, series<float> source2) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_crossunder_d67bf2(ctx, )
        self.locals = CrossunderLocals(self.inner)

    def next(self, source1: float, source2: float) -> Optional[bool]:
        return self.inner.next(_7864_source1=source1, _7865_source2=source2)
...
`cross(series<float> source1, series<float> source2) -> bool`
    """
    return _lib.Incr_fn_cross_ab9b36(ctx=ctx, ).collect(_7867_source1=source1, _7868_source2=source2)
...
`cross(series<float> source1, series<float> source2) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_cross_ab9b36(ctx, )
        self.locals = CrossLocals(self.inner)

    def next(self, source1: float, source2: float) -> Optional[bool]:
        return self.inner.next(_7867_source1=source1, _7868_source2=source2)
...
`highestbars(series<float> src, int length = 14) -> int`
    """
    return _lib.Incr_fn_highestbars_b599c2(ctx=ctx, ).collect(_7870_src=src, _7871_length=length)
...
`highestbars(series<float> src, int length = 14) -> int`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_highestbars_b599c2(ctx, )
        self.locals = HighestbarsLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[int]:
        return self.inner.next(_7870_src=src, _7871_length=length)
...
`lowestbars(series<float> src, int length = 14) -> int`
    """
    return _lib.Incr_fn_lowestbars_23164c(ctx=ctx, ).collect(_7873_src=src, _7874_length=length)
...
`lowestbars(series<float> src, int length = 14) -> int`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_lowestbars_23164c(ctx, )
        self.locals = LowestbarsLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[int]:
        return self.inner.next(_7873_src=src, _7874_length=length)
...
`highest(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_highest_61dfd4(ctx=ctx, ).collect(_7876_src=src, _7877_length=length)
...
`highest(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_highest_61dfd4(ctx, )
        self.locals = HighestLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7876_src=src, _7877_length=length)
...
`lowest(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_lowest_f4e8c6(ctx=ctx, ).collect(_7879_src=src, _7880_length=length)
...
`lowest(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_lowest_f4e8c6(ctx, )
        self.locals = LowestLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7879_src=src, _7880_length=length)
...
`swma(series<float> src) -> float`
    """
    return _lib.Incr_fn_swma_58fd04(ctx=ctx, ).collect(_7882_src=src)
...
`swma(series<float> src) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_swma_58fd04(ctx, )
        self.locals = SwmaLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_7882_src=src)
...
`sma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_sma_f0898a(ctx=ctx, ).collect(_7884_src=src, _7885_length=length)
...
`sma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_sma_f0898a(ctx, )
        self.locals = SmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7884_src=src, _7885_length=length)
...
`ema(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_ema_c148a3(ctx=ctx, ).collect(_7887_src=src, _7888_length=length)
...
`ema(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_ema_c148a3(ctx, )
        self.locals = EmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7887_src=src, _7888_length=length)
...
`rma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_rma_4574d0(ctx=ctx, ).collect(_7890_src=src, _7891_length=length)
...
`rma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_rma_4574d0(ctx, )
        self.locals = RmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7890_src=src, _7891_length=length)
...
`wma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_wma_3560a7(ctx=ctx, ).collect(_7893_src=src, _7894_length=length)
...
`wma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_wma_3560a7(ctx, )
        self.locals = WmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7893_src=src, _7894_length=length)
...
`lwma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_lwma_17baf7(ctx=ctx, ).collect(_7896_src=src, _7897_length=length)
...
`lwma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_lwma_17baf7(ctx, )
        self.locals = LwmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7896_src=src, _7897_length=length)
...
`hma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_hma_68552e(ctx=ctx, ).collect(_7899_src=src, _7900_length=length)
...
`hma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_hma_68552e(ctx, )
        self.locals = HmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7899_src=src, _7900_length=length)
...
`vwma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_vwma_314242(ctx=ctx, ).collect(_7902_src=src, _7903_length=length)
...
`vwma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_vwma_314242(ctx, )
        self.locals = VwmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7902_src=src, _7903_length=length)
...
`dev(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_dev_5cee02(ctx=ctx, ).collect(_7905_src=src, _7906_length=length)
...
`dev(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_dev_5cee02(ctx, )
        self.locals = DevLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7905_src=src, _7906_length=length)
...
`tr(bool handle_na = true) -> series<float>`
    """
    return _lib.Incr_fn_tr_1df0a4(ctx=ctx, ).collect(_7908_handle_na=handle_na)
...
`atr(int length = 14) -> float`
    """
    return _lib.Incr_fn_atr_f973bf(ctx=ctx, ).collect(_7910_length=length)
...
`rsi(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_rsi_b25228(ctx=ctx, ).collect(_7912_src=src, _7913_length=length)
...
`rsi(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_rsi_b25228(ctx, )
        self.locals = RsiLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7912_src=src, _7913_length=length)
...
`cci(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_cci_be3210(ctx=ctx, ).collect(_7915_src=src, _7916_length=length)
...
`cci(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_cci_be3210(ctx, )
        self.locals = CciLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7915_src=src, _7916_length=length)
...
`stdev(series<float> src, int length, bool biased = true) -> float`
    """
    return _lib.Incr_fn_stdev_663b71(ctx=ctx, ).collect(_7918_src=src, _7919_length=length, _7920_biased=biased)
...
`stdev(series<float> src, int length, bool biased = true) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_stdev_663b71(ctx, )
        self.locals = StdevLocals(self.inner)

    def next(self, src: float, length: int, biased: Optional[bool] = None) -> Optional[float]:
        return self.inner.next(_7918_src=src, _7919_length=length, _7920_biased=biased)
...
`aroon(int length = 14) -> [float, float]`
    """
    return _lib.Incr_fn_aroon_e5eb4b(ctx=ctx, ).collect(_7922_length=length)
...
`supertrend(series<float> src, float factor, int atr_period) -> [float, int]`
    """
    return _lib.Incr_fn_supertrend_8cc169(ctx=ctx, ).collect(_7924_src=src, _7925_factor=factor, _7926_atr_period=atr_period)
...
`supertrend(series<float> src, float factor, int atr_period) -> [float, int]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_supertrend_8cc169(ctx, )
        self.locals = SupertrendLocals(self.inner)

    def next(self, src: float, factor: float, atr_period: int) -> Optional[Tuple[float, int]]:
        return self.inner.next(_7924_src=src, _7925_factor=factor, _7926_atr_period=atr_period)
...
`awesome_oscillator(series<float> src, int slow_length = 5, int fast_length = 34) -> float`
    """
    return _lib.Incr_fn_awesome_oscillator_6fe4cc(ctx=ctx, ).collect(_7928_src=src, _7929_slow_length=slow_length, _7930_fast_length=fast_length)
...
`awesome_oscillator(series<float> src, int slow_length = 5, int fast_length = 34) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_awesome_oscillator_6fe4cc(ctx, )
    ...
    def next(self, src: float, slow_length: Optional[int] = None, fast_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7928_src=src, _7929_slow_length=slow_length, _7930_fast_length=fast_length)
...
`balance_of_power() -> float`
    """
    return _lib.Incr_fn_balance_of_power_dc3f82(ctx=ctx, ).collect()
...
`balance_of_power() -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_balance_of_power_dc3f82(ctx, )
...
`bollinger_bands_pct_b(series<float> src, int length = 20, float mult = 2.0) -> float`
    """
    return _lib.Incr_fn_bollinger_bands_pct_b_128bfc(ctx=ctx, ).collect(_7935_src=src, _7936_length=length, _7937_mult=mult)
...
`bollinger_bands_pct_b(series<float> src, int length = 20, float mult = 2.0) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bollinger_bands_pct_b_128bfc(ctx, )
    ...
    def next(self, src: float, length: Optional[int] = None, mult: Optional[float] = None) -> Optional[float]:
        return self.inner.next(_7935_src=src, _7936_length=length, _7937_mult=mult)
...
`bollinger_bands_width(series<float> src, int length = 20, float mult = 2.0) -> float`
    """
    return _lib.Incr_fn_bollinger_bands_width_70ba16(ctx=ctx, ).collect(_7944_src=src, _7945_length=length, _7946_mult=mult)
...
`bollinger_bands_width(series<float> src, int length = 20, float mult = 2.0) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bollinger_bands_width_70ba16(ctx, )
        self.locals = BollingerBandsWidthLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None, mult: Optional[float] = None) -> Optional[float]:
        return self.inner.next(_7944_src=src, _7945_length=length, _7946_mult=mult)
...
`bollinger_bands(series<float> src, int length = 20, float mult = 2.0) -> [float, float]`
    """
    return _lib.Incr_fn_bollinger_bands_4a2ad7(ctx=ctx, ).collect(_7953_src=src, _7954_length=length, _7955_mult=mult)
...
`bollinger_bands(series<float> src, int length = 20, float mult = 2.0) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bollinger_bands_4a2ad7(ctx, )
    ...
    def next(self, src: float, length: Optional[int] = None, mult: Optional[float] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_7953_src=src, _7954_length=length, _7955_mult=mult)
...
`chaikin_money_flow(int length = 20) -> float`
    """
    return _lib.Incr_fn_chaikin_money_flow_8245d9(ctx=ctx, ).collect(_7961_length=length)
...
class ChaikinMoneyFlowLocals:
    ...
    def cumVol(self) -> float:
        return self.__inner._7962_cumVol()
...
`chaikin_money_flow(int length = 20) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_chaikin_money_flow_8245d9(ctx, )
        self.locals = ChaikinMoneyFlowLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7961_length=length)
...
`chande_kroll_stop(int atr_length = 10, float atr_coeff = 1.0, int stop_length = 9) -> [float, float]`
    """
    return _lib.Incr_fn_chande_kroll_stop_a83884(ctx=ctx, ).collect(_7966_atr_length=atr_length, _7967_atr_coeff=atr_coeff, _7968_stop_length=stop_length)
...
`chande_kroll_stop(int atr_length = 10, float atr_coeff = 1.0, int stop_length = 9) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_chande_kroll_stop_a83884(ctx, )
    ...
    def next(self, atr_length: Optional[int] = None, atr_coeff: Optional[float] = None, stop_length: Optional[int] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_7966_atr_length=atr_length, _7967_atr_coeff=atr_coeff, _7968_stop_length=stop_length)
...
`choppiness_index(int length = 14) -> float`
    """
    return _lib.Incr_fn_choppiness_index_2c3ef1(ctx=ctx, ).collect(_7977_length=length)
...
`choppiness_index(int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_choppiness_index_2c3ef1(ctx, )
        self.locals = ChoppinessIndexLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7977_length=length)
...
`connors_rsi(series<float> src, int rsi_length = 3, int up_down_length = 2, int roc_length = 100) -> float`
    """
    return _lib.Incr_fn_connors_rsi_4df548(ctx=ctx, ).collect(_7984_src=src, _7985_rsi_length=rsi_length, _7986_up_down_length=up_down_length, _7987_roc_length=roc_length)
...
`connors_rsi(series<float> src, int rsi_length = 3, int up_down_length = 2, int roc_length = 100) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_connors_rsi_4df548(ctx, )
    ...
    def next(self, src: float, rsi_length: Optional[int] = None, up_down_length: Optional[int] = None, roc_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7984_src=src, _7985_rsi_length=rsi_length, _7986_up_down_length=up_down_length, _7987_roc_length=roc_length)
...
`coppock_curve(series<float> src, int wma_length = 10, int long_roc_length = 14, int short_roc_length = 11) -> float`
    """
    return _lib.Incr_fn_coppock_curve_80079c(ctx=ctx, ).collect(_7993_src=src, _7994_wma_length=wma_length, _7995_long_roc_length=long_roc_length, _7996_short_roc_length=short_roc_length)
...
`coppock_curve(series<float> src, int wma_length = 10, int long_roc_length = 14, int short_roc_length = 11) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_coppock_curve_80079c(ctx, )
    ...
    def next(self, src: float, wma_length: Optional[int] = None, long_roc_length: Optional[int] = None, short_roc_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_7993_src=src, _7994_wma_length=wma_length, _7995_long_roc_length=long_roc_length, _7996_short_roc_length=short_roc_length)
...
`donchian_channel(series<float> src, int length = 20) -> [float, float, float]`
    """
    return _lib.Incr_fn_donchian_channel_c17391(ctx=ctx, ).collect(_7998_src=src, _7999_length=length)
...
`donchian_channel(series<float> src, int length = 20) -> [float, float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_donchian_channel_c17391(ctx, )
    ...
    def next(self, src: float, length: Optional[int] = None) -> Optional[Tuple[float, float, float]]:
        return self.inner.next(_7998_src=src, _7999_length=length)
...
`macd(series<float> src, int short_length = 12, int long_length = 26) -> float`
    """
    return _lib.Incr_fn_macd_f12474(ctx=ctx, ).collect(_8004_src=src, _8005_short_length=short_length, _8006_long_length=long_length)
...
`macd(series<float> src, int short_length = 12, int long_length = 26) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_macd_f12474(ctx, )
    ...
    def next(self, src: float, short_length: Optional[int] = None, long_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8004_src=src, _8005_short_length=short_length, _8006_long_length=long_length)
...
`price_oscillator(series<float> src, int short_length = 12, int long_length = 26) -> float`
    """
    return _lib.Incr_fn_price_oscillator_91a9cd(ctx=ctx, ).collect(_8009_src=src, _8010_short_length=short_length, _8011_long_length=long_length)
...
`price_oscillator(series<float> src, int short_length = 12, int long_length = 26) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_price_oscillator_91a9cd(ctx, )
        self.locals = PriceOscillatorLocals(self.inner)

    def next(self, src: float, short_length: Optional[int] = None, long_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8009_src=src, _8010_short_length=short_length, _8011_long_length=long_length)
...
`relative_vigor_index(int length = 14) -> float`
    """
    return _lib.Incr_fn_relative_vigor_index_6e4ff5(ctx=ctx, ).collect(_8016_length=length)
...
`relative_vigor_index(int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_relative_vigor_index_6e4ff5(ctx, )
        self.locals = RelativeVigorIndexLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8016_length=length)
...
`relative_volatility_index(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_relative_volatility_index_5dea6d(ctx=ctx, ).collect(_8018_src=src, _8019_length=length)
...
`relative_volatility_index(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_relative_volatility_index_5dea6d(ctx, )
        self.locals = RelativeVolatilityIndexLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8018_src=src, _8019_length=length)
...
`stochastic_rsi(series<float> src, int stoch_length = 14, int rsi_length = 14, int k = 3, int d = 3) -> [float, float]`
    """
    return _lib.Incr_fn_stochastic_rsi_4c373c(ctx=ctx, ).collect(_8025_src=src, _8026_stoch_length=stoch_length, _8027_rsi_length=rsi_length, _8028_k=k, _8029_d=d)
...
`stochastic_rsi(series<float> src, int stoch_length = 14, int rsi_length = 14, int k = 3, int d = 3) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_stochastic_rsi_4c373c(ctx, )
    ...
    def next(self, src: float, stoch_length: Optional[int] = None, rsi_length: Optional[int] = None, k: Optional[int] = None, d: Optional[int] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_8025_src=src, _8026_stoch_length=stoch_length, _8027_rsi_length=rsi_length, _8028_k=k, _8029_d=d)
...
`ultimate_oscillator(int fast_length = 7, int medium_length = 14, int slow_length = 28) -> float`
    """
    return _lib.Incr_fn_ultimate_oscillator_ae6edd(ctx=ctx, ).collect(_8038_fast_length=fast_length, _8039_medium_length=medium_length, _8040_slow_length=slow_length)
...
`ultimate_oscillator(int fast_length = 7, int medium_length = 14, int slow_length = 28) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_ultimate_oscillator_ae6edd(ctx, )
    ...
    def next(self, fast_length: Optional[int] = None, medium_length: Optional[int] = None, slow_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8038_fast_length=fast_length, _8039_medium_length=medium_length, _8040_slow_length=slow_length)
...
`volume_oscillator(int short_length = 5, int long_length = 10) -> float`
    """
    return _lib.Incr_fn_volume_oscillator_b3ffad(ctx=ctx, ).collect(_8050_short_length=short_length, _8051_long_length=long_length)
...
`volume_oscillator(int short_length = 5, int long_length = 10) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_volume_oscillator_b3ffad(ctx, )
    ...
    def next(self, short_length: Optional[int] = None, long_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8050_short_length=short_length, _8051_long_length=long_length)
...
`vortex_indicator(int length = 14) -> [float, float]`
    """
    return _lib.Incr_fn_vortex_indicator_2d9de8(ctx=ctx, ).collect(_8056_length=length)
...
`vortex_indicator(int length = 14) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_vortex_indicator_2d9de8(ctx, )
        self.locals = VortexIndicatorLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_8056_length=length)
...
`williams_pct_r(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_williams_pct_r_4969c6(ctx=ctx, ).collect(_8063_src=src, _8064_length=length)
...
`williams_pct_r(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_williams_pct_r_4969c6(ctx, )
        self.locals = WilliamsPctRLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8063_src=src, _8064_length=length)
...
`advance_decline_ratio(int length = 9) -> float`
    """
    return _lib.Incr_fn_advance_decline_ratio_3be40b(ctx=ctx, ).collect(_8069_length=length)
...
`advance_decline_ratio(int length = 9) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_advance_decline_ratio_3be40b(ctx, )
        self.locals = AdvanceDeclineRatioLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8069_length=length)
...
`detrended_price_oscillator(int length = 21, bool centered = false) -> series<float>`
    """
    return _lib.Incr_fn_detrended_price_oscillator_a0a257(ctx=ctx, ).collect(_8075_length=length, _8076_centered=centered)
...
`detrended_price_oscillator(int length = 21, bool centered = false) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_detrended_price_oscillator_a0a257(ctx, )
    ...
    def next(self, length: Optional[int] = None, centered: Optional[bool] = None) -> Optional[float]:
        return self.inner.next(_8075_length=length, _8076_centered=centered)
...
`bull_bear_power(int length = 13) -> series<float>`
    """
    return _lib.Incr_fn_bull_bear_power_529bd7(ctx=ctx, ).collect(_8081_length=length)
...
`bull_bear_power(int length = 13) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bull_bear_power_529bd7(ctx, )
        self.locals = BullBearPowerLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8081_length=length)
...
`absolute_price_oscillator(series<float> src, int fast_length = 12, int slow_length = 26) -> float`
    """
    return _lib.Incr_fn_absolute_price_oscillator_ef42a6(ctx=ctx, ).collect(_8087_src=src, _8088_fast_length=fast_length, _8089_slow_length=slow_length)
...
`absolute_price_oscillator(series<float> src, int fast_length = 12, int slow_length = 26) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_absolute_price_oscillator_ef42a6(ctx, )
    ...
    def next(self, src: float, fast_length: Optional[int] = None, slow_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8087_src=src, _8088_fast_length=fast_length, _8089_slow_length=slow_length)
...
`know_sure_thing(series<float> src, int roc_length1 = 10, int roc_length2 = 15, int roc_length3 = 20, int roc_length4 = 30, int sma_length1 = 10, int sma_length2 = 10, int sma_length3 = 10, int sma_length4 = 15, int sig_length = 9) -> [float, float]`
    """
    return _lib.Incr_fn_know_sure_thing_82eaaa(ctx=ctx, ).collect(_8093_src=src, _8094_roc_length1=roc_length1, _8095_roc_length2=roc_length2, _8096_roc_length3=roc_length3, _8097_roc_length4=roc_length4, _8098_sma_length1=sma_length1, _8099_sma_length2=sma_length2, _8100_sma_length3=sma_length3, _8101_sma_length4=sma_length4, _8102_sig_length=sig_length)
...
`know_sure_thing(series<float> src, int roc_length1 = 10, int roc_length2 = 15, int roc_length3 = 20, int roc_length4 = 30, int sma_length1 = 10, int sma_length2 = 10, int sma_length3 = 10, int sma_length4 = 15, int sig_length = 9) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_know_sure_thing_82eaaa(ctx, )
    ...
    def next(self, src: float, roc_length1: Optional[int] = None, roc_length2: Optional[int] = None, roc_length3: Optional[int] = None, roc_length4: Optional[int] = None, sma_length1: Optional[int] = None, sma_length2: Optional[int] = None, sma_length3: Optional[int] = None, sma_length4: Optional[int] = None, sig_length: Optional[int] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_8093_src=src, _8094_roc_length1=roc_length1, _8095_roc_length2=roc_length2, _8096_roc_length3=roc_length3, _8097_roc_length4=roc_length4, _8098_sma_length1=sma_length1, _8099_sma_length2=sma_length2, _8100_sma_length3=sma_length3, _8101_sma_length4=sma_length4, _8102_sig_length=sig_length)
...
`momentum(series<float> src, int length = 10) -> series<float>`
    """
    return _lib.Incr_fn_momentum_c1114d(ctx=ctx, ).collect(_8110_src=src, _8111_length=length)
...
`momentum(series<float> src, int length = 10) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_momentum_c1114d(ctx, )
        self.locals = MomentumLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8110_src=src, _8111_length=length)
...
`trix(series<float> src, int length = 18) -> series<float>`
    """
    return _lib.Incr_fn_trix_51f633(ctx=ctx, ).collect(_8113_src=src, _8114_length=length)
...
`trix(series<float> src, int length = 18) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_trix_51f633(ctx, )
        self.locals = TrixLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8113_src=src, _8114_length=length)
...
`true_strength_index(series<float> src, int long_length = 25, int short_length = 13) -> float`
    """
    return _lib.Incr_fn_true_strength_index_769cbe(ctx=ctx, ).collect(_8116_src=src, _8117_long_length=long_length, _8118_short_length=short_length)
...
`true_strength_index(series<float> src, int long_length = 25, int short_length = 13) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_true_strength_index_769cbe(ctx, )
    ...
    def next(self, src: float, long_length: Optional[int] = None, short_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8116_src=src, _8117_long_length=long_length, _8118_short_length=short_length)
...
`dema(series<float> src, int length = 9) -> float`
    """
    return _lib.Incr_fn_dema_2fe529(ctx=ctx, ).collect(_8124_src=src, _8125_length=length)
...
`dema(series<float> src, int length = 9) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_dema_2fe529(ctx, )
        self.locals = DemaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8124_src=src, _8125_length=length)
...
`fwma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_fwma_e1bb6e(ctx=ctx, ).collect(_8134_src=src, _8135_length=length)
...
`fwma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_fwma_e1bb6e(ctx, )
        self.locals = FwmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8134_src=src, _8135_length=length)
...
`money_flow_index(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_money_flow_index_05c5aa(ctx=ctx, ).collect(_8141_src=src, _8142_length=length)
...
`money_flow_index(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_money_flow_index_05c5aa(ctx, )
        self.locals = MoneyFlowIndexLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8141_src=src, _8142_length=length)
...
`ease_of_movement(int length = 14, int divisor = 10000) -> float`
    """
    return _lib.Incr_fn_ease_of_movement_e1afc2(ctx=ctx, ).collect(_8144_length=length, _8145_divisor=divisor)
...
`ease_of_movement(int length = 14, int divisor = 10000) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_ease_of_movement_e1afc2(ctx, )
    ...
    def next(self, length: Optional[int] = None, divisor: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8144_length=length, _8145_divisor=divisor)
...
`elder_force_index(int length = 13) -> float`
    """
    return _lib.Incr_fn_elder_force_index_45c0a2(ctx=ctx, ).collect(_8147_length=length)
...
`elder_force_index(int length = 13) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_elder_force_index_45c0a2(ctx, )
        self.locals = ElderForceIndexLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8147_length=length)
...
`tema(series<float> src, int length = 9) -> float`
    """
    return _lib.Incr_fn_tema_655401(ctx=ctx, ).collect(_8149_src=src, _8150_length=length)
...
`tema(series<float> src, int length = 9) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_tema_655401(ctx, )
        self.locals = TemaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_8149_src=src, _8150_length=length)
