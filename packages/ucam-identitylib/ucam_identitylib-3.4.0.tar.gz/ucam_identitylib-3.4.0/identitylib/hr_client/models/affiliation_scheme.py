...
class AffiliationScheme(str, Enum):
    """
    An enumeration.
    """
    ...
    allowed enum values
    """
    INSTITUTION_DOT_V1_DOT_HUMAN_MINUS_RESOURCES_DOT_UNIVERSITY_DOT_IDENTIFIERS_DOT_CAM_DOT_AC_DOT_UK = 'institution.v1.human-resources.university.identifiers.cam.ac.uk'
    INSTITUTION_DOT_V1_DOT_STUDENT_MINUS_RECORDS_DOT_UNIVERSITY_DOT_IDENTIFIERS_DOT_CAM_DOT_AC_DOT_UK = 'institution.v1.student-records.university.identifiers.cam.ac.uk'
