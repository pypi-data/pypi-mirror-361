...
class AppealsCase(BaseModel):
    """
    AppealsCase
    """ # noqa: E501
    appeals_case_id: StrictInt = Field(alias="appealsCaseId")
    appeals_case_url: StrictStr = Field(alias="appealsCaseUrl")
    resolution: Optional[DistrictCaseResolution] = None
    filed_on: date = Field(alias="filedOn")
    terminated: Optional[date] = None
    __properties: ClassVar[List[str]] = ["appealsCaseId", "appealsCaseUrl", "resolution", "filedOn", "terminated"]
