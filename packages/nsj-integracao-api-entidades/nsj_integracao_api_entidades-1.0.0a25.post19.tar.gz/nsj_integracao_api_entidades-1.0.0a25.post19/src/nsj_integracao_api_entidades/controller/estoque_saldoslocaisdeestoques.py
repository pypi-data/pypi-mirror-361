...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/saldoslocaisdeestoques"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/saldoslocaisdeestoques/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/saldoslocaisdeestoques/verificacao-integridade"
