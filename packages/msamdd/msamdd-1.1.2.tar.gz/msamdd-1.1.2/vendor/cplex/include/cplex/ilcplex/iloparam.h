...
struct Param {
  ...
  struct Benders {
    ...
    struct Tolerances {
      #if !defined(_WIN32) && !defined(CPX_FORCE_DEPRECATION_WARNINGS)
      CPXDEPRECATED(20010000)
      #endif
  ...
  struct MIP {
    struct Cuts {
      ...
      static const IloCplex::IntParam Nodecuts = IntParam(CPX_PARAM_NODECUTS);
    ...
    struct Limits {
      ...
      static const IloCplex::NumParam LowerObjStop = NumParam(CPX_PARAM_LOWEROBJSTOP);
      ...
      static const IloCplex::NumParam UpperObjStop = NumParam(CPX_PARAM_UPPEROBJSTOP);
    };
    ...
    struct Strategy {
      ...
      static const IloCplex::IntParam CardLs = IntParam(CPX_PARAM_CARDLS);
      ...
      static const IloCplex::NumParam HeuristicEffort = NumParam(CPX_PARAM_HEUREFFORT);
  ...
  struct Preprocessing {
    ...
    static const IloCplex::IntParam Reformulations = IntParam(CPX_PARAM_PREREFORM);
    ...
    static const IloCplex::IntParam SOS1Reform = IntParam(CPX_PARAM_SOS1REFORM);
    static const IloCplex::IntParam SOS2Reform = IntParam(CPX_PARAM_SOS2REFORM);
  ...
  // Returns true if the specified id is a bool param.
  static inline bool isBooleanParameter(int id) {
    switch (id) {
      case CPX_PARAM_CLONELOG: return true;
      case CPX_PARAM_LBHEUR: return true;
      case CPX_PARAM_MEMORYEMPHASIS: return true;
      case CPX_PARAM_MIPORDIND: return true;
      case CPX_PARAM_MPSLONGNUM: return true;
      case CPX_PARAM_NUMERICALEMPHASIS: return true;
      case CPX_PARAM_PARAMDISPLAY: return true;
      case CPX_PARAM_PERIND: return true;
      case CPX_PARAM_PREIND: return true;
      case CPX_PARAM_QPMAKEPSDIND: return true;
      case CPX_PARAM_RECORD: return true;
      case CPX_PARAM_SIFTSIM: return true;
