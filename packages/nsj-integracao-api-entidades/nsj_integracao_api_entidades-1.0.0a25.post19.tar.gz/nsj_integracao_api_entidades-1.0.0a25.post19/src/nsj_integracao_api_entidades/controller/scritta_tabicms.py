...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/scritta/tabicms"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/scritta/tabicms/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/scritta/tabicms/verificacao-integridade"
