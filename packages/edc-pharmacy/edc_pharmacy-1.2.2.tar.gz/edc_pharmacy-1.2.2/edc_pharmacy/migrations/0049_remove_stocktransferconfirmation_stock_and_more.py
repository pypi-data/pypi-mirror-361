...
class Migration(migrations.Migration):
    ...
    operations = [
                ...
                (
                    ...
                    models.DateTimeField(
                        default=datetime.datetime(
                            2024, 11, 21, 3, 22, 23, 555563, tzinfo=datetime.timezone.utc
                        )
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="+",
                        to="edc_pharmacy.stocktransferconfirmation2",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["modified", "created"], name="edc_pharmac_modifie_1b1617_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="stocktransferconfirmation2",
            index=models.Index(
                fields=["user_modified", "user_created"], name="edc_pharmac_user_mo_d1bbde_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="stocktransferconfirmationitem",
            index=models.Index(
                fields=["modified", "created"], name="edc_pharmac_modifie_84ddbd_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="stocktransferconfirmationitem",
            index=models.Index(
                fields=["user_modified", "user_created"], name="edc_pharmac_user_mo_956b50_idx"
            ),
        ),
    ]
