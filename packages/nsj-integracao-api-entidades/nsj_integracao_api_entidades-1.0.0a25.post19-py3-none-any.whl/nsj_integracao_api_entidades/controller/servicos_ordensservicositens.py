...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/ordensservicositens"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/ordensservicositens/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/ordensservicositens/verificacao-integridade"
