...
class TgaImage(aspose.imaging.RasterCachedImage):
    ...
    def __init__(self, path: str):
        '''Initializes a new  object using the provided file path for
    ...
    def __init__(self, raster_image: aspose.imaging.RasterImage):
        '''Create a new instance of the  class by providing a raster
    ...
    def __init__(self, stream: io.RawIOBase):
        '''Initialize a new instance of the  class using a stream to
    ...
    @overload
    def clone(self, tga_image: aspose.imaging.fileformats.tga.TgaImage):
        '''Replicate the properties of another  object, creating a
    ...
    @staticmethod
    def create_from_stream(stream: io.RawIOBase) -> aspose.imaging.fileformats.tga.TgaImage:
        '''Initializes a new instance of the  class.
    ...
    def equals(self, other: aspose.imaging.fileformats.tga.TgaImage) -> bool:
        ...
        instance is equal to the second image provided as a
        ...
        :param other: Second  that takes part in comparison.
    ...
    def author_comments(self, value : str):
        ...
    ...
    @property
    def date_time_stamp(self) -> Optional[DateTime]:
        ...
    
    @date_time_stamp.setter
    def date_time_stamp(self, value : Optional[DateTime]):
        ...
    ...
    def job_name_or_id(self, value : str):
        ...
    
    @property
    def job_time(self) -> Optional[TimeSpan]:
        ...
    
    @job_time.setter
    def job_time(self, value : Optional[TimeSpan]):
        ...
    ...
    @property
    def software_version_letter(self) -> char:
        ...
    
    @software_version_letter.setter
    def software_version_letter(self, value : char):
        ...
    ...
    def software_version_number(self, value : int):
        ...
    ...
    @software_id.setter
    def software_id(self, value : str):
        ...
