...
class OnboardingPromptOptionResponse(BaseModel):
    ...
    role_ids: List[Annotated[str, Field(strict=True)]]
    channel_ids: List[Annotated[str, Field(strict=True)]]
    __properties: ClassVar[List[str]] = ["id", "title", "description", "emoji", "role_ids", "channel_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "emoji": SettingsEmojiResponse.from_dict(obj["emoji"]) if obj.get("emoji") is not None else None,
