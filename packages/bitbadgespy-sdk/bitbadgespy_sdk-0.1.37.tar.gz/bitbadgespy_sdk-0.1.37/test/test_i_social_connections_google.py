...
class TestISocialConnectionsGoogle(unittest.TestCase):
    """ISocialConnectionsGoogle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISocialConnectionsGoogle:
        """Test ISocialConnectionsGoogle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISocialConnectionsGoogle`
        """
        model = ISocialConnectionsGoogle()
        if include_optional:
            return ISocialConnectionsGoogle(
                username = '',
                id = '',
                last_updated = None
            )
    ...
    def testISocialConnectionsGoogle(self):
        """Test ISocialConnectionsGoogle"""
