...
from sigma import Petstore, AsyncPetstore, APIResponseValidationError
from sigma._types import Omit
from sigma._models import BaseModel, FinalRequestOptions
from sigma._exceptions import PetstoreError, APIStatusError, APITimeoutError, APIResponseValidationError
from sigma._base_client import (
    DEFAULT_TIMEOUT,
...
class TestPetstore:
    client = Petstore(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(PetstoreError):
            with update_env(**{"SIGMA_SDK_BEARER_TOKEN": Omit()}):
                client2 = Petstore(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_base_url_env(self) -> None:
        with update_env(PETSTORE_BASE_URL="http://localhost:5000/from/env"):
            client = Petstore(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(PETSTORE_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                Petstore(bearer_token=bearer_token, _strict_response_validation=True, environment="prod")

            client = Petstore(
                base_url=None, bearer_token=bearer_token, _strict_response_validation=True, environment="prod"
            )
            assert str(client.base_url).startswith("https://sigma.sideef5ect.com")
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Petstore(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Petstore(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("sigma._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Petstore) -> None:
        respx_mock.get("/trading/orders").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            client.trading.with_streaming_response.list().__enter__()

        assert _get_open_connections(self.client) == 0

    @mock.patch("sigma._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Petstore) -> None:
        respx_mock.get("/trading/orders").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/trading/orders").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        ...
        response = client.trading.with_raw_response.list(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.trading.with_raw_response.list(extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncPetstore:
    client = AsyncPetstore(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(PetstoreError):
            with update_env(**{"SIGMA_SDK_BEARER_TOKEN": Omit()}):
                client2 = AsyncPetstore(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_base_url_env(self) -> None:
        with update_env(PETSTORE_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncPetstore(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(PETSTORE_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                AsyncPetstore(bearer_token=bearer_token, _strict_response_validation=True, environment="prod")
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncPetstore(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncPetstore(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        self, respx_mock: MockRouter, async_client: AsyncPetstore
    ) -> None:
        respx_mock.get("/trading/orders").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            await async_client.trading.with_streaming_response.list().__aenter__()
    ...
    async def test_retries_taken(
        ...
        response = await client.trading.with_raw_response.list()
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.trading.with_raw_response.list(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.trading.with_raw_response.list(extra_headers={"x-stainless-retry-count": "42"})
    ...
    def test_get_platform(self) -> None:
        ...
        from sigma._utils import asyncify
        from sigma._base_client import get_platform
