...
class IFilterBadgesInCollectionPayload(BaseModel):
    ...
    price_range: Optional[IUintRange] = Field(default=None, description="The listing prices ($BADGE)", alias="priceRange")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["badgeIds", "categories", "tags", "mostViewed", "bookmark", "attributes", "priceRange"]
