"""
Schema definitions for Littercoder FLUX 1.0 Pro API.
"""
...
class LittercoderFluxV1ProInput(BaseModel):
...
LittercoderFluxV1ProOutput = Union[LittercoderAsyncResponse, LittercoderAsyncWebhookResponse] 
