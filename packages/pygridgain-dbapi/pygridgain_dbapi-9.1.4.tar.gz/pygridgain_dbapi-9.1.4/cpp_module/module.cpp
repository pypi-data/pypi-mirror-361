...
static PyObject* pygridgain_dbapi_connect(PyObject* self, PyObject* args, PyObject* kwargs) {
    static char *kwlist[] = {
        "address",
        "identity",
        "secret",
...
static PyMethodDef methods[] = {
    {"connect", (PyCFunction)pygridgain_dbapi_connect, METH_VARARGS | METH_KEYWORDS, nullptr},
...
PyMODINIT_FUNC PyInit__pygridgain_dbapi_extension(void) { // NOLINT(*-reserved-identifier)
    PyObject* mod;
