...
class uLogger:
    ...
    def __init__(self, Print:bool=True, PrintLevel:uLoggerLevel=uLoggerLevel.WARNING, PrintColor:bool=False):
        '''
        ...
        self.header_len = 69
        self.subheader_char = '-'
        self.write_level = uLoggerLevel.INFO
        self.print = Print
    ...
    def SetWriteLevel(self, Level:uLoggerLevel):
        '''
        Only write enteries at or above **Level**.
        '''
        self.write_level = Level

    def WriteBlank(self, Level=uLoggerLevel.INFO):
        '''
        Writes a blank line.
        '''
        self.WriteLine("", Level)

    def WriteLine(self, Line, Level=uLoggerLevel.INFO):
        '''
    ...
    def WriteDetails(self, Line):
        ...
        '''
        self.WriteLine(f"[+GREY]{Line}[+]", uLoggerLevel.DETAILS)
        
    def WriteWarning(self, Line):
        '''
        Writes a **Line** at level *WARNING*.
        '''
        self.WriteLine(f"[+YELLOW]{Line}[+]", uLoggerLevel.WARNING)
        
    def WriteError(self, Line):
        '''
        Writes a **Line** at level *ERROR*.
        '''
        self.WriteLine(f"[+LT_RED]{Line}[+]", uLoggerLevel.ERROR)

    # Printing

    def SetPrint(self, Print:bool=True, Level:uLoggerLevel=None, Color:bool=None):
        '''
    ...
    def SetPrintLevel(self, PrintLevel:uLoggerLevel):
        '''
...
class uFileLogger(uLogger):
    def __init__(self, Filepath:str=None, Print:bool=True, PrintLevel:uLoggerLevel=uLoggerLevel.WARNING, PrintColor:bool=False):
        '''
    ...
    def imp_writeline(self, in_line, in_level):
        decoration = ""
        if in_level == uLoggerLevel.DETAILS:
            decoration = ".."
        elif in_level == uLoggerLevel.WARNING:
            decoration = "*WARN: "
        elif in_level == uLoggerLevel.ERROR:
            decoration = "*ERROR: "
