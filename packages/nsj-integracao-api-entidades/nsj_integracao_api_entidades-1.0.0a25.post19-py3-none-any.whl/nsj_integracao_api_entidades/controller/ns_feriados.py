...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/feriados"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/feriados/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/feriados/verificacao-integridade"
