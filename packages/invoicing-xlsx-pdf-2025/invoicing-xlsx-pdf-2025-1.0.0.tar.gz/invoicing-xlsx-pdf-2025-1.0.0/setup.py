...
setup(
  name = 'invoicing-xlsx-pdf-2025',         #* Your package will have this name
  ...
  author = 'Luke Curran',                   # Your name
  author_email = '231lukecurran@gmail.com',  # Your email
  url = 'https://github.com/LC231/python-mega-course-20-Python-Package',              # Homepage of your library (e.g. github or your website)
