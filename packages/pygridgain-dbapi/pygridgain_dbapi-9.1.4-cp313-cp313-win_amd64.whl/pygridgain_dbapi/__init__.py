...
from pygridgain_dbapi import _pygridgain_dbapi_extension
from pygridgain_dbapi import native_type_code
...
def connect(address: [str], **kwargs) -> Connection:
    ...
    """
    return _pygridgain_dbapi_extension.connect(address=address, **kwargs)
