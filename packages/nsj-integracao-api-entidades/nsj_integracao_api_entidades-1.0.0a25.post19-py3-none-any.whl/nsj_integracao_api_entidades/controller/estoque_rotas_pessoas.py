...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/rotas_pessoas"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/rotas_pessoas/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/rotas_pessoas/verificacao-integridade"
