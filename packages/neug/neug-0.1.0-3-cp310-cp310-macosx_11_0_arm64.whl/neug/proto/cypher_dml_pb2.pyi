...
class ReadCSV(google.protobuf.message.Message):
    ...
    class options(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["auto_detection", b"auto_detection", "delimiter", b"delimiter", "escape_char", b"escape_char", "header", b"header", "ignore_errors", b"ignore_errors", "parallel", b"parallel", "quote_char", b"quote_char", "skip_num", b"skip_num"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["csv_options", b"csv_options"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["batch_reader", b"batch_reader", "csv_options", b"csv_options", "file_path", b"file_path"]) -> None: ...
...
class DataSource(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["read_csv", b"read_csv", "source", b"source"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["read_csv", b"read_csv", "source", b"source"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["source", b"source"]) -> typing.Literal["read_csv"] | None: ...
...
class PropertyMapping(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["data", b"data", "property", b"property"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["data", b"data", "property", b"property"]) -> None: ...
...
class BatchInsertVertex(google.protobuf.message.Message):
    ...
    @property
    def property_mappings(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PropertyMapping]:
    ...
    def __init__(
        ...
        *,
        ...
        property_mappings: collections.abc.Iterable[global___PropertyMapping] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["vertex_type", b"vertex_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["property_mappings", b"property_mappings", "vertex_type", b"vertex_type"]) -> None: ...
...
class BatchInsertEdge(google.protobuf.message.Message):
    ...
    @property
    def source_vertex_binding(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PropertyMapping]:
        """Specify the source node bound to the edge via column mapping."""

    @property
    def destination_vertex_binding(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PropertyMapping]:
    ...
    def __init__(
        ...
        *,
        ...
        source_vertex_binding: collections.abc.Iterable[global___PropertyMapping] | None = ...,
        destination_vertex_binding: collections.abc.Iterable[global___PropertyMapping] | None = ...,
        property_mappings: collections.abc.Iterable[global___PropertyMapping] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["edge_type", b"edge_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["destination_vertex_binding", b"destination_vertex_binding", "edge_type", b"edge_type", "property_mappings", b"property_mappings", "source_vertex_binding", b"source_vertex_binding"]) -> None: ...
...
class InsertVertex(google.protobuf.message.Message):
    ...
    class Entry(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["alias", b"alias", "vertex_type", b"vertex_type"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["alias", b"alias", "conflict_action", b"conflict_action", "property_mappings", b"property_mappings", "vertex_type", b"vertex_type"]) -> None: ...

    ENTRIES_FIELD_NUMBER: builtins.int
    @property
    def entries(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___InsertVertex.Entry]:
...
class InsertEdge(google.protobuf.message.Message):
    ...
    class Entry(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["alias", b"alias", "destination_vertex_binding", b"destination_vertex_binding", "edge_type", b"edge_type", "source_vertex_binding", b"source_vertex_binding"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["alias", b"alias", "conflict_action", b"conflict_action", "destination_vertex_binding", b"destination_vertex_binding", "edge_type", b"edge_type", "property_mappings", b"property_mappings", "source_vertex_binding", b"source_vertex_binding"]) -> None: ...

    ENTRIES_FIELD_NUMBER: builtins.int
    @property
    def entries(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___InsertEdge.Entry]: ...
    def __init__(
        self,
        *,
...
class SetVertexProperty(google.protobuf.message.Message):
    ...
    class Entry(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["property_mapping", b"property_mapping", "vertex_binding", b"vertex_binding"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["property_mapping", b"property_mapping", "vertex_binding", b"vertex_binding"]) -> None: ...

    ENTRIES_FIELD_NUMBER: builtins.int
    @property
    def entries(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___SetVertexProperty.Entry]:
        """set multiple vertex properties based on the multiple aliases"""

    def __init__(
        self,
        *,
        entries: collections.abc.Iterable[global___SetVertexProperty.Entry] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["entries", b"entries"]) -> None: ...
...
class SetEdgeProperty(google.protobuf.message.Message):
    ...
    class Entry(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["edge_binding", b"edge_binding", "property_mapping", b"property_mapping"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["edge_binding", b"edge_binding", "property_mapping", b"property_mapping"]) -> None: ...

    ENTRIES_FIELD_NUMBER: builtins.int
    @property
    def entries(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___SetEdgeProperty.Entry]:
...
class DeleteVertex(google.protobuf.message.Message):
    ...
    class _typeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[DeleteVertex._type.ValueType], builtins.type):
    ...
    class Entry(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["vertex_binding", b"vertex_binding"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["delete_type", b"delete_type", "vertex_binding", b"vertex_binding"]) -> None: ...

    ENTRIES_FIELD_NUMBER: builtins.int
    @property
    def entries(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___DeleteVertex.Entry]:
...
class DeleteEdge(google.protobuf.message.Message):
    ...
    EDGE_BINDING_FIELD_NUMBER: builtins.int
    @property
    def edge_binding(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[expr_pb2.Variable]:
    ...
    def ClearField(self, field_name: typing.Literal["edge_binding", b"edge_binding"]) -> None: ...
