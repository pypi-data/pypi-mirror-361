...
class DoubleArray3(object):
    ...
    def __init__(self, *args):
        _ifcopenshell_wrapper.DoubleArray3_swiginit(self, _ifcopenshell_wrapper.new_DoubleArray3(*args))
...
# Register DoubleArray3 in _ifcopenshell_wrapper:
_ifcopenshell_wrapper.DoubleArray3_swigregister(DoubleArray3)
...
class Settings(object):
    ...
    def get_type(self, name):
        r"""get_type(Settings self, std::string const & name) -> std::string"""
...
class geometry_conversion_result(object):
    r"""Proxy of C++ IfcGeom::geometry_conversion_result class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    index = property(_ifcopenshell_wrapper.geometry_conversion_result_index_get, _ifcopenshell_wrapper.geometry_conversion_result_index_set, doc=r"""index : int""")
    item = property(_ifcopenshell_wrapper.geometry_conversion_result_item_get, _ifcopenshell_wrapper.geometry_conversion_result_item_set, doc=r"""item : ifcopenshell::geometry::taxonomy::ptr""")
    products = property(_ifcopenshell_wrapper.geometry_conversion_result_products_get, _ifcopenshell_wrapper.geometry_conversion_result_products_set, doc=r"""products : std::vector<(std::pair<(p.q(const).IfcUtil::IfcBaseEntity,ifcopenshell::geometry::taxonomy::matrix4::ptr)>,std::allocator<(std::pair<(p.q(const).IfcUtil::IfcBaseEntity,ifcopenshell::geometry::taxonomy::matrix4::ptr)>)>)>""")
    representation = property(_ifcopenshell_wrapper.geometry_conversion_result_representation_get, _ifcopenshell_wrapper.geometry_conversion_result_representation_set, doc=r"""representation : p.IfcUtil::IfcBaseEntity""")
    products_2 = property(_ifcopenshell_wrapper.geometry_conversion_result_products_2_get, _ifcopenshell_wrapper.geometry_conversion_result_products_2_set, doc=r"""products_2 : aggregate_of_instance::ptr""")
    breps = property(_ifcopenshell_wrapper.geometry_conversion_result_breps_get, _ifcopenshell_wrapper.geometry_conversion_result_breps_set, doc=r"""breps : std::vector<(p.IfcGeom::BRepElement,std::allocator<(p.IfcGeom::BRepElement)>)>""")
    elements = property(_ifcopenshell_wrapper.geometry_conversion_result_elements_get, _ifcopenshell_wrapper.geometry_conversion_result_elements_set, doc=r"""elements : std::vector<(p.IfcGeom::Element,std::allocator<(p.IfcGeom::Element)>)>""")

    def __init__(self):
        r"""__init__(geometry_conversion_result self) -> geometry_conversion_result"""
        _ifcopenshell_wrapper.geometry_conversion_result_swiginit(self, _ifcopenshell_wrapper.new_geometry_conversion_result())
    __swig_destroy__ = _ifcopenshell_wrapper.delete_geometry_conversion_result

# Register geometry_conversion_result in _ifcopenshell_wrapper:
_ifcopenshell_wrapper.geometry_conversion_result_swigregister(geometry_conversion_result)
...
class SerializerSettings(object):
    ...
    def get_type(self, name):
        r"""get_type(SerializerSettings self, std::string const & name) -> std::string"""
...
class equal_functor(object):
    r"""Proxy of C++ ifcopenshell::geometry::taxonomy::equal_functor class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __call__(self, a, b):
        r"""__call__(equal_functor self, ifcopenshell::geometry::taxonomy::item::ptr const & a, ifcopenshell::geometry::taxonomy::item::ptr const & b) -> bool"""
        return _ifcopenshell_wrapper.equal_functor___call__(self, a, b)

    def __init__(self):
        r"""__init__(equal_functor self) -> equal_functor"""
        _ifcopenshell_wrapper.equal_functor_swiginit(self, _ifcopenshell_wrapper.new_equal_functor())
    __swig_destroy__ = _ifcopenshell_wrapper.delete_equal_functor

# Register equal_functor in _ifcopenshell_wrapper:
_ifcopenshell_wrapper.equal_functor_swigregister(equal_functor)
class hash_functor(object):
    r"""Proxy of C++ ifcopenshell::geometry::taxonomy::hash_functor class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __call__(self, a):
        r"""__call__(hash_functor self, ifcopenshell::geometry::taxonomy::item::ptr const & a) -> size_t"""
        return _ifcopenshell_wrapper.hash_functor___call__(self, a)

    def __init__(self):
        r"""__init__(hash_functor self) -> hash_functor"""
        _ifcopenshell_wrapper.hash_functor_swiginit(self, _ifcopenshell_wrapper.new_hash_functor())
    __swig_destroy__ = _ifcopenshell_wrapper.delete_hash_functor

# Register hash_functor in _ifcopenshell_wrapper:
_ifcopenshell_wrapper.hash_functor_swigregister(hash_functor)
class point3(object):
...
class loop(object):
    ...
    fi = property(_ifcopenshell_wrapper.loop_fi_get, _ifcopenshell_wrapper.loop_fi_set, doc=r"""fi : boost::optional<(ifcopenshell::geometry::taxonomy::function_item::ptr)>""")
...
def helmert_curve_point(A0, A1, A2, s):
    r"""helmert_curve_point(double A0, double A1, double A2, double s) -> std::vector< double,std::allocator< double > >"""
...
class ColladaSerializer(WriteOnlyGeometrySerializer):
    r"""Proxy of C++ ColladaSerializer class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, dae_filename, geometry_settings, settings):
        r"""__init__(ColladaSerializer self, std::string const & dae_filename, Settings geometry_settings, SerializerSettings settings) -> ColladaSerializer"""
        _ifcopenshell_wrapper.ColladaSerializer_swiginit(self, _ifcopenshell_wrapper.new_ColladaSerializer(dae_filename, geometry_settings, settings))

    def ready(self):
        r"""ready(ColladaSerializer self) -> bool"""
        return _ifcopenshell_wrapper.ColladaSerializer_ready(self)

    def writeHeader(self):
        r"""writeHeader(ColladaSerializer self)"""
...
# Register ColladaSerializer in _ifcopenshell_wrapper:
_ifcopenshell_wrapper.ColladaSerializer_swigregister(ColladaSerializer)
...
class file(object):
    ...
    def get_inverses_by_declaration(self, instance_id, type, attribute_index):
        r"""get_inverses_by_declaration(file self, int instance_id, declaration type, int attribute_index) -> aggregate_of_instance::ptr"""
    ...
    def get_total_inverses_by_id(self, instance_id):
        r"""get_total_inverses_by_id(file self, int instance_id) -> size_t"""
