...
class DataFrame:
    ...
    def _merge_cached_schema(self, other: "DataFrame") -> Optional[StructType]:
    ...
    transpose.__doc__ = PySparkDataFrame.transpose.__doc__
    ...
    mergeInto.__doc__ = PySparkDataFrame.mergeInto.__doc__
    ...
    checkpoint.__doc__ = PySparkDataFrame.checkpoint.__doc__
    ...
    localCheckpoint.__doc__ = PySparkDataFrame.localCheckpoint.__doc__
    ...
    plot.__doc__ = PySparkDataFrame.plot.__doc__
