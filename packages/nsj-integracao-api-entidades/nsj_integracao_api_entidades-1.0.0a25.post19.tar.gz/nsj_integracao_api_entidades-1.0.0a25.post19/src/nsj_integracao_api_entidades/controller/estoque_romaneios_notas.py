...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/romaneios_notas"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/romaneios_notas/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/romaneios_notas/verificacao-integridade"
