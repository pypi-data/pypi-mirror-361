...
#--------------------------------------------------
# Obtendo a Area no plano XY da Heteroestrutura ---
#--------------------------------------------------
...
Area = Area*(1e-16)  # Convertendo de Å^2 para cm^2
#--------------------------------------------------

#--------------------------------------------------------------------
# Obtendo o rotulo e o nº de átomos para cada tipo de ion da rede ---
#--------------------------------------------------------------------
VTemp = poscar.readline().split()
...
#--------------------------------------------------------------------------------------
acf_files = {}  # Criando um dicionário para armazenar os arquivos ACF_material_'i'.dat
