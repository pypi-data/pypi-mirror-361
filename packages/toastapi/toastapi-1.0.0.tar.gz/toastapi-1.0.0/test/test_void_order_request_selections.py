...
from toasttab.models.void_order_request_selections import VoidOrderRequestSelections

class TestVoidOrderRequestSelections(unittest.TestCase):
    """VoidOrderRequestSelections unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VoidOrderRequestSelections:
        """Test VoidOrderRequestSelections
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoidOrderRequestSelections`
        """
        model = VoidOrderRequestSelections()
        if include_optional:
            return VoidOrderRequestSelections(
                void_all = True
            )
        else:
            return VoidOrderRequestSelections(
    ...
    def testVoidOrderRequestSelections(self):
        """Test VoidOrderRequestSelections"""
