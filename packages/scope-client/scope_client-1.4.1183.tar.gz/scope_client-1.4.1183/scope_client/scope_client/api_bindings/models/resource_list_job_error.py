...
class ResourceListJobError(BaseModel):
    """
    ResourceListJobError
    """ # noqa: E501
    records: List[JobError] = Field(description="List of records.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [JobError.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
