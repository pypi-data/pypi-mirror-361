...
class PTABTrialDates(BaseModel):
    """
    PTABTrialDates
    """ # noqa: E501
    filed: date
    terminated: Optional[date] = None
    institution_decision: Optional[date] = Field(alias="institutionDecision")
    final_decision: Optional[date] = Field(alias="finalDecision")
    __properties: ClassVar[List[str]] = ["filed", "terminated", "institutionDecision", "finalDecision"]
