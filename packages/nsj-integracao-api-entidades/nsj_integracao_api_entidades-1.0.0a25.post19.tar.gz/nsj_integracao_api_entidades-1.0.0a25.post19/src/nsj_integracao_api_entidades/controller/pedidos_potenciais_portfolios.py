...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/potenciais_portfolios"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/potenciais_portfolios/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/potenciais_portfolios/verificacao-integridade"
