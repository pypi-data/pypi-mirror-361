...
class ControllerCapabilities(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ControllerCapabilities from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ControllerCapabilities from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "support_freedrive": obj.get("support_freedrive"),
            "support_control": obj.get("support_control")
        })
        return _obj
