...
class OpenDssReport(_message.Message):
    __slots__ = ("di", "phv", "ov", "vr", "sr", "el", "tr", "lr", "ibr", "le", "losses", "nm", "kvm", "failure")
    ...
    failure: bool
    def __init__(self, di: _Optional[_Union[_EnergyMeter_pb2.DemandIntervalReport, _Mapping]] = ..., phv: _Optional[_Union[_EnergyMeter_pb2.PhaseVoltageReport, _Mapping]] = ..., ov: _Optional[_Union[_EnergyMeter_pb2.OverloadReport, _Mapping]] = ..., vr: _Optional[_Union[_EnergyMeter_pb2.VoltageReport, _Mapping]] = ..., sr: _Optional[_Union[_Diagnostics_pb2.SummaryReport, _Mapping]] = ..., el: _Optional[_Union[_Diagnostics_pb2.EventLog, _Mapping]] = ..., tr: _Optional[_Union[_Diagnostics_pb2.TapsReport, _Mapping]] = ..., lr: _Optional[_Union[_Diagnostics_pb2.LoopReport, _Mapping]] = ..., ibr: _Optional[_Union[_Diagnostics_pb2.IsolatedBusesReport, _Mapping]] = ..., le: _Optional[_Union[_Diagnostics_pb2.LossesEntry, _Mapping]] = ..., losses: _Optional[_Union[_Diagnostics_pb2.LossesTotals, _Mapping]] = ..., nm: _Optional[_Union[_Diagnostics_pb2.NodeMismatch, _Mapping]] = ..., kvm: _Optional[_Union[_Diagnostics_pb2.KVBaseMismatch, _Mapping]] = ..., failure: bool = ...) -> None: ...
