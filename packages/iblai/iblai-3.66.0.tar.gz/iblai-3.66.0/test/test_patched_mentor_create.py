...
class TestPatchedMentorCreate(unittest.TestCase):
    """PatchedMentorCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedMentorCreate:
        """Test PatchedMentorCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedMentorCreate`
        """
        model = PatchedMentorCreate()
        if include_optional:
            return PatchedMentorCreate(
                name = '',
                unique_id = '',
                flow = None,
                slug = 'z',
    ...
    def testPatchedMentorCreate(self):
        """Test PatchedMentorCreate"""
