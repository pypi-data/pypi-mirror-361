...
class ATP:
    ...
    def get_df_sts(self):
        ...
        try:
            ...
            print("Erro ao salvar o arquivo CSV dos resultados estatísticos. A execução continuará normalmente.")
    ...
    def get_df_shots_total(self, df_sts):
        ...
        try:
            ...
            print("Erro ao salvar o arquivo CSV dos resultados dos gráficos. A execução continuará normalmente.")
        return df
...
if __name__ == "__main__":
    ...
    oATP.dic_relacoes = {
               "TF":{"eqp": "TF1 230/13.8kV Porto Alegre 6", "v_ft": "TF", "cn_rms": "NTF_R", "cn_max": "TF_TC", "energ": "PR"},
             "TF_D":{"eqp": "TF1 230/13.8kV Porto Alegre 6 (Regime)", "v_ft": "TF_D", "cn_rms": "", "cn_max": "", "energ": ""},
              "ITA":{"eqp": "TF UHE ITÁ", "v_ft": "", "cn_rms": "NITA_R", "cn_max": "", "energ": ""},
              "976":{"eqp": "TF 525/230kV Gravataí", "v_ft": "976", "cn_rms": "NGR52R", "cn_max": "", "energ": ""},
             "1210":{"eqp": "TF 230/138kV Gravataí 2", "v_ft": "1210", "cn_rms": "NGR23R", "cn_max": "", "energ": ""},
