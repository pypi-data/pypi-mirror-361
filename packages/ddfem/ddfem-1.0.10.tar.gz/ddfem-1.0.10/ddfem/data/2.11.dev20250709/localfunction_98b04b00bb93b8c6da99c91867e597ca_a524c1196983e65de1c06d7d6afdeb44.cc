#ifndef GUARD_98b04b00bb93b8c6da99c91867e597ca
#define GUARD_98b04b00bb93b8c6da99c91867e597ca
...
namespace UFLLocalFunctions_98b04b00bb93b8c6da99c91867e597ca
{
  ...
  : public Dune::Fem::BindableGridFunctionWithSpace<GridPart,Dune::Dim<1>>
{
  ...
  void jacobian ( const Point &x, typename FunctionSpaceType::JacobianRangeType &result ) const
  {
    ...
    const auto tmp94 = tmp1[ 1 ] + tmp1[ 1 ];
    const auto tmp95 = tmp94 / tmp49;
    const auto tmp96 = tmp95 * (tmp34 > tmp33 ? 1 : 0.0);
    const auto tmp97 = tmp27 + tmp27;
    const auto tmp98 = tmp97 / tmp53;
    const auto tmp99 = -1 * tmp98;
    const auto tmp100 = tmp57 * tmp99;
    const auto tmp101 = tmp100 + tmp96;
    const auto tmp102 = tmp101 * (tmp35 > tmp26 ? 1 : 0.0);
    const auto tmp103 = tmp20 + tmp20;
    const auto tmp104 = tmp103 / tmp61;
    const auto tmp105 = -1 * tmp104;
    const auto tmp106 = tmp65 * tmp105;
    const auto tmp107 = tmp106 + tmp102;
    const auto tmp108 = tmp107 * (tmp36 < tmp19 ? 1 : 0.0);
    const auto tmp109 = tmp94 / tmp69;
    const auto tmp110 = tmp73 * tmp109;
    const auto tmp111 = tmp110 + tmp108;
    const auto tmp112 = tmp111 * (tmp37 < tmp13 ? 1 : 0.0);
    const auto tmp113 = tmp94 / tmp77;
    const auto tmp114 = tmp81 * tmp113;
    const auto tmp115 = tmp114 + tmp112;
    const auto tmp116 = tmp115 * (tmp38 > tmp7 ? 1 : 0.0);
    const auto tmp117 = tmp86 * tmp95;
    const auto tmp118 = tmp117 + tmp116;
    const auto tmp119 = 3 * tmp118;
    const auto tmp120 = tmp119 / tmp0;
    const auto tmp121 = tmp120 * tmp48;
    const auto tmp122 = -1 * tmp121;
    const auto tmp123 = 0.5 * tmp122;
    (result[ 0 ])[ 0 ] = tmp93;
    (result[ 0 ])[ 1 ] = tmp123;
  }
  ...
  void hessian ( const Point &x, typename FunctionSpaceType::HessianRangeType &result ) const
  {
    ...
    const auto tmp152 = tmp1[ 1 ] + tmp1[ 1 ];
    const auto tmp153 = tmp152 / tmp49;
    const auto tmp154 = 2 * tmp153;
    const auto tmp155 = tmp154 * tmp51;
    const auto tmp156 = -1 * tmp155;
    const auto tmp157 = tmp156 / tmp49;
    const auto tmp158 = tmp157 * (tmp34 > tmp33 ? 1 : 0.0);
    const auto tmp159 = tmp27 + tmp27;
    const auto tmp160 = tmp159 / tmp58;
    const auto tmp161 = 2 * tmp160;
    const auto tmp162 = tmp161 * tmp59;
    const auto tmp163 = -1 * tmp162;
    const auto tmp164 = tmp163 / tmp58;
    const auto tmp165 = -1 * tmp164;
    const auto tmp166 = tmp67 * tmp165;
    const auto tmp167 = tmp166 + tmp158;
    const auto tmp168 = tmp167 * (tmp35 > tmp26 ? 1 : 0.0);
    const auto tmp169 = tmp20 + tmp20;
    const auto tmp170 = tmp169 / tmp71;
    const auto tmp171 = 2 * tmp170;
    const auto tmp172 = tmp171 * tmp72;
    const auto tmp173 = -1 * tmp172;
    const auto tmp174 = tmp173 / tmp71;
    const auto tmp175 = -1 * tmp174;
    const auto tmp176 = tmp80 * tmp175;
    const auto tmp177 = tmp176 + tmp168;
    const auto tmp178 = tmp177 * (tmp36 < tmp19 ? 1 : 0.0);
    const auto tmp179 = tmp152 / tmp84;
    const auto tmp180 = 2 * tmp179;
    const auto tmp181 = tmp180 * tmp86;
    const auto tmp182 = -1 * tmp181;
    const auto tmp183 = tmp182 / tmp84;
    const auto tmp184 = tmp93 * tmp183;
    const auto tmp185 = tmp184 + tmp178;
    const auto tmp186 = tmp185 * (tmp37 < tmp13 ? 1 : 0.0);
    const auto tmp187 = tmp152 / tmp97;
    const auto tmp188 = 2 * tmp187;
    const auto tmp189 = tmp188 * tmp99;
    const auto tmp190 = -1 * tmp189;
    const auto tmp191 = tmp190 / tmp97;
    const auto tmp192 = tmp106 * tmp191;
    const auto tmp193 = tmp192 + tmp186;
    const auto tmp194 = tmp193 * (tmp38 > tmp7 ? 1 : 0.0);
    const auto tmp195 = tmp111 * tmp157;
    const auto tmp196 = tmp195 + tmp194;
    const auto tmp197 = 3 * tmp196;
    const auto tmp198 = tmp197 / tmp0;
    const auto tmp199 = tmp198 * tmp48;
    const auto tmp200 = tmp153 * (tmp34 > tmp33 ? 1 : 0.0);
    const auto tmp201 = -1 * tmp160;
    const auto tmp202 = tmp67 * tmp201;
    const auto tmp203 = tmp202 + tmp200;
    const auto tmp204 = tmp203 * (tmp35 > tmp26 ? 1 : 0.0);
    const auto tmp205 = -1 * tmp170;
    const auto tmp206 = tmp80 * tmp205;
    const auto tmp207 = tmp206 + tmp204;
    const auto tmp208 = tmp207 * (tmp36 < tmp19 ? 1 : 0.0);
    const auto tmp209 = tmp93 * tmp179;
    const auto tmp210 = tmp209 + tmp208;
    const auto tmp211 = tmp210 * (tmp37 < tmp13 ? 1 : 0.0);
    const auto tmp212 = tmp106 * tmp187;
    const auto tmp213 = tmp212 + tmp211;
    const auto tmp214 = tmp213 * (tmp38 > tmp7 ? 1 : 0.0);
    const auto tmp215 = tmp111 * tmp153;
    const auto tmp216 = tmp215 + tmp214;
    const auto tmp217 = 3 * tmp216;
    const auto tmp218 = tmp217 / tmp0;
    const auto tmp219 = tmp218 * tmp136;
    const auto tmp220 = 2.0 * tmp219;
    const auto tmp221 = 2.0 * tmp218;
    const auto tmp222 = tmp221 * tmp139;
    const auto tmp223 = tmp222 * tmp47;
    const auto tmp224 = -1 * tmp223;
    const auto tmp225 = tmp224 + tmp220;
    const auto tmp226 = tmp225 / tmp44;
    const auto tmp227 = 2 * tmp226;
    const auto tmp228 = tmp227 * tmp47;
    const auto tmp229 = tmp228 * tmp135;
    const auto tmp230 = tmp229 + tmp199;
    const auto tmp231 = -1 * tmp230;
    const auto tmp232 = 0.5 * tmp231;
    const auto tmp233 = tmp52 * tmp153;
    const auto tmp234 = -1 * tmp233;
    const auto tmp235 = tmp234 / tmp49;
    const auto tmp236 = tmp235 * (tmp34 > tmp33 ? 1 : 0.0);
    const auto tmp237 = tmp60 * tmp160;
    const auto tmp238 = -1 * tmp237;
    const auto tmp239 = tmp238 / tmp58;
    const auto tmp240 = -1 * tmp239;
    const auto tmp241 = tmp67 * tmp240;
    const auto tmp242 = tmp241 + tmp236;
    const auto tmp243 = tmp242 * (tmp35 > tmp26 ? 1 : 0.0);
    const auto tmp244 = tmp73 * tmp170;
    const auto tmp245 = -1 * tmp244;
    const auto tmp246 = tmp245 / tmp71;
    const auto tmp247 = -1 * tmp246;
    const auto tmp248 = tmp80 * tmp247;
    const auto tmp249 = tmp248 + tmp243;
    const auto tmp250 = tmp249 * (tmp36 < tmp19 ? 1 : 0.0);
    const auto tmp251 = tmp87 * tmp179;
    const auto tmp252 = -1 * tmp251;
    const auto tmp253 = tmp252 / tmp84;
    const auto tmp254 = tmp93 * tmp253;
    const auto tmp255 = tmp254 + tmp250;
    const auto tmp256 = tmp255 * (tmp37 < tmp13 ? 1 : 0.0);
    const auto tmp257 = tmp100 * tmp187;
    const auto tmp258 = -1 * tmp257;
    const auto tmp259 = tmp258 / tmp97;
    const auto tmp260 = tmp106 * tmp259;
    const auto tmp261 = tmp260 + tmp256;
    const auto tmp262 = tmp261 * (tmp38 > tmp7 ? 1 : 0.0);
    const auto tmp263 = tmp111 * tmp235;
    const auto tmp264 = tmp263 + tmp262;
    const auto tmp265 = 3 * tmp264;
    const auto tmp266 = tmp265 / tmp0;
    const auto tmp267 = tmp266 * tmp48;
    const auto tmp268 = tmp147 * tmp218;
    const auto tmp269 = tmp268 + tmp267;
    const auto tmp270 = -1 * tmp269;
    const auto tmp271 = 0.5 * tmp270;
    const auto tmp272 = tmp154 * tmp153;
    const auto tmp273 = -1 * tmp272;
    const auto tmp274 = 2 + tmp273;
    const auto tmp275 = tmp274 / tmp49;
    const auto tmp276 = tmp275 * (tmp34 > tmp33 ? 1 : 0.0);
    const auto tmp277 = tmp161 * tmp160;
    const auto tmp278 = -1 * tmp277;
    const auto tmp279 = 2 + tmp278;
    const auto tmp280 = tmp279 / tmp58;
    const auto tmp281 = -1 * tmp280;
    const auto tmp282 = tmp67 * tmp281;
    const auto tmp283 = tmp282 + tmp276;
    const auto tmp284 = tmp283 * (tmp35 > tmp26 ? 1 : 0.0);
    const auto tmp285 = tmp171 * tmp170;
    const auto tmp286 = -1 * tmp285;
    const auto tmp287 = 2 + tmp286;
    const auto tmp288 = tmp287 / tmp71;
    const auto tmp289 = -1 * tmp288;
    const auto tmp290 = tmp80 * tmp289;
    const auto tmp291 = tmp290 + tmp284;
    const auto tmp292 = tmp291 * (tmp36 < tmp19 ? 1 : 0.0);
    const auto tmp293 = tmp180 * tmp179;
    const auto tmp294 = -1 * tmp293;
    const auto tmp295 = 2 + tmp294;
    const auto tmp296 = tmp295 / tmp84;
    const auto tmp297 = tmp93 * tmp296;
    const auto tmp298 = tmp297 + tmp292;
    const auto tmp299 = tmp298 * (tmp37 < tmp13 ? 1 : 0.0);
    const auto tmp300 = tmp188 * tmp187;
    const auto tmp301 = -1 * tmp300;
    const auto tmp302 = 2 + tmp301;
    const auto tmp303 = tmp302 / tmp97;
    const auto tmp304 = tmp106 * tmp303;
    const auto tmp305 = tmp304 + tmp299;
    const auto tmp306 = tmp305 * (tmp38 > tmp7 ? 1 : 0.0);
    const auto tmp307 = tmp111 * tmp275;
    const auto tmp308 = tmp307 + tmp306;
    const auto tmp309 = 3 * tmp308;
    const auto tmp310 = tmp309 / tmp0;
    const auto tmp311 = tmp310 * tmp48;
    const auto tmp312 = tmp228 * tmp218;
    const auto tmp313 = tmp312 + tmp311;
    const auto tmp314 = -1 * tmp313;
    const auto tmp315 = 0.5 * tmp314;
    ((result[ 0 ])[ 0 ])[ 0 ] = tmp151;
    ((result[ 0 ])[ 0 ])[ 1 ] = tmp232;
    ((result[ 0 ])[ 1 ])[ 0 ] = tmp271;
    ((result[ 0 ])[ 1 ])[ 1 ] = tmp315;
...
PYBIND11_MODULE( localfunction_98b04b00bb93b8c6da99c91867e597ca_a524c1196983e65de1c06d7d6afdeb44, module )
{
  typedef UFLLocalFunctions_98b04b00bb93b8c6da99c91867e597ca::UFLLocalFunction< typename Dune::FemPy::GridPart< Dune::Fem::FilteredGridPart< Dune::FemPy::GridPart< Dune::Fem::AdaptiveLeafGridPart< Dune::ALUGrid< 2, 2, Dune::simplex > > >, Dune::Fem::SimpleFilter< Dune::FemPy::GridPart< Dune::Fem::AdaptiveLeafGridPart< Dune::ALUGrid< 2, 2, Dune::simplex > > > >, true > > > LocalFunctionType;
  if constexpr( LocalFunctionType::gridPartValid )
  {
      auto cls = Dune::Python::insertClass<LocalFunctionType>(module,"UFLLocalFunction",Dune::Python::GenerateTypeName("UFLLocalFunctions_98b04b00bb93b8c6da99c91867e597ca::UFLLocalFunction< typename Dune::FemPy::GridPart< Dune::Fem::FilteredGridPart< Dune::FemPy::GridPart< Dune::Fem::AdaptiveLeafGridPart< Dune::ALUGrid< 2, 2, Dune::simplex > > >, Dune::Fem::SimpleFilter< Dune::FemPy::GridPart< Dune::Fem::AdaptiveLeafGridPart< Dune::ALUGrid< 2, 2, Dune::simplex > > > >, true > > >"), Dune::Python::IncludeFiles({"python/dune/generated/localfunction_98b04b00bb93b8c6da99c91867e597ca_a524c1196983e65de1c06d7d6afdeb44.cc"})).first;
