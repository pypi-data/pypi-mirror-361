...
class JoinGroupCall(TLRequest[TypeUpdates]):
    ...
    def __init__(
        ...
        key_fingerprint: Optional[int] = None
    ):
        ...
        Args:
            ...
            key_fingerprint (Optional[int], optional): ...
        """
    ...
    def to_bytes(self, boxed: bool=True):
        with Writer(b'\xf3\x1d\x1e\xd6' if boxed else b'') as writer:
            with writer.flag() as flags:
                ...
                if flags(self.key_fingerprint, 3):
