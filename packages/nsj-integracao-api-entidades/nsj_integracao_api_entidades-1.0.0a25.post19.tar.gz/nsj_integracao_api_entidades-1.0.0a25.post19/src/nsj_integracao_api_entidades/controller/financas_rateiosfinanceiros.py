...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/rateiosfinanceiros"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/rateiosfinanceiros/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/rateiosfinanceiros/verificacao-integridade"
