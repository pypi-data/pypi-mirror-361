...
def pipeline_data_connection_orm_to_proto(
    ...
    return models_pb2.PipelineDataConnection(
        ...
        data_connector=data_connector_orm_to_proto(orm_obj.data_connector),
...
def pipeline_data_connection_proto_to_orm(
    ...
    orm_obj = eorm.PipelineDataConnection(
        ...
        glob=proto_obj.glob,
        room_id=room_id,
        last_ingestion_time=proto_obj.last_ingestion_time.ToDatetime(),
        last_successful_ingestion_time=proto_obj.last_ingestion_time.ToDatetime(),
    )
    orm_obj = session.merge(orm_obj)
    return Ok(orm_obj)
...
def pipeline_data_connection_delete_orms(
