...
def GetInstanceObject(panelphase, i):
	...
	if subpanelname == 'View Dual-Array':
		object.append( panelphase.pipelineitems[i].input_1_filename.objectpath.GetValue() )
		object.append( panelphase.pipelineitems[i].input_2_filename.objectpath.GetValue() )
		object.append( panelphase.pipelineitems[i].rbampphase.GetStringSelection() )
		object.append( panelphase.pipelineitems[i].contour.value.GetValue() )
		object.append( panelphase.pipelineitems[i].opacity.value.GetValue() )
		object.append( panelphase.pipelineitems[i].phasemax.value.GetValue() )
		...
		object.append( panelphase.pipelineitems[i].meshsubiter.value.GetValue() )
		object.append( panelphase.pipelineitems[i].contour_support.value.GetValue() )
		object.append( panelphase.pipelineitems[i].opacity_support.value.GetValue() )
		object.append( panelphase.pipelineitems[i].feature_angle_support.value.GetValue() )
...
def SetInstanceObject(panelphase, instance, idx, subpanel_items):
	...
	if subpanelname in subpanel_items:
		...
		if subpanelname == 'View Array':
			...
			DoListCheck(panelphase, object, idx)
		if subpanelname == 'View Dual-Array':
			panelphase.pipelineitems.insert(idx, SubPanel_View_DualArray(panelphase.panel2, panelphase.ancestor))
			panelphase.pipelineitems[idx].Hide()
			panelphase.hbox2.Add(panelphase.pipelineitems[idx], 2, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=10)
			panelphase.pipelineitems[idx].input_1_filename.objectpath.SetValue(object[0])
			panelphase.pipelineitems[idx].input_2_filename.objectpath.SetValue(object[1])
			panelphase.pipelineitems[idx].rbampphase.SetStringSelection(object[2])
			panelphase.pipelineitems[idx].contour.value.SetValue(object[3])
			panelphase.pipelineitems[idx].opacity.value.SetValue(object[4])
			...
			panelphase.pipelineitems[idx].sx.value.SetValue(object[15])
			panelphase.pipelineitems[idx].sy.value.SetValue(object[16])
			panelphase.pipelineitems[idx].sz.value.SetValue(object[17])
			panelphase.pipelineitems[idx].axes_fontfactor.value.SetValue(object[18])
			panelphase.pipelineitems[idx].meshsubiter.value.SetValue(object[19])
			panelphase.pipelineitems[idx].contour_support.value.SetValue(object[20])
			panelphase.pipelineitems[idx].opacity_support.value.SetValue(object[21])
			panelphase.pipelineitems[idx].feature_angle_support.value.SetValue(object[22])
			panelphase.pipelineitems[idx].OnRadioSelect(None)
			DoListCheck(panelphase, object, idx)
		if subpanelname == 'View Object':
