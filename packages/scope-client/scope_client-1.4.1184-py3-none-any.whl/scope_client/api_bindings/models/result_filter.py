...
RESULTFILTER_ANY_OF_SCHEMAS = ["PostMetricsQueryResultFilter", "PostMetricsQueryResultFilterAndGroup", "PostMetricsQueryResultFilterOrGroup"]
...
class ResultFilter(BaseModel):
    ...
    anyof_schema_1_validator: Optional[PostMetricsQueryResultFilter] = None
    ...
    anyof_schema_3_validator: Optional[PostMetricsQueryResultFilterOrGroup] = None
    if TYPE_CHECKING:
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = ResultFilter.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ResultFilter with anyOf schemas: PostMetricsQueryResultFilter, PostMetricsQueryResultFilterAndGroup, PostMetricsQueryResultFilterOrGroup. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ResultFilter with anyOf schemas: PostMetricsQueryResultFilter, PostMetricsQueryResultFilterAndGroup, PostMetricsQueryResultFilterOrGroup. Details: " + ", ".join(error_messages))
        else:
            return instance
