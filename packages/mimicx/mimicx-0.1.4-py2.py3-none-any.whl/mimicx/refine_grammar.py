...
class RefineGrammar:
    ...
    def correct_document(self, query: str, lang: str = None, model: str = "DOCUMENT", 
...
def main():
    """
    Example usage of the SpeedPresta client.
    """
    # Initialize client
    client = MimicText()
    
    # Example text from your curl command
    text_to_correct = "Qu on ny pouvait plus réver car la société prend tous, même la liberté de penser"
    try:
        # Make the correction request
        result = client.correct_document(text_to_correct)
        print("Success!")
