...
from osn_selenium.webdrivers.Yandex.flags import (
	YandexFlags,
	YandexFlagsManager
)
...
from osn_selenium.webdrivers.Yandex.protocols import (
	TrioYandexWebDriverWrapperProtocol
)


class YandexWebDriver(ChromeWebDriver):
	"""
	Manages a Yandex Browser session using Selenium WebDriver.

	This class specializes ChromeWebDriver for Yandex Browser. It sets up and manages
	...
	def to_wrapper(self) -> TrioYandexWebDriverWrapperProtocol:
		"""
		...
		Returns:
			TrioYandexWebDriverWrapperProtocol: A TrioBrowserWebDriverWrapper instance wrapping this BrowserWebDriver.
		"""
