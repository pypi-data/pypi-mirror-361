...
class DistrictCaseRemedy(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "type", "judgmentSource", "awardedToPartyIds", "againstPartyIds", "docketEntryFiled", "negated", "reinstated", "docketEntryId", "negatedDocketEntryId", "reinstatedDocketEntryId"]
