...
class IndividualFindingsFilter(BaseModel):
    """
    ...
    patent_invalidity_reasons: Optional[PatentInvalidityReasonsFilter] = Field(default=None, alias="patentInvalidityReasons")
    __properties: ClassVar[List[str]] = ["judgmentSource", "nameType", "date", "awardedToParties", "awardedAgainstParties", "patentInvalidityReasons"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of patent_invalidity_reasons
        if self.patent_invalidity_reasons:
            _dict['patentInvalidityReasons'] = self.patent_invalidity_reasons.to_dict()
        ...
        # set to None if patent_invalidity_reasons (nullable) is None
        # and model_fields_set contains the field
        if self.patent_invalidity_reasons is None and "patent_invalidity_reasons" in self.model_fields_set:
            _dict['patentInvalidityReasons'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "patentInvalidityReasons": PatentInvalidityReasonsFilter.from_dict(obj["patentInvalidityReasons"]) if obj.get("patentInvalidityReasons") is not None else None
        })
        return _obj
