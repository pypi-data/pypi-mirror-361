...
class V1Beta1Photo(BaseModel):
    ...
    """ # noqa: E501
    approved_at: Optional[datetime] = Field(default=None, description="If non-NULL, when this photo was approved as being a good representation of the person it relates to", alias="approvedAt")
    approved_by: Optional[StrictStr] = Field(default=None, description="The identifier of the user who approved this photo - may not be known for legacy data", alias="approvedBy")
    ...
    id: StrictStr
    identifiers: List[V1Beta1PhotoIdentifierSummary]
    image_height: Optional[StrictInt] = Field(description="The height of the image", alias="imageHeight")
    image_width: Optional[StrictInt] = Field(description="The width of the image", alias="imageWidth")
    invalidated_at: Optional[datetime] = Field(default=None, description="If non-NULL, the date & time that the photo was invalidated", alias="invalidatedAt")
    invalidated_by: Optional[StrictStr] = Field(default=None, description="The identifier of the user who invalidated this photo.", alias="invalidatedBy")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="A freeform block of JSON metadata related to this photo")
    original_link: StrictStr = Field(alias="originalLink")
    review_postponed_at: Optional[datetime] = Field(default=None, description="If non-NULL, the date & time that the photo was last skipped during review process", alias="reviewPostponedAt")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # and model_fields_set contains the field
        if self.invalidated_by is None and "invalidated_by" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.review_postponed_at is None and "review_postponed_at" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "identifiers": [V1Beta1PhotoIdentifierSummary.from_dict(_item) for _item in obj["identifiers"]] if obj.get("identifiers") is not None else None,
            "imageHeight": obj.get("imageHeight"),
            "imageWidth": obj.get("imageWidth"),
            "invalidatedAt": obj.get("invalidatedAt"),
            "invalidatedBy": obj.get("invalidatedBy"),
            "metadata": obj.get("metadata"),
            "originalLink": obj.get("originalLink"),
            "reviewPostponedAt": obj.get("reviewPostponedAt"),
