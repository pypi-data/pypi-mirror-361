...
import pandas as pd
from .schemas.sick_leave import SickLeaveSchema
    ...
    def get(self,
        ...
        Args:
            ...
            skip (int, optional): Number of records to skip (OFFSET clause). Max 2000. Defaults to None.
                            Example: 0
            validate (bool, optional): Whether to validate the data against the SickLeaveSchema. Defaults to False.

        Returns:
            pd.DataFrame: DataFrame containing sick leave data
