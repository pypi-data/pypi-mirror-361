...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/numeros_docfis"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/numeros_docfis/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/numeros_docfis/verificacao-integridade"
