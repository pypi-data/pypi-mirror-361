...
class TAttributeUpdateReq(object):
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    ...
                    for _i297 in range(_size293):
                        ...
                        _val299 = TSchemaRegionAttributeInfo()
                        _val299.read(iprot)
                        self.attributeUpdateMap[_key298] = _val299
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributeUpdateMap is not None:
            ...
            for kiter300, viter301 in self.attributeUpdateMap.items():
                oprot.writeI32(kiter300)
...
class TRollbackSchemaBlackListReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i313 in range(_size309):
                        ...
                        _elem314.read(iprot)
                        self.schemaRegionIdList.append(_elem314)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter315 in self.schemaRegionIdList:
                iter315.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pathPatternTree is not None:
...
class TDeleteDataForDeleteSchemaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i327 in range(_size323):
                        ...
                        _elem328.read(iprot)
                        self.dataRegionIdList.append(_elem328)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.dataRegionIdList is not None:
            ...
            for iter329 in self.dataRegionIdList:
                iter329.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pathPatternTree is not None:
...
class TDeleteTimeSeriesReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i334 in range(_size330):
                        _elem335 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem335.read(iprot)
                        self.schemaRegionIdList.append(_elem335)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter336 in self.schemaRegionIdList:
                iter336.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pathPatternTree is not None:
...
class TConstructSchemaBlackListWithTemplateReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i341 in range(_size337):
                        _elem342 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem342.read(iprot)
                        self.schemaRegionIdList.append(_elem342)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i347 in range(_size343):
                        ...
                        for _i354 in range(_size350):
                            ...
                            _val349.append(_elem355)
                        iprot.readListEnd()
                        self.templateSetInfo[_key348] = _val349
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter356 in self.schemaRegionIdList:
                iter356.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.templateSetInfo is not None:
            ...
            for kiter357, viter358 in self.templateSetInfo.items():
                oprot.writeString(kiter357.encode('utf-8') if sys.version_info[0] == 2 else kiter357)
                oprot.writeListBegin(TType.I32, len(viter358))
...
class TRollbackSchemaBlackListWithTemplateReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i364 in range(_size360):
                        _elem365 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem365.read(iprot)
                        self.schemaRegionIdList.append(_elem365)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i370 in range(_size366):
                        ...
                        for _i377 in range(_size373):
                            ...
                            _val372.append(_elem378)
                        iprot.readListEnd()
                        self.templateSetInfo[_key371] = _val372
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter379 in self.schemaRegionIdList:
                iter379.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.templateSetInfo is not None:
            oprot.writeFieldBegin('templateSetInfo', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.LIST, len(self.templateSetInfo))
            for kiter380, viter381 in self.templateSetInfo.items():
                oprot.writeString(kiter380.encode('utf-8') if sys.version_info[0] == 2 else kiter380)
                oprot.writeListBegin(TType.I32, len(viter381))
                for iter382 in viter381:
...
class TDeactivateTemplateReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i387 in range(_size383):
                        _elem388 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem388.read(iprot)
                        self.schemaRegionIdList.append(_elem388)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i393 in range(_size389):
                        ...
                        for _i400 in range(_size396):
                            ...
                            _val395.append(_elem401)
                        iprot.readListEnd()
                        self.templateSetInfo[_key394] = _val395
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter402 in self.schemaRegionIdList:
                iter402.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.templateSetInfo is not None:
            oprot.writeFieldBegin('templateSetInfo', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.LIST, len(self.templateSetInfo))
            for kiter403, viter404 in self.templateSetInfo.items():
                oprot.writeString(kiter403.encode('utf-8') if sys.version_info[0] == 2 else kiter403)
                oprot.writeListBegin(TType.I32, len(viter404))
...
class TCheckSchemaRegionUsingTemplateReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i417 in range(_size413):
                        _elem418 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem418.read(iprot)
                        self.schemaRegionIdList.append(_elem418)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter419 in self.schemaRegionIdList:
                iter419.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TCheckTimeSeriesExistenceReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i424 in range(_size420):
                        _elem425 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem425.read(iprot)
                        self.schemaRegionIdList.append(_elem425)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            ...
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter426 in self.schemaRegionIdList:
                iter426.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TPushPipeMetaReq(object):
    ...
    def write(self, oprot):
        ...
        if self.pipeMetas is not None:
            ...
            for iter433 in self.pipeMetas:
                oprot.writeBinary(iter433)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TPushPipeMetaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i438 in range(_size434):
                        _elem439 = TPushPipeMetaRespExceptionMessage()
                        _elem439.read(iprot)
                        self.exceptionMessages.append(_elem439)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.exceptionMessages is not None:
            ...
            for iter440 in self.exceptionMessages:
                iter440.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TPushMultiPipeMetaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i445 in range(_size441):
                        ...
                        self.pipeMetas.append(_elem446)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i451 in range(_size447):
                        _elem452 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.pipeNamesToDrop.append(_elem452)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.pipeMetas is not None:
            oprot.writeFieldBegin('pipeMetas', TType.LIST, 1)
            oprot.writeListBegin(TType.STRING, len(self.pipeMetas))
            for iter453 in self.pipeMetas:
                oprot.writeBinary(iter453)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pipeNamesToDrop is not None:
            ...
            for iter454 in self.pipeNamesToDrop:
...
class TPushTopicMetaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i459 in range(_size455):
                        ...
                        self.topicMetas.append(_elem460)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.topicMetas is not None:
            ...
            for iter461 in self.topicMetas:
                oprot.writeBinary(iter461)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TPushMultiTopicMetaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i466 in range(_size462):
                        ...
                        self.topicMetas.append(_elem467)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i472 in range(_size468):
                        _elem473 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.topicNamesToDrop.append(_elem473)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.topicMetas is not None:
            oprot.writeFieldBegin('topicMetas', TType.LIST, 1)
            oprot.writeListBegin(TType.STRING, len(self.topicMetas))
            for iter474 in self.topicMetas:
        ...
        if self.topicNamesToDrop is not None:
            ...
            for iter475 in self.topicNamesToDrop:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i480 in range(_size476):
                        _elem481 = TPushTopicMetaRespExceptionMessage()
                        _elem481.read(iprot)
...
class TPushConsumerGroupMetaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i487 in range(_size483):
                        ...
                        self.consumerGroupMetas.append(_elem488)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.consumerGroupMetas is not None:
            ...
            for iter489 in self.consumerGroupMetas:
                oprot.writeBinary(iter489)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TPushConsumerGroupMetaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i494 in range(_size490):
                        _elem495 = TPushConsumerGroupMetaRespExceptionMessage()
                        _elem495.read(iprot)
                        self.exceptionMessages.append(_elem495)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.exceptionMessages is not None:
            oprot.writeFieldBegin('exceptionMessages', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.exceptionMessages))
            for iter496 in self.exceptionMessages:
                iter496.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TRollbackViewSchemaBlackListReq(object):
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter510 in self.schemaRegionIdList:
                iter510.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pathPatternTree is not None:
...
class TDeleteViewSchemaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i515 in range(_size511):
                        _elem516 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem516.read(iprot)
                        self.schemaRegionIdList.append(_elem516)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter517 in self.schemaRegionIdList:
                iter517.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pathPatternTree is not None:
...
class TAlterViewReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i522 in range(_size518):
                        _elem523 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem523.read(iprot)
                        self.schemaRegionIdList.append(_elem523)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i528 in range(_size524):
                        ...
                        self.viewBinaryList.append(_elem529)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter530 in self.schemaRegionIdList:
                iter530.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.viewBinaryList is not None:
            ...
            for iter531 in self.viewBinaryList:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i536 in range(_size532):
                        ...
                        self.tsDataset.append(_elem537)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
...
class TFetchTimeseriesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i543 in range(_size539):
                        ...
                        self.columnNameList.append(_elem544)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i549 in range(_size545):
                        ...
                        self.columnTypeList.append(_elem550)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.MAP:
                    ...
                    for _i555 in range(_size551):
                        _key556 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val557 = iprot.readI32()
                        self.columnNameIndexMap[_key556] = _val557
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.LIST:
                    ...
                    for _i562 in range(_size558):
                        ...
                        self.tsDataset.append(_elem563)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.columnNameList is not None:
            ...
            for iter564 in self.columnNameList:
        ...
        if self.columnTypeList is not None:
            ...
            for iter565 in self.columnTypeList:
        ...
        if self.columnNameIndexMap is not None:
            ...
            for kiter566, viter567 in self.columnNameIndexMap.items():
                oprot.writeString(kiter566.encode('utf-8') if sys.version_info[0] == 2 else kiter566)
                oprot.writeI32(viter567)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.tsDataset is not None:
            oprot.writeFieldBegin('tsDataset', TType.LIST, 6)
            oprot.writeListBegin(TType.STRING, len(self.tsDataset))
            for iter568 in self.tsDataset:
                oprot.writeBinary(iter568)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.hasMoreData is not None:
...
class TOperatorStatistics(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i573 in range(_size569):
                        _key574 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val575 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.specifiedInfo[_key574] = _val575
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.specifiedInfo is not None:
            ...
            for kiter576, viter577 in self.specifiedInfo.items():
...
class TFetchFragmentInstanceStatisticsResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i582 in range(_size578):
                        _key583 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val584 = TOperatorStatistics()
                        _val584.read(iprot)
                        self.operatorStatisticsMap[_key583] = _val584
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
    ...
    def write(self, oprot):
        ...
        if self.operatorStatisticsMap is not None:
            ...
            for kiter585, viter586 in self.operatorStatisticsMap.items():
