...
class LobbyMessageResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "content", "lobby_id", "channel_id", "author", "metadata", "flags", "application_id"]
    ...
    def lobby_id_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^(0|[1-9][0-9]*)$", value):
            raise ValueError(r"must validate the regular expression /^(0|[1-9][0-9]*)$/")
        return value
