...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/negociacoes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/negociacoes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/negociacoes/verificacao-integridade"
