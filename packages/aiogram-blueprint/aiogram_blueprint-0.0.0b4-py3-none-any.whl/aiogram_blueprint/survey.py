...
QUESTIONS = {
    "run_type": "Choose how the bot should be launched:",
    "components": "Select the components to include in your project:",
    "db_type": "Choose the type of database to use:",
    "add_admin": "Would you like to include a Web Admin Panel?",
    "admin_auth": "Select the authentication method for the Web Admin Panel:"
}
