...
region_lang_codes = {
        # "CN":  {"phone_code": 86,  "lang_code": "zh",  "system_lang_code": "zh_Hans"},   # 中国
        "NG":  {"phone_code": 234, "lang_code": "ig",  "system_lang_code": "ig_NG"},   # 尼日利亚
        "US":  {"phone_code": 1,   "lang_code": "en",  "system_lang_code": "en-US"},   # 美国 
        # "CA":  {"phone_code": 1,   "lang_code": "en",  "system_lang_code": "en-CA"},   # 加拿大
        # "RU":  {"phone_code": 7,   "lang_code": "ru",  "system_lang_code": "ru-RU"},   # 俄罗斯
        "EG":  {"phone_code": 20,  "lang_code": "ar",  "system_lang_code": "ar_ar"},   # 埃及
        "MA":  {"phone_code": 212, "lang_code": "ta",  "system_lang_code": "ta_MM"},   # 摩洛哥
        # "SV":  {"phone_code": 503, "lang_code": "es",  "system_lang_code": "es_SV"},  # 萨尔瓦多
        # "BR":  {"phone_code": 55,  "lang_code": "pt",  "system_lang_code": "pt_BR"},  # 巴西
        # "PH":  {"phone_code": 63,  "lang_code": "ta",  "system_lang_code": "ta_PH"},  # 菲律宾
        # "MM":  {"phone_code": 95,  "lang_code": "ta",  "system_lang_code": "ta_MM"},  # 缅甸
        "IL":  {"phone_code": 972,  "lang_code": "as",  "system_lang_code": "as_IN"},  # 以色列
        # "TN":  {"phone_code": 216,  "lang_code": "ar",  "system_lang_code": "ar_TN"},  # 突尼斯
        "ID":  {"phone_code": 62,  "lang_code": "id",  "system_lang_code": "id_ID"},  # 印度尼西亚
        # "AT":  {"phone_code": 43,  "lang_code": "de",  "system_lang_code": "de_AT"},  # 奥地利
        # "PK":  {"phone_code": 92,  "lang_code": "en",  "system_lang_code": "en_PK"},  # 巴基斯坦
        # "BD":  {"phone_code": 880,  "lang_code": "bn",  "system_lang_code": "bn_BD"},  # 孟加拉
        # "AZ":  {"phone_code": 994,  "lang_code": "az",  "system_lang_code": "az_Latn"},  # 阿塞拜疆
        # "UZ":  {"phone_code": 998,  "lang_code": "uz",  "system_lang_code": "uz_UZ"},  # 乌兹别克斯坦
        # "VN":  {"phone_code": 84,  "lang_code": "vi",  "system_lang_code": "vi_VN"},  # 越南
        # "JP":  {"phone_code": 81,  "lang_code": "ja",  "system_lang_code": "ja_JP"},  # 日本
        "KE":  {"phone_code": 254,  "lang_code": "ki",  "system_lang_code": "ki_KE"},  # 肯尼亚
        "IR":  {"phone_code": 98,  "lang_code": "as",  "system_lang_code": "as_IN"},  # 伊朗
        # "ZA":  {"phone_code": 27,  "lang_code": "zu",  "system_lang_code": "zu_ZA"},  # 南非
        # "LV":  {"phone_code": 371,  "lang_code": "lv",  "system_lang_code": "lv_LV"},  # 拉脱维亚
        # "PL":  {"phone_code": 48,  "lang_code": "pl",  "system_lang_code": "pl_PL"},  # 波兰
        # "DE":  {"phone_code": 49,  "lang_code": "de",  "system_lang_code": "de"},  # 德国
        # "CO":  {"phone_code": 57,  "lang_code": "es",  "system_lang_code": "es_CO"},  # 哥伦比亚
        # "MX":  {"phone_code": 52,  "lang_code": "es",  "system_lang_code": "es_MX"},  # 墨西哥
        # "VE":  {"phone_code": 52,  "lang_code": "es",  "system_lang_code": "es_VE"},  # 委内瑞拉
        # "HK":  {"phone_code": 852,  "lang_code": "zh",  "system_lang_code": "zh_HK"},  # 香港
        # "KH":  {"phone_code": 855,  "lang_code": "km",  "system_lang_code": "km_KH"},  # 柬埔寨
        # "DZ":  {"phone_code": 213,  "lang_code": "ar",  "system_lang_code": "ar_DZ"},  # 阿尔及利亚
        # "LY":  {"phone_code": 218,  "lang_code": "ar",  "system_lang_code": "ar_LY"},  # 利比亚
        # "TH":  {"phone_code": 61,  "lang_code": "th",  "system_lang_code": "th"},  # 泰国
        # "SE":  {"phone_code": 46,  "lang_code": "sv",  "system_lang_code": "sv_SE"},  # 瑞典
        # "AO":  {"phone_code": 244,  "lang_code": "pt",  "system_lang_code": "pt_AO"},  # 安哥拉
        # "IN":  {"phone_code": 91,  "lang_code": "as",  "system_lang_code": "as_IN"},  # 印度
        # "NL":  {"phone_code": 31,  "lang_code": "nl",  "system_lang_code": "nl_NL"},  # 荷兰
        # "LU":  {"phone_code": 352,  "lang_code": "pt",  "system_lang_code": "pt_LU"},  # 葡萄牙
        # "CH":  {"phone_code": 41,  "lang_code": "de",  "system_lang_code": "de_CH"},  # 瑞士
        # "AE":  {"phone_code": 971,  "lang_code": "ar",  "system_lang_code": "ar_AE"},  # 阿联酋
    }
...
def getByRegion(
    ...
    """
        通过地区生成api参数,
    """
    region_lang_code = region_lang_codes.get(region) or region_lang_codes.get('US')

    if system.lower() in ['macos','linux','windows']:
        api = API.TelegramDesktop.Generate(system=system.lower(), unique_id=unique_id)
    elif system and system.lower() == 'android':
        api = API.TelegramAndroid.Generate(unique_id=unique_id)
    elif system and system.lower() == 'androidx':
        api = API.TelegramAndroidX.Generate(unique_id=unique_id)
    elif system and system.lower() == 'ios':
        api = API.TelegramIOS.Generate(unique_id=unique_id)
    elif system and system.lower() == 'web_z':
        api = API.TelegramWeb_Z.Generate(unique_id=unique_id)
    elif system and system.lower() == 'web_k':
        api = API.TelegramWeb_K.Generate(unique_id=unique_id)
    elif system and system.lower() == 'web_oram':
        api = API.Webogram.Generate(unique_id=unique_id)
    else:
        raise Exception(f"未知的 {system}")
    
    if api_id:  api.api_id = api_id
    if api_hash:  api.api_hash = api_hash
    
    if lang_pack: api.lang_pack=lang_pack
    if device_model: api.device_model=device_model
    if system_version: api.system_version=system_version
    if app_version: api.app_version = app_version
    api.lang_code=region_lang_code.get('lang_code')
    api.system_lang_code = region_lang_code.get('system_lang_code')
    return api