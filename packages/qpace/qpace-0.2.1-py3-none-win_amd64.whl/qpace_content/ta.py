...
`accdist() -> float`
    """
    return _lib.Incr_fn_accdist_f54e18(ctx=ctx, ).collect()
...
`accdist() -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_accdist_f54e18(ctx, )
...
`cum(series<float> src) -> float`
    """
    return _lib.Incr_fn_cum_0d34a5(ctx=ctx, ).collect(_11809_src=src)
...
`cum(series<float> src) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_cum_0d34a5(ctx, )
        self.locals = CumLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_11809_src=src)
...
`change(series<float> src) -> series<float>`
    """
    return _lib.Incr_fn_change_197235(ctx=ctx, ).collect(_11811_src=src)
...
`change(series<float> src) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_change_197235(ctx, )
        self.locals = ChangeLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_11811_src=src)
...
`barssince(series<bool> condition) -> int`
    """
    return _lib.Incr_fn_barssince_9952fc(ctx=ctx, ).collect(_11813_condition=condition)
...
`barssince(series<bool> condition) -> int`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_barssince_9952fc(ctx, )
        self.locals = BarssinceLocals(self.inner)

    def next(self, condition: bool) -> Optional[int]:
        return self.inner.next(_11813_condition=condition)
...
`roc(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_roc_8aa57a(ctx=ctx, ).collect(_11815_src=src, _11816_length=length)
...
`roc(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_roc_8aa57a(ctx, )
        self.locals = RocLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11815_src=src, _11816_length=length)
...
`crossover(series<float> source1, series<float> source2) -> bool`
    """
    return _lib.Incr_fn_crossover_de5cf3(ctx=ctx, ).collect(_11818_source1=source1, _11819_source2=source2)
...
`crossover(series<float> source1, series<float> source2) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_crossover_de5cf3(ctx, )
        self.locals = CrossoverLocals(self.inner)

    def next(self, source1: float, source2: float) -> Optional[bool]:
        return self.inner.next(_11818_source1=source1, _11819_source2=source2)
...
`crossunder(series<float> source1, series<float> source2) -> bool`
    """
    return _lib.Incr_fn_crossunder_26e8d8(ctx=ctx, ).collect(_11821_source1=source1, _11822_source2=source2)
...
`crossunder(series<float> source1, series<float> source2) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_crossunder_26e8d8(ctx, )
        self.locals = CrossunderLocals(self.inner)

    def next(self, source1: float, source2: float) -> Optional[bool]:
        return self.inner.next(_11821_source1=source1, _11822_source2=source2)
...
`cross(series<float> source1, series<float> source2) -> bool`
    """
    return _lib.Incr_fn_cross_fd1599(ctx=ctx, ).collect(_11824_source1=source1, _11825_source2=source2)
...
`cross(series<float> source1, series<float> source2) -> bool`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_cross_fd1599(ctx, )
        self.locals = CrossLocals(self.inner)

    def next(self, source1: float, source2: float) -> Optional[bool]:
        return self.inner.next(_11824_source1=source1, _11825_source2=source2)
...
`highestbars(series<float> src, int length = 14) -> int`
    """
    return _lib.Incr_fn_highestbars_a2a267(ctx=ctx, ).collect(_11827_src=src, _11828_length=length)
...
`highestbars(series<float> src, int length = 14) -> int`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_highestbars_a2a267(ctx, )
        self.locals = HighestbarsLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[int]:
        return self.inner.next(_11827_src=src, _11828_length=length)
...
`lowestbars(series<float> src, int length = 14) -> int`
    """
    return _lib.Incr_fn_lowestbars_2f68d5(ctx=ctx, ).collect(_11830_src=src, _11831_length=length)
...
`lowestbars(series<float> src, int length = 14) -> int`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_lowestbars_2f68d5(ctx, )
        self.locals = LowestbarsLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[int]:
        return self.inner.next(_11830_src=src, _11831_length=length)
...
`highest(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_highest_002aa4(ctx=ctx, ).collect(_11833_src=src, _11834_length=length)
...
`highest(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_highest_002aa4(ctx, )
        self.locals = HighestLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11833_src=src, _11834_length=length)
...
`lowest(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_lowest_e9bc36(ctx=ctx, ).collect(_11836_src=src, _11837_length=length)
...
`lowest(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_lowest_e9bc36(ctx, )
        self.locals = LowestLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11836_src=src, _11837_length=length)
...
`swma(series<float> src) -> float`
    """
    return _lib.Incr_fn_swma_cdab59(ctx=ctx, ).collect(_11839_src=src)
...
`swma(series<float> src) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_swma_cdab59(ctx, )
        self.locals = SwmaLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_11839_src=src)
...
`sma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_sma_6783f4(ctx=ctx, ).collect(_11841_src=src, _11842_length=length)
...
`sma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_sma_6783f4(ctx, )
        self.locals = SmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11841_src=src, _11842_length=length)
...
`ema(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_ema_ced39c(ctx=ctx, ).collect(_11844_src=src, _11845_length=length)
...
`ema(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_ema_ced39c(ctx, )
        self.locals = EmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11844_src=src, _11845_length=length)
...
`rma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_rma_2dead7(ctx=ctx, ).collect(_11847_src=src, _11848_length=length)
...
`rma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_rma_2dead7(ctx, )
        self.locals = RmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11847_src=src, _11848_length=length)
...
`wma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_wma_656252(ctx=ctx, ).collect(_11850_src=src, _11851_length=length)
...
`wma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_wma_656252(ctx, )
        self.locals = WmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11850_src=src, _11851_length=length)
...
`lwma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_lwma_4d600f(ctx=ctx, ).collect(_11853_src=src, _11854_length=length)
...
`lwma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_lwma_4d600f(ctx, )
        self.locals = LwmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11853_src=src, _11854_length=length)
...
`hma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_hma_2a7c25(ctx=ctx, ).collect(_11856_src=src, _11857_length=length)
...
`hma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_hma_2a7c25(ctx, )
        self.locals = HmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11856_src=src, _11857_length=length)
...
`vwma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_vwma_e6754d(ctx=ctx, ).collect(_11859_src=src, _11860_length=length)
...
`vwma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_vwma_e6754d(ctx, )
        self.locals = VwmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11859_src=src, _11860_length=length)
...
`dev(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_dev_6fb05e(ctx=ctx, ).collect(_11862_src=src, _11863_length=length)
...
`dev(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_dev_6fb05e(ctx, )
        self.locals = DevLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11862_src=src, _11863_length=length)
...
`tr(bool handle_na = true) -> series<float>`
    """
    return _lib.Incr_fn_tr_43981c(ctx=ctx, ).collect(_11865_handle_na=handle_na)
...
`atr(int length = 14) -> float`
    """
    return _lib.Incr_fn_atr_675ea8(ctx=ctx, ).collect(_11867_length=length)
...
`rsi(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_rsi_c5a64d(ctx=ctx, ).collect(_11869_src=src, _11870_length=length)
...
`rsi(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_rsi_c5a64d(ctx, )
        self.locals = RsiLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11869_src=src, _11870_length=length)
...
`cci(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_cci_16ad30(ctx=ctx, ).collect(_11872_src=src, _11873_length=length)
...
`cci(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_cci_16ad30(ctx, )
        self.locals = CciLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11872_src=src, _11873_length=length)
...
`stdev(series<float> src, int length, bool biased = true) -> float`
    """
    return _lib.Incr_fn_stdev_829075(ctx=ctx, ).collect(_11875_src=src, _11876_length=length, _11877_biased=biased)
...
`stdev(series<float> src, int length, bool biased = true) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_stdev_829075(ctx, )
        self.locals = StdevLocals(self.inner)

    def next(self, src: float, length: int, biased: Optional[bool] = None) -> Optional[float]:
        return self.inner.next(_11875_src=src, _11876_length=length, _11877_biased=biased)
...
`aroon(int length = 14) -> [float, float]`
    """
    return _lib.Incr_fn_aroon_ef4f8c(ctx=ctx, ).collect(_11879_length=length)
...
`supertrend(series<float> src, float factor, int atr_period) -> [float, int]`
    """
    return _lib.Incr_fn_supertrend_073dae(ctx=ctx, ).collect(_11881_src=src, _11882_factor=factor, _11883_atr_period=atr_period)
...
`supertrend(series<float> src, float factor, int atr_period) -> [float, int]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_supertrend_073dae(ctx, )
        self.locals = SupertrendLocals(self.inner)

    def next(self, src: float, factor: float, atr_period: int) -> Optional[Tuple[float, int]]:
        return self.inner.next(_11881_src=src, _11882_factor=factor, _11883_atr_period=atr_period)
...
`awesome_oscillator(series<float> src, int slow_length = 5, int fast_length = 34) -> float`
    """
    return _lib.Incr_fn_awesome_oscillator_61d727(ctx=ctx, ).collect(_11885_src=src, _11886_slow_length=slow_length, _11887_fast_length=fast_length)
...
`awesome_oscillator(series<float> src, int slow_length = 5, int fast_length = 34) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_awesome_oscillator_61d727(ctx, )
    ...
    def next(self, src: float, slow_length: Optional[int] = None, fast_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11885_src=src, _11886_slow_length=slow_length, _11887_fast_length=fast_length)
...
`balance_of_power() -> float`
    """
    return _lib.Incr_fn_balance_of_power_84732d(ctx=ctx, ).collect()
...
`balance_of_power() -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_balance_of_power_84732d(ctx, )
...
`bollinger_bands_pct_b(series<float> src, int length = 20, float mult = 2.0) -> float`
    """
    return _lib.Incr_fn_bollinger_bands_pct_b_937a7b(ctx=ctx, ).collect(_11892_src=src, _11893_length=length, _11894_mult=mult)
...
`bollinger_bands_pct_b(series<float> src, int length = 20, float mult = 2.0) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bollinger_bands_pct_b_937a7b(ctx, )
    ...
    def next(self, src: float, length: Optional[int] = None, mult: Optional[float] = None) -> Optional[float]:
        return self.inner.next(_11892_src=src, _11893_length=length, _11894_mult=mult)
...
`bollinger_bands_width(series<float> src, int length = 20, float mult = 2.0) -> float`
    """
    return _lib.Incr_fn_bollinger_bands_width_ab65f5(ctx=ctx, ).collect(_11901_src=src, _11902_length=length, _11903_mult=mult)
...
`bollinger_bands_width(series<float> src, int length = 20, float mult = 2.0) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bollinger_bands_width_ab65f5(ctx, )
        self.locals = BollingerBandsWidthLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None, mult: Optional[float] = None) -> Optional[float]:
        return self.inner.next(_11901_src=src, _11902_length=length, _11903_mult=mult)
...
`bollinger_bands(series<float> src, int length = 20, float mult = 2.0) -> [float, float]`
    """
    return _lib.Incr_fn_bollinger_bands_967162(ctx=ctx, ).collect(_11910_src=src, _11911_length=length, _11912_mult=mult)
...
`bollinger_bands(series<float> src, int length = 20, float mult = 2.0) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bollinger_bands_967162(ctx, )
    ...
    def next(self, src: float, length: Optional[int] = None, mult: Optional[float] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_11910_src=src, _11911_length=length, _11912_mult=mult)
...
`chaikin_money_flow(int length = 20) -> float`
    """
    return _lib.Incr_fn_chaikin_money_flow_4d9fa7(ctx=ctx, ).collect(_11918_length=length)
...
class ChaikinMoneyFlowLocals:
    ...
    def cumVol(self) -> float:
        return self.__inner._11919_cumVol()
...
`chaikin_money_flow(int length = 20) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_chaikin_money_flow_4d9fa7(ctx, )
        self.locals = ChaikinMoneyFlowLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11918_length=length)
...
`chande_kroll_stop(int atr_length = 10, float atr_coeff = 1.0, int stop_length = 9) -> [float, float]`
    """
    return _lib.Incr_fn_chande_kroll_stop_762e80(ctx=ctx, ).collect(_11923_atr_length=atr_length, _11924_atr_coeff=atr_coeff, _11925_stop_length=stop_length)
...
`chande_kroll_stop(int atr_length = 10, float atr_coeff = 1.0, int stop_length = 9) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_chande_kroll_stop_762e80(ctx, )
    ...
    def next(self, atr_length: Optional[int] = None, atr_coeff: Optional[float] = None, stop_length: Optional[int] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_11923_atr_length=atr_length, _11924_atr_coeff=atr_coeff, _11925_stop_length=stop_length)
...
`choppiness_index(int length = 14) -> float`
    """
    return _lib.Incr_fn_choppiness_index_f03e96(ctx=ctx, ).collect(_11934_length=length)
...
`choppiness_index(int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_choppiness_index_f03e96(ctx, )
        self.locals = ChoppinessIndexLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11934_length=length)
...
`connors_rsi(series<float> src, int rsi_length = 3, int up_down_length = 2, int roc_length = 100) -> float`
    """
    return _lib.Incr_fn_connors_rsi_0e5621(ctx=ctx, ).collect(_11941_src=src, _11942_rsi_length=rsi_length, _11943_up_down_length=up_down_length, _11944_roc_length=roc_length)
...
`connors_rsi(series<float> src, int rsi_length = 3, int up_down_length = 2, int roc_length = 100) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_connors_rsi_0e5621(ctx, )
    ...
    def next(self, src: float, rsi_length: Optional[int] = None, up_down_length: Optional[int] = None, roc_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11941_src=src, _11942_rsi_length=rsi_length, _11943_up_down_length=up_down_length, _11944_roc_length=roc_length)
...
`coppock_curve(series<float> src, int wma_length = 10, int long_roc_length = 14, int short_roc_length = 11) -> float`
    """
    return _lib.Incr_fn_coppock_curve_ca0b13(ctx=ctx, ).collect(_11950_src=src, _11951_wma_length=wma_length, _11952_long_roc_length=long_roc_length, _11953_short_roc_length=short_roc_length)
...
`coppock_curve(series<float> src, int wma_length = 10, int long_roc_length = 14, int short_roc_length = 11) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_coppock_curve_ca0b13(ctx, )
    ...
    def next(self, src: float, wma_length: Optional[int] = None, long_roc_length: Optional[int] = None, short_roc_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11950_src=src, _11951_wma_length=wma_length, _11952_long_roc_length=long_roc_length, _11953_short_roc_length=short_roc_length)
...
`donchian_channel(series<float> src, int length = 20) -> [float, float, float]`
    """
    return _lib.Incr_fn_donchian_channel_ad4f0a(ctx=ctx, ).collect(_11955_src=src, _11956_length=length)
...
`donchian_channel(series<float> src, int length = 20) -> [float, float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_donchian_channel_ad4f0a(ctx, )
    ...
    def next(self, src: float, length: Optional[int] = None) -> Optional[Tuple[float, float, float]]:
        return self.inner.next(_11955_src=src, _11956_length=length)
...
`macd(series<float> src, int short_length = 12, int long_length = 26) -> float`
    """
    return _lib.Incr_fn_macd_c17e55(ctx=ctx, ).collect(_11961_src=src, _11962_short_length=short_length, _11963_long_length=long_length)
...
`macd(series<float> src, int short_length = 12, int long_length = 26) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_macd_c17e55(ctx, )
    ...
    def next(self, src: float, short_length: Optional[int] = None, long_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11961_src=src, _11962_short_length=short_length, _11963_long_length=long_length)
...
`price_oscillator(series<float> src, int short_length = 12, int long_length = 26) -> float`
    """
    return _lib.Incr_fn_price_oscillator_2a59ee(ctx=ctx, ).collect(_11966_src=src, _11967_short_length=short_length, _11968_long_length=long_length)
...
`price_oscillator(series<float> src, int short_length = 12, int long_length = 26) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_price_oscillator_2a59ee(ctx, )
        self.locals = PriceOscillatorLocals(self.inner)

    def next(self, src: float, short_length: Optional[int] = None, long_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11966_src=src, _11967_short_length=short_length, _11968_long_length=long_length)
...
`relative_vigor_index(int length = 14) -> float`
    """
    return _lib.Incr_fn_relative_vigor_index_9227cd(ctx=ctx, ).collect(_11973_length=length)
...
`relative_vigor_index(int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_relative_vigor_index_9227cd(ctx, )
        self.locals = RelativeVigorIndexLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11973_length=length)
...
`relative_volatility_index(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_relative_volatility_index_e970f7(ctx=ctx, ).collect(_11975_src=src, _11976_length=length)
...
`relative_volatility_index(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_relative_volatility_index_e970f7(ctx, )
        self.locals = RelativeVolatilityIndexLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11975_src=src, _11976_length=length)
...
`stochastic_rsi(series<float> src, int stoch_length = 14, int rsi_length = 14, int k = 3, int d = 3) -> [float, float]`
    """
    return _lib.Incr_fn_stochastic_rsi_afd35d(ctx=ctx, ).collect(_11982_src=src, _11983_stoch_length=stoch_length, _11984_rsi_length=rsi_length, _11985_k=k, _11986_d=d)
...
`stochastic_rsi(series<float> src, int stoch_length = 14, int rsi_length = 14, int k = 3, int d = 3) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_stochastic_rsi_afd35d(ctx, )
    ...
    def next(self, src: float, stoch_length: Optional[int] = None, rsi_length: Optional[int] = None, k: Optional[int] = None, d: Optional[int] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_11982_src=src, _11983_stoch_length=stoch_length, _11984_rsi_length=rsi_length, _11985_k=k, _11986_d=d)
...
`ultimate_oscillator(int fast_length = 7, int medium_length = 14, int slow_length = 28) -> float`
    """
    return _lib.Incr_fn_ultimate_oscillator_abbcb4(ctx=ctx, ).collect(_11995_fast_length=fast_length, _11996_medium_length=medium_length, _11997_slow_length=slow_length)
...
`ultimate_oscillator(int fast_length = 7, int medium_length = 14, int slow_length = 28) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_ultimate_oscillator_abbcb4(ctx, )
    ...
    def next(self, fast_length: Optional[int] = None, medium_length: Optional[int] = None, slow_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_11995_fast_length=fast_length, _11996_medium_length=medium_length, _11997_slow_length=slow_length)
...
`volume_oscillator(int short_length = 5, int long_length = 10) -> float`
    """
    return _lib.Incr_fn_volume_oscillator_3019dd(ctx=ctx, ).collect(_12007_short_length=short_length, _12008_long_length=long_length)
...
`volume_oscillator(int short_length = 5, int long_length = 10) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_volume_oscillator_3019dd(ctx, )
    ...
    def next(self, short_length: Optional[int] = None, long_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_12007_short_length=short_length, _12008_long_length=long_length)
...
`vortex_indicator(int length = 14) -> [float, float]`
    """
    return _lib.Incr_fn_vortex_indicator_1ec133(ctx=ctx, ).collect(_12013_length=length)
...
`vortex_indicator(int length = 14) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_vortex_indicator_1ec133(ctx, )
        self.locals = VortexIndicatorLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_12013_length=length)
...
`williams_pct_r(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_williams_pct_r_b5abdc(ctx=ctx, ).collect(_12020_src=src, _12021_length=length)
...
`williams_pct_r(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_williams_pct_r_b5abdc(ctx, )
        self.locals = WilliamsPctRLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_12020_src=src, _12021_length=length)
...
`advance_decline_ratio(int length = 9) -> float`
    """
    return _lib.Incr_fn_advance_decline_ratio_2dcab4(ctx=ctx, ).collect(_12026_length=length)
...
`advance_decline_ratio(int length = 9) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_advance_decline_ratio_2dcab4(ctx, )
        self.locals = AdvanceDeclineRatioLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_12026_length=length)
...
`detrended_price_oscillator(int length = 21, bool centered = false) -> series<float>`
    """
    return _lib.Incr_fn_detrended_price_oscillator_063ba6(ctx=ctx, ).collect(_12032_length=length, _12033_centered=centered)
...
`detrended_price_oscillator(int length = 21, bool centered = false) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_detrended_price_oscillator_063ba6(ctx, )
    ...
    def next(self, length: Optional[int] = None, centered: Optional[bool] = None) -> Optional[float]:
        return self.inner.next(_12032_length=length, _12033_centered=centered)
...
`bull_bear_power(int length = 13) -> series<float>`
    """
    return _lib.Incr_fn_bull_bear_power_388bc3(ctx=ctx, ).collect(_12038_length=length)
...
`bull_bear_power(int length = 13) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bull_bear_power_388bc3(ctx, )
        self.locals = BullBearPowerLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_12038_length=length)
...
`absolute_price_oscillator(series<float> src, int fast_length = 12, int slow_length = 26) -> float`
    """
    return _lib.Incr_fn_absolute_price_oscillator_a38e89(ctx=ctx, ).collect(_12044_src=src, _12045_fast_length=fast_length, _12046_slow_length=slow_length)
...
`absolute_price_oscillator(series<float> src, int fast_length = 12, int slow_length = 26) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_absolute_price_oscillator_a38e89(ctx, )
    ...
    def next(self, src: float, fast_length: Optional[int] = None, slow_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_12044_src=src, _12045_fast_length=fast_length, _12046_slow_length=slow_length)
...
`know_sure_thing(series<float> src, int roc_length1 = 10, int roc_length2 = 15, int roc_length3 = 20, int roc_length4 = 30, int sma_length1 = 10, int sma_length2 = 10, int sma_length3 = 10, int sma_length4 = 15, int sig_length = 9) -> [float, float]`
    """
    return _lib.Incr_fn_know_sure_thing_5aa958(ctx=ctx, ).collect(_12050_src=src, _12051_roc_length1=roc_length1, _12052_roc_length2=roc_length2, _12053_roc_length3=roc_length3, _12054_roc_length4=roc_length4, _12055_sma_length1=sma_length1, _12056_sma_length2=sma_length2, _12057_sma_length3=sma_length3, _12058_sma_length4=sma_length4, _12059_sig_length=sig_length)
...
`know_sure_thing(series<float> src, int roc_length1 = 10, int roc_length2 = 15, int roc_length3 = 20, int roc_length4 = 30, int sma_length1 = 10, int sma_length2 = 10, int sma_length3 = 10, int sma_length4 = 15, int sig_length = 9) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_know_sure_thing_5aa958(ctx, )
    ...
    def next(self, src: float, roc_length1: Optional[int] = None, roc_length2: Optional[int] = None, roc_length3: Optional[int] = None, roc_length4: Optional[int] = None, sma_length1: Optional[int] = None, sma_length2: Optional[int] = None, sma_length3: Optional[int] = None, sma_length4: Optional[int] = None, sig_length: Optional[int] = None) -> Optional[Tuple[float, float]]:
        return self.inner.next(_12050_src=src, _12051_roc_length1=roc_length1, _12052_roc_length2=roc_length2, _12053_roc_length3=roc_length3, _12054_roc_length4=roc_length4, _12055_sma_length1=sma_length1, _12056_sma_length2=sma_length2, _12057_sma_length3=sma_length3, _12058_sma_length4=sma_length4, _12059_sig_length=sig_length)
...
`momentum(series<float> src, int length = 10) -> series<float>`
    """
    return _lib.Incr_fn_momentum_e06708(ctx=ctx, ).collect(_12067_src=src, _12068_length=length)
...
`momentum(series<float> src, int length = 10) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_momentum_e06708(ctx, )
        self.locals = MomentumLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_12067_src=src, _12068_length=length)
...
`trix(series<float> src, int length = 18) -> series<float>`
    """
    return _lib.Incr_fn_trix_474aad(ctx=ctx, ).collect(_12070_src=src, _12071_length=length)
...
`trix(series<float> src, int length = 18) -> series<float>`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_trix_474aad(ctx, )
        self.locals = TrixLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_12070_src=src, _12071_length=length)
...
`true_strength_index(series<float> src, int long_length = 25, int short_length = 13) -> float`
    """
    return _lib.Incr_fn_true_strength_index_56fb98(ctx=ctx, ).collect(_12073_src=src, _12074_long_length=long_length, _12075_short_length=short_length)
...
`true_strength_index(series<float> src, int long_length = 25, int short_length = 13) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_true_strength_index_56fb98(ctx, )
    ...
    def next(self, src: float, long_length: Optional[int] = None, short_length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_12073_src=src, _12074_long_length=long_length, _12075_short_length=short_length)
...
`dema(series<float> src, int length = 9) -> float`
    """
    return _lib.Incr_fn_dema_287f47(ctx=ctx, ).collect(_12081_src=src, _12082_length=length)
...
`dema(series<float> src, int length = 9) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_dema_287f47(ctx, )
        self.locals = DemaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_12081_src=src, _12082_length=length)
...
`fwma(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_fwma_4438d5(ctx=ctx, ).collect(_12091_src=src, _12092_length=length)
...
`fwma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_fwma_4438d5(ctx, )
        self.locals = FwmaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_12091_src=src, _12092_length=length)
...
`money_flow_index(series<float> src, int length = 14) -> float`
    """
    return _lib.Incr_fn_money_flow_index_87f999(ctx=ctx, ).collect(_12098_src=src, _12099_length=length)
...
`money_flow_index(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_money_flow_index_87f999(ctx, )
        self.locals = MoneyFlowIndexLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_12098_src=src, _12099_length=length)
...
`ease_of_movement(int length = 14, int divisor = 10000) -> float`
    """
    return _lib.Incr_fn_ease_of_movement_711e45(ctx=ctx, ).collect(_12101_length=length, _12102_divisor=divisor)
...
`ease_of_movement(int length = 14, int divisor = 10000) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_ease_of_movement_711e45(ctx, )
    ...
    def next(self, length: Optional[int] = None, divisor: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_12101_length=length, _12102_divisor=divisor)
...
`elder_force_index(int length = 13) -> float`
    """
    return _lib.Incr_fn_elder_force_index_c4d359(ctx=ctx, ).collect(_12104_length=length)
...
`elder_force_index(int length = 13) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_elder_force_index_c4d359(ctx, )
        self.locals = ElderForceIndexLocals(self.inner)

    def next(self, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_12104_length=length)
...
`tema(series<float> src, int length = 9) -> float`
    """
    return _lib.Incr_fn_tema_5fbfc0(ctx=ctx, ).collect(_12106_src=src, _12107_length=length)
...
`tema(series<float> src, int length = 9) -> float`
    ...
    def __init__(self, ctx: Ctx, ):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_tema_5fbfc0(ctx, )
        self.locals = TemaLocals(self.inner)

    def next(self, src: float, length: Optional[int] = None) -> Optional[float]:
        return self.inner.next(_12106_src=src, _12107_length=length)
