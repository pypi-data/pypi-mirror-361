...
class ApiEnhancedPolicyViolationDTOV2(BaseModel):
    ...
    is_legacy: Optional[StrictBool] = Field(default=None, alias="isLegacy")
    ...
    __properties: ClassVar[List[str]] = ["component", "constraintViolations", "fixTime", "isLegacy", "isWaived", "legacyViolationTime", "openTime", "policyId", "policyName", "policyViolationId", "reportId", "reportUrl", "stageId", "threatLevel", "waiveTime"]
