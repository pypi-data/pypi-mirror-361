...
from ...types.protocols import criterion_create_params, criterion_update_params
...
class CriteriaResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        body_protocol_id: Optional[int] | NotGiven = NOT_GIVEN,
        ...
        """
        return self._post(
            f"/v2/protocols/{path_protocol_id}/criteria",
    ...
    def update(
        ...
        *,
        ...
        """
        return self._put(
            f"/v2/protocols/{path_protocol_id}/criteria/{criterion_id}",
            body=maybe_transform(
                {
                    "summary": summary,
                    "type": type,
    ...
    def list(
        ...
        *,
        ...
        """
        return self._get(
            f"/protocols/{protocol_id}/criteria",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            f"/v2/protocols/{protocol_id}/criteria/{criterion_id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
