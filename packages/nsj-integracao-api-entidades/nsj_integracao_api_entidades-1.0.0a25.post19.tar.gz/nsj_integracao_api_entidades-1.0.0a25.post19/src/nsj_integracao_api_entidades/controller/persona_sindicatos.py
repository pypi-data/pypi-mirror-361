...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/sindicatos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/sindicatos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/sindicatos/verificacao-integridade"
