...
setup(
  name = 'invoicing-pdf-shaffaan',         #* Your package will have this name
  packages = ['invoicing'],   #* Name the package again
  version = '1.2.0',         #* To be increased every time your change your library
  ...
  author = 'Shaffaan Amir',                   # Your name
  author_email = 'amirshaffaan@gmail.com',  # Your email
  url = 'https://google.com',              # Homepage of your library (e.g. github or your website)
