...
class MessageAction:  # type: ignore
    ...
    Constructors:
        This base type has 53 constructors available.
    ...
    def __init__(self):
        raise TypeError(
            ...
            "More info: https://telegramplayground.github.io/pyrogram/telegram/base/message-action"
        )
