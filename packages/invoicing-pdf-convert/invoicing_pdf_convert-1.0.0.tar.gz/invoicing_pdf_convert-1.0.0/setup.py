...
setup(
  name = 'invoicing-pdf-convert',         #* Your package will have this name
  ...
  author = 'Manuel Martinez',                   # Your name
  author_email = 'manuelmartinez199802@gmail.com',  # Your email
  url = 'https://github.com/juanma-codes/invoicing',              # Homepage of your library (e.g. github or your website)
