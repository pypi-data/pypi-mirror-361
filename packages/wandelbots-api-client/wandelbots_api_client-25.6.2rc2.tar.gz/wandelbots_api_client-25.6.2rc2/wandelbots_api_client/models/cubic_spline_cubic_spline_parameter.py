...
class CubicSplineCubicSplineParameter(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CubicSplineCubicSplineParameter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CubicSplineCubicSplineParameter from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "path_parameter": obj.get("path_parameter")
        })
        return _obj
