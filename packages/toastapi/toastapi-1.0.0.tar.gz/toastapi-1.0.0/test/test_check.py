...
from toasttab.models.check import Check
    ...
    def make_instance(self, include_optional) -> Check:
        ...
        if include_optional:
            return Check(
                ...
                selections = [
                    toasttab.models.selection.Selection()
                    ],
                customer = toasttab.models.customer.Customer(),
                amount = 1.337,
                tax_amount = 1.337,
                total_amount = 1.337,
                payments = [
                    toasttab.models.payment.Payment()
                    ],
                applied_discounts = [
                    toasttab.models.applied_discount.AppliedDiscount()
                    ],
                voided = True,
