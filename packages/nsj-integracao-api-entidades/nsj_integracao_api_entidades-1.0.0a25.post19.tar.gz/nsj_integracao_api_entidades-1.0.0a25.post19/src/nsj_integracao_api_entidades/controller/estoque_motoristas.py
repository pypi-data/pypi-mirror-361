...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/motoristas"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/motoristas/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/motoristas/verificacao-integridade"
