...
Python's standard routines from the 'multiprocessing' package and its 'Pool()' method. It 
provides improved feedback through several "progress bar" implementations (class 'Progress'). 
