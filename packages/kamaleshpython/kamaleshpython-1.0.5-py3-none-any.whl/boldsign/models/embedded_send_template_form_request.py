...
class EmbeddedSendTemplateFormRequest(BaseModel):
    """
    ...
    show_toolbar: Optional[StrictBool] = Field(default=None, alias="showToolbar")
    send_view_option: Optional[StrictStr] = Field(default=None, alias="sendViewOption")
    show_save_button: Optional[StrictBool] = Field(default=None, alias="showSaveButton")
    locale: Optional[StrictStr] = None
    show_send_button: Optional[StrictBool] = Field(default=None, alias="showSendButton")
    show_preview_button: Optional[StrictBool] = Field(default=None, alias="showPreviewButton")
    show_navigation_buttons: Optional[StrictBool] = Field(default=None, alias="showNavigationButtons")
    send_link_valid_till: Optional[datetime] = Field(default=None, alias="sendLinkValidTill")
    show_tooltip: Optional[StrictBool] = Field(default=None, alias="showTooltip")
    ...
    __properties: ClassVar[List[str]] = ["files", "fileUrls", "redirectUrl", "showToolbar", "sendViewOption", "showSaveButton", "locale", "showSendButton", "showPreviewButton", "showNavigationButtons", "sendLinkValidTill", "showTooltip", "documentId", "title", "message", "roles", "brandId", "labels", "disableEmails", "disableSMS", "hideDocumentId", "reminderSettings", "cc", "expiryDays", "expiryDateType", "expiryValue", "enablePrintAndSign", "enableReassign", "enableSigningOrder", "disableExpiryAlert", "documentInfo", "onBehalfOf", "isSandbox", "roleRemovalIndices", "documentDownloadOption", "metaData", "recipientNotificationSettings", "formGroups", "removeFormFields", "enableAuditTrailLocalization", "downloadFileName", "scheduledSendTime", "allowScheduledSend"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sendViewOption": obj.get("sendViewOption"),
            "showSaveButton": obj.get("showSaveButton"),
            "locale": obj.get("locale"),
            "showSendButton": obj.get("showSendButton"),
            "showPreviewButton": obj.get("showPreviewButton"),
            "showNavigationButtons": obj.get("showNavigationButtons"),
            "sendLinkValidTill": obj.get("sendLinkValidTill"),
            "showTooltip": obj.get("showTooltip"),
