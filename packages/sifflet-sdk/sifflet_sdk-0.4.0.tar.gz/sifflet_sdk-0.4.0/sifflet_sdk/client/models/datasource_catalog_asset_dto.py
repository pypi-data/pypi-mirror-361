...
class DatasourceCatalogAssetDto(BaseModel):
    """
    ...
    last_week_statuses: Optional[List[LastIngestionStatusDto]] = Field(default=None, alias="lastWeekStatuses")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DatasourceCatalogAssetDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DatasourceCatalogAssetDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "lastWeekStatuses": (
                    [LastIngestionStatusDto.from_dict(_item) for _item in obj["lastWeekStatuses"]]
