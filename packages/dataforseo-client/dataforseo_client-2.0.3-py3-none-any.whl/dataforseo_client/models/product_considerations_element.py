...
class ProductConsiderationsElement(BaseModel):
    ...
    expanded_element: Optional[List[Optional[ProductConsiderationsExpandedElement]]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expanded_element": [ProductConsiderationsExpandedElement.from_dict(_item) for _item in obj["expanded_element"]] if obj.get("expanded_element") is not None else None
        })
        return _obj
