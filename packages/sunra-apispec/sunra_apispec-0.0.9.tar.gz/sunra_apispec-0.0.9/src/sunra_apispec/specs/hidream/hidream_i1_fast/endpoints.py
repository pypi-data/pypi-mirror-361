...
service = BaseAPIService(
    title="HiDream I1 Fast API",
    description="API for HiDream I1 Fast text-to-image model",
    version="1.0.0",
    output_schema=HiDreamI1FastOutput,
)

@service.app.post(
    f"/{model_path}/text-to-image",
    response_model=SubmitResponse,
    description="Generate image from text prompts using HiDream I1 Fast model",
)
