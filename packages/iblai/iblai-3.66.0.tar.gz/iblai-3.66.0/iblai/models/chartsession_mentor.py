...
class ChartsessionMentor(BaseModel):
    """
    ChartsessionMentor
    """ # noqa: E501
    name: StrictStr
    mentor_tenant: StrictStr
    description: StrictStr
    profile_image: StrictStr
    created_by: StrictStr
    unique_id: StrictStr
    proactive_prompt: StrictStr
    __properties: ClassVar[List[str]] = ["name", "mentor_tenant", "description", "profile_image", "created_by", "unique_id", "proactive_prompt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "mentor_tenant": obj.get("mentor_tenant"),
