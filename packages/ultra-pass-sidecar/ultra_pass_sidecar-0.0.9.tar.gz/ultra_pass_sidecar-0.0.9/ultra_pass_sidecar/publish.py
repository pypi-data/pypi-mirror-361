...
def upload_to_pypi():
    ...
    # 如需更换请手动修改此处
    pypi_token = "pypi-AgEIcHlwaS5vcmcCJGM4ZWFlYmQ1LWQyZGUtNDk1My1hMWI1LTY2ZjcxZTgyNjE3YQACKlszLCI3NjY1M2U2NS0yODNmLTQ4YTQtOTJkMi1iNWU4OGU5Nzg1NGIiXQAABiAUaUMHZX7jNnu5g0pZXmNevCTx1AWxAzg6REMm4ImheA"
...
def smart_publish():
    """智能发布流程"""
    print("🚀 Ultra Pass Sidecar 智能发布工具")
    print("=" * 50)
    
    # 检查必要文件
    required_files = ['setup.py', 'README.md', 'ultra_pass_sidecar/__init__.py']
    ...
    if env_choice == '1':
        ...
        print("🔗 测试安装命令:")
        print(f"pip install --index-url https://test.pypi.org/simple/ ultra-pass-sidecar=={new_version}")
        ...
        print("📦 包已成功上传到正式PyPI")
        print("🔗 安装命令:")
        print(f"pip install ultra-pass-sidecar=={new_version}")
...
def manual_publish():
    """手动发布流程（保留原有功能）"""
    print("🚀 Ultra Pass Sidecar 手动发布工具")
    print("=" * 50)
