...
class ElispChunker(BaseChunker):
    ...
    def _get_tree_sitter_language(self) -> Any:
        ...
        # tree-sitter-elisp package not available on PyPI
        # Migrated from tree-sitter-languages but no individual package exists
        raise ImportError(
            "tree-sitter-elisp package is not available on PyPI. "
            "Elisp chunking is currently disabled after tree-sitter-languages migration."
        )
