...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/equipes_vendedores"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/equipes_vendedores/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/equipes_vendedores/verificacao-integridade"
