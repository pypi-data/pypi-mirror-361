...
class PollMediaCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    text: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=300)]] = None
    emoji: Optional[PollEmojiCreateRequest] = None
    __properties: ClassVar[List[str]] = ["text", "emoji"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "text": obj.get("text"),
            "emoji": PollEmojiCreateRequest.from_dict(obj["emoji"]) if obj.get("emoji") is not None else None
        })
        return _obj
