...
class ProfileApi:
    ...
    async def get_team_user_usage(
        ...
        _param = self._get_team_user_usage_serialize(
            slug=slug,
    ...
    @validate_call
    async def get_team_user_usage_with_http_info(
        self,
        slug: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_team_user_usage_without_preload_content(
        self,
        slug: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_team_user_usage_serialize(
        self,
        slug,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/mailroom/teams/{slug}/profile/usage',
    ...
    def _get_user_usage_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/profile/usage',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
