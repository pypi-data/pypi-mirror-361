...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/df_fretes_volumes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/df_fretes_volumes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/df_fretes_volumes/verificacao-integridade"
