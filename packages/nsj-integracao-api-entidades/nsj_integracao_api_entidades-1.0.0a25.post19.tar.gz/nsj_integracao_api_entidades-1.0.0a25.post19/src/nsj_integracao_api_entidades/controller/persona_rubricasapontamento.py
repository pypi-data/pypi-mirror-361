...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/rubricasapontamento"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/rubricasapontamento/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/rubricasapontamento/verificacao-integridade"
