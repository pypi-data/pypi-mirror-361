...
class DatasetDetailsDto(BaseModel):
    """
    DatasetDetailsDto
    """  # noqa: E501
    ...
    size: Optional[Dict[str, StrictInt]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DatasetDetailsDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DatasetDetailsDto from a dict"""
        if obj is None:
            return None
