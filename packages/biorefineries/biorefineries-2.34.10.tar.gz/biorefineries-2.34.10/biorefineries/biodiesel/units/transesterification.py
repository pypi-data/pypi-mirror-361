...
class Transesterification(Unit):
    ...
    def __init__(self, ID='', ins=None, outs=(), *,
                 efficiency=None, excess_methanol, T, x_catalyst, transesterification=None,
                 ):
        ...
        self.catalyst_dissolution = Reaction('NaOCH3 -> NaOH + Methanol', reactant='NaOCH3', X=1)
    ...
    def efficiency(self):
        ...
        return self.transesterification.X.mean()
    @efficiency.setter
    def efficiency(self, efficiency):
        self.transesterification.X[:] = efficiency
    ...
    def _run(self):
        ...
        self.catalyst_dissolution(product)
        product.T = self.T
