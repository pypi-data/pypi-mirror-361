...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/unidades"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/unidades/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/unidades/verificacao-integridade"
