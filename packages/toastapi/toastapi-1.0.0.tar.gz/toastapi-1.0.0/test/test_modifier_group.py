...
from toasttab.models.modifier_group import ModifierGroup
...
class TestModifierGroup(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ModifierGroup:
        """Test ModifierGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModifierGroup`
        """
        model = ModifierGroup()
        if include_optional:
