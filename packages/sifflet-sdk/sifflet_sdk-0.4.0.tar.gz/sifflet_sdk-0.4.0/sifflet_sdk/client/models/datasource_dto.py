...
class DatasourceDto(BaseModel):
    ...
    cron_expression_description: Optional[StrictStr] = Field(default=None, alias="cronExpressionDescription")
    description: Optional[StrictStr] = None
    entity_type: StrictStr = Field(alias="entityType")
    id: StrictStr
    last_ingestion_status: Optional[LastIngestionStatusDto] = Field(default=None, alias="lastIngestionStatus")
    ...
    name: StrictStr
    next_execution: Optional[StrictInt] = Field(default=None, alias="nextExecution")
    ...
    def entity_type_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('INTEGRATION', 'DATASOURCE', 'DATASOURCE_INGESTION_RUN', 'DATASET', 'DASHBOARD', 'CHART', 'COLLECTION', 'DATASET_FIELD', 'DAG', 'TRANSFORMATION', 'RULE_RUN', 'INCIDENT', 'USER', 'ACCESS_TOKEN', 'SIFFLET_RULE', 'CONFIG', 'TAG', 'DOMAIN', 'ALERTING_HOOK', 'RULE_MONITORING_RECOMMENDATION', 'DATAPOINT_QUALIFICATION', 'DECLARED_ASSET', 'WEBHOOK', 'SIFFLET_AGENT', 'SIFFLET_AGENT_JOB', 'AI_METADATA_PREDICTION', 'CUSTOM_METADATA', 'CUSTOM_METADATA_ENTRY', 'DATA_PRODUCT')"
            )
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of last_ingestion_status
        if self.last_ingestion_status:
            _dict["lastIngestionStatus"] = self.last_ingestion_status.to_dict()
        ...
        _obj = cls.model_validate(
            {
                ...
                "cronExpressionDescription": obj.get("cronExpressionDescription"),
                "description": obj.get("description"),
                "entityType": obj.get("entityType"),
                "id": obj.get("id"),
                "lastIngestionStatus": (
                    LastIngestionStatusDto.from_dict(obj["lastIngestionStatus"])
                    if obj.get("lastIngestionStatus") is not None
                    else None
                ),
                ...
                "params": (
                    GetAllDatasourceParamsType200ResponseInner.from_dict(obj["params"])
