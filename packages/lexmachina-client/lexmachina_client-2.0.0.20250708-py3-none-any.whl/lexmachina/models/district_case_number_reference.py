...
class DistrictCaseNumberReference(BaseModel):
    """
    DistrictCaseNumberReference
    """ # noqa: E501
    url: StrictStr
    district_case_id: StrictInt = Field(alias="districtCaseId")
    case_number: StrictStr = Field(alias="caseNumber")
    court: StrictStr
    title: StrictStr
    __properties: ClassVar[List[str]] = ["url", "districtCaseId", "caseNumber", "court", "title"]
