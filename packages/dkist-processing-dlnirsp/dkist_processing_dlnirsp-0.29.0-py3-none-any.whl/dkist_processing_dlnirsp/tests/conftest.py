...
class FileParameter(InputDatasetFilePointer):
    ...
    def _populate_file_object(self):
        self.file_pointer = FileObject(
            ...
            tag=DlnirspTag.parameter(self.object_key),
        )
        return self
...
class DlnirspTestingParameters:
    ...
    dlnirsp_linearization_saturation_threshold_jband: float = 45000.0
    dlnirsp_linearization_saturation_threshold_hband: float = 35000.0
