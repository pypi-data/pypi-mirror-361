...
class PatentCaseInformation(BaseModel):
    """
    PatentCaseInformation
    """ # noqa: E501
    number_of_cases: StrictInt = Field(alias="numberOfCases")
    findings: List[PatentFindings]
    __properties: ClassVar[List[str]] = ["numberOfCases", "findings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "numberOfCases": obj.get("numberOfCases"),
            "findings": [PatentFindings.from_dict(_item) for _item in obj["findings"]] if obj.get("findings") is not None else None
        })
        return _obj
