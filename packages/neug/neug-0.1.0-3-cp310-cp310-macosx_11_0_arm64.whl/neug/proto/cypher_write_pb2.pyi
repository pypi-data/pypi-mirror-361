...
class Set(google.protobuf.message.Message):
    ...
    class Item(google.protobuf.message.Message):
        ...
        class _KindEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Set.Item._Kind.ValueType], builtins.type):
        ...
        def ClearField(self, field_name: typing.Literal["key", b"key", "kind", b"kind", "value", b"value"]) -> None: ...

    ITEMS_FIELD_NUMBER: builtins.int
    @property
    def items(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Set.Item]: ...
    def __init__(
        self,
        *,
...
class Load(google.protobuf.message.Message):
    ...
    class _KindEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Load._Kind.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class ColumnMappings(google.protobuf.message.Message):
        ...
        class LoadingConfig(google.protobuf.message.Message):
            ...
            class DataSource(google.protobuf.message.Message):
                ...
                def ClearField(self, field_name: typing.Literal["location", b"location", "scheme", b"scheme"]) -> None: ...
            ...
            class Format(google.protobuf.message.Message):
                ...
                class Metadata(google.protobuf.message.Message):
                    ...
                    def ClearField(self, field_name: typing.Literal["block_size", b"block_size", "delimiter", b"delimiter", "double_quote", b"double_quote", "escape_char", b"escape_char", "header_row", b"header_row", "quote_char", b"quote_char", "quoting", b"quoting"]) -> None: ...

                METADATA_FIELD_NUMBER: builtins.int
                @property
                def metadata(self) -> global___Load.ColumnMappings.LoadingConfig.Format.Metadata: ...
                def __init__(
                    self,
                    *,
                    metadata: global___Load.ColumnMappings.LoadingConfig.Format.Metadata | None = ...,
                ) -> None: ...
            ...
            @property
            def data_source(self) -> global___Load.ColumnMappings.LoadingConfig.DataSource: ...
            @property
            def format(self) -> global___Load.ColumnMappings.LoadingConfig.Format: ...
            def __init__(
                self,
                *,
                data_source: global___Load.ColumnMappings.LoadingConfig.DataSource | None = ...,
                format: global___Load.ColumnMappings.LoadingConfig.Format | None = ...,
            ) -> None: ...
            def HasField(self, field_name: typing.Literal["data_source", b"data_source", "format", b"format"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing.Literal["data_source", b"data_source", "format", b"format"]) -> None: ...
        ...
        class ColumnMapping(google.protobuf.message.Message):
            ...
            class Column(google.protobuf.message.Message):
                ...
                def ClearField(self, field_name: typing.Literal["index", b"index", "name", b"name"]) -> None: ...
            ...
            def HasField(self, field_name: typing.Literal["column", b"column", "property", b"property"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing.Literal["column", b"column", "property", b"property"]) -> None: ...
        ...
        class Input(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing.Literal["dyn_path", b"dyn_path", "input", b"input", "path", b"path"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing.Literal["dyn_path", b"dyn_path", "input", b"input", "path", b"path"]) -> None: ...
            def WhichOneof(self, oneof_group: typing.Literal["input", b"input"]) -> typing.Literal["path", "dyn_path"] | None: ...
        ...
        class VertexMapping(google.protobuf.message.Message):
            ...
            @property
            def inputs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Load.ColumnMappings.Input]: ...
            @property
            def column_mappings(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Load.ColumnMappings.ColumnMapping]: ...
            def __init__(
                self,
                *,
                type_name: builtins.str = ...,
                inputs: collections.abc.Iterable[global___Load.ColumnMappings.Input] | None = ...,
                column_mappings: collections.abc.Iterable[global___Load.ColumnMappings.ColumnMapping] | None = ...,
            ) -> None: ...
            def ClearField(self, field_name: typing.Literal["column_mappings", b"column_mappings", "inputs", b"inputs", "type_name", b"type_name"]) -> None: ...
        ...
        class EdgeMapping(google.protobuf.message.Message):
            ...
            class TypeTriplet(google.protobuf.message.Message):
                ...
                def ClearField(self, field_name: typing.Literal["destination_vertex", b"destination_vertex", "edge", b"edge", "source_vertex", b"source_vertex"]) -> None: ...
            ...
            COLUMN_MAPPINGS_FIELD_NUMBER: builtins.int
            @property
            def type_triplet(self) -> global___Load.ColumnMappings.EdgeMapping.TypeTriplet: ...
            @property
            def inputs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Load.ColumnMappings.Input]: ...
            @property
            def source_vertex_mappings(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Load.ColumnMappings.ColumnMapping]: ...
            @property
            def destination_vertex_mappings(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Load.ColumnMappings.ColumnMapping]: ...
            @property
            def column_mappings(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Load.ColumnMappings.ColumnMapping]: ...
            def __init__(
                self,
                *,
                type_triplet: global___Load.ColumnMappings.EdgeMapping.TypeTriplet | None = ...,
                inputs: collections.abc.Iterable[global___Load.ColumnMappings.Input] | None = ...,
                source_vertex_mappings: collections.abc.Iterable[global___Load.ColumnMappings.ColumnMapping] | None = ...,
                destination_vertex_mappings: collections.abc.Iterable[global___Load.ColumnMappings.ColumnMapping] | None = ...,
                column_mappings: collections.abc.Iterable[global___Load.ColumnMappings.ColumnMapping] | None = ...,
            ) -> None: ...
            def HasField(self, field_name: typing.Literal["type_triplet", b"type_triplet"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing.Literal["column_mappings", b"column_mappings", "destination_vertex_mappings", b"destination_vertex_mappings", "inputs", b"inputs", "source_vertex_mappings", b"source_vertex_mappings", "type_triplet", b"type_triplet"]) -> None: ...
        ...
        @property
        def vertex_mappings(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Load.ColumnMappings.VertexMapping]: ...
        @property
        def edge_mappings(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Load.ColumnMappings.EdgeMapping]: ...
        def __init__(
            self,
            *,
            load_config: global___Load.ColumnMappings.LoadingConfig | None = ...,
            vertex_mappings: collections.abc.Iterable[global___Load.ColumnMappings.VertexMapping] | None = ...,
            edge_mappings: collections.abc.Iterable[global___Load.ColumnMappings.EdgeMapping] | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["load_config", b"load_config"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["edge_mappings", b"edge_mappings", "load_config", b"load_config", "vertex_mappings", b"vertex_mappings"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["mappings", b"mappings"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["kind", b"kind", "mappings", b"mappings"]) -> None: ...
...
class Delete(google.protobuf.message.Message):
    ...
    @property
    def keys(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[expr_pb2.Expression]: ...
    def __init__(
        self,
        *,
        detached: builtins.bool = ...,
    ...
    def ClearField(self, field_name: typing.Literal["detached", b"detached", "keys", b"keys"]) -> None: ...
