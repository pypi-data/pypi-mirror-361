...
class Categories(BaseSDK):
    def list(
        ...
        *,
    ...
    ) -> Optional[models.AccountingCategoriesAllResponse]:
        r"""List Categories
        ...
        request = models.AccountingCategoriesAllRequest(
            raw=raw,
        ...
        req = self._build_request(
            ...
            _globals=models.AccountingCategoriesAllGlobals(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="accounting.categoriesAll",
                oauth2_scopes=[],
        ...
        def next_func() -> Optional[models.AccountingCategoriesAllResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.AccountingCategoriesAllResponse(
                get_categories_response=unmarshal_json_response(
                    Optional[models.GetCategoriesResponse], http_res
                ),
    ...
    def get(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.AccountingCategoriesOneResponse:
        r"""Get Category
        ...
        request = models.AccountingCategoriesOneRequest(
            id=id,
            consumer_id=consumer_id,
            app_id=app_id,
            service_id=service_id,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.AccountingCategoriesOneGlobals(
                consumer_id=self.sdk_configuration.globals.consumer_id,
                app_id=self.sdk_configuration.globals.app_id,
            ),
            security=self.sdk_configuration.security,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="accounting.categoriesOne",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.AccountingCategoriesOneResponse(
                get_category_response=unmarshal_json_response(
                    Optional[models.GetCategoryResponse], http_res
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
