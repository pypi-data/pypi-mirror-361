...
class OrmPipeline(object):
    ...
    def __init__(self, created_by_id=None, created_dt=None, description=None, edges=None, favorite=None, id=None, immutable_slug=None, last_revision=None, last_triggered_by=None, last_triggered_dt=None, name=None, organization_id=None, updated_dt=None, volume_id=None, local_vars_configuration=None):  # noqa: E501
