"""
Schema definitions for Black Forest Labs Official FLUX Kontext Max API.
...
class BFLFluxKontextMaxInput(BaseModel):
    """Input schema for FLUX Kontext Max API requests."""
...
class BFLResultResponse(BaseModel):
