...
class RecipientChangeLog(BaseModel):
    """
    RecipientChangeLog
    """ # noqa: E501
    added: Optional[List[Added]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "added": [Added.from_dict(_item) for _item in obj["added"]] if obj.get("added") is not None else None,
            "removed": [Removed.from_dict(_item) for _item in obj["removed"]] if obj.get("removed") is not None else None
        })
        return _obj
