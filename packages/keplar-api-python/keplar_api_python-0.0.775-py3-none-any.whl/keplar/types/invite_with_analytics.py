...
class InviteWithAnalytics(UniversalBaseModel):
    id: str
    name: str
    ...
    live_at: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="liveAt")] = None
    ...
    max_responses: typing_extensions.Annotated[float, FieldMetadata(alias="maxResponses")]
    completed_response_count: typing_extensions.Annotated[float, FieldMetadata(alias="completedResponseCount")]
...
update_forward_refs(InviteWithAnalytics)
