...
from .schema import ReplicateImagen4UltraInput


class ReplicateTextToImageAdapter(IReplicateAdapter):
    """Adapter for text-to-image generation using Imagen4-Ultra model on Replicate."""
    ...
    def convert_input(self, data) -> dict:
        ...
        replicate_input = ReplicateImagen4UltraInput(
    ...
    def get_request_url(self) -> str:
        ...
        return "https://api.replicate.com/v1/models/google/imagen-4-ultra/predictions"
