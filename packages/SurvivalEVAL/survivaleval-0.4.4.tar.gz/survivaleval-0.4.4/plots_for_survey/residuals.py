...
from SurvivalEVAL import DistributionEvaluator
...
survs_cox = cph.predict_survival_function(x_test).T.values

eval = DistributionEvaluator(survs_cox, df_test['time'].values, df_test['event'].values)
