...
class GetApiThreadsThreadIdFilesResponse(UniversalBaseModel):
    files: typing.List["ThreadFile"]
    signed_urls: typing_extensions.Annotated[typing.List[str], FieldMetadata(alias="signedUrls")]
    total: int
    limit: int
    offset: int
...
update_forward_refs(GetApiThreadsThreadIdFilesResponse)
