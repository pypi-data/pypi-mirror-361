...
class JudgmentEventsList(BaseModel):
    """
    JudgmentEventsList
    """ # noqa: E501
    judgment_events: List[StrictStr] = Field(alias="judgmentEvents")
    court: Optional[Court] = None
    __properties: ClassVar[List[str]] = ["judgmentEvents", "court"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "judgmentEvents": obj.get("judgmentEvents"),
