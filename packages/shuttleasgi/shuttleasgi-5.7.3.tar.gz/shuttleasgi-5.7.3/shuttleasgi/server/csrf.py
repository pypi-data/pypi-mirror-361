...
from shuttleasgi.baseapp import get_logger
from shuttleasgi.cookies import Cookie
from shuttleasgi.exceptions import Unauthorized
...
from shuttleasgi.server.security import SecurityPolicyHandler
...
class AntiForgeryHandler:
    ...
    def set_cookie(self, response: Response, value: str, secure: bool = False) -> None:
        ...
        response : Response
            The instance of shuttleasgi `Response` that will include the cookie for the
            client.
