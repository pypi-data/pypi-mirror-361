...
@app.command(
    help="List models that are available in the Model Registry. "
...
@app.command(help="Add a new version to an existing model in the Model Registry.")
def add_version(
    model_id: str = typer.Argument(
        ...,
    ...
    engine_version: str = typer.Option(
        ...,
        help=(
            "Engine version, for example `nvflare:2.5.2`. For information "
...
@app.command(
    ...
    "Add a new model in the Model Registry.",
