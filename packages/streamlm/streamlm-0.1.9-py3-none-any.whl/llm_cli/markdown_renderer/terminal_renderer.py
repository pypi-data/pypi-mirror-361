"""
terminal_renderer - Parse Markdown and turn it into nicely-formatted text for terminal display.

Based on md2term but customized for StreamLM's streaming requirements.
"""
