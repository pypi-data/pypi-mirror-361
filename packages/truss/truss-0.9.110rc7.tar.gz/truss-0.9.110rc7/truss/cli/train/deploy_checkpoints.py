...
BUILD_TIME_TRUSS_CONFIG_EXCLUSION_LIST = [
    ...
    "buildless_deploy",  # Whether to deploy with buildless mode
]
...
def create_build_time_config(context_path_str: Path) -> None:
    ...
    truss_config["runtime"]["truss_server_version_override"] = "0.9.110rc007"
...
def prepare_checkpoint_deploy(
    ...
    # temporary: explicitly set server-side truss version
    rendered_truss.runtime.truss_server_version_override = "0.9.110rc007"
