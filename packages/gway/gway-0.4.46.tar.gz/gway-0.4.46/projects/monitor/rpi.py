...
def render_rpi(target: str | None = None) -> str:
    """Return HTML fragment for the Pi clone interface."""
...
def monitor_rpi():
    """Simple monitor that exposes clone state."""
    gw.monitor.set_states("rpi", _CLONE_STATE.copy())
