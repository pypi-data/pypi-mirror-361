...
class MyTestCase(unittest.TestCase):
    ...
    def test_sed_extract12(self):
        maps_input = {'maps': [
            ('%spred_350_HerM33es_allsurveys_37arcsec_with160_250_march27.fits' % DATA_PATH)],
            'nside_input': 16384,
            'ordering': Ordering.NESTED,
            'hdu': 0,
            'wav': [350],
        ...
        path_image, path_plot, res = sed_extract(
            maps_input, region_input, plot=True, save=True, output_path=OUTPUT_PATH
        )
