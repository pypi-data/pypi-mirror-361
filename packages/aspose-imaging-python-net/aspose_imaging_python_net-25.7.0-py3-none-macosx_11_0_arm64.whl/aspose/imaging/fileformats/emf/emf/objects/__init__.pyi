...
class EmfPixelFormatDescriptor(EmfObject):
    ...
    @property
    def pixel_type(self) -> byte:
        ...
    
    @pixel_type.setter
    def pixel_type(self, value : byte):
        ...
    
    @property
    def c_color_bits(self) -> byte:
        ...
    
    @c_color_bits.setter
    def c_color_bits(self, value : byte):
        ...
    
    @property
    def c_red_bits(self) -> byte:
        ...
    
    @c_red_bits.setter
    def c_red_bits(self, value : byte):
        ...
    
    @property
    def c_red_shift(self) -> byte:
        ...
    
    @c_red_shift.setter
    def c_red_shift(self, value : byte):
        ...
    
    @property
    def c_green_bits(self) -> byte:
        ...
    
    @c_green_bits.setter
    def c_green_bits(self, value : byte):
        ...
    
    @property
    def c_green_shift(self) -> byte:
        ...
    
    @c_green_shift.setter
    def c_green_shift(self, value : byte):
        ...
    
    @property
    def c_blue_bits(self) -> byte:
        ...
    
    @c_blue_bits.setter
    def c_blue_bits(self, value : byte):
        ...
    
    @property
    def c_blue_shift(self) -> byte:
        ...
    
    @c_blue_shift.setter
    def c_blue_shift(self, value : byte):
        ...
    
    @property
    def c_alpha_bits(self) -> byte:
        ...
    
    @c_alpha_bits.setter
    def c_alpha_bits(self, value : byte):
        ...
    
    @property
    def c_alpha_shift(self) -> byte:
        ...
    
    @c_alpha_shift.setter
    def c_alpha_shift(self, value : byte):
        ...
    
    @property
    def c_accum_bits(self) -> byte:
        ...
    
    @c_accum_bits.setter
    def c_accum_bits(self, value : byte):
        ...
    
    @property
    def c_accum_red_bits(self) -> byte:
        ...
    
    @c_accum_red_bits.setter
    def c_accum_red_bits(self, value : byte):
        ...
    
    @property
    def c_accum_green_bits(self) -> byte:
        ...
    
    @c_accum_green_bits.setter
    def c_accum_green_bits(self, value : byte):
        ...
    
    @property
    def c_accum_blue_bits(self) -> byte:
        ...
    
    @c_accum_blue_bits.setter
    def c_accum_blue_bits(self, value : byte):
        ...
    
    @property
    def c_accum_alpha_bits(self) -> byte:
        ...
    
    @c_accum_alpha_bits.setter
    def c_accum_alpha_bits(self, value : byte):
        ...
    
    @property
    def c_depth_bits(self) -> byte:
        ...
    
    @c_depth_bits.setter
    def c_depth_bits(self, value : byte):
        ...
    
    @property
    def c_stencil_bits(self) -> byte:
        ...
    
    @c_stencil_bits.setter
    def c_stencil_bits(self, value : byte):
        ...
    
    @property
    def c_aux_buffers(self) -> byte:
        ...
    
    @c_aux_buffers.setter
    def c_aux_buffers(self, value : byte):
        ...
    
    @property
    def layer_type(self) -> byte:
        ...
    
    @layer_type.setter
    def layer_type(self, value : byte):
        ...
    
    @property
    def b_reserved(self) -> byte:
        ...
    
    @b_reserved.setter
    def b_reserved(self, value : byte):
        ...
