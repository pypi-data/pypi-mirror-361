# -*- coding: utf-8 -*-
#
# Pyfive documentation build configuration file, created by
...
project = u'Pyfive'
copyright = u'{0}, Pyfive Development Team'.format(datetime.now().year)
...
html_short_title = "Pyfive {0}".format(release)
...
latex_documents = [
    ('index', 'Pyfive_Users_Guide.tex',
     u'Pyfive User\'s and Developer\'s Guide',
     u'Pyfive Development Team', 'manual'),
]
...
# texinfo_documents = [
#  ('index', 'Pyfive', u'Pyfive Documentation',
...
epub_title = u'Pyfive'
epub_author = u'Pyfive Development Team'
epub_publisher = u'Pyfive Development Team'
epub_copyright = u'Pyfive Development Team'

# The basename for the epub file. It defaults to the project name.
# epub_basename = u'Pyfive'
...
generate_sidebar(globals(), "pyfive")
