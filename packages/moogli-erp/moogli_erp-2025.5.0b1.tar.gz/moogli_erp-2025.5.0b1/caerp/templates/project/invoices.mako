...
<div id="project_invoices_tab">
	<div class='layout flex two_cols content_vertical_padding separate_bottom_dashed'>
		...
		<div role='group' class='align_right'>
			...
			%>
			<a class='btn icon_only_mobile' onclick="window.openPopup('${url_xls}');" href='javascript:void(0);' title="Export au format Excel (xls) dans une nouvelle fenêtre" aria-label="Export au format Excel (xls) dans une nouvelle fenêtre">
				${api.icon('file-excel')}
				Excel
			</a>
