...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/itens"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/itens/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/itens/verificacao-integridade"
