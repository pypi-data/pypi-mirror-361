...
class SoundboardCreateRequest(BaseModel):
    ...
    volume: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = None
    emoji_id: Optional[Annotated[str, Field(strict=True)]] = None
    emoji_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=32)]] = None
    sound: StrictStr
    __properties: ClassVar[List[str]] = ["name", "volume", "emoji_id", "emoji_name", "sound"]
