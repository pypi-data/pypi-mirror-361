...
from shuttleasgi.url import join_prefix
...
class DefaultSerializer(Serializer):
    """
    Default OAD serializer used by ShuttleASGI.
    ShuttleASGI generates OpenAPI Specification files containing
    ...
    def get_type_name_for_generic(self, name: str) -> str:
        ...
        The following is more for backward compatibility in ShuttleASGI.
        """
