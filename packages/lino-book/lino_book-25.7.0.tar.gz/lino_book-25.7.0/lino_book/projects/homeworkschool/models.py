...
class Person(contacts.Person, Born):
...
#~ """,label=_("Lesson"))
#~ event = dd.Panel("""
# ~ id:8 user priority transparent #rset
...
def my_details(sender, **kw):
    ...
    site.modules.cal.Events.add_detail_panel(
        'general', """
...
# TODO : move to plugin
def setup_main_menu(config, site, user_type, main, ar=None):
