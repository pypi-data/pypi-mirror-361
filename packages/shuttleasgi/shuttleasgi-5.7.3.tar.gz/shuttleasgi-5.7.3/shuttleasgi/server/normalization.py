...
from shuttleasgi.normalization import copy_special_attributes
from shuttleasgi.server import responses
from shuttleasgi.server.routing import Route
from shuttleasgi.server.sse import ServerSentEvent, ServerSentEventsResponse
...
def ensure_response(result) -> Response:
    ...
    of `shuttleasgi.messages.Response` class.
