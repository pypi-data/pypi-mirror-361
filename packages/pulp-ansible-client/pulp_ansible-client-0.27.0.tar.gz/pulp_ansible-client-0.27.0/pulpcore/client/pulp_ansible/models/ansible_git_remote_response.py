...
class AnsibleGitRemoteResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["total_timeout", "connect_timeout", "headers", "pulp_last_updated", "hidden_fields", "pulp_created", "tls_validation", "max_retries", "sock_read_timeout", "client_cert", "ca_cert", "url", "name", "prn", "rate_limit", "sock_connect_timeout", "pulp_href", "pulp_labels", "proxy_url", "download_concurrency", "metadata_only", "git_ref"]
