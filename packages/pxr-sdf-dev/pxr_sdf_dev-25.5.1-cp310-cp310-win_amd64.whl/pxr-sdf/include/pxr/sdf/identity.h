...
#ifndef PXR_SDF_IDENTITY_H
#define PXR_SDF_IDENTITY_H
...
inline void TfDelegatedCountIncrement(pxr::Sdf_Identity* p) {
    ++p->_refCount;
}
inline void TfDelegatedCountDecrement(pxr::Sdf_Identity* p) noexcept {
