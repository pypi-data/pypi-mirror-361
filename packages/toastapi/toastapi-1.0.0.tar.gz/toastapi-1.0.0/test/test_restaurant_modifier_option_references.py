...
from toasttab.models.restaurant_modifier_option_references import RestaurantModifierOptionReferences

class TestRestaurantModifierOptionReferences(unittest.TestCase):
    """RestaurantModifierOptionReferences unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestaurantModifierOptionReferences:
        """Test RestaurantModifierOptionReferences
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestaurantModifierOptionReferences`
        """
        model = RestaurantModifierOptionReferences()
        if include_optional:
            return RestaurantModifierOptionReferences(
                identifier = 56
            )
        else:
            return RestaurantModifierOptionReferences(
    ...
    def testRestaurantModifierOptionReferences(self):
        """Test RestaurantModifierOptionReferences"""
