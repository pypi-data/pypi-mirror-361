...
def _load_theme_from_filesystem(theme_name: str) -> str:
    ...
    possible_paths = [
        # 相对于当前模块的路径
        os.path.join(os.path.dirname(__file__), "..", "styles", f"{theme_name}_theme.qss"),
        # 相对于包根目录的路径
        os.path.join(os.path.dirname(__file__), "..", "..", "feedback_ui", "styles", f"{theme_name}_theme.qss"),
        # 绝对路径（如果在包中）
        os.path.join(os.path.dirname(os.path.dirname(__file__)), "styles", f"{theme_name}_theme.qss"),
    ]
