...
class JdbcDatasourceConnectionParams(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["USER_PASSWORD", "MYSQL"]):
            raise ValueError("must be one of enum values ('USER_PASSWORD', 'MYSQL')")
        return value
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {"USER_PASSWORD": "UserPasswordConnectionParams"}
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[UserPasswordConnectionParams]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[UserPasswordConnectionParams]]:
