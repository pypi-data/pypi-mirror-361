...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/movimentosponto"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/movimentosponto/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/movimentosponto/verificacao-integridade"
