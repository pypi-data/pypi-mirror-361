...
from nkunyim_iam.auth.oauth2.rfc6749 import AccessDeniedError
from nkunyim_iam.auth.oauth2.rfc6749 import ImplicitGrant
from nkunyim_iam.auth.oauth2.rfc6749 import InvalidScopeError
from nkunyim_iam.auth.oauth2.rfc6749 import OAuth2Error
from nkunyim_iam.auth.oauth2.rfc6749.hooks import hooked
...
class OpenIDImplicitGrant(ImplicitGrant):
    ...
    def generate_user_info(self, user, scope):
        ...
        MUST implement this method in subclass, e.g.::
            ...
            from nkunyim_iam.auth.oidc.core import UserInfo
        ...
        :return: ``nkunyim_iam.auth.oidc.core.UserInfo`` instance
        """
        raise NotImplementedError()
