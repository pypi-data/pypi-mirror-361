...
class TestREPLProcess:
    ...
    def test_process_input_empty_input(self):
        ...
        # Mock prompt session returning empty input
        mock_session = Mock()
    ...
    def test_process_input_command(self):
        ...
        # Mock prompt session returning help command
        mock_session = Mock()
    ...
    def test_process_input_command_case_insensitive(self):
        ...
        # Mock prompt session returning uppercase command
        mock_session = Mock()
        mock_session.prompt.return_value = "HELP"
        repl.session = mock_session
    ...
    def test_process_input_text_capture(self):
        ...
        # Mock prompt session returning text
        mock_session = Mock()
    ...
    def test_process_input_eof_error(self):
        ...
        # Mock prompt session raising EOFError
        mock_session = Mock()
    ...
    def test_start_keyboard_interrupt_handling(self, mock_console, mock_session_class, mock_create_db):
        ...
        mock_console.print.assert_any_call("💡 Use 'exit' or 'quit' to leave Goldfish")
