...
class S2VClient(AbstractContextManager["S2VClient"]):
    ...
    def validate(
        ...
        deploy_objects: str | None = None,
        deploy_objects_except: str | None = None,
    ) -> ValidationResult:
        ...
        params["deploy_objects"] = deploy_objects if deploy_objects else ""
        params["deploy_objects_except"] = deploy_objects_except if deploy_objects_except else ""
    ...
    def generate(
        ...
        params["cli_version"] = version if version else "0.0.0"
