...
class WebhookSlackEmbedField(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=152133)]] = None
    value: Optional[Annotated[str, Field(strict=True, max_length=152133)]] = None
    inline: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["name", "value", "inline"]
