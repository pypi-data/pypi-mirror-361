...
class TestApiKeysApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_add_teams_api_key(self) -> None:
    ...
    async def test_add_user_api_key(self) -> None:
    ...
    async def test_delete_teams_api_key(self) -> None:
    ...
    async def test_delete_user_api_key(self) -> None:
    ...
    async def test_update_team_api_key(self) -> None:
    ...
    async def test_update_user_api_key(self) -> None:
