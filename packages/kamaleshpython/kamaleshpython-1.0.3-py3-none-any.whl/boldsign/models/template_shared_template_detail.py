...
class TemplateSharedTemplateDetail(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["teamId", "accessType"]
    ...
    def access_type_validate_enum(cls, value):
        ...
        if value not in set(['Use', 'Edit']):
            raise ValueError("must be one of enum values ('Use', 'Edit')")
        return value
