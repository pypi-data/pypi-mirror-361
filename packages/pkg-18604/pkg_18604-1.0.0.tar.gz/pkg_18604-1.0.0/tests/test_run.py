...
def test_checkout_branch_return_branch_object(get_repo):
    ...
    """
    remote_name = 'origin'
    branch_name = 'ci-testing'
    default_branch = 'main'
    gitconfig_name = 'Lisa Gherardini'
    gitconfig_email = 'lisa.gherardini@example.com'

    result = checkout_branch(get_repo, remote_name, default_branch, branch_name, gitconfig_name, gitconfig_email)
...
def test_checkout_branch_return_none_01(get_repo):
    ...
    result = checkout_branch(get_repo, remote_name, default_branch, badge_branch, gitconfig_name, gitconfig_email)
    print(f'\nCheckout branch result: {result}')
