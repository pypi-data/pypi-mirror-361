...
# Release history
# 1.4.6 - Trust Assessment Release
#         - Implemented sophisticated three-tier trust verdict system (ALLOW/DENY/DEFER)
#         - Stricter auto-promotion criteria: quality ≥8.0, usage ≥10M downloads/200 reverse deps
#         - Auto-deny logic for problematic crates with security issues or poor quality
#         - Deprecation detection for abandoned or deprecated crates
#         - Enhanced sentiment analysis with realistic community assessment
#         - Fixed IRL engine parameter ordering for accurate decision making
#         - Comprehensive trust assessment with security, quality, and ecosystem analysis
