...
class RemittanceData(BaseModel):
    ...
    RemittanceData
    """ # noqa: E501
    date_created: Optional[datetime] = Field(default=None, description="Represents the date and time when the remittance was processed. This timestamp follows the ISO 8601 format for datetime representation.")
