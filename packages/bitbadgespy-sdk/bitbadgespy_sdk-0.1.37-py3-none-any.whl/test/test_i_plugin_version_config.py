    ...
    def make_instance(self, include_optional) -> IPluginVersionConfig:
        ...
        if include_optional:
            return IPluginVersionConfig(
                ...
                user_input_redirect = bitbadgespy_sdk.models.plugin_version_config_payload_user_input_redirect.PluginVersionConfigPayload_userInputRedirect(
                    base_uri = '', 
                    tutorial_uri = '', ),
                claim_creator_redirect = bitbadgespy_sdk.models.plugin_version_config_payload_claim_creator_redirect.PluginVersionConfigPayload_claimCreatorRedirect(
                    tool_uri = '', 
                    tutorial_uri = '', 
                    tester_uri = '', ),
