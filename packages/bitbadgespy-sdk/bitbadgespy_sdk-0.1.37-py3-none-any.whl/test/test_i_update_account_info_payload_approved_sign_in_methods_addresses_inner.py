...
class TestIUpdateAccountInfoPayloadApprovedSignInMethodsAddressesInner(unittest.TestCase):
    """IUpdateAccountInfoPayloadApprovedSignInMethodsAddressesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateAccountInfoPayloadApprovedSignInMethodsAddressesInner:
        """Test IUpdateAccountInfoPayloadApprovedSignInMethodsAddressesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateAccountInfoPayloadApprovedSignInMethodsAddressesInner`
        """
        model = IUpdateAccountInfoPayloadApprovedSignInMethodsAddressesInner()
        if include_optional:
            return IUpdateAccountInfoPayloadApprovedSignInMethodsAddressesInner(
                address = '',
                scopes = [
    ...
    def testIUpdateAccountInfoPayloadApprovedSignInMethodsAddressesInner(self):
        """Test IUpdateAccountInfoPayloadApprovedSignInMethodsAddressesInner"""
