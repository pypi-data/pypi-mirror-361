...
class CdrGradient:
    ...
    @stops.setter
    def stops(self, value : List[aspose.imaging.fileformats.cdr.types.CdrGradientStop]):
        '''Sets the stops.'''
        ...
...
class CdrImageFill:
    ...
    def __init__(self, id: int, width: float, height: float, is_relative: bool, x_offset: float, y_offset: float, rcp_offset: float, flags: byte):
        '''Initializes a new instance of the  class.
