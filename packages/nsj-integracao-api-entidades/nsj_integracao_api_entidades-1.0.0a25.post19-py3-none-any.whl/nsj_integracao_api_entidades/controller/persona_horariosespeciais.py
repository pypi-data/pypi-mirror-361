...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/horariosespeciais"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/horariosespeciais/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/horariosespeciais/verificacao-integridade"
