...
service = BaseAPIService(
    title="Luma Ray 2 API",
    description="API for Luma Ray 2 video generation model - A high-quality video generation model capable of creating realistic videos with coherent motion from text prompts. Available in 540p and 720p resolutions.",
    version="1.0.0",
