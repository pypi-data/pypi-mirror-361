...
class System(object):
    ...
    # System
    def UefiCapsuleUpdate(self):
        o = flatbuffers.number_types.UOffsetTFlags.py_type(self._tab.Offset(14))
        if o != 0:
            return self._tab.String(o + self._tab.Pos)
        return None

def SystemStart(builder): builder.StartObject(6)
def Start(builder):
...
def SystemAddUefiCapsuleUpdate(builder, uefiCapsuleUpdate): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(uefiCapsuleUpdate), 0)
def AddUefiCapsuleUpdate(builder, uefiCapsuleUpdate):
    return SystemAddUefiCapsuleUpdate(builder, uefiCapsuleUpdate)
...
class SystemT(object):
    ...
    def __init__(self):
        ...
        self.uefiCapsuleUpdate = None  # type: str
    ...
    def __eq__(self, other):
        return type(self) == type(other) and \
            ...
            self.imageUpdateCapable == other.imageUpdateCapable and \
            self.uefiCapsuleUpdate == other.uefiCapsuleUpdate
    ...
    def _UnPack(self, system):
        ...
        self.uefiCapsuleUpdate = system.UefiCapsuleUpdate()
    ...
    def Pack(self, builder):
        ...
        if self.uefiCapsuleUpdate is not None:
            uefiCapsuleUpdate = builder.CreateString(self.uefiCapsuleUpdate)
        SystemStart(builder)
        ...
        if self.uefiCapsuleUpdate is not None:
            SystemAddUefiCapsuleUpdate(builder, uefiCapsuleUpdate)
