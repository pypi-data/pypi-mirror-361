...
def get_driving_coordinates(startPoint: str, endPoint: str, options: o.Options) -> list[list[float]] | None:
    try:
        data = get_driving_data(startPoint, endPoint, options)
...
"""
Получение по маршруту следования
...
any
"""
def get_driving_data(startPoint: str, endPoint: str, options: o.Options):
    try:
