...
class TaskManager:
    ...
    def initialize_db(self) -> None:
        ...
        with db_connection(self.DB_NAME) as cursor:
            ...
            CREATE TABLE IF NOT EXISTS tasks (
                ...
                meta TEXT NOT NULL,
                created_time TEXT NOT NULL,     -- 格式: YYYY-MM-DD HH:MM:SS
                updated_time TEXT NOT NULL,     -- 格式: YYYY-MM-DD HH:MM:SS
                business_type TEXT              -- 新增字段：业务类型
            )
            """)
            # 索引
    ...
    def add_task(self, meta: Dict, business_type: str, status: str = "INIT") -> int:
        """添加新任务（使用完整时间格式）"""
