# Legacy load.py - ALL FUNCTIONS MOVED TO REFACTORED MODULES
...
# Functions are automatically imported and registered via:
# from . import loaders  # in __init__.py

# TODO: Remove this file once confirmed all functionality works
