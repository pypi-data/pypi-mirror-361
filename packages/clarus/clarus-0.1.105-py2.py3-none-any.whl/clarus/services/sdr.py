...
def summary(output=None, **params):
    return clarus.services.api_request('SDR', 'Summary', output=output, **params)

def tradefilter(output=None, **params):
    return clarus.services.api_request('SDR', 'TradeFilter', output=output, **params)

def tradelist(output=None, **params):
    return clarus.services.api_request('SDR', 'TradeList', output=output, **params)
