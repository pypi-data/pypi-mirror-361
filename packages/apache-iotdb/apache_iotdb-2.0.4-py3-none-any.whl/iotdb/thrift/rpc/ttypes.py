...
class TSAggregationQueryReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i509 in range(_size505):
                        _elem510 = iprot.readI32()
                        self.aggregations.append(_elem510)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.paths is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.paths))
            for iter511 in self.paths:
                oprot.writeString(iter511.encode('utf-8') if sys.version_info[0] == 2 else iter511)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.aggregations is not None:
            oprot.writeFieldBegin('aggregations', TType.LIST, 4)
            oprot.writeListBegin(TType.I32, len(self.aggregations))
            for iter512 in self.aggregations:
...
class TSCreateMultiTimeseriesReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i523 in range(_size519):
                        ...
                        self.dataTypes.append(_elem524)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i529 in range(_size525):
                        ...
                        self.encodings.append(_elem530)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.LIST:
                    ...
                    for _i535 in range(_size531):
                        ...
                        self.compressors.append(_elem536)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.LIST:
                    ...
                    for _i541 in range(_size537):
                        ...
                        for _i547 in range(_size543):
                            _key548 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                            _val549 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                            _elem542[_key548] = _val549
                        iprot.readMapEnd()
                        self.propsList.append(_elem542)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.LIST:
                    ...
                    for _i554 in range(_size550):
                        ...
                        for _i560 in range(_size556):
                            _key561 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                            _val562 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                            _elem555[_key561] = _val562
                        iprot.readMapEnd()
                        self.tagsList.append(_elem555)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.LIST:
                    ...
                    for _i567 in range(_size563):
                        ...
                        for _i573 in range(_size569):
                            ...
                            _elem568[_key574] = _val575
                        iprot.readMapEnd()
                        self.attributesList.append(_elem568)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.LIST:
                    ...
                    for _i580 in range(_size576):
                        _elem581 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.measurementAliasList.append(_elem581)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.compressors is not None:
            ...
            oprot.writeListBegin(TType.I32, len(self.compressors))
            for iter585 in self.compressors:
                oprot.writeI32(iter585)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.propsList is not None:
            ...
            for iter586 in self.propsList:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter586))
                for kiter587, viter588 in iter586.items():
        ...
        if self.tagsList is not None:
            ...
            oprot.writeListBegin(TType.MAP, len(self.tagsList))
            for iter589 in self.tagsList:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter589))
                for kiter590, viter591 in iter589.items():
                    oprot.writeString(kiter590.encode('utf-8') if sys.version_info[0] == 2 else kiter590)
                    oprot.writeString(viter591.encode('utf-8') if sys.version_info[0] == 2 else viter591)
                oprot.writeMapEnd()
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.attributesList is not None:
            ...
            oprot.writeListBegin(TType.MAP, len(self.attributesList))
            for iter592 in self.attributesList:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter592))
                for kiter593, viter594 in iter592.items():
                    oprot.writeString(kiter593.encode('utf-8') if sys.version_info[0] == 2 else kiter593)
                    oprot.writeString(viter594.encode('utf-8') if sys.version_info[0] == 2 else viter594)
                oprot.writeMapEnd()
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.measurementAliasList is not None:
            ...
            for iter595 in self.measurementAliasList:
...
class ServerProperties(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i600 in range(_size596):
                        ...
                        self.supportedTimeAggregationOperations.append(_elem601)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.supportedTimeAggregationOperations is not None:
            ...
            for iter602 in self.supportedTimeAggregationOperations:
...
class TSAppendSchemaTemplateReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i613 in range(_size609):
                        ...
                        self.dataTypes.append(_elem614)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.LIST:
                    ...
                    for _i619 in range(_size615):
                        ...
                        self.encodings.append(_elem620)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.LIST:
                    ...
                    for _i625 in range(_size621):
                        ...
                        self.compressors.append(_elem626)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.measurements is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.measurements))
            for iter627 in self.measurements:
        ...
        if self.compressors is not None:
            ...
            oprot.writeListBegin(TType.I32, len(self.compressors))
            for iter630 in self.compressors:
...
class TSQueryTemplateResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i635 in range(_size631):
                        ...
                        self.measurements.append(_elem636)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.measurements is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.measurements))
            for iter637 in self.measurements:
...
class TCreateTimeseriesUsingSchemaTemplateReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i642 in range(_size638):
                        ...
                        self.devicePathList.append(_elem643)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.devicePathList is not None:
            ...
            for iter644 in self.devicePathList:
...
class TPipeSubscribeResp(object):
    ...
    def write(self, oprot):
        ...
        if self.body is not None:
            ...
            for iter651 in self.body:
                oprot.writeBinary(iter651)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TSConnectionInfoResp(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i656 in range(_size652):
                        _elem657 = TSConnectionInfo()
                        _elem657.read(iprot)
                        self.connectionInfoList.append(_elem657)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.connectionInfoList is not None:
            ...
            for iter658 in self.connectionInfoList:
                iter658.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
