...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/perfisusuario"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/perfisusuario/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/perfisusuario/verificacao-integridade"
