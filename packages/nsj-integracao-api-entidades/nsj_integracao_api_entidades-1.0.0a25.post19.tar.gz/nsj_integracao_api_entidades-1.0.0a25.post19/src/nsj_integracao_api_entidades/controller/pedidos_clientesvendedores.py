...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/clientesvendedores"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/clientesvendedores/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/clientesvendedores/verificacao-integridade"
