...
class FileAnalyzer:
    ...
    def find_symbol_references(self, file_path: str, symbol_name: str) -> dict[str, Any]:
        ...
        try:
            ...
            # Format references
            # Note: We return ALL references (including cross-file) as this method
            # is used by both single-file and multi-file reference finding tools
            formatted_references = self.references_op.format_references(
                raw_references, file_lines
            )
