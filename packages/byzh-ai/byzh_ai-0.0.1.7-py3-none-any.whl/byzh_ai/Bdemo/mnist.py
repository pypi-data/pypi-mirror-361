...
def b_mnist(saveDir):
    ...
    myTrainer.set_writer1(saveDir / 'logawa.txt', mode='w')
    ...
    #### 画图 ####
    myTrainer.draw_loss_acc(saveDir / 'checkpoint/latest_checkpoint.jpg', isShow=False)
