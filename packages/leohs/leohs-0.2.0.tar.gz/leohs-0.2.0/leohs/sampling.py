...
def process_chunk_big_gdf(chunk, overlap_points_gdf, overlap_imgs_df, col_names, LS7, LS8, CFMask_filtering, Water, Snow, Pixel_difference,project_ID):
    if project_ID != None:
...
def create_big_gdf(overlap_points_gdf,overlap_df,Max_img_samples,LS7,LS8, SR_or_TOA, num_cores,
    ...
    big_gdf.to_csv(os.path.join(Save_folder_path, f"{dtype}_Landsatsamples.csv"))
