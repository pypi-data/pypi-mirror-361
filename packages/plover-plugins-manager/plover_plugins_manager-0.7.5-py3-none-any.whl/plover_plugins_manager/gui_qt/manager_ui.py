...
class Ui_PluginsManager(object):
    def setupUi(self, PluginsManager):
        ...
        self.install_git = QtWidgets.QToolButton(self.info_frame)
        icon = QtGui.QIcon()
        icon.addFile(":/plugins_manager/git.png", QtCore.QSize(), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.install_git.setIcon(icon)
        self.install_git.setObjectName("install_git")
        self.horizontalLayout.addWidget(self.install_git)
        ...
        self.install_git.clicked.connect(PluginsManager.on_install_git) # type: ignore
    ...
    def retranslateUi(self, PluginsManager):
        ...
        self.install_git.setText(_translate("PluginsManager", "..."))
