 ...
 * Copyright IBM Corporation 1988, 2022. All Rights Reserved.
 *
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcallbackexitcutloop (CPXCALLBACKCONTEXTptr context)
{
   return CPX_CALL (callbackexitcutloop) (context);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcallbackgetrelaxationpi (CPXCALLBACKCONTEXTptr context,
                                double *lrpi, CPXDIM lrbeg,
                                CPXDIM lrend, double *qrpi,
                                int *qrpidef, CPXDIM qrbeg,
                                CPXDIM qrend, double *qzerotol_p)
{
   return CPX_CALL (callbackgetrelaxationpi) (context, lrpi, lrbeg, lrend, qrpi, qrpidef, qrbeg, qrend, qzerotol_p);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcallbackgetrelaxationstatus (CPXCALLBACKCONTEXTptr context,
                                    int *nodelpstat_p, CPXLONG flags)
{
   return CPX_CALL (callbackgetrelaxationstatus) (context, nodelpstat_p, flags);
}


CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcallbackmakebranch (CPXCALLBACKCONTEXTptr context,
                           CPXDIM varcnt, CPXDIM const *varind,
                           char const *varlu, double const *varbd,
                           ...
                           CPXCNT *seqnum_p)
{
   return CPX_CALL (callbackmakebranch) (context, varcnt, varind, varlu, varbd, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, nodeest, seqnum_p);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcallbackprunenode (CPXCALLBACKCONTEXTptr context)
{
   return CPX_CALL (callbackprunenode) (context);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcallbackrejectcandidatelocal (CPXCALLBACKCONTEXTptr context,
                                     CPXDIM rcnt, CPXNNZ nzcnt,
                                     double const *rhs,
                                     char const *sense,
                                     CPXNNZ const *rmatbeg,
                                     ...
                                     double const *rmatval)
{
   return CPX_CALL (callbackrejectcandidatelocal) (context, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetconflictgroups (CPXCENVptr env, CPXCLPptr lp,
                          CPXNNZ *concnt_p, double *grppref,
                          CPXNNZ *grpbeg, CPXDIM *grpind,
                          char *grptype, CPXNNZ grpspace,
                          CPXNNZ *surplus_p, CPXDIM begin, CPXDIM end)
{
   return CPX_CALL (getconflictgroups) (env, lp, concnt_p, grppref, grpbeg, grpind, grptype, grpspace, surplus_p, begin, end);
}


CPX_STATIC_INLINE
CPXNNZ CPXPUBLIC
   CPXXgetconflictnumgroups (CPXCENVptr env, CPXCLPptr lp)
{
   return CPX_CALL (getconflictnumgroups) (env, lp);
}


CPX_STATIC_INLINE
CPXCNT CPXPUBLIC
   CPXXgetconflictnumpasses (CPXCENVptr env, CPXCLPptr lp)
{
   return CPX_CALL (getconflictnumpasses) (env, lp);
}
...
CPX_STATIC_INLINE CPXDEPRECATED(20010000)
int CPXPUBLIC
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXreadcopystartinfo (CPXCENVptr env, CPXLPptr lp,
                          char const *filename_str)
{
   return CPX_CALL (readcopystartinfo) (env, lp, filename_str);
}
