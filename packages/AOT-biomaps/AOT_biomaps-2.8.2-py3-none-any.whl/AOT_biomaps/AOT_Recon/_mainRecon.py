...
class Recon(ABC):
    ...
    def show(self, withTumor=True, savePath=None):
        if withTumor:
            ...
            plt.colorbar()
            plt.subplot(1, 2, 2)
            plt.imshow(image, cmap='hot', vmin=0, vmax=np.max(self.experiment.OpticImage.phantom), extent=(self.experiment.params.general['Xrange'][0],self.experiment.params.general['Xrange'][1], self.experiment.params.general['Zrange'][1], self.experiment.params.general['Zrange'][0]))
            ...
            plt.colorbar()
            plt.subplot(1, 2, 2)
            plt.imshow(image, cmap='hot', vmin=0, vmax=np.max(self.experiment.OpticImage.laser), extent=(self.experiment.params.general['Xrange'][0],self.experiment.params.general['Xrange'][1], self.experiment.params.general['Zrange'][1], self.experiment.params.general['Zrange'][0]))
