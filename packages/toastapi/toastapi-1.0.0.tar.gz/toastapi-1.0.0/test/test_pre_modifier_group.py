...
from toasttab.models.pre_modifier_group import PreModifierGroup

class TestPreModifierGroup(unittest.TestCase):
    """PreModifierGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreModifierGroup:
        """Test PreModifierGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreModifierGroup`
        """
        model = PreModifierGroup()
        if include_optional:
            return PreModifierGroup(
                ...
                reference_id = 56,
                pre_modifiers = [
                    toasttab.models.pre_modifier.PreModifier(
                        name = '', 
                        guid = '', 
                        fixed_price = 1.337, 
                        display_mode = 'PREFIX', )
