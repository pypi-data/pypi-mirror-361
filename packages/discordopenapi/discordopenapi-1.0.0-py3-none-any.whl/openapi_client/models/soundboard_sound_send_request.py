...
class SoundboardSoundSendRequest(BaseModel):
    ...
    source_guild_id: Optional[Annotated[str, Field(strict=True)]] = None
    __properties: ClassVar[List[str]] = ["sound_id", "source_guild_id"]

    @field_validator('sound_id')
    def sound_id_validate_regular_expression(cls, value):
