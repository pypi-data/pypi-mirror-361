...
from .service_providers.bfl_official.adapter import BFLFluxV11ProTextToImageAdapter, BFLFluxV11ProImageToImageAdapter
from .service_providers.littercoder.adapter import LittercoderFluxV11ProTextToImageAdapter, LittercoderFluxV11ProImageToImageAdapter
...
service = BaseAPIService(
    ...
    description="API for Black Forest Labs FLUX-1.1-Pro image generation model",
    version="1.0.0",
    ...
    f"{model_path}/text-to-image": [
        {
            ...
            "adapter": BFLFluxV11ProTextToImageAdapter,
            "request_type": RequestType.ASYNC,
        },
        {
            "service_provider": ServiceProviderEnum.LITTERCODER.value,
            "adapter": LittercoderFluxV11ProTextToImageAdapter,
            "request_type": RequestType.ASYNC,
        }
    ],
    f"{model_path}/image-to-image": [
        {
            "service_provider": ServiceProviderEnum.BLACK_FOREST_LABS.value,
            "adapter": BFLFluxV11ProImageToImageAdapter,
            "request_type": RequestType.ASYNC,
        },
        {
            "service_provider": ServiceProviderEnum.LITTERCODER.value,
            "adapter": LittercoderFluxV11ProImageToImageAdapter,
            "request_type": RequestType.ASYNC,
        }
    ],
}
