...
from tf_quant_finance.math.pde.steppers.parabolic_equation_stepper import (
...
def weighted_implicit_explicit_scheme(theta):
    ...
    def _marching_scheme(value_grid, t1, t2, equation_params_fn):
        ...
        if theta == 0:  # fully implicit scheme
            ...
            rhs = _weighted_scheme_explicit_part(
                value_grid, diag, superdiag, subdiag, theta, t1, t2
            )
        ...
        if theta < 1:
            ...
            return _weighted_scheme_implicit_part(
                rhs, diag, superdiag, subdiag, theta, t1, t2
            )
        return rhs
