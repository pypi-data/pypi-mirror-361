...
class OrderFillEventV1(_message.Message):
    __slots__ = ("maker_order", "order", "liquidation_order", "fill_amount", "maker_fee", "taker_fee", "total_filled_maker", "total_filled_taker", "affiliate_rev_share", "maker_builder_fee", "taker_builder_fee", "maker_builder_address", "taker_builder_address")
    ...
    def __init__(self, maker_order: _Optional[_Union[_clob_pb2.IndexerOrder, _Mapping]] = ..., order: _Optional[_Union[_clob_pb2.IndexerOrder, _Mapping]] = ..., liquidation_order: _Optional[_Union[LiquidationOrderV1, _Mapping]] = ..., fill_amount: _Optional[int] = ..., maker_fee: _Optional[int] = ..., taker_fee: _Optional[int] = ..., total_filled_maker: _Optional[int] = ..., total_filled_taker: _Optional[int] = ..., affiliate_rev_share: _Optional[int] = ..., maker_builder_fee: _Optional[int] = ..., taker_builder_fee: _Optional[int] = ..., maker_builder_address: _Optional[str] = ..., taker_builder_address: _Optional[str] = ...) -> None: ...
