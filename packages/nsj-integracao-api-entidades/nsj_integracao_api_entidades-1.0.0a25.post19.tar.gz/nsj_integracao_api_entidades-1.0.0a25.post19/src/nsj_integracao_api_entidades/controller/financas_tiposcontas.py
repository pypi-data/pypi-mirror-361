...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/tiposcontas"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/tiposcontas/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/tiposcontas/verificacao-integridade"
