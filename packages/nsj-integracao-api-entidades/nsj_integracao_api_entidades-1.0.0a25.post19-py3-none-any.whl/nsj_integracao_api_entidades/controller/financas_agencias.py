...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/agencias"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/agencias/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/agencias/verificacao-integridade"
