...
class OrmProjectEdges(object):
    ...
    def __init__(self, dashboards=None, experiment_fields=None, experiments=None, organization=None, persistent_artifacts=None, pipelines=None, policies=None, primary_owner=None, project_datasets=None, repositories=None, run_executions=None, run_tracking_dashboards=None, run_tracking_fields=None, service_account_subjects=None, tag_group=None, user_starred_projects=None, volume=None, local_vars_configuration=None):  # noqa: E501
