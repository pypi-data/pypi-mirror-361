...
from agent_tools.credential_pool_base import LocalCredentialPool, RemoteCredentialPool


async def test_credential_pool_manager(
    credential_pool_cls: type[LocalCredentialPool | RemoteCredentialPool],
