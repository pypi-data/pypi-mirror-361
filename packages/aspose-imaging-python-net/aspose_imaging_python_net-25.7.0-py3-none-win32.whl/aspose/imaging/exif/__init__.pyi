...
class ExifData(TiffDataTypeController):
    ...
    @overload
    def __init__(self, exifdata: List[aspose.imaging.fileformats.tiff.TiffDataType]):
    ...
    @overload
    def __init__(self, common_tags: List[aspose.imaging.fileformats.tiff.TiffDataType], exif_tags: List[aspose.imaging.fileformats.tiff.TiffDataType], gps_tags: List[aspose.imaging.fileformats.tiff.TiffDataType]):
        '''Initializes a new instance of the  class with data from array.
    ...
    @overload
    def remove_tag(self, tag: aspose.imaging.exif.ExifProperties):
    ...
    def remove_tag_id(self, tag_id: int):
        '''Remove tag from container
    ...
    def aperture_value(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    def brightness_value(self, value : aspose.imaging.fileformats.tiff.TiffSRational):
        ...
    ...
    @color_space.setter
    def color_space(self, value : aspose.imaging.exif.enums.ExifColorSpace):
        ...
    ...
    def compressed_bits_per_pixel(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    @contrast.setter
    def contrast(self, value : aspose.imaging.exif.enums.ExifContrast):
        '''Sets the contrast.'''
        ...
    ...
    def custom_rendered(self, value : aspose.imaging.exif.enums.ExifCustomRendered):
        ...
    ...
    def digital_zoom_ratio(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    def exposure_bias_value(self, value : aspose.imaging.fileformats.tiff.TiffSRational):
        ...
    ...
    def exposure_index(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    def exposure_mode(self, value : aspose.imaging.exif.enums.ExifExposureMode):
        ...
    ...
    def exposure_program(self, value : aspose.imaging.exif.enums.ExifExposureProgram):
        ...
    ...
    def exposure_time(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    @f_number.setter
    def f_number(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    @file_source.setter
    def file_source(self, value : aspose.imaging.exif.enums.ExifFileSource):
        ...
    ...
    @flash.setter
    def flash(self, value : aspose.imaging.exif.enums.ExifFlash):
        '''Sets the flash.'''
        ...
    ...
    @flash_energy.setter
    def flash_energy(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    @focal_length.setter
    def focal_length(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    def focal_plane_resolution_unit(self, value : aspose.imaging.exif.enums.ExifUnit):
        ...
    ...
    def focal_plane_x_resolution(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    def focal_plane_y_resolution(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    @gps_altitude.setter
    def gps_altitude(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    def gps_altitude_ref(self, value : aspose.imaging.exif.enums.ExifGPSAltitudeRef):
        ...
    ...
    @gpsdop.setter
    def gpsdop(self, value : aspose.imaging.fileformats.tiff.TiffRational):
    ...
    def gps_dest_bearing(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    def gps_dest_distance(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    def gps_dest_latitude(self, value : List[aspose.imaging.fileformats.tiff.TiffRational]):
        ...
    ...
    def gps_dest_longitude(self, value : List[aspose.imaging.fileformats.tiff.TiffRational]):
        ...
    ...
    def gps_img_direction(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    @gps_latitude.setter
    def gps_latitude(self, value : List[aspose.imaging.fileformats.tiff.TiffRational]):
        ...
    ...
    def gps_longitude(self, value : List[aspose.imaging.fileformats.tiff.TiffRational]):
        ...
    ...
    @gps_speed.setter
    def gps_speed(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    def gps_timestamp(self, value : List[aspose.imaging.fileformats.tiff.TiffRational]):
        ...
    ...
    @gain_control.setter
    def gain_control(self, value : aspose.imaging.exif.enums.ExifGainControl):
        ...
    ...
    @gamma.setter
    def gamma(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        '''Sets the gamma.'''
        ...
    ...
    def lens_specification(self, value : List[aspose.imaging.fileformats.tiff.TiffRational]):
        ...
    ...
    @light_source.setter
    def light_source(self, value : aspose.imaging.exif.enums.ExifLightSource):
        ...
    ...
    def max_aperture_value(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    def metering_mode(self, value : aspose.imaging.exif.enums.ExifMeteringMode):
        ...
    ...
    @orientation.setter
    def orientation(self, value : aspose.imaging.exif.enums.ExifOrientation):
    ...
    @properties.setter
    def properties(self, value : List[aspose.imaging.fileformats.tiff.TiffDataType]):
    ...
    @saturation.setter
    def saturation(self, value : aspose.imaging.exif.enums.ExifSaturation):
        '''Sets the saturation.'''
        ...
    ...
    def scene_capture_type(self, value : aspose.imaging.exif.enums.ExifSceneCaptureType):
        ...
    ...
    def sensing_method(self, value : aspose.imaging.exif.enums.ExifSensingMethod):
        ...
    ...
    def shutter_speed_value(self, value : aspose.imaging.fileformats.tiff.TiffSRational):
        ...
    ...
    def subject_distance(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    def subject_distance_range(self, value : aspose.imaging.exif.enums.ExifSubjectDistanceRange):
        ...
    ...
    def white_balance(self, value : aspose.imaging.exif.enums.ExifWhiteBalance):
        ...
    ...
    @white_point.setter
    def white_point(self, value : List[aspose.imaging.fileformats.tiff.TiffRational]):
        ...
    ...
    @common_tags.setter
    def common_tags(self, value : List[aspose.imaging.fileformats.tiff.TiffDataType]):
        ...
    ...
    @exif_tags.setter
    def exif_tags(self, value : List[aspose.imaging.fileformats.tiff.TiffDataType]):
        ...
    ...
    @gps_tags.setter
    def gps_tags(self, value : List[aspose.imaging.fileformats.tiff.TiffDataType]):
        ...
    
    ...

class IHasExifData(aspose.imaging.IHasMetadata):
...
class IHasJpegExifData(IHasExifData):
    '''instance container interface.'''
...
class JpegExifData(ExifData):
    ...
    @overload
    def __init__(self, exifdata: aspose.imaging.exif.ExifData):
        '''Initializes a new instance of the  class with data from array.
    ...
    def primary_chromaticities(self, value : List[aspose.imaging.fileformats.tiff.TiffRational]):
        ...
    ...
    def reference_black_white(self, value : List[aspose.imaging.fileformats.tiff.TiffRational]):
        ...
    ...
    def resolution_unit(self, value : aspose.imaging.exif.enums.ExifUnit):
        ...
    ...
    @thumbnail.setter
    def thumbnail(self, value : aspose.imaging.RasterImage):
    ...
    @x_resolution.setter
    def x_resolution(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
    ...
    def y_cb_cr_positioning(self, value : aspose.imaging.exif.enums.ExifYCbCrPositioning):
        ...
    ...
    @y_resolution.setter
    def y_resolution(self, value : aspose.imaging.fileformats.tiff.TiffRational):
        ...
