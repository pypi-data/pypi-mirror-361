...
class Billing(TypedDict, total=False):
    ...
    provider_type: Required[Annotated[Literal["BillingProvider"], PropertyInfo(alias="providerType")]]
...
class EventMapping(TypedDict, total=False):
    _277: Annotated[str, PropertyInfo(alias="277")]
...
class Referring(TypedDict, total=False):
    ...
    provider_type: Required[Annotated[Literal["ReferringProvider"], PropertyInfo(alias="providerType")]]
