...
from toasttab.models.orders_order_guid_delivery_info_patch_request import OrdersOrderGuidDeliveryInfoPatchRequest

class TestOrdersOrderGuidDeliveryInfoPatchRequest(unittest.TestCase):
    """OrdersOrderGuidDeliveryInfoPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrdersOrderGuidDeliveryInfoPatchRequest:
        """Test OrdersOrderGuidDeliveryInfoPatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrdersOrderGuidDeliveryInfoPatchRequest`
        """
        model = OrdersOrderGuidDeliveryInfoPatchRequest()
        if include_optional:
            return OrdersOrderGuidDeliveryInfoPatchRequest(
                delivered_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                dispatched_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
    ...
    def testOrdersOrderGuidDeliveryInfoPatchRequest(self):
        """Test OrdersOrderGuidDeliveryInfoPatchRequest"""
