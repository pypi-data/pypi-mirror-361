...
class RectangularCapsule3(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RectangularCapsule3 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RectangularCapsule3 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "shape_type": obj.get("shape_type") if obj.get("shape_type") is not None else 'rectangular_capsule',
