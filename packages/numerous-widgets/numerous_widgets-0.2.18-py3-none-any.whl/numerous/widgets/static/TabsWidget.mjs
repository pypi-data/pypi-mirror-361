...
}, defaultPrevented: 0, isTrusted: 0 }, qu = we(ut), Zt = A({}, ut, { view: 0, detail: 0 }), Yc = we(Zt), xl, _l, pt, nl = A({}, Zt, { screenX: 0, screenY: 0, clientX: 0, clientY: 0, pageX: 0, pageY: 0, ctrlKey: 0, shiftKey: 0, altKey: 0, metaKey: 0, getModifierState: bu, button: 0, buttons: 0, relatedTarget: function(e) {
...
} }), Xo = we(nl), Xc = A({}, nl, { dataTransfer: 0 }), Gc = we(Xc), Zc = A({}, Zt, { relatedTarget: 0 }), Nl = we(Zc), Jc = A({}, ut, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }), qc = we(Jc), bc = A({}, ut, { clipboardData: function(e) {
...
} }), sf = we(of), af = A({}, nl, { pointerId: 0, width: 0, height: 0, pressure: 0, tangentialPressure: 0, tiltX: 0, tiltY: 0, twist: 0, pointerType: 0, isPrimary: 0 }), Zo = we(af), cf = A({}, Zt, { touches: 0, targetTouches: 0, changedTouches: 0, altKey: 0, metaKey: 0, ctrlKey: 0, shiftKey: 0, getModifierState: bu }), ff = we(cf), df = A({}, ut, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }), pf = we(df), mf = A({}, nl, {
  deltaX: function(e) {
...
function _d({
  ...
  return U.useEffect(() => {
    l && o && o(!1);
  }, [l, o]), /* @__PURE__ */ U.createElement("div", { className: "tabs-container" }, t && /* @__PURE__ */ U.createElement("label", { className: "tabs-label" }, /* @__PURE__ */ U.createElement("span", null, t), r && /* @__PURE__ */ U.createElement(xd, { tooltip: r })), /* @__PURE__ */ U.createElement("div", { className: "tabs-list" }, /* @__PURE__ */ U.createElement("div", { className: "tabs-row" }, n.map((i) => /* @__PURE__ */ U.createElement(
    "div",
    {
      key: i,
      className: `tab ${e === i ? "active" : ""}`,
      onClick: () => u(i)
    },
    i
  )))));
