...
def search_docs(query: str, category: str | None = None, top_n: int = 20) -> dict[str, object]:
    """
    ...
    try:
        ...
        results = repository.search_documents(keywords, category=category, top_n=top_n)
