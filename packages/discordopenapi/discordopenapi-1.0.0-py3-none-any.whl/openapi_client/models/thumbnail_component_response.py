...
class ThumbnailComponentResponse(BaseModel):
    ...
    spoiler: StrictBool
    __properties: ClassVar[List[str]] = ["type", "id", "media", "description", "spoiler"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "media": UnfurledMediaResponse.from_dict(obj["media"]) if obj.get("media") is not None else None,
