...
class Added(BaseModel):
    ...
    signer_phone_number: Optional[StrictStr] = Field(default=None, alias="signerPhoneNumber")
    __properties: ClassVar[List[str]] = ["signerName", "signerEmail", "signerPhoneNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "signerPhoneNumber": obj.get("signerPhoneNumber")
        })
        return _obj
