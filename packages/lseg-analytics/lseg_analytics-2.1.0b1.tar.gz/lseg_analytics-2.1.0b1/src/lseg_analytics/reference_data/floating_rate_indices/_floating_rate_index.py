    ...
    def _create(self, location: Location) -> None:
        ...
        try:
            ...
            response = check_and_raise(
                Client().floating_rate_indices_resource.create(
                    location=location,
            ...
            logger.error(f"Error creating FloatingRateIndex: {err}")
            raise err

    def _overwrite(self) -> None:
        """
        Overwrite a FloatingRateIndex that exists in the platform.
