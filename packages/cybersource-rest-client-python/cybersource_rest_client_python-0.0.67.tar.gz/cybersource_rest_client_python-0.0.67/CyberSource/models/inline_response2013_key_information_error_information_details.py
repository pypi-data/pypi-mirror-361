...
class InlineResponse2013KeyInformationErrorInformationDetails(object):
    """
    ...
    def __init__(self, field=None, reason=None):
        """
        InlineResponse2013KeyInformationErrorInformationDetails - a model defined in Swagger
        """
    ...
    def field(self, field):
        """
        Sets the field of this InlineResponse2013KeyInformationErrorInformationDetails.
        This is the flattened JSON object field name/path that is either missing or invalid
    ...
    def reason(self, reason):
        """
        Sets the reason of this InlineResponse2013KeyInformationErrorInformationDetails.
        Possible reasons for the error. Possible values:  - MISSING_FIELD  - INVALID_DATA 
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InlineResponse2013KeyInformationErrorInformationDetails):
            return False
