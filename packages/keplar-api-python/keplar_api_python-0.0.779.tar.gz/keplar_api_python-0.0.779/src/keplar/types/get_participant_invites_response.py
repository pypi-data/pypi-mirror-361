...
class GetParticipantInvitesResponse(UniversalBaseModel):
    participant_invites: typing_extensions.Annotated[
        typing.List["ParticipantInvite"], FieldMetadata(alias="participantInvites")
    ]
    total: float
...
update_forward_refs(GetParticipantInvitesResponse)
