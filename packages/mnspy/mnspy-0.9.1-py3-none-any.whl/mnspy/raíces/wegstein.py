...
class Wegstein(Raices):
    ...
    x_0: float
        valor del primer x inicial para cálculo de la pendiente
    x_1: float
        valor del segundo x inicial para cálculo de la pendiente
    tol: float | int
    ...
    graficar(mostrar_sol: bool, mostrar_iter: bool, mostrar_lin_iter: bool, n_puntos: int):
        Realiza la gráfica del cálculo de la raíz por el método de Wegstein.
