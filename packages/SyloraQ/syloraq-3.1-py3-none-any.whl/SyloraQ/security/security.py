...
def derive_key_bytes(password: str, salt: bytes = b'some_salt_here', iterations: int = 100_000, key_len: int = 16) -> bytes:return hashlib.pbkdf2_hmac('sha256', password.encode(), salt, iterations, dklen=key_len)
