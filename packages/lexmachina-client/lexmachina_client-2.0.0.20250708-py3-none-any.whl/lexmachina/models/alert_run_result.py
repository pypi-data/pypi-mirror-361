...
class AlertRunResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertId", "type", "count", "run", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "run": obj.get("run"),
            "items": [AlertItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
