...
from toasttab.models.job_wage_override import JobWageOverride

class TestJobWageOverride(unittest.TestCase):
    """JobWageOverride unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobWageOverride:
        """Test JobWageOverride
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobWageOverride`
        """
        model = JobWageOverride()
        if include_optional:
            return JobWageOverride(
                wage = 1.337,
                job_reference = toasttab.models.external_reference.ExternalReference()
            )
        else:
            return JobWageOverride(
                wage = 1.337,
