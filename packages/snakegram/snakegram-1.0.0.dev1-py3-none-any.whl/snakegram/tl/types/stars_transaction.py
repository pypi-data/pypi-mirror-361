...
class StarsTransaction(TLObject, family='TypeStarsTransaction'):
    ...
    def __init__(
        ...
        Args:
            ...
            stars ('TypeStarsAmount'): Amount of Stars (negative for outgoing transactions).
    ...
    def to_bytes(self, boxed: bool=True):
        with Writer(b'&\xc9\xdfd' if boxed else b'') as writer:
