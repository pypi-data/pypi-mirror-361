...
CDN_T="https://t.cdn.fostrom.dev/fostrom-device-agent/$VERSION"
CDN_B="https://b.cdn.fostrom.dev/fostrom-device-agent/$VERSION"
CDN_C="https://c.cdn.fostrom.dev/fostrom-device-agent/$VERSION"
...
try_download() {
    ...
    for CDN_URL in "$CDN_T" "$CDN_B" "$CDN_C"; do
