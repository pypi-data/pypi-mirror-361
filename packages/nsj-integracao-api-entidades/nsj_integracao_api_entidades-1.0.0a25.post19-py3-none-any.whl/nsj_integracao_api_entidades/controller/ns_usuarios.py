...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/usuarios"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/usuarios/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/usuarios/verificacao-integridade"
