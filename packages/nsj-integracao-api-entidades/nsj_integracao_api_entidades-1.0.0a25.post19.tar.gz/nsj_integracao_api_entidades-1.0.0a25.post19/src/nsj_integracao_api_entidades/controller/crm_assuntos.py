...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/assuntos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/assuntos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/assuntos/verificacao-integridade"
