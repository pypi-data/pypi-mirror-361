...
from .service_providers.bfl_official.adapter import BFLFluxV1DevTextToImageAdapter, BFLFluxV1DevImageToImageAdapter
from .service_providers.littercoder.adapter import LittercoderFluxV1DevTextToImageAdapter, LittercoderFluxV1DevImageToImageAdapter
...
service = BaseAPIService(
    ...
    description="API for Black Forest Labs FLUX-1.0-Dev image generation model",
    version="1.0.0",
    ...
    f"{model_path}/text-to-image": [
        {
            ...
            "adapter": BFLFluxV1DevTextToImageAdapter,
            "request_type": RequestType.ASYNC,
        },
        {
            "service_provider": ServiceProviderEnum.LITTERCODER.value,
            "adapter": LittercoderFluxV1DevTextToImageAdapter,
            "request_type": RequestType.ASYNC,
        }
    ],
    f"{model_path}/image-to-image": [
        {
            "service_provider": ServiceProviderEnum.BLACK_FOREST_LABS.value,
            "adapter": BFLFluxV1DevImageToImageAdapter,
            "request_type": RequestType.ASYNC,
        },
        {
            "service_provider": ServiceProviderEnum.LITTERCODER.value,
            "adapter": LittercoderFluxV1DevImageToImageAdapter,
            "request_type": RequestType.ASYNC,
        }
    ],
} 
