        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "payment_method": {"type": "string", "enum": ["bank", "paypal", "cash", "venmo", "zelle", "cash_app"]},
                    "payment_method_details": {"type": "string", "description": "Payment method details"},
                    "user_id": {"type": "string", "description": "User ID (optional)"},
                },
                "required": ["customer_email", "customer_name", "payment_method"],
            },
        ),
        types.Tool(
