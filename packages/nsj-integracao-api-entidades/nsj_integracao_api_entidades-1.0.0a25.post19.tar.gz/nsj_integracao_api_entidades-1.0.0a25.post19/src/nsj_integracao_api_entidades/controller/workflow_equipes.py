...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/equipes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/equipes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/equipes/verificacao-integridade"
