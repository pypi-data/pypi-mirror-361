...
class ArcCmsRouter:
    ...
    def register_routes(cls, router: APIRouter, base_path: Union[Path, str]):
        ...
        try:
            ...
            logger.info(f"[pyarccore -> router.py] ArcCmsRouter | register_routes - modules_metadata: {modules_metadata}")
            ...
            if modules_dir.exists():
                for module_name in modules_metadata.keys():
                    ...
                    logger.info(f"[pyarccore -> router.py] ArcCmsRouter | register_routes - datas: {cstmParams1}")
