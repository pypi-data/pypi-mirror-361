...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/segmentosatuacao"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/segmentosatuacao/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/crm/segmentosatuacao/verificacao-integridade"
