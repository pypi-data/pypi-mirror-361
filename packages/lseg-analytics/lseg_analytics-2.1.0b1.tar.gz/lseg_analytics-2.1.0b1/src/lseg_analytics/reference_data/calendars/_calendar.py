...
class Calendar(ResourceBase):
    ...
    def compute_dates(
        ...
        *,
        ...
        try:
            ...
            logger.error(f"Error compute_dates for calendar with id. {err}")
    ...
    def count_periods(
        ...
        *,
        ...
        try:
            ...
            logger.error(f"Error count_periods for calendar with id. {err}")
            check_exception_and_raise(err)
    ...
    def _create(self, location: Location) -> None:
        ...
        try:
            ...
            logger.error(f"Error creating Calendar: {err}")
            raise err
    ...
    def generate_date_schedule(
        ...
        *,
        ...
        try:
            ...
            logger.error(f"Error generate_date_schedule for calendar with id. {err}")
            check_exception_and_raise(err)
    ...
    def generate_holidays(
        ...
        *,
        ...
        try:
            ...
            logger.error(f"Error generate_holidays for calendar with id. {err}")
            check_exception_and_raise(err)

    def _overwrite(self) -> None:
        """
        Overwrite a Calendar that exists in the platform.
