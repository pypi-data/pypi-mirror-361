...
conf = cloudbeds_pms_v1_3.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.cloudbeds.com/api/v1.3" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("cloudbeds_pms_v1_3")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "https://api.cloudbeds.com/api/v1.3",
