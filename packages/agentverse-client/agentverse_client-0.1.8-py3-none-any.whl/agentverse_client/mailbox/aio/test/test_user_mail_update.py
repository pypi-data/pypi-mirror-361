...
class TestUserMailUpdate(unittest.TestCase):
    """UserMailUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserMailUpdate:
        """Test UserMailUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserMailUpdate`
        """
        model = UserMailUpdate()
        if include_optional:
            return UserMailUpdate(
                email = ''
            )
        else:
            return UserMailUpdate(
