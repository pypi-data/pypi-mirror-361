...
class EmbeddedSigningLink(BaseModel):
    """
    EmbeddedSigningLink
    """ # noqa: E501
    sign_link: Optional[StrictStr] = Field(default=None, alias="signLink")
    __properties: ClassVar[List[str]] = ["signLink"]
