...
resname_1to3 = {v: k for k, v in resname_3to1.items()}
...
def get_standard_atom_mask(restype) -> np.ndarray:
    res3 = restype if len(restype) == 3 else resname_1to3(restype)
    mask = np.array(resname_to_atom14names[res3]) != ''
    return mask
