...
class FxForwardCurve(ResourceBase):
    ...
    def calculate(
        ...
        *,
        ...
        try:
            ...
            logger.error(f"Error calculate for fxForwardCurve with id. {err}")
    ...
    def _create(self, location: Location) -> None:
        ...
        try:
            ...
            logger.error(f"Error creating FxForwardCurve: {err}")
            raise err

    def _overwrite(self) -> None:
        """
        Overwrite a FxForwardCurve that exists in the platform.
