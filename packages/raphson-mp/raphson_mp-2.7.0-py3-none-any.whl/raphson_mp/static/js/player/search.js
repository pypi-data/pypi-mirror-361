...
import { AlbumBrowse, ArtistBrowse, browse, populateTrackTable } from "./browse.js";
...
class Search {
    ...
    async #performSearch(searchNow = false) {
        ...
        // Tracks
        {
            ...
            await populateTrackTable(this.#searchResultTracks, tracks);
        }
        ...
        // Albums
        {
            ...
            for (const album of albums) {
                ...
                const imgUri = album.getCoverURL('low', false);
                ...
                result.addEventListener('click', () => browse.browse(new AlbumBrowse(album.name, album.artist)));
