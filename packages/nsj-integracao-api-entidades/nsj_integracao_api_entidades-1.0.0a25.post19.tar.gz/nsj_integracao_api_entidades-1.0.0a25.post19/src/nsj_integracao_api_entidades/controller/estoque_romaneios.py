...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/romaneios"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/romaneios/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/romaneios/verificacao-integridade"
