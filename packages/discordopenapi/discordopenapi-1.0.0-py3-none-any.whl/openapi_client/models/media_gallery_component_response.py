...
class MediaGalleryComponentResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "id", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "items": [MediaGalleryItemResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
