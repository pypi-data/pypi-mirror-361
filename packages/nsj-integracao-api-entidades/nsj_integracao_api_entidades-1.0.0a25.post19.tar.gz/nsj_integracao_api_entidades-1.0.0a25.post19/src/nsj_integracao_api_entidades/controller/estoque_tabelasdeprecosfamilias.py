...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/tabelasdeprecosfamilias"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/tabelasdeprecosfamilias/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/tabelasdeprecosfamilias/verificacao-integridade"
