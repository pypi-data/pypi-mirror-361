...
class MAKELA1(AbstractConstrainedMinimisation):
    """MAKELA1 problem - A nonlinear minmax problem.
    ...
    def constraint(self, y):
        ...
        # Constraints:
        # F1: -u - x1 - x2 <= 0
        # F2: -u - x1 - x2 + x1^2 + x2^2 <= -1
        c1 = -u - x1 - x2
        c2 = -u - x1 - x2 + x1**2 + x2**2 - 1.0
