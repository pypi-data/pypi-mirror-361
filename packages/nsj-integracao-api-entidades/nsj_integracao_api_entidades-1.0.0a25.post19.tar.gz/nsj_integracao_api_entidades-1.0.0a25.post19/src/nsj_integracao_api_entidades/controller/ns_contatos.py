...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/contatos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/contatos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/contatos/verificacao-integridade"
