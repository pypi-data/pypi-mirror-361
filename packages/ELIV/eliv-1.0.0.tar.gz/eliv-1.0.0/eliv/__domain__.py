...
class ELIVDomain:
    """
    The ELIVDomain class serves as a client for interacting with the ELIV DNS API.

    This class provides functionality to manage domains, such as querying TLD
    information, checking domain availability, registering domains, updating
    domain settings, and retrieving domain details.
