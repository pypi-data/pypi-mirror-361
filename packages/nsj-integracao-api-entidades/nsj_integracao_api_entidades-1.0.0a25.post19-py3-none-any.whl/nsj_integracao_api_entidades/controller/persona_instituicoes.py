...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/instituicoes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/instituicoes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/instituicoes/verificacao-integridade"
