...
class NotificationSettings(BaseModel):
    ...
    """ # noqa: E501
    viewed: Optional[StrictBool] = True
    sent: Optional[StrictBool] = False
    delivery_failed: Optional[StrictBool] = Field(default=True, alias="deliveryFailed")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "viewed": obj.get("viewed") if obj.get("viewed") is not None else True,
            "sent": obj.get("sent") if obj.get("sent") is not None else False,
            "deliveryFailed": obj.get("deliveryFailed") if obj.get("deliveryFailed") is not None else True,
