...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/faixas"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/faixas/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/faixas/verificacao-integridade"
