    ...
    SELECT 
        ...
        CASE 
            WHEN LOWER(Column_Name) LIKE '%phone%' OR LOWER(Column_Name) LIKE '%address%' 
              ...
              OR LOWER(Column_Name) = 'ssn' THEN 1 ELSE 0 END AS has_PII
    FROM oct_column
...
left join AppliedRLS b on c.Dataset_ID = b.DatasetID and c.Table_Name = b.TargetTable    
    """)
    df.write.mode("overwrite").saveAsTable("oct_TablesRLS_Check")
...
def oct_graph_relationships():
    ...
    result_df.write.format("delta").mode("overwrite").saveAsTable("oct_graph_relationships")
...
def final_optimize_tables():
    table_paths = [
        ...
        "abfss://07df884c-5185-45e4-9c8e-ebee3aca6605@msit-onelake.dfs.fabric.microsoft.com/2a5d1cfa-70ba-438a-a5ec-d5a288b58d17/Tables/ds_published_status",
        "abfss://07df884c-5185-45e4-9c8e-ebee3aca6605@msit-onelake.dfs.fabric.microsoft.com/2a5d1cfa-70ba-438a-a5ec-d5a288b58d17/Tables/oct_measuresbridge",
        "abfss://07df884c-5185-45e4-9c8e-ebee3aca6605@msit-onelake.dfs.fabric.microsoft.com/2a5d1cfa-70ba-438a-a5ec-d5a288b58d17/Tables/oct_tables_without_relationship",
        "abfss://07df884c-5185-45e4-9c8e-ebee3aca6605@msit-onelake.dfs.fabric.microsoft.com/2a5d1cfa-70ba-438a-a5ec-d5a288b58d17/Tables/oct_roles_v1_final",
        "abfss://07df884c-5185-45e4-9c8e-ebee3aca6605@msit-onelake.dfs.fabric.microsoft.com/2a5d1cfa-70ba-438a-a5ec-d5a288b58d17/Tables/msxitelemetry_details",
        "abfss://07df884c-5185-45e4-9c8e-ebee3aca6605@msit-onelake.dfs.fabric.microsoft.com/2a5d1cfa-70ba-438a-a5ec-d5a288b58d17/Tables/oct_columnv1",
        "abfss://07df884c-5185-45e4-9c8e-ebee3aca6605@msit-onelake.dfs.fabric.microsoft.com/2a5d1cfa-70ba-438a-a5ec-d5a288b58d17/Tables/oct_tablesrls_check",
        "abfss://07df884c-5185-45e4-9c8e-ebee3aca6605@msit-onelake.dfs.fabric.microsoft.com/2a5d1cfa-70ba-438a-a5ec-d5a288b58d17/Tables/oct_graph_relationships"
        ]
