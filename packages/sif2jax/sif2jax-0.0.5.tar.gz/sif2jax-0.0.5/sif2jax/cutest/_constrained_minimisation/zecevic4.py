...
class ZECEVIC4(AbstractConstrainedMinimisation):
    """ZECEVIC4 problem - Problem 4 from Zecevic.
    ...
    def objective(self, y, args):
        ...
        # OBJ = -60*x1 - 8*x2 + 6*x1^2 + x2^2 + 166
        # Note: pycutest seems to add the constant instead of subtracting
        return -60.0 * x1 - 8.0 * x2 + 6.0 * x1**2 + x2**2 + 166.0
