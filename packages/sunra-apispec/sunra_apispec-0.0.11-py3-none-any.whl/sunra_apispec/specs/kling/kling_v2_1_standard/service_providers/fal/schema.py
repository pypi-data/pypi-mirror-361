...
class KlingVideoV21StandardImageToVideoInput(BaseModel):
    """Input schema for Kling V2.1 Standard Image-to-Video generation via FAL."""
...
class KlingVideoV21StandardImageToVideoOutput(BaseModel):
    """Output schema for Kling V2.1 Standard Image-to-Video generation via FAL."""
