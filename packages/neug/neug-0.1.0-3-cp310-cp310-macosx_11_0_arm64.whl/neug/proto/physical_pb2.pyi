...
class PhysicalOpr(google.protobuf.message.Message):
    ...
    class Operator(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["apply", b"apply", "create_edge", b"create_edge", "create_vertex", b"create_vertex", "dedup", b"dedup", "delete", b"delete", "delete_edge", b"delete_edge", "delete_vertex", b"delete_vertex", "edge", b"edge", "group_by", b"group_by", "intersect", b"intersect", "join", b"join", "limit", b"limit", "load", b"load", "load_edge", b"load_edge", "load_vertex", b"load_vertex", "op_kind", b"op_kind", "order_by", b"order_by", "path", b"path", "procedure_call", b"procedure_call", "project", b"project", "repartition", b"repartition", "root", b"root", "sample", b"sample", "scan", b"scan", "select", b"select", "set", b"set", "set_edge", b"set_edge", "set_vertex", b"set_vertex", "sink", b"sink", "source", b"source", "unfold", b"unfold", "union", b"union", "vertex", b"vertex"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["apply", b"apply", "create_edge", b"create_edge", "create_vertex", b"create_vertex", "dedup", b"dedup", "delete", b"delete", "delete_edge", b"delete_edge", "delete_vertex", b"delete_vertex", "edge", b"edge", "group_by", b"group_by", "intersect", b"intersect", "join", b"join", "limit", b"limit", "load", b"load", "load_edge", b"load_edge", "load_vertex", b"load_vertex", "op_kind", b"op_kind", "order_by", b"order_by", "path", b"path", "procedure_call", b"procedure_call", "project", b"project", "repartition", b"repartition", "root", b"root", "sample", b"sample", "scan", b"scan", "select", b"select", "set", b"set", "set_edge", b"set_edge", "set_vertex", b"set_vertex", "sink", b"sink", "source", b"source", "unfold", b"unfold", "union", b"union", "vertex", b"vertex"]) -> None: ...
        def WhichOneof(self, oneof_group: typing.Literal["op_kind", b"op_kind"]) -> typing.Literal["project", "select", "group_by", "order_by", "dedup", "unfold", "limit", "scan", "sink", "apply", "join", "union", "intersect", "repartition", "root", "sample", "vertex", "edge", "path", "procedure_call", "set", "load", "delete", "source", "load_vertex", "load_edge", "create_vertex", "create_edge", "set_vertex", "set_edge", "delete_vertex", "delete_edge"] | None: ...
...
class QueryPlan(google.protobuf.message.Message):
    ...
    class _ModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[QueryPlan._Mode.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def ClearField(self, field_name: typing.Literal["mode", b"mode", "plan", b"plan"]) -> None: ...
...
class PhysicalPlan(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["ddl_plan", b"ddl_plan", "plan", b"plan", "query_plan", b"query_plan"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["ddl_plan", b"ddl_plan", "plan", b"plan", "plan_id", b"plan_id", "query_plan", b"query_plan"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["plan", b"plan"]) -> typing.Literal["ddl_plan", "query_plan"] | None: ...
...
class PhysicalPlans(google.protobuf.message.Message):
    ...
    @property
    def plans(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PhysicalPlan]: ...
    def __init__(
        self,
        *,
