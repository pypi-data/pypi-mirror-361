...
app.add_typer(
    models.app,
    name="models",
    help="Interact with the Model Registry.",
)


@app.command(
    help="Interactive login to the Apheris platform. You will be forwarded to a website. "
...
@app.command(help="Log out of the Apheris platform.")
def logout():
    import apheris_auth
