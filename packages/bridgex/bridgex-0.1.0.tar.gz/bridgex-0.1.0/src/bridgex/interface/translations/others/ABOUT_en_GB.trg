...
<div class="main">
    <section id="main-about">
        <h1 id="header">Bridgex</h1>
        <div class="logo center">
            <img src=":/img/logo-bridgex-2" width="200" class="center logo-bridgex"/>
    <pre>&copy;2025 <a href="https://github.com/Dev2Forge">Dev2Forge</a> - <a href="https://github.com/Dev2Forge/bridgex/blob/main/LICENSE">MIT</a></pre>
        </div>
        <div id="content-about">
            <p>
            Bridgex provides a simple graphical interface for automatically converting documents to Markdown format.
          </p>
    ...
    ".zip", ".mhtml",".htm", ".epub", ".html"</pre>
        <p><strong>And Many More!</strong></p>
          <p>
            When loading a file, Bridgex extracts plain text and transforms it into Markdown while maintaining the structure whenever possible.
    ...
    <div>
        ...
        <pre class="center">Support <a href="mailto:bridgex@dev2forge.software">bridgex@dev2forge.software</a></pre>
    </div>
</div>