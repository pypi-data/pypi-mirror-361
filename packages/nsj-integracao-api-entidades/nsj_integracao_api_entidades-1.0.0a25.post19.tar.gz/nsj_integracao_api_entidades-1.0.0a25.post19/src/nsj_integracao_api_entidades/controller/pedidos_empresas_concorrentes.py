...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/empresas_concorrentes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/empresas_concorrentes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/empresas_concorrentes/verificacao-integridade"
