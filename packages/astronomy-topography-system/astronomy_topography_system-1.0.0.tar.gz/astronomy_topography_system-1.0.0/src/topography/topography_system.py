...
try:
    from astronomy_ai.elevation.elevation_api import ElevationAPI
    from astronomy_ai.utils.location_parser import LocationParser
    from astronomy_ai.analysis.contour_analyzer import ContourAnalyzer
    from astronomy_ai.analysis.obstruction_calculator import ObstructionCalculator
except ImportError:
