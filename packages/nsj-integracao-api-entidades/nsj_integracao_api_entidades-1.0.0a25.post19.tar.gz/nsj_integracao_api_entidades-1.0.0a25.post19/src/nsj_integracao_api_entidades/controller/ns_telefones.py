...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/telefones"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/telefones/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/telefones/verificacao-integridade"
