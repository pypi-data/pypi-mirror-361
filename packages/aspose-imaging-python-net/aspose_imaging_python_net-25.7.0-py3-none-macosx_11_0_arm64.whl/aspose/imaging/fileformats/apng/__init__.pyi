...
class ApngImage(aspose.imaging.RasterCachedMultipageImage):
    ...
    def __init__(self, options: aspose.imaging.imageoptions.ApngOptions, width: int, height: int):
        '''Begin working with the  class by initializing
    ...
    @overload
    def add_frame(self, frame_image: aspose.imaging.RasterImage):
    ...
    @overload
    def add_frame(self, frame_image: aspose.imaging.RasterImage, frame_time: int):
    ...
    @overload
    def insert_frame(self, index: int, frame_image: aspose.imaging.RasterImage):
    ...
    @overload
    def insert_frame(self, index: int, frame_image: aspose.imaging.RasterImage, frame_time: int):
        '''Inserts new frame into the own frame collection at the specified index.
        The contents of the new frame will be filled from the specified image.
    ...
    def set_default_image(self, image: aspose.imaging.RasterImage):
    ...
    def interlaced(self) -> bool:
        '''Quickly determine whether this  object is interlaced
