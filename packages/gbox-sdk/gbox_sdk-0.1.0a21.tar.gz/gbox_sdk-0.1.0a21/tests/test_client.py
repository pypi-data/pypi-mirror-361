...
from gbox_sdk._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: GboxClient | AsyncGboxClient) -> int:
...
class TestGboxClient:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "gbox_sdk/_legacy_response.py",
                        "gbox_sdk/_response.py",
    ...
    def test_multipart_repeating_array(self, client: GboxClient) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = GboxClient(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        ...
        with update_env(GBOX_CLIENT_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                GboxClient(api_key=api_key, _strict_response_validation=True, environment="production")
    ...
    def test_base_url_trailing_slash(self, client: GboxClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: GboxClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: GboxClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = GboxClient(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: GboxClient) -> None:
        respx_mock.post("/boxes/android").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    @mock.patch("gbox_sdk._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: GboxClient) -> None:
        respx_mock.post("/boxes/android").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/boxes/android").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: GboxClient, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.v1.boxes.with_raw_response.create_android(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.v1.boxes.with_raw_response.create_android(extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncGboxClient:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncGboxClient) -> None:
    ...
    def test_base_url_env(self) -> None:
        ...
        with update_env(GBOX_CLIENT_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                AsyncGboxClient(api_key=api_key, _strict_response_validation=True, environment="production")
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncGboxClient(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    async def test_retries_taken(
        ...
        response = await client.v1.boxes.with_raw_response.create_android()
    ...
    def test_get_platform(self) -> None:
        ...
        from gbox_sdk._utils import asyncify
        from gbox_sdk._base_client import get_platform
