...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('dt', '_lin_solver_args', '_lin_solver_cls', 'time', 'gfu_old', 'c', 'bfmstar')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('dt', '_lin_solver_args', 'gfv_old', '_lin_solver_cls', 'time', 'gfu_old', 'gfa_old', 'c', 'bfmstar')
