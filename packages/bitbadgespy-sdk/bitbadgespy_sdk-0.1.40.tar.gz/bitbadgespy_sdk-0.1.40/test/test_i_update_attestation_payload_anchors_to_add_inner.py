...
class TestIUpdateAttestationPayloadAnchorsToAddInner(unittest.TestCase):
    """IUpdateAttestationPayloadAnchorsToAddInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateAttestationPayloadAnchorsToAddInner:
        """Test IUpdateAttestationPayloadAnchorsToAddInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateAttestationPayloadAnchorsToAddInner`
        """
        model = IUpdateAttestationPayloadAnchorsToAddInner()
        if include_optional:
            return IUpdateAttestationPayloadAnchorsToAddInner(
                tx_hash = '',
                message = ''
            )
        else:
    ...
    def testIUpdateAttestationPayloadAnchorsToAddInner(self):
        """Test IUpdateAttestationPayloadAnchorsToAddInner"""
