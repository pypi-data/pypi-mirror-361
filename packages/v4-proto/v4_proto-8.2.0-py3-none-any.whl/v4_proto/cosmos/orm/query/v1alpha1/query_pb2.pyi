...
class IndexValue(_message.Message):
    ...
    def __init__(self, uint: _Optional[int] = ..., int: _Optional[int] = ..., str: _Optional[str] = ..., bytes: _Optional[bytes] = ..., enum: _Optional[str] = ..., bool: bool = ..., timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., duration: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ...) -> None: ...
