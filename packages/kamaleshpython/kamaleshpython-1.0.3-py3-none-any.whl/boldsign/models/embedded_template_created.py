...
class EmbeddedTemplateCreated(BaseModel):
    """
    EmbeddedTemplateCreated
    """ # noqa: E501
    template_id: Optional[StrictStr] = Field(default=None, alias="templateId")
    create_url: Optional[StrictStr] = Field(default=None, alias="createUrl")
    __properties: ClassVar[List[str]] = ["templateId", "createUrl"]
