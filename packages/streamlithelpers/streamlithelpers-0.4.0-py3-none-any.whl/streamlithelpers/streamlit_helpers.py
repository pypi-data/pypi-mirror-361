...
class SessionObject:
    ...
    def __init__(self, name: str, history_size: int = 0, cleanup_func: Callable[[T], Any] = lambda t: None, default_value: T | None = None):
        """
    ...
    def __call__(self, func: Callable[..., T]) -> T:
        ...
        def get(default_val: T | None = None) -> T:
            ...
            """
            return get_state(self.name, default_val or self.default_value)
