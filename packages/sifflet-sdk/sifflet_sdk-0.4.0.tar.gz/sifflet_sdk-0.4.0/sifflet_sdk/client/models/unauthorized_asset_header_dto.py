...
class UnauthorizedAssetHeaderDto(BaseModel):
    """
    ...
    urn: StrictStr
    associated_domains_names: List[StrictStr] = Field(alias="associatedDomainsNames")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UnauthorizedAssetHeaderDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UnauthorizedAssetHeaderDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "urn": obj.get("urn"),
                "associatedDomainsNames": obj.get("associatedDomainsNames"),
            }
        )
        return _obj
