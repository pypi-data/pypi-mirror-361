...
import pandas as pd
from .schemas.payroll import PayrollSchema

# Entity type constant
ENTITY_TYPE = "hr2d__Verloning__c"


class Payroll:
    """
    Handles payroll operations for HR2Day API.
    Payroll holds information about payroll records in the Salesforce system.
    """
    ...
    def get(self,
        ...
        """
        Get payroll data from Salesforce.
        ...
        Args:
            ...
            validate (bool, optional): Whether to validate the data against the PayrollSchema. Defaults to False.

        Returns:
            pd.DataFrame: DataFrame containing payroll data
