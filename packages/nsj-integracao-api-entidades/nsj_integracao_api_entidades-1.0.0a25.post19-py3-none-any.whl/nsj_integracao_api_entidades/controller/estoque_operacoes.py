...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/operacoes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/operacoes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/operacoes/verificacao-integridade"
