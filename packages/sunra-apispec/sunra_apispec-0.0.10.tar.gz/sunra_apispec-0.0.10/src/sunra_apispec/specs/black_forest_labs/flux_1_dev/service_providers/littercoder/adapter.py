"""
Adapter for Littercoder FLUX 1.0 Dev API service provider.
...
class LittercoderFluxV1DevTextToImageAdapter(ILittercoderAdapter):
    """Adapter for FLUX 1.0 Dev text-to-image generation using Littercoder API."""
    
    def convert_input(self, data) -> dict:
        """Convert Sunra TextToImageInput to Littercoder LittercoderFluxV1DevInput format."""
        input_model = TextToImageInput.model_validate(data)
        
        littercoder_input = LittercoderFluxV1DevInput(
    ...
    def get_request_endpoint(self) -> str:
        """Get the request endpoint for FLUX 1.0 Dev."""
        return "/flux/v1/flux-dev"
    
    def get_status_endpoint(self, task_id: str) -> str:
        """Get the status endpoint for FLUX 1.0 Dev."""
...
class LittercoderFluxV1DevImageToImageAdapter(ILittercoderAdapter):
    """Adapter for FLUX 1.0 Dev image-to-image generation using Littercoder API."""
    
    def convert_input(self, data) -> dict:
        """Convert Sunra ImageToImageInput to Littercoder LittercoderFluxV1DevInput format."""
