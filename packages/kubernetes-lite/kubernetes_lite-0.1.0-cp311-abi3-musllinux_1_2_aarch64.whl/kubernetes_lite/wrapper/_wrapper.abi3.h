...
//
extern long long int client_EmptyEvent();
extern void client_Set_EmptyEvent(long long int val);
extern long long int client_WrappedDynamicClient_Resource(long long int _handle, char* apiVersion, char* kind);
extern long long int client_WrappedNamespaceableResourceInterface_Apply(long long int _handle, char* name, long long int obj, long long int opts, long long int subresources);
extern long long int client_WrappedNamespaceableResourceInterface_ApplyStatus(long long int _handle, char* name, long long int obj, long long int opts);
extern long long int client_WrappedNamespaceableResourceInterface_Create(long long int _handle, long long int obj, long long int opts, long long int subresources);
extern char* client_WrappedNamespaceableResourceInterface_Delete(long long int _handle, char* name, long long int opts, long long int subresources);
extern char* client_WrappedNamespaceableResourceInterface_DeleteCollection(long long int _handle, long long int opts, long long int listOptions);
extern long long int client_WrappedNamespaceableResourceInterface_Get(long long int _handle, char* name, long long int opts, long long int subresources);
extern long long int client_WrappedNamespaceableResourceInterface_List(long long int _handle, long long int opts);
extern long long int client_WrappedNamespaceableResourceInterface_Namespace(long long int _handle, char* arg_0);
extern long long int client_WrappedNamespaceableResourceInterface_Patch(long long int _handle, char* name, char* pt, long long int data, long long int opts, long long int subresources);
extern long long int client_WrappedNamespaceableResourceInterface_Update(long long int _handle, long long int obj, long long int opts, long long int subresources);
extern long long int client_WrappedNamespaceableResourceInterface_UpdateStatus(long long int _handle, long long int obj, long long int opts);
extern long long int client_WrappedNamespaceableResourceInterface_Watch(long long int _handle, long long int opts);
extern long long int client_WrappedResourceInterface_Apply(long long int _handle, char* name, long long int obj, long long int opts, long long int subresources);
extern long long int client_WrappedResourceInterface_ApplyStatus(long long int _handle, char* name, long long int obj, long long int opts);
extern long long int client_WrappedResourceInterface_Create(long long int _handle, long long int obj, long long int opts, long long int subresources);
extern char* client_WrappedResourceInterface_Delete(long long int _handle, char* name, long long int opts, long long int subresources);
extern char* client_WrappedResourceInterface_DeleteCollection(long long int _handle, long long int opts, long long int listOptions);
extern long long int client_WrappedResourceInterface_Get(long long int _handle, char* name, long long int opts, long long int subresources);
extern long long int client_WrappedResourceInterface_List(long long int _handle, long long int opts);
extern long long int client_WrappedResourceInterface_Patch(long long int _handle, char* name, char* pt, long long int data, long long int opts, long long int subresources);
extern long long int client_WrappedResourceInterface_Update(long long int _handle, long long int obj, long long int opts, long long int subresources);
extern long long int client_WrappedResourceInterface_UpdateStatus(long long int _handle, long long int obj, long long int opts);
extern long long int client_WrappedResourceInterface_Watch(long long int _handle, long long int opts);
extern long long int client_WrappedWatchInterface_Next(long long int _handle);
extern void client_WrappedWatchInterface_Stop(long long int _handle, char goRun);
extern long long int client_NewWrappedDynamicClient(float qps, long long int burst, char* timeout);
extern long long int client_NewWrappedDynamicClientWithConfig(long long int config, float qps, long long int burst, char* timeout);
extern long long int client_NewWrappedWatchInterface(long long int watcher);

// --- wrapping struct: setup.SetupEnvTestResult ---
//
extern long long int setup_SetupEnvTestResult_CTor();
extern long long int setup_SetupEnvTest(long long int stdin_data, long long int arg_data);
extern long long int server_EnvTestEnvironment_GetKubeConfig(long long int _handle);
extern long long int server_EnvTestEnvironment_Start(long long int _handle);
extern char* server_EnvTestEnvironment_Stop(long long int _handle);
extern long long int server_NewEnvTestEnvironment();
extern long long int server_NewEnvTestEnvironmentWithPath(char* path);
