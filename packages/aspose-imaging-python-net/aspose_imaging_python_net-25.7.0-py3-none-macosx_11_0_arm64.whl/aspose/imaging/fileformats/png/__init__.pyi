...
class PngImage(aspose.imaging.RasterCachedImage):
    ...
    def __init__(self, width: int, height: int):
        '''Initialize a new object of the  class by providing the
    ...
    def __init__(self, path: str):
        '''Constructs a new instance of the  class using the path
    ...
    def __init__(self, raster_image: aspose.imaging.RasterImage):
        '''Creates a new instance of the  class by providing a raster
    ...
    @overload
    def __init__(self, path: str, color_type: aspose.imaging.fileformats.png.PngColorType):
        '''Initializes a new instance of the  class by specifying the
    ...
    @overload
    def __init__(self, raster_image: aspose.imaging.RasterImage, color_type: aspose.imaging.fileformats.png.PngColorType):
        '''Creates a new instance of the  class by specifying a
    ...
    def __init__(self, stream: io.RawIOBase):
        '''Creates a new instance of the  class by initializing it
    ...
    @overload
    def __init__(self, width: int, height: int, color_type: aspose.imaging.fileformats.png.PngColorType):
        '''Instantiate a fresh instance of the  class, specifying
    ...
    @overload
    def __init__(self, png_options: aspose.imaging.imageoptions.PngOptions, width: int, height: int):
        '''Initialize a new instance of the  class, incorporating
    ...
    @staticmethod
    def create_from_stream(stream: io.RawIOBase) -> aspose.imaging.fileformats.png.PngImage:
        '''Initializes a new instance of the  class.
    ...
    def interlaced(self) -> bool:
        '''Retrieves a boolean value indicating whether the  is
