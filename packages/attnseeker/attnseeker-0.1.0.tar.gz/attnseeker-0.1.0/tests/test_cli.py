...
class TestCLIIntegration:
    ...
    def test_cli_output_contains_expected_messages(self, mock_print):
        ...
        greeting_output = any("Hello, World! I'm seeking attention!" in str(call) for call in calls)
    ...
    def test_cli_custom_name_output(self, mock_print):
        ...
        calls = mock_print.call_args_list
        greeting_output = any("Hello, Alice! I'm seeking attention!" in str(call) for call in calls)
        assert greeting_output
