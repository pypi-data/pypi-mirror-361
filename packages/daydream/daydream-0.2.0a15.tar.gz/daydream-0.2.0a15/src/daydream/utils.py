...
def iprint(message: str, **kwargs: Any) -> None:
    """Please use this when printing during interactive setup, i.e. when `daydream configure` runs.

    This is a wrapper around rich.print() and supports the same arguments including styles. It will add a "> " to the beginning of each message.
    """
    rich.print(f"> {message}", **kwargs)
