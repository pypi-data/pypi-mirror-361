...
import commonocean.visualization.draw_dispatch_cr as draw_dispatch_core
import matplotlib.pyplot as plt

import commonocean_dc.collision.visualization.pycrcc


def _create_drawers_dict_pycrcc():
    draw_func_pycrcc = {}
    if 'commonocean_dc.collision.visualization.pycrcc' in sys.modules.keys():
        draw_func_pycrcc.update(commonocean_dc.collision.visualization.pycrcc.draw_func_dict)
...
def _create_default_draw_params_pycrcc():
    ...
    if 'commonocean_dc.collision.visualization.pycrcc' in sys.modules.keys():
        draw_params.update(commonocean_dc.collision.visualization.pycrcc.create_default_draw_params())
    return draw_params
...
def draw_object(obj, plot_limits=None, ax=None, draw_params=None,
    ...
    """
    Main function for drawing objects from the commonocean-collision-checker.
