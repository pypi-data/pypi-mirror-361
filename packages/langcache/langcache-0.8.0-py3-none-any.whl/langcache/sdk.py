...
class LangCache(BaseSDK):
    ...
    def search(
        ...
        *,
        ...
        :param attributes: Key-value pairs of attributes based on which to filter the cache entries. If multiple attributes are provided, only entries matching all attributes can be returned.
        ...
        request = models.SearchRequest(
            cache_id=cache_id,
            search_entries_request=models.SearchEntriesRequest(
                prompt=prompt,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.search_entries_request,
                False,
                False,
                "json",
                models.SearchEntriesRequest,
            ),
            timeout_ms=timeout_ms,
        )
    ...
    def set(
        ...
        *,
        ...
        r"""Add a new cache entry to the cache

        :param prompt: The entry's prompt
        :param response: The entry's response
        :param cache_id: The ID of the cache
        :param attributes: Key-value pairs of attributes to be associated with the entry, can be used for filtering when searching for entries. All attribute names that can be associated with an entry must be initially defined during the cache creation.
        ...
        request = models.SetRequest(
            cache_id=cache_id,
            set_entry_request=models.SetEntryRequest(
                prompt=prompt,
                response=response,
                attributes=attributes,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.set_entry_request, False, False, "json", models.SetEntryRequest
            ),
            timeout_ms=timeout_ms,
        )
    ...
    def delete_query(
        ...
        *,
        ...
        r"""Delete cache entries based on the request parameters

        :param attributes: Key-value pairs of attributes based on which to delete cache entries. If multiple attributes are provided, only entries matching all attributes will be deleted.
        :param cache_id: The ID of the cache
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
