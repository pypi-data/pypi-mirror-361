        ...
        <table class="hover_table">
            <thead>
                ...
                <tr>
                    ...
                    %endfor
                    <th scope="col" class="col_number" title="Total des kilomètres validés dans MoOGLi en ${year}">
                        <span class="screen-reader-text">Total des </span>K<span class="screen-reader-text">ilo</span>m<span class="screen-reader-text">ètre</span>s<span class="screen-reader-text"> validés dans MoOGLi en ${year}</span>
                    </th>
