...
class ContentAwareFillWatermarkOptions(WatermarkOptions):
    ...
    @overload
    def __init__(self, mask: List[aspose.imaging.Point]):
    ...
    @overload
    def __init__(self, mask: aspose.imaging.GraphicsPath):
        '''Initializes a new instance of the  class.
    ...
    @mask.setter
    def mask(self, value : Iterable[aspose.imaging.Point]):
        '''Sets the mask.'''
        ...
    ...
    def graphics_path_mask(self, value : aspose.imaging.GraphicsPath):
        ...
    
    @property
    def patch_size(self) -> byte:
        ...
    
    @patch_size.setter
    def patch_size(self, value : byte):
        ...
    ...
    def max_painting_attempts(self, value : int):
        ...
    ...
    def interest_area(self, value : aspose.imaging.Rectangle):
        ...
...
class TeleaWatermarkOptions(WatermarkOptions):
    ...
    def half_patch_size(self, value : int):
        ...
