...
- <code title="post /api/v2/hie/patient/documents">client.v2.hie.patients.<a href="./src/samplehc/resources/v2/hie/patients.py">retrieve_documents</a>(\*\*<a href="src/samplehc/types/v2/hie/patient_retrieve_documents_params.py">params</a>) -> <a href="./src/samplehc/types/v2/hie/patient_retrieve_documents_response.py">PatientRetrieveDocumentsResponse</a></code>
...
- <code title="post /api/v2/hie/patient/documents">client.v2.hie.documents.<a href="./src/samplehc/resources/v2/hie/documents.py">query</a>(\*\*<a href="src/samplehc/types/v2/hie/document_query_params.py">params</a>) -> <a href="./src/samplehc/types/v2/hie/document_query_response.py">DocumentQueryResponse</a></code>
- <code title="post /api/v2/hie/document/upload">client.v2.hie.documents.<a href="./src/samplehc/resources/v2/hie/documents.py">upload</a>(\*\*<a href="src/samplehc/types/v2/hie/document_upload_params.py">params</a>) -> object</code>
