...
class Agent:
    ...
    async def agent_continue_as_new(self, *args: Any, **kwargs: Any) -> None:
        ...
        await temporal_workflow.wait_condition(lambda: workflow_info.is_continue_as_new_suggested())
        await temporal_workflow.wait_condition(lambda: all_events_finished())
