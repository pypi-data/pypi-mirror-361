...
def create_provider(provider_data: dict):
    ...
    try:
        ...
        click.secho(f"❌ Failed to create model provider: {e}", fg="red")


def list_providers(page=1, size=10, sort=None, filter=None, search=None):
    """List model providers"""
    try:
        hub = get_model_hub()
        result = hub.get_model_providers(page=page, size=size, sort=sort, filter=filter, search=search)
        ...
        click.secho(f"❌ Failed to list model providers: {e}", fg="red")
...
def get_provider(provider_id: str):
    ...
    try:
        ...
        click.secho(f"❌ Failed to get model provider: {e}", fg="red")
...
def update_provider(provider_id: str, provider_data: dict):
    ...
    try:
        ...
        click.secho(f"❌ Failed to update model provider: {e}", fg="red")
...
def delete_provider(provider_id: str):
    ...
    try:
        ...
        click.secho(f"❌ Failed to delete model provider: {e}", fg="red") 