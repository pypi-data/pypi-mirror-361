...
class GraphDataType(google.protobuf.message.Message):
    ...
    class _GraphElementOptEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[GraphDataType._GraphElementOpt.ValueType], builtins.type):
    ...
    class GraphElementLabel(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["dst_label", b"dst_label", "src_label", b"src_label"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["dst_label", b"dst_label", "label", b"label", "src_label", b"src_label"]) -> None: ...
    ...
    class GraphElementTypeField(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["prop_id", b"prop_id", "type", b"type"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["prop_id", b"prop_id", "type", b"type"]) -> None: ...
    ...
    class GraphElementType(google.protobuf.message.Message):
        ...
        @property
        def props(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___GraphDataType.GraphElementTypeField]: ...
        def __init__(
            self,
            *,
            label: global___GraphDataType.GraphElementLabel | None = ...,
            props: collections.abc.Iterable[global___GraphDataType.GraphElementTypeField] | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["label", b"label"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["label", b"label", "props", b"props"]) -> None: ...
    ...
    @property
    def graph_data_type(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___GraphDataType.GraphElementType]: ...
    def __init__(
        self,
        *,
        element_opt: global___GraphDataType.GraphElementOpt.ValueType = ...,
        graph_data_type: collections.abc.Iterable[global___GraphDataType.GraphElementType] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["element_opt", b"element_opt", "graph_data_type", b"graph_data_type"]) -> None: ...
...
class IrDataType(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["data_type", b"data_type", "graph_type", b"graph_type", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["data_type", b"data_type", "graph_type", b"graph_type", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["type", b"type"]) -> typing.Literal["data_type", "graph_type"] | None: ...
