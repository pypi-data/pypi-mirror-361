...
from toasttab.models.void_order_request import VoidOrderRequest

class TestVoidOrderRequest(unittest.TestCase):
    """VoidOrderRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VoidOrderRequest:
        """Test VoidOrderRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoidOrderRequest`
        """
        model = VoidOrderRequest()
        if include_optional:
            return VoidOrderRequest(
                selections = toasttab.models.void_order_request_selections.voidOrder_request_selections(
                    void_all = True, ),
                payments = toasttab.models.void_order_request_selections.voidOrder_request_selections(
                    void_all = True, )
            )
        else:
            return VoidOrderRequest(
