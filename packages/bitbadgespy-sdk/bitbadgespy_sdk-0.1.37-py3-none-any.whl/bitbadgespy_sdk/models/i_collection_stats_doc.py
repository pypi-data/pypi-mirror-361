...
class ICollectionStatsDoc(BaseModel):
    ...
    overall_volume: ICosmosCoin = Field(description="The overall volume of the collection", alias="overallVolume")
    daily_volume: ICosmosCoin = Field(description="The daily volume of the collection", alias="dailyVolume")
    weekly_volume: ICosmosCoin = Field(description="The weekly volume of the collection", alias="weeklyVolume")
    monthly_volume: ICosmosCoin = Field(description="The monthly volume of the collection", alias="monthlyVolume")
    yearly_volume: ICosmosCoin = Field(description="The yearly volume of the collection", alias="yearlyVolume")
    ...
    floor_price: Optional[ICosmosCoin] = Field(default=None, description="Floor price of the collection", alias="floorPrice")
    ...
    payout_reward: Optional[ICosmosCoin] = Field(default=None, description="The payout reward", alias="payoutReward")
    __properties: ClassVar[List[str]] = ["_docId", "_id", "overallVolume", "dailyVolume", "weeklyVolume", "monthlyVolume", "yearlyVolume", "lastUpdatedAt", "collectionId", "floorPrice", "uniqueOwners", "floorPriceHistory", "payoutReward"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of overall_volume
        if self.overall_volume:
            _dict['overallVolume'] = self.overall_volume.to_dict()
        # override the default output from pydantic by calling `to_dict()` of daily_volume
        if self.daily_volume:
            _dict['dailyVolume'] = self.daily_volume.to_dict()
        # override the default output from pydantic by calling `to_dict()` of weekly_volume
        if self.weekly_volume:
            _dict['weeklyVolume'] = self.weekly_volume.to_dict()
        # override the default output from pydantic by calling `to_dict()` of monthly_volume
        if self.monthly_volume:
            _dict['monthlyVolume'] = self.monthly_volume.to_dict()
        # override the default output from pydantic by calling `to_dict()` of yearly_volume
        if self.yearly_volume:
            _dict['yearlyVolume'] = self.yearly_volume.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of payout_reward
        if self.payout_reward:
            _dict['payoutReward'] = self.payout_reward.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_id": obj.get("_id"),
            "overallVolume": ICosmosCoin.from_dict(obj["overallVolume"]) if obj.get("overallVolume") is not None else None,
            "dailyVolume": ICosmosCoin.from_dict(obj["dailyVolume"]) if obj.get("dailyVolume") is not None else None,
            "weeklyVolume": ICosmosCoin.from_dict(obj["weeklyVolume"]) if obj.get("weeklyVolume") is not None else None,
            "monthlyVolume": ICosmosCoin.from_dict(obj["monthlyVolume"]) if obj.get("monthlyVolume") is not None else None,
            "yearlyVolume": ICosmosCoin.from_dict(obj["yearlyVolume"]) if obj.get("yearlyVolume") is not None else None,
            ...
            "payoutReward": ICosmosCoin.from_dict(obj["payoutReward"]) if obj.get("payoutReward") is not None else None
        })
        return _obj
