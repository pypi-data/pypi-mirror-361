...
class LUKVLE6(AbstractConstrainedMinimisation):
    """LUKVLE6 - Generalized Broyden banded function with exponential constraints.

    Problem 5.6 from Luksan and Vlcek test problems.
    ...
    def constraint(self, y):
        ...
        num_constraints = (n - 1) // 2  # Ensure we don't go out of bounds
