...
#ifndef PXR_SDF_PY_SPEC_H
#define PXR_SDF_PY_SPEC_H
...
///
/// This file introduces a few pxr::boost::python::class_ def visitors to make
...
template <typename T>
struct pointee<pxr::SdfHandle<T> > {
    typedef T type;
};
