...
class WyriwygProducts(BaseModel):
    """
    WyriwygProducts
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WyriwygProducts from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WyriwygProducts from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [WyriwygProduct.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
