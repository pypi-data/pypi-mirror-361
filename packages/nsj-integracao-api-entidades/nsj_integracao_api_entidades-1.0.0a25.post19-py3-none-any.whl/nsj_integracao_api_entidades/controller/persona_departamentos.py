...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/departamentos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/departamentos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/departamentos/verificacao-integridade"
