...
def ComponentVersionInfoStart(builder): builder.StartObject(12)
def Start(builder):
...
def ComponentVersionInfoAddAppName(builder, appName): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(appName), 0)
def AddAppName(builder, appName):
    return ComponentVersionInfoAddAppName(builder, appName)
def ComponentVersionInfoAddActive(builder, active): builder.PrependBoolSlot(11, active, 0)
def AddActive(builder, active):
    return ComponentVersionInfoAddActive(builder, active)
...
class ComponentVersionInfoT(object):
    ...
    def _UnPack(self, componentVersionInfo):
        ...
        self.appName = componentVersionInfo.AppName()
        self.active = componentVersionInfo.Active()
    ...
    def Pack(self, builder):
        ...
        if self.appName is not None:
            ComponentVersionInfoAddAppName(builder, appName)
        ComponentVersionInfoAddActive(builder, self.active)
