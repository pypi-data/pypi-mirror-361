...
def create_build_time_config(context_path_str: Path) -> None:
    ...
    truss_config["runtime"] = {}
    truss_config["runtime"]["truss_server_version_override"] = "0.9.110rc003"
...
def prepare_checkpoint_deploy(
    ...
    rendered_truss = _render_vllm_lora_truss_config(
        checkpoint_deploy_config, buildless_deploy
    )
    ...
    # temporary: explicitly set server-side truss version
    rendered_truss.runtime.truss_server_version_override = "0.9.110rc003"
...
def _render_vllm_lora_truss_config(
    checkpoint_deploy: DeployCheckpointsConfigComplete, buildless_deploy: bool
    ...
    if buildless_deploy:
        checkpoint_str = "__CHECKPOINT_DIR_PLACEHOLDER__"
    else:
        checkpoint_parts = []
