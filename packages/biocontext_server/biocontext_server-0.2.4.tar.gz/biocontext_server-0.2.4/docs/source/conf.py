...
sys.path.insert(0, os.path.abspath("../../src/biocontext_server"))

# Project information
project = "BioContextAI"
...
autoapi_dirs = ["../../src/biocontext_server"]
autoapi_options = [
    "members",
    "undoc-members",
    "show-inheritance",
...
html_theme_options = {
    "repository_url": "https://github.com/biocontext_ai/server",
...
html_title = "BioContextAI Server"
html_css_files = [
    "css/custom.css",
]
