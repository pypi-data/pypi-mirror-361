...
class DataLabCompute17(TypedDict):
    v2: DataLabComputeV2


DataLabCompute14 = Union[DataLabCompute, DataLabCompute16, DataLabCompute17]


DataLabComputeOrUnknown = Optional[DataLabCompute14]
...
class DataScienceDataRoomV16(TypedDict):
    interactive: InteractiveDataScienceDataRoomV1


DataScienceDataRoomV1 = Union[DataScienceDataRoomV15, DataScienceDataRoomV16]
