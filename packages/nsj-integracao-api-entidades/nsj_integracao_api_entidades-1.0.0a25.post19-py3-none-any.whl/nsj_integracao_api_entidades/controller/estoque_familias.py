...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/familias"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/familias/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/familias/verificacao-integridade"
