...
class CheckRequiredFiles:
    def __init__(self):
        ...
        self.main_window = self.path2GUI / 'masina.ui'
        self.add_auto_window = self.path2GUI / 'add_auto.ui'
        guiFiles = [self.main_window, self.add_auto_window]
...
class MyApp(QMainWindow, CheckRequiredFiles):
    def __init__(self):
        ...
        # self.user = None
        # self.app = None
        # self.app_users = Users(self.user, rappmysql.ini_users)
        # self.app_users.init_app('auto', rappmysql.ini_masina)
        # if caller == 'main':
    ...
    def export_full_profile(self):
        ...
        if self.ui.CB_export_profile_with_files.isChecked():
            self.user.export_car_sql(car_id=id_all_cars, export_files=True)
        else:
            self.user.export_car_sql(car_id=id_all_cars, export_files=False)
...
##################################################################
    ...
    #     # print('Module: {}, Class: {}, Def: {}'.format(__name__, __class__, sys._getframe().f_code.co_name))
    #     if displayTableHead:
    #         tableHead, table = self.app.convert_to_display_table(self.app.tableHead, self.app.expenses,
    #                                                              displayTableHead)
    #     else:
    ...
    #     # print('Module: {}, Class: {}, Def: {}'.format(__name__, __class__, sys._getframe().f_code.co_name))
    #     if displayTableHead:
    #         tableHead, table = self.income.convert_to_display_table(self.income.tableHead, self.income.income,
    #                                                                 displayTableHead)
    #     else:
...
class AddCarWindow(QDialog, CheckRequiredFiles):
    def __init__(self, ):
        super(AddCarWindow, self).__init__()
        Ui_MainWindow, QtBaseClass = uic.loadUiType(self.add_auto_window)
