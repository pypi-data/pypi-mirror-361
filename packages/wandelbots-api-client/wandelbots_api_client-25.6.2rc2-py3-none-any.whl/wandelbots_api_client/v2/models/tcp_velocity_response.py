...
class TcpVelocityResponse(BaseModel):
    ...
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['TCP_VELOCITY_RECEIVED']):
            raise ValueError("must be one of enum values ('TCP_VELOCITY_RECEIVED')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TcpVelocityResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TcpVelocityResponse from a dict"""
        if obj is None:
            return None
