...
class Tracker:
    ...
    def update(self, detections):
        ...
        for track_idx, detection_idx in matches:
            ...
            # 如果detection指定了target_id，且与track ID不同，更新track ID
            if detection.target_id is not None and detection.target_id != 0 and detection.target_id != '0'  and detection.target_id != track.id:
                old_id = track.id
