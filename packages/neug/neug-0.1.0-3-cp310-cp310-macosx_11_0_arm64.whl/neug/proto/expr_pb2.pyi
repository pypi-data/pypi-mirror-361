...
class PathFunction(google.protobuf.message.Message):
    ...
    class _FuncOptEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[PathFunction._FuncOpt.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class PathElementKeys(google.protobuf.message.Message):
        ...
        @property
        def keys(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Property]: ...
        def __init__(
            self,
            *,
    ...
    class PathElementKeyValues(google.protobuf.message.Message):
        ...
        @property
        def key_vals(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PathFunction.PathElementKeyValues.PathElementKeyValue]: ...
        def __init__(
            self,
            *,
            key_vals: collections.abc.Iterable[global___PathFunction.PathElementKeyValues.PathElementKeyValue] | None = ...,
        ) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["map", b"map", "node_type", b"node_type", "path_key", b"path_key", "property", b"property", "tag", b"tag", "vars", b"vars"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["map", b"map", "node_type", b"node_type", "opt", b"opt", "path_key", b"path_key", "property", b"property", "tag", b"tag", "vars", b"vars"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["path_key", b"path_key"]) -> typing.Literal["property", "vars", "map"] | None: ...
...
class VariableKeyValue(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["key", b"key", "nested", b"nested", "path_func", b"path_func", "val", b"val", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["key", b"key", "nested", b"nested", "path_func", b"path_func", "val", b"val", "value", b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["value", b"value"]) -> typing.Literal["val", "path_func", "nested"] | None: ...
...
class ToDate(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["date_str", b"date_str"]) -> None: ...
...
class ToDatetime(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["datetime_str", b"datetime_str"]) -> None: ...
...
class ToInterval(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["interval_str", b"interval_str"]) -> None: ...
...
class ExprOpr(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["arith", b"arith", "brace", b"brace", "case", b"case", "const", b"const", "date_time_minus", b"date_time_minus", "extract", b"extract", "item", b"item", "logical", b"logical", "map", b"map", "node_type", b"node_type", "param", b"param", "path_concat", b"path_concat", "path_func", b"path_func", "time_interval", b"time_interval", "to_date", b"to_date", "to_datetime", b"to_datetime", "to_interval", b"to_interval", "udf_func", b"udf_func", "var", b"var", "var_map", b"var_map", "vars", b"vars"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["arith", b"arith", "brace", b"brace", "case", b"case", "const", b"const", "date_time_minus", b"date_time_minus", "extract", b"extract", "item", b"item", "logical", b"logical", "map", b"map", "node_type", b"node_type", "param", b"param", "path_concat", b"path_concat", "path_func", b"path_func", "time_interval", b"time_interval", "to_date", b"to_date", "to_datetime", b"to_datetime", "to_interval", b"to_interval", "udf_func", b"udf_func", "var", b"var", "var_map", b"var_map", "vars", b"vars"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["item", b"item"]) -> typing.Literal["logical", "arith", "const", "var", "brace", "vars", "var_map", "param", "case", "extract", "map", "time_interval", "date_time_minus", "path_concat", "path_func", "udf_func", "to_date", "to_datetime", "to_interval"] | None: ...
