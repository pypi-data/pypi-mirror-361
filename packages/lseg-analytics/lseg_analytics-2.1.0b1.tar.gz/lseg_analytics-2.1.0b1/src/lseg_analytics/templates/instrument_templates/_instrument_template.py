    ...
    def _create(self, location: Location) -> None:
        ...
        try:
            ...
            response = check_and_raise(
                Client().instrument_templates_resource.create(
                    location=location,
            ...
            logger.error(f"Error creating InstrumentTemplate: {err}")
            raise err

    def _overwrite(self) -> None:
        """
        Overwrite a InstrumentTemplate that exists in the platform.
