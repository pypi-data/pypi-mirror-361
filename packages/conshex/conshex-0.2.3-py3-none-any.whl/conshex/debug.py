from conshex.core import Construct, Subconstruct
...
class Debugger(Subconstruct):
    ...
    Example::
        ...
        path is (building)
          File "/media/arkadiusz/MAIN/GitHub/conshex/conshex/debug.py", line 192, in _build
            return self.subcon._build(obj, stream, context, path)
          File "/media/arkadiusz/MAIN/GitHub/conshex/conshex/core.py", line 2149, in _build
            raise RangeError("expected %d elements, found %d" % (count, len(obj)))
        conshex.core.RangeError: expected 3 elements, found 0

        > /media/arkadiusz/MAIN/GitHub/conshex/conshex/core.py(2149)_build()
        -> raise RangeError("expected %d elements, found %d" % (count, len(obj)))
        (Pdb) q
        --------------------------------------------------
    """
