...
from aind_labtracks_service_client.api_client import ApiClient, RequestSerialized
from aind_labtracks_service_client.api_response import ApiResponse
from aind_labtracks_service_client.rest import RESTResponseType
...
class DefaultApi:
    ...
    def get_subject(
        ...
        ## Subject metadata Retrieves subject information from LabTracks.
    ...
    def get_tasks(
        ...
        ## Task metadata Retrieves Task information from LabTracks.
    ...
    def _get_tasks_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tasks/{subject_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
