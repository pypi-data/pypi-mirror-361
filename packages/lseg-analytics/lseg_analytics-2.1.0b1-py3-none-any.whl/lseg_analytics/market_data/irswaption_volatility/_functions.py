...
def calculate(
    *,
    universe: Optional[List[VolatilityCubeSurfaceRequestItem]] = None,
    ...
    try:
        ...
        response = check_and_raise(Client().irswaption_volatility.calculate(fields=fields, universe=universe))
