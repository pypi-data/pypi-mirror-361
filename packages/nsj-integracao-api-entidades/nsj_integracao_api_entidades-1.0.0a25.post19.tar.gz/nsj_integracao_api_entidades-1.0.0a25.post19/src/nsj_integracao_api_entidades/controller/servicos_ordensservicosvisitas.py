...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/ordensservicosvisitas"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/ordensservicosvisitas/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/ordensservicosvisitas/verificacao-integridade"
