...
class Limiter(_message.Message):
    ...
    def __init__(self, period: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., baseline_minimum: _Optional[bytes] = ..., baseline_tvl_ppm: _Optional[int] = ...) -> None: ...
