...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/medicos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/medicos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/medicos/verificacao-integridade"
