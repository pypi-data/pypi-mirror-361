...
def calculate(
    *,
    ...
    try:
        ...
        response = check_and_raise(Client().commodities_curves.calculate(fields=fields, universe=universe))
    ...
    *,
    ...
    try:
        ...
        response = check_and_raise(
            Client().commodities_curves.calculate_by_id(curve_id=curve_id, fields=fields, valuation_date=valuation_date)
        )
...
def create(
    *,
    ...
    try:
        ...
        response = check_and_raise(
            Client().commodities_curves.create(
...
def delete(*, curve_id: str) -> bool:
    """
    Delete a CommoditiesCurveDefinition that exists in the platform.
    ...
    try:
        ...
        check_and_raise(Client().commodities_curves.delete(curve_id=curve_id))
...
def overwrite(
    *,
    ...
    """
    Overwrite a CommoditiesCurveDefinition that exists in the platform.
    ...
    try:
        ...
        response = check_and_raise(
            Client().commodities_curves.overwrite(
                body=CommoditiesCurveCreateRequest(curve_definition=curve_definition, segments=segments),
                curve_id=curve_id,
            )
        )
...
def read(*, curve_id: str, fields: Optional[str] = None) -> CommoditiesCurveResponse:
    """
    Access a CommoditiesCurveDefinition existing in the platform (read).
    ...
    try:
        ...
        response = check_and_raise(Client().commodities_curves.read(curve_id=curve_id, fields=fields))
...
def search(
    *,
    ...
    try:
        ...
        response = check_and_raise(Client().commodities_curves.search(fields=fields, universe=universe))
