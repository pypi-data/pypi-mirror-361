...
class EmbeddedSendCreated(BaseModel):
    """
    EmbeddedSendCreated
    """ # noqa: E501
    document_id: Optional[StrictStr] = Field(default=None, alias="documentId")
    send_url: Optional[StrictStr] = Field(default=None, alias="sendUrl")
    __properties: ClassVar[List[str]] = ["documentId", "sendUrl"]
