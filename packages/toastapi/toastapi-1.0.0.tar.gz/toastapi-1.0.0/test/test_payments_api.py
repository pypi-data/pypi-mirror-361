...
from toasttab.api.payments_api import PaymentsApi
...
class TestPaymentsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_orders_checks_payments_post(self) -> None:
        """Test case for orders_checks_payments_post

        Post payments
        """
        pass

    async def test_orders_order_guid_checks_check_guid_payments_payment_guid_patch(self) -> None:
        """Test case for orders_order_guid_checks_check_guid_payments_payment_guid_patch

        Update a tip amount
        """
        pass

    async def test_payments_get(self) -> None:
    ...
    async def test_payments_guid_get(self) -> None:
        """Test case for payments_guid_get
