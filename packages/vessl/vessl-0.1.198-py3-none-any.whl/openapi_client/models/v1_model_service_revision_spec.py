...
class V1ModelServiceRevisionSpec(object):
    ...
    def __init__(self, autoscaling=None, command=None, env_vars=None, expose=None, monitoring=None, openapi=None, ports=None, pre_created_service_account_name=None, readiness_probe=None, runner_type=None, service_account=None, volume_claim_mounts=None, volume_v2_mounts=None, local_vars_configuration=None):  # noqa: E501
