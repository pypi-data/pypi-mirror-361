...
if TYPE_CHECKING:
    ...
    from .setop import SetGlobals, SetGlobalsTypedDict, SetRequest, SetRequestTypedDict
...
_dynamic_imports: dict[str, str] = {
    ...
    "DeleteQueryRequest": ".deletequeryop",
    "DeleteQueryRequestTypedDict": ".deletequeryop",
