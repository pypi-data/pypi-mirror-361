...
class TestPluginVersionConfigPayloadUserInputRedirect(unittest.TestCase):
    """PluginVersionConfigPayloadUserInputRedirect unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PluginVersionConfigPayloadUserInputRedirect:
        """Test PluginVersionConfigPayloadUserInputRedirect
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PluginVersionConfigPayloadUserInputRedirect`
        """
        model = PluginVersionConfigPayloadUserInputRedirect()
        if include_optional:
            return PluginVersionConfigPayloadUserInputRedirect(
                base_uri = '',
                tutorial_uri = ''
            )
        else:
    ...
    def testPluginVersionConfigPayloadUserInputRedirect(self):
        """Test PluginVersionConfigPayloadUserInputRedirect"""
