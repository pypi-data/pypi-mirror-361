...
import pandas as pd
from .schemas.sick_leave_period import SickLeavePeriodSchema

# Entity type constant
ENTITY_TYPE = "hr2d__SickLeavePer__c"


class SickLeavePeriod:
    """
    Handles sick leave period operations for HR2Day API.
    SickLeavePeriod holds information about sick leave period records in the Salesforce system.
    """

    def __init__(self, hr2day_instance):
        """
        Initialize the SickLeavePeriod class.
    ...
    def get(self,
        ...
        """
        Get sick leave period data from Salesforce.
        ...
        Args:
            ...
            skip (int, optional): Number of records to skip (OFFSET clause). Max 2000. Defaults to None.
                            Example: 0
            validate (bool, optional): Whether to validate the data against the SickLeavePeriodSchema. Defaults to False.

        Returns:
            pd.DataFrame: DataFrame containing sick leave period data
