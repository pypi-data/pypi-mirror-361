...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/tiposordensservicos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/tiposordensservicos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/servicos/tiposordensservicos/verificacao-integridade"
