...
def calculate(
    *,
    ...
    try:
        ...
        response = check_and_raise(Client().credit_curves.calculate(fields=fields, universe=universe))
    ...
    *,
    ...
    try:
        ...
        response = check_and_raise(
            Client().credit_curves.calculate_by_id(curve_id=curve_id, fields=fields, valuation_date=valuation_date)
        )
...
def delete(*, curve_id: str) -> bool:
    """
    Delete a CreditCurveDefinition that exists in the platform.
    ...
    try:
        ...
        check_and_raise(Client().credit_curves.delete(curve_id=curve_id))
...
def overwrite(
    *,
    ...
    """
    Overwrite a CreditCurveDefinition that exists in the platform.
    ...
    try:
        ...
        response = check_and_raise(
            Client().credit_curves.overwrite(
                body=CreditCurveCreateRequest(curve_definition=curve_definition, segments=segments),
                curve_id=curve_id,
            )
        )
...
def read(*, curve_id: str, fields: Optional[str] = None) -> CreditCurveResponse:
    """
    Access a CreditCurveDefinition existing in the platform (read).
    ...
    try:
        ...
        response = check_and_raise(Client().credit_curves.read(curve_id=curve_id, fields=fields))
...
def search(
    *,
    ...
    try:
        ...
        response = check_and_raise(Client().credit_curves.search(fields=fields, universe=universe))
