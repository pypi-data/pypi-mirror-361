...
# ==============================================================================
# residuals
cox_res = evler.residuals(method="CoxSnell", draw_figure=False)
martingale_res = evler.residuals(method="Martingale", draw_figure=False)
deviance_res = evler.residuals(method="Deviance", draw_figure=False)
...
bar1 = axes[0].bar([x - 0.2 for x in bins], obs_probs, width=0.4, color='r', align='center')
bar2 = axes[0].bar([x + 0.2 for x in bins], exp_probs, width=0.4, color='g', align='center')
...
summary, _ = evler.integrated_calibration_index(make_figure=False)
...
axes[1].plot([0, 1], [0, 1], 'k--', label='Perfect Calibration', color="grey", linewidth=2)
axes[1].plot(exp_probs, obs_probs, 'o-', color=color_list[0], label="DN-1-cal", linewidth=2)
axes[1].plot(summary["curve"]["grid"], summary["curve"]["cal_pred"], '-', color=color_list[1], label="Smooth 1-cal", linewidth=2)
