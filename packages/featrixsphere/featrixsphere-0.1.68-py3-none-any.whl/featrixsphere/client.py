...
class PredictionGrid:
    ...
    def plot_3d(self, class_name: str = None, figsize: tuple = (12, 9), title: str = None):
        ...
        # For 3D surface: X corresponds to axis 0, Y corresponds to axis 1
        ...
        # Plot surface - matrix orientation matches X, Y meshgrid
        surf = ax.plot_surface(X, Y, matrix, cmap=self._colormap, alpha=0.8)
