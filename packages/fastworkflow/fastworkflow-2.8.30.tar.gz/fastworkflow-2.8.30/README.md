...
Create a simple Python class in `messaging_app_1/application/send_message.py`.
...
Create a file named `messaging_app_1/application/_commands/send_message.py`. This file tells `fastWorkflow` how to handle the `send_message` command.
...
```sh
# Train the workflow
fastworkflow train ./messaging_app_1 fastworkflow.env fastworkflow.passwords.env

# Run the workflow
fastworkflow run ./messaging_app_1 fastworkflow.env fastworkflow.passwords.env
```
