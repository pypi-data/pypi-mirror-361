...
from toasttab.models.toast_reference import ToastReference

class TestToastReference(unittest.TestCase):
    """ToastReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ToastReference:
        """Test ToastReference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ToastReference`
        """
        model = ToastReference()
        if include_optional:
