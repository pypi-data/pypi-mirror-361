...
class TestIMetadataAttributesInnerValue(unittest.TestCase):
    """IMetadataAttributesInnerValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMetadataAttributesInnerValue:
        """Test IMetadataAttributesInnerValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMetadataAttributesInnerValue`
        """
        model = IMetadataAttributesInnerValue()
        if include_optional:
            return IMetadataAttributesInnerValue(
            )
        else:
            return IMetadataAttributesInnerValue(
        )
    ...
    def testIMetadataAttributesInnerValue(self):
        """Test IMetadataAttributesInnerValue"""
