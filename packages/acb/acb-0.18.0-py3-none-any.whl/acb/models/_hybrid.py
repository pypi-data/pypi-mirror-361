...
from acb.models._query import Query, QueryBuilder, registry
from acb.models._repository import (
    Repository,
    RepositoryFactory,
    RepositoryOptions,
)
from acb.models._specification import Specification, SpecificationBuilder
from acb.models._specification import field as spec_field
...
class SimpleQuery[T]:
    ...
    async def where(self, **conditions) -> "SimpleQuery[T]":
...
class ModelManager[T]:
    ...
    def query(self, style: QueryStyle | None = None):
...
class ACBQuery:
    def __init__(
        ...
        self._model_managers: dict[type, ModelManager] = {}
    ...
    def query(self, model_class: type[T], style: QueryStyle | None = None):
