...
def validate_tasks(tasks: List[Dict[str, Any]], schema: Dict[str, Any]) -> None:
    ...
    for task in tasks:
        ...
        # Validate inputs and input_mapping
        ...
        # Validate prompt_template for LLM tasks (if using global config)
        ...
        # Validate model (if present for LLM tasks)
...
def validate_global_config(config: Dict[str, Any]) -> None:
    ...
    # Validate backend_host (optional, fallback if backend_hosts not present)
    ...
    # Validate backend_hosts (optional)
    ...
    sample_schema = {
        ...
        "tasks": [
            ...
            },
            {
                ...
                "inputs": [1],
                "input_mapping": [{"source": "task_results", "key": "data", "task_id": 1}],
                "model": "mistralai/mixtral-8x7b-instruct"  # Task-specific model
            }
        ],
        "global_config": {
