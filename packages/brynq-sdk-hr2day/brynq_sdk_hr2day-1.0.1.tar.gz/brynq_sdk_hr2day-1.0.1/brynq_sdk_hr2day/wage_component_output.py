...
import pandas as pd
from .schemas.wage_component_output import WageComponentOutputSchema

# Entity type constant
ENTITY_TYPE = "hr2d__Looncompoutput__c"


class WageComponentOutput:
    """
    Handles wage component output operations for HR2Day API.
    WageComponentOutput holds information about wage component outputs in the Salesforce system.
    """

    def __init__(self, hr2day_instance):
        """
        Initialize the WageComponentOutput class.
    ...
    def get(self,
        ...
        """
        Get wage component output data from Salesforce.
        ...
        Args:
            ...
            validate (bool, optional): Whether to validate the data against the WageComponentOutputSchema. Defaults to False.

        Returns:
            pd.DataFrame: DataFrame containing wage component output data
        ...
        return self.hr2day.get(
            ...
            limit=limit,
            offset=skip,
            schema=WageComponentOutputSchema
        ) 