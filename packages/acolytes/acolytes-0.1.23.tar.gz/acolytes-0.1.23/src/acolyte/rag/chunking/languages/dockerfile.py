...
class DockerfileChunker(BaseChunker, PatternDetectionMixin):
    ...
    def _get_tree_sitter_language(self) -> Any:
        ...
        # tree-sitter-dockerfile package not available on PyPI
        # Migrated from tree-sitter-languages but no individual package exists
        raise ImportError(
            "tree-sitter-dockerfile package is not available on PyPI. "
            "Dockerfile chunking is currently disabled after tree-sitter-languages migration."
        )
