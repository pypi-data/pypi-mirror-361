...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/papeis"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/papeis/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/workflow/papeis/verificacao-integridade"
