...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/conjuntosservicos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/conjuntosservicos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/conjuntosservicos/verificacao-integridade"
