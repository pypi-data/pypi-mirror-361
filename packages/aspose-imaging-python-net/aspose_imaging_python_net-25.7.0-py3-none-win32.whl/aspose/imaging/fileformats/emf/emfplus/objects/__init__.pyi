...
class EmfPlusPathPointTypeRle(EmfPlusBasePointType):
    ...
    @property
    def run_count(self) -> byte:
        ...
    
    @run_count.setter
    def run_count(self, value : byte):
        ...
...
class EmfPlusRegionNodeChildNodes(EmfPlusStructureObjectType):
    ...
    @property
    def operation(self) -> EmfPlusRegionNodeChildNodes.NodesOperation:
        '''Gets the operation.'''
        ...
    
    @operation.setter
    def operation(self, value : EmfPlusRegionNodeChildNodes.NodesOperation):
        '''Sets the operation.'''
        ...
