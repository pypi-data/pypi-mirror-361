...
from toasttab.models.modifier_option import ModifierOption

class TestModifierOption(unittest.TestCase):
    """ModifierOption unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModifierOption:
        """Test ModifierOption
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModifierOption`
        """
