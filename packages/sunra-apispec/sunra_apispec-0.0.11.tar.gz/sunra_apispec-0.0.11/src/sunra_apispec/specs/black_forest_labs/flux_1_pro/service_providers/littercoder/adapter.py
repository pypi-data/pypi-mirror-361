"""
Adapter for Littercoder FLUX 1.0 Pro API service provider.
...
class LittercoderFluxV1ProTextToImageAdapter(ILittercoderAdapter):
    """Adapter for FLUX 1.0 Pro text-to-image generation using Littercoder API."""
    
    def convert_input(self, data) -> dict:
        """Convert Sunra TextToImageInput to Littercoder LittercoderFluxV1ProInput format."""
        input_model = TextToImageInput.model_validate(data)
        
        littercoder_input = LittercoderFluxV1ProInput(
    ...
    def get_request_endpoint(self) -> str:
        """Get the request endpoint for FLUX 1.0 Pro."""
        return "/flux/v1/flux-pro"
    
    def get_status_endpoint(self, task_id: str) -> str:
        """Get the status endpoint for FLUX 1.0 Pro."""
...
class LittercoderFluxV1ProImageToImageAdapter(ILittercoderAdapter):
    """Adapter for FLUX 1.0 Pro image-to-image generation using Littercoder API."""
    
    def convert_input(self, data) -> dict:
        """Convert Sunra ImageToImageInput to Littercoder LittercoderFluxV1ProInput format."""
