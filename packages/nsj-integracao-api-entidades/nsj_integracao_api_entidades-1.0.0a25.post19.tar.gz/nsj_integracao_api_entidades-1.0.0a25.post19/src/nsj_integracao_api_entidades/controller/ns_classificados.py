...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/classificados"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/classificados/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/classificados/verificacao-integridade"
