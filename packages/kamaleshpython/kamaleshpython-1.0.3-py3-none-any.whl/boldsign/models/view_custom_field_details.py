...
class ViewCustomFieldDetails(BaseModel):
    """
    ...
    field_order: Optional[StrictInt] = Field(default=None, alias="fieldOrder")
    ...
    __properties: ClassVar[List[str]] = ["customFieldId", "fieldName", "fieldDescription", "fieldOrder", "brandId", "sharedField", "formField"]
