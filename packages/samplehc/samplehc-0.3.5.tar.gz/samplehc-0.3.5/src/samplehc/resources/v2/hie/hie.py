...
class HieResourceWithRawResponse:
    ...
    def patients(self) -> PatientsResourceWithRawResponse:
        return PatientsResourceWithRawResponse(self._hie.patients)
...
class AsyncHieResourceWithRawResponse:
    ...
    def patients(self) -> AsyncPatientsResourceWithRawResponse:
        return AsyncPatientsResourceWithRawResponse(self._hie.patients)
...
class HieResourceWithStreamingResponse:
    ...
    def patients(self) -> PatientsResourceWithStreamingResponse:
        return PatientsResourceWithStreamingResponse(self._hie.patients)
...
class AsyncHieResourceWithStreamingResponse:
    ...
    def patients(self) -> AsyncPatientsResourceWithStreamingResponse:
        return AsyncPatientsResourceWithStreamingResponse(self._hie.patients)
