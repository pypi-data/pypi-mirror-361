...
class FederalDistrictDamagesList(BaseModel):
    """
    FederalDistrictDamagesList
    """ # noqa: E501
    court: Optional[Court] = None
    damages_by_pratice_area: Dict[str, List[StrictStr]] = Field(alias="damagesByPraticeArea")
    __properties: ClassVar[List[str]] = ["court", "damagesByPraticeArea"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "damagesByPraticeArea": obj.get("damagesByPraticeArea")
        })
        return _obj
