...
class TesseractModule(ll.LogicLayerModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.tempdir = temp_dir or Path.cwd()
    ...
    def query_data(
        ...
        """Execute a request for data from the server."""
    ...
    def multiquery_data(
        ...
        return data_response(
            result,
            extension,
            annotations=query.get_annotations(),
            tempdir=self.tempdir,
        )
    ...
    def debug_sql(
        ...
        return debug_response(accept, request=params, query=query, sql=debug)
