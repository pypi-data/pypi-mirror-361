...
from shuttleasgi import Request, Response, StreamedContent
from shuttleasgi.common.files.asyncfs import FilesHandler
from shuttleasgi.common.files.info import FileInfo
from shuttleasgi.common.files.pathsutils import get_mime_type_from_name
from shuttleasgi.exceptions import BadRequest, InvalidArgument, RangeNotSatisfiable
from shuttleasgi.ranges import InvalidRangeValue, Range, RangePart
...
def get_response_for_file(
    ...
    if request.method == "HEAD":
        ...
        # and responses with a body in ShuttleASGI have content-type
