...
def if_else(condition: ConditionType | Callable[[dict[str, Any]], bool], if_branch: BasePipelineStep | list[BasePipelineStep], else_branch: BasePipelineStep | list[BasePipelineStep], input_state_map: dict[str, str] | None = None, output_state: str | None = None, runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None, name: str | None = None) -> ConditionalStep:
    ...
    ```
    This will cause the step to execute the PositiveComponent if the `input` in the pipeline state is greater than 0,
    and the NegativeComponent otherwise. The result of the condition will be stored in the pipeline state under
    the key `condition_result`. The threshold value is passed as a fixed argument to the condition.
...
def switch(condition: ConditionType, branches: dict[str, BasePipelineStep | list[BasePipelineStep]], input_state_map: dict[str, str] | None = None, output_state: str | None = None, default: BasePipelineStep | list[BasePipelineStep] | None = None, runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None, name: str | None = None) -> ConditionalStep:
    ...
    Usage example:
    ```python
    condition = lambda state: state["query"].split(state["separator"])[0]
    branches = {
    ...
    runtime_config_map = {"separator": "delimiter"}
    fixed_args = {"min_length": 3}
    ...
    "search", the FilterComponent if it is "filter", and the NoOpComponent otherwise. The separator for the query
    is taken from the runtime configuration under the key `delimiter`. The minimum length requirement is passed as a
    fixed argument. The result of the condition will be stored in the pipeline state under the key `condition_result`.
...
def toggle(condition: ConditionType | Callable[[dict[str, Any]], bool] | str, if_branch: BasePipelineStep | list[BasePipelineStep], input_state_map: dict[str, str] | None = None, output_state: str | None = None, runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None, name: str | None = None) -> ConditionalStep:
    ...
    Usage example with callable:
    ```python
    condition = lambda state: state["feature_enabled"]
    feature_step = step(FeatureComponent(), {"input": "input"}, "output")

    toggle_step = toggle(condition, feature_step, {"input": "input"}, "toggle_result")
    ```
