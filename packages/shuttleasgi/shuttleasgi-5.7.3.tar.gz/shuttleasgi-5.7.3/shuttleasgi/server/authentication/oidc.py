...
from shuttleasgi.cookies import Cookie
from shuttleasgi.exceptions import BadRequest, Unauthorized
from shuttleasgi.messages import Request, Response, get_absolute_url_to_path
from shuttleasgi.server.application import Application, ApplicationEvent
...
from shuttleasgi.server.authorization import allow_anonymous
from shuttleasgi.server.dataprotection import generate_secret, get_serializer
from shuttleasgi.server.headers.cache import cache_control
from shuttleasgi.server.responses import accepted, bad_request, html, json, ok, redirect
from shuttleasgi.utils import ensure_str
from shuttleasgi.utils.aio import FailedRequestError, HTTPHandler


def get_logger() -> logging.Logger:
    logger = logging.getLogger("shuttleasgi.oidc")
...
def use_openid_connect(
    ...
    auth_handler : Optional[OpenIDTokensHandler]
        ...
        examples](https://github.com/Neoteroi/ShuttleASGI-Examples/tree/main/oidc)
