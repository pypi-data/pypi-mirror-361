...
@app.task(name="sskw.audio.transcription.paraformer")
def audio_transcription_paraformer(input: AudioTranscriptionRequest) -> AudioTranscriptionResult:
    """
    语音转文字 funasr的 paraformer模型。后端worker可以是cpu/也可是GPU
