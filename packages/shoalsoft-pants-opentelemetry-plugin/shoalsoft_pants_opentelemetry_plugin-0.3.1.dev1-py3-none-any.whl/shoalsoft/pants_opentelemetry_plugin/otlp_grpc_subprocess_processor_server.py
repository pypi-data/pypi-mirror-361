...
class Server:
        ...
        try:
            while not self.shutdown_event.is_set():
                ...
                if message_data is None:
                    self.logger.info("stdin closed, signaling shutdown.")
    ...
    def process_messages(self) -> None:
        ...
        self.logger.info(f"Draining remaining messages (#remaining={self.message_queue.qsize()}).")
        while self.message_queue.qsize() > 0:
            ...
            try:
                ...
                self.logger.error(f"Error processing message: {e}")
        self.logger.info("Finished draining remaining messages.")
