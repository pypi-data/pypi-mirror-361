...
from sqla_handler import SqlaHandler
...
class TestSqlaHandler:
    ...
    def test_execute(self, mocker, mock_engine):
        ...
        mock_text = mocker.patch("sqla_handler.sqlalchemy.text")
    ...
    def test_read_sql(self, mocker, mock_engine):
        ...
        table = "test_table"
        columns = ("col1", "col2")
        mock_pd_read_sql = mocker.patch("sqla_handler.pandas.read_sql", return_value=df)
        query_handler = SqlaHandler(mock_engine)
    ...
    def test_read_sql_chunked(self, mocker, mock_engine):
        ...
        table = "test_table"
        columns = ("col1", "col2")
        mock_pd_read_sql = mocker.patch("sqla_handler.pandas.read_sql", return_value=df_l)
        query_handler = SqlaHandler(mock_engine)
