...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/produtos_faixas_precos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/produtos_faixas_precos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/produtos_faixas_precos/verificacao-integridade"
