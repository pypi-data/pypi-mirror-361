...
class MessageActionSetChatTheme(TLObject, family='TypeMessageAction'):
    ...
    def __init__(
        ...
        Args:
            emoticon (str): The emoji that identifies a chat theme
        """

        self.emoticon = emoticon

    def to_bytes(self, boxed: bool=True):
        with Writer(b'Ecx\xaa' if boxed else b'') as writer:
...
class MessageActionStarGift(TLObject, family='TypeMessageAction'):
    ...
    def to_bytes(self, boxed: bool=True):
        with Writer(b'\xa4\xe8\x17G' if boxed else b'') as writer:
            with writer.flag() as flags:
...
class MessageActionStarGiftUnique(TLObject, family='TypeMessageAction'):
    ...
    def to_bytes(self, boxed: bool=True):
        with Writer(b'\x81\xcb\xdf\xac' if boxed else b'') as writer:
            with writer.flag() as flags:
