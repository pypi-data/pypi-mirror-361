...
class UpdateDraftMessage(TLObject, family='TypeUpdate'):
    ...
    def to_bytes(self, boxed: bool=True):
        with Writer(b'm\xecI\x1b' if boxed else b'') as writer:
            with writer.flag() as flags:
                writer.object(
                    self.peer,
                    group_id=0XB4DECBCA
...
class UpdateChannelReadMessagesContents(TLObject, family='TypeUpdate'):
    ...
    def to_bytes(self, boxed: bool=True):
        with Writer(b']\x05)\xea' if boxed else b'') as writer:
            with writer.flag() as flags:
                writer.long(self.channel_id)
...
class UpdateDialogUnreadMark(TLObject, family='TypeUpdate'):
    ...
    def to_bytes(self, boxed: bool=True):
        with Writer(b'\xc3Yd\xe1' if boxed else b'') as writer:
            with writer.flag() as flags:
                flags(self.unread, 0)
                writer.object(
                    self.peer,
...
class UpdateMessageReactions(TLObject, family='TypeUpdate'):
    ...
    def to_bytes(self, boxed: bool=True):
        with Writer(b'\xb8<\x1b^' if boxed else b'') as writer:
            with writer.flag() as flags:
                writer.object(
                    self.peer,
                    group_id=0XB4DECBCA
...
class UpdateBroadcastRevenueTransactions(TLObject, family='TypeUpdate'):
    """
    ...
    def __init__(
        ...
        Args:
            peer ('TypePeer'): Channel
            balances ('TypeBroadcastRevenueBalances'): New ad revenue balance.
        """
    ...
    def to_bytes(self, boxed: bool=True):
        with Writer(b'\xf5a\xd9\xdf' if boxed else b'') as writer:
            writer.object(
                self.peer,
                group_id=0XB4DECBCA
            )
