...
class ContentAdmIndexGroup:
    ...
    def create_index_group(self, index_group: IndexGroup) -> int:
        ...
        try:
            ...
            local_headers = deepcopy(self.headers)
            local_headers['Content-Type'] = 'application/vnd.asg-mobius-admin-topicgroups.v1+json'
            local_headers['Accept'] = 'application/vnd.asg-mobius-admin-topicgroups.v1+json'
