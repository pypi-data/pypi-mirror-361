...
from toasttab.models.applicable_discounts_request import ApplicableDiscountsRequest

class TestApplicableDiscountsRequest(unittest.TestCase):
    """ApplicableDiscountsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicableDiscountsRequest:
        """Test ApplicableDiscountsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicableDiscountsRequest`
        """
        model = ApplicableDiscountsRequest()
        if include_optional:
            return ApplicableDiscountsRequest(
                order = toasttab.models.order.Order(),
                promo_code = ''
            )
        else:
            return ApplicableDiscountsRequest(
    ...
    def testApplicableDiscountsRequest(self):
        """Test ApplicableDiscountsRequest"""
