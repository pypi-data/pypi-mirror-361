...
class Pds4Products(BaseModel):
    """
    Pds4Products
    """ # noqa: E501
    data: List[Pds4Product]
    summary: Summary
    __properties: ClassVar[List[str]] = ["data", "summary"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Pds4Products from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Pds4Products from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [Pds4Product.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
