...
class HealthApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.check_endpoint = _Endpoint(
            settings={
                ...
                'auth': [],
                'endpoint_path': '/authservice/health',
                'operation_id': 'check',
                'http_method': 'GET',
                'servers': None,
            },
    ...
    def check(
        ...
        **kwargs
        ...
        Returns the health status of the auth service.        This endpoint is used to monitor the operational status of the auth service.        It typically returns a simple status indicator, such as 'UP' or 'OK', confirming that the service is operational and available.  # noqa: E501
