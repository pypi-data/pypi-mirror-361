...
class Interface(object):
    ...
    def CapabilityList(self, j):
        ...
        if o != 0:
            ...
            from comm.profinet.device.fbs.Capability import Capability
            obj = Capability()
...
import comm.profinet.device.fbs.Capability
try:
...
class InterfaceT(object):
    ...
    def __init__(self):
        ...
        self.capabilityList = None  # type: List[comm.profinet.device.fbs.Capability.CapabilityT]
        ...
        if not interface.CapabilityListIsNone():
            ...
            for i in range(interface.CapabilityListLength()):
                if interface.CapabilityList(i) is None:
                    ...
                    capability_ = comm.profinet.device.fbs.Capability.CapabilityT.InitFromObj(interface.CapabilityList(i))
