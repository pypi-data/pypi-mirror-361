...
class TestIUpdateAccountInfoPayloadApprovedSignInMethodsDiscord(unittest.TestCase):
    """IUpdateAccountInfoPayloadApprovedSignInMethodsDiscord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateAccountInfoPayloadApprovedSignInMethodsDiscord:
        """Test IUpdateAccountInfoPayloadApprovedSignInMethodsDiscord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateAccountInfoPayloadApprovedSignInMethodsDiscord`
        """
        model = IUpdateAccountInfoPayloadApprovedSignInMethodsDiscord()
        if include_optional:
            return IUpdateAccountInfoPayloadApprovedSignInMethodsDiscord(
                scopes = [
    ...
    def testIUpdateAccountInfoPayloadApprovedSignInMethodsDiscord(self):
        """Test IUpdateAccountInfoPayloadApprovedSignInMethodsDiscord"""
