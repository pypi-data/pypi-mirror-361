...
from toasttab.api.shifts_api import ShiftsApi


class TestShiftsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_shifts_get(self) -> None:
        """Test case for shifts_get

        Get shifts
        """
        pass

    async def test_shifts_post(self) -> None:
        """Test case for shifts_post

        Create a shift
        """
        pass

    async def test_shifts_shift_id_delete(self) -> None:
        """Test case for shifts_shift_id_delete

        Delete a shift
        """
        pass

    async def test_shifts_shift_id_get(self) -> None:
        """Test case for shifts_shift_id_get

        Get a shift
        """
        pass

    async def test_shifts_shift_id_put(self) -> None:
        """Test case for shifts_shift_id_put
