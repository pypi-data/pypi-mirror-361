...
from codeset import Codeset, AsyncCodeset, APIResponseValidationError
from codeset._types import Omit
from codeset._models import BaseModel, FinalRequestOptions
from codeset._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from codeset._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Codeset | AsyncCodeset) -> int:
...
class TestCodeset:
    client = Codeset(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "codeset/_legacy_response.py",
                        "codeset/_response.py",
    ...
    def test_client_timeout_option(self) -> None:
        client = Codeset(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_validate_headers(self) -> None:
        ...
        with update_env(**{"CODESET_API_KEY": Omit()}):
            client2 = Codeset(base_url=base_url, api_key=None, _strict_response_validation=True)
    ...
    def test_base_url_setter(self) -> None:
        client = Codeset(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(CODESET_BASE_URL="http://localhost:5000/from/env"):
            client = Codeset(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Codeset(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Codeset(
    ...
    def test_base_url_trailing_slash(self, client: Codeset) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Codeset) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Codeset) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Codeset(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Codeset(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Codeset(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Codeset) -> None:
    ...
    @mock.patch("codeset._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Codeset) -> None:
    ...
    def test_omit_retry_count_header(
        self, client: Codeset, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncCodeset:
    client = AsyncCodeset(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with update_env(**{"CODESET_API_KEY": Omit()}):
            client2 = AsyncCodeset(base_url=base_url, api_key=None, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(CODESET_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncCodeset(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncCodeset) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncCodeset) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncCodeset) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncCodeset(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncCodeset(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        self, respx_mock: MockRouter, async_client: AsyncCodeset
    ) -> None:
        respx_mock.get("/health").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    @mock.patch("codeset._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    async def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncCodeset) -> None:
        respx_mock.get("/health").mock(return_value=httpx.Response(500))
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncCodeset, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from codeset._utils import asyncify
        from codeset._base_client import get_platform
