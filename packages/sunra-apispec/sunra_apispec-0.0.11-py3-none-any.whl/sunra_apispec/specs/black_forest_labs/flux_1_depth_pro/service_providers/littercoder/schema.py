"""
Schema definitions for Littercoder FLUX 1.0 Depth Pro API.
"""
...
class LittercoderFluxV1DepthProInput(BaseModel):
    """Input schema for FLUX Depth Pro image generation."""
...
LittercoderFluxV1DepthProOutput = Union[LittercoderAsyncResponse, LittercoderAsyncWebhookResponse] 
