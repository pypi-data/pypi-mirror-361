...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/negociacoesitens"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/negociacoesitens/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/compras/negociacoesitens/verificacao-integridade"
