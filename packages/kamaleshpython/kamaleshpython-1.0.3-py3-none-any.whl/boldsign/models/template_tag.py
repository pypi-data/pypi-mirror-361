...
class TemplateTag(BaseModel):
    ...
    TemplateTag
    """ # noqa: E501
    template_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="templateId")
    document_labels: Optional[List[StrictStr]] = Field(default=None, alias="documentLabels")
    ...
    __properties: ClassVar[List[str]] = ["templateId", "documentLabels", "templateLabels", "onBehalfOf"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "documentLabels": obj.get("documentLabels"),
