...
service = BaseAPIService(
    title="HiDream I1 Dev API",
    description="API for HiDream I1 Dev text-to-image model",
    version="1.0.0",
    output_schema=HiDreamI1DevOutput,
)

@service.app.post(
    f"/{model_path}/text-to-image",
    response_model=SubmitResponse,
    description="Generate image from text prompts using HiDream I1 Dev model",
)
