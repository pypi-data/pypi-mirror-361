...
from bluehive import BlueHive, AsyncBlueHive, APIResponseValidationError
from bluehive._types import Omit
from bluehive._models import BaseModel, FinalRequestOptions
from bluehive._exceptions import BlueHiveError, APIStatusError, APITimeoutError, APIResponseValidationError
from bluehive._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: BlueHive | AsyncBlueHive) -> int:
...
class TestBlueHive:
    client = BlueHive(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "bluehive/_legacy_response.py",
                        "bluehive/_response.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(BlueHiveError):
            with update_env(**{"BLUEHIVE_API_KEY": Omit()}):
                client2 = BlueHive(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_base_url_setter(self) -> None:
        client = BlueHive(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(BLUE_HIVE_BASE_URL="http://localhost:5000/from/env"):
            client = BlueHive(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            BlueHive(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            BlueHive(
    ...
    def test_base_url_trailing_slash(self, client: BlueHive) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: BlueHive) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: BlueHive) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            BlueHive(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = BlueHive(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = BlueHive(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("bluehive._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: BlueHive) -> None:
        respx_mock.get("/v1/health").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    @mock.patch("bluehive._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: BlueHive) -> None:
        respx_mock.get("/v1/health").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/v1/health").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: BlueHive, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncBlueHive:
    client = AsyncBlueHive(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(BlueHiveError):
            with update_env(**{"BLUEHIVE_API_KEY": Omit()}):
                client2 = AsyncBlueHive(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_base_url_env(self) -> None:
        with update_env(BLUE_HIVE_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncBlueHive(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncBlueHive) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncBlueHive) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncBlueHive) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncBlueHive(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncBlueHive(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        self, respx_mock: MockRouter, async_client: AsyncBlueHive
    ) -> None:
        respx_mock.get("/v1/health").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncBlueHive, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from bluehive._utils import asyncify
        from bluehive._base_client import get_platform
