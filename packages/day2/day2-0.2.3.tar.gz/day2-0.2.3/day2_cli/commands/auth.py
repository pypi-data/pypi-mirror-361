...
def login(
    ...
    try:
        ...
        should_prompt = (
            not profile_explicitly_provided  # User didn't specify --profile
        ...
        if should_prompt:
            ...
            # No choice was made - use smart detection for backward compatibility
            temp_credentials = Credentials(
                api_key=api_key,
                api_secret_key=api_secret_key,
                profile_name=credential_profile_name,
                base_url=config.base_url,
            )
            credential_section = temp_credentials.credential_section
