...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/concessionariasvts"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/concessionariasvts/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/concessionariasvts/verificacao-integridade"
