...
class StateDocket(BaseModel):
    """
    StateDocket
    """ # noqa: E501
    entries: List[StateDocketEntry]
    retrieved: DocketEntriesIncludedInOutput
    count: StrictInt
    __properties: ClassVar[List[str]] = ["entries", "retrieved", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [StateDocketEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
