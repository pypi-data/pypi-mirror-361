...
def generate_validation_prompt_v2(model_name, sentence, context):
  ...
  return "You are given a math problem, possibly with a partial solution. You will also be given a question regarding the current logic. Your job is to answer the given question in one simple sentence, as briefly as possible. CONTSTRAINT: Do not use any <think></think> tags, and don't include reasoning steps. Do not attempt to solve the original problem:\n\nOriginal Problem: " + context + "\n\nQuestion: " + question