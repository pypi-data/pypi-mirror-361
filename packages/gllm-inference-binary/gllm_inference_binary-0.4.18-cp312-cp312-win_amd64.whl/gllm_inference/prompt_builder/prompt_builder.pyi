...
class PromptBuilder:
    ...
    def __init__(self, system_template: str = '', user_template: str = '', ignore_extra_keys: bool = False) -> None:
        ...
        """
    def format(self, history: MultimodalPrompt | None = None, attachments: list[Attachment] | None = None, **kwargs: Any) -> MultimodalPrompt:
        ...
        It also handles the provided history and attachments. It formats the prompt as a `MultimodalPrompt`.

        Args:
            history (MultimodalPrompt | None, optional): The optional history to be included in the prompt.
                Defaults to None.
            attachments (list[Attachment] | None, optional): The optional attachments to be included in
