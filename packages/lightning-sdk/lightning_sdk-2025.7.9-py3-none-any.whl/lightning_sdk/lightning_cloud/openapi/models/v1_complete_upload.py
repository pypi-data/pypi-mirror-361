...
class V1CompleteUpload(object):
    ...
    @property
    def etag(self) -> 'str':
        """Gets the etag of this V1CompleteUpload.  # noqa: E501


        :return: The etag of this V1CompleteUpload.  # noqa: E501
        :rtype: str
        """
        return self._etag
    ...
    def etag(self, etag: 'str'):
        """Sets the etag of this V1CompleteUpload.


        :param etag: The etag of this V1CompleteUpload.  # noqa: E501
        :type: str
        """
    ...
    def part_number(self) -> 'str':
        """Gets the part_number of this V1CompleteUpload.  # noqa: E501


        :return: The part_number of this V1CompleteUpload.  # noqa: E501
        :rtype: str
        """
    ...
    def part_number(self, part_number: 'str'):
        """Sets the part_number of this V1CompleteUpload.


        :param part_number: The part_number of this V1CompleteUpload.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self) -> dict:
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1CompleteUpload, dict):
    ...
    def __eq__(self, other: 'V1CompleteUpload') -> bool:
        """Returns true if both objects are equal"""
        if not isinstance(other, V1CompleteUpload):
            return False

        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'V1CompleteUpload') -> bool:
