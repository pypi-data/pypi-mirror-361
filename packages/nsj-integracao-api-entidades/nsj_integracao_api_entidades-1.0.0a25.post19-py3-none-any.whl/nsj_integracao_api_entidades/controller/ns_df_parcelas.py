...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/df_parcelas"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/df_parcelas/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/df_parcelas/verificacao-integridade"
