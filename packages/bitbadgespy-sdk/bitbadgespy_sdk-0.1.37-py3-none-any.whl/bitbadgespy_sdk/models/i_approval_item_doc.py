...
class IApprovalItemDoc(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_docId", "_id", "collectionId", "approvalId", "approvalLevel", "approverAddress", "approvalType", "used", "sufficientBalances", "price", "isActive", "badgeId", "approval", "deletedAt", "nextCheckTime"]
