...
class FeedbackUI(QMainWindow):
    ...
    def _create_description_area(self, parent_layout: QVBoxLayout):
        ...
        self.description_label.setMarkdownEnabled(self._should_enable_markdown_rendering())
    ...
    def _execute_optimization_async(
        ...
        try:
            ...
            # 兼容包安装模式和开发模式的导入
            try:
                from interactive_feedback_server.cli import _optimize_user_input_internal
            except ImportError:
                from src.interactive_feedback_server.cli import _optimize_user_input_internal
