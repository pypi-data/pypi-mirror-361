...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/contaspadroes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/contaspadroes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/contaspadroes/verificacao-integridade"
