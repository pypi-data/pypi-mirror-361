...
class AutoControlGUIWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Keyboard button
        grid.addWidget(QLabel("Keyboard Button:"), 5, 0)
        ...
        self.repeat_count_times = QRadioButton("Repeat")
        self.repeat_count_input = QLineEdit()
        self.repeat_count_input.setValidator(QIntValidator())
        self.repeat_count_input.setPlaceholderText("Times")
