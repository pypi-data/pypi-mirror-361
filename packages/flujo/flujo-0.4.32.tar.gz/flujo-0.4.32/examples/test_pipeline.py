...
@step
async def echo_step(data: str, *, context: TestContext | None = None) -> str:
...
@step
async def transform_step(data: str, *, context: TestContext | None = None) -> str:
...
@step
async def finalize_step(data: str, *, context: TestContext | None = None) -> str:
