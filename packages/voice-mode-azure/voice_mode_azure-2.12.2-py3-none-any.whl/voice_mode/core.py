...
def get_openai_clients(api_key: str, stt_base_url: Optional[str] = None, tts_base_url: Optional[str] = None) -> dict:
    ...
    def create_client(base_url: Optional[str], purpose: str) -> AsyncOpenAI:
        ...
        is_azure = azure_endpoint and base_url and azure_endpoint in base_url
        ...
        if is_azure and api_version:
            ...
            # Construct Azure OpenAI URL with deployment path
            azure_base_url = f"{base_url}/openai/deployments/{deployment_name}"
            
            # Add api-version parameter
            azure_base_url = f"{azure_base_url}?api-version={api_version}"
