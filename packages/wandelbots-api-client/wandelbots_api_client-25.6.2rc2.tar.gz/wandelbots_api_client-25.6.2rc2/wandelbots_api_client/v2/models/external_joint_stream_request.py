...
class ExternalJointStreamRequest(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExternalJointStreamRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExternalJointStreamRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "states": [
                ...
                ExternalJointStreamDatapoint.from_dict(_item) if hasattr(ExternalJointStreamDatapoint, 'from_dict') else _item
                # <<< End modification
                for _item in obj["states"]
            ] if obj.get("states") is not None else None
        })
        return _obj
