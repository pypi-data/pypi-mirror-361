...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/perfiltrib_est"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/perfiltrib_est/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/estoque/perfiltrib_est/verificacao-integridade"
