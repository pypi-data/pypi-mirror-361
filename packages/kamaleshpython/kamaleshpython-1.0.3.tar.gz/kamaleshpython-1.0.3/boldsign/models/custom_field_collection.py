...
class CustomFieldCollection(BaseModel):
    """
    CustomFieldCollection
    """ # noqa: E501
    result: Optional[List[ViewCustomFieldDetails]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": [ViewCustomFieldDetails.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None
        })
        return _obj
    ...
    def openapi_types(cls) -> Dict[str, str]:
        return {
            "result": "(List[ViewCustomFieldDetails],)",
        }
