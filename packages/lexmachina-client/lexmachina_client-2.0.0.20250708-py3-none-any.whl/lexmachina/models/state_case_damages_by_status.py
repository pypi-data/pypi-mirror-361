...
class StateCaseDamagesByStatus(BaseModel):
    """
    StateCaseDamagesByStatus
    """ # noqa: E501
    active: List[StateCaseDamages]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "active": [StateCaseDamages.from_dict(_item) for _item in obj["active"]] if obj.get("active") is not None else None
        })
        return _obj
