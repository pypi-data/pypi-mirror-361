...
CPXLIBAPI
int CPXPUBLIC
   CPXLcallbackexitcutloop (CPXCALLBACKCONTEXTptr context);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLcallbackgetrelaxationpi (CPXCALLBACKCONTEXTptr context,
                                double *lrpi, CPXINT lrbeg,
                                CPXINT lrend, double *qrpi,
                                int *qrpidef, CPXINT qrbeg,
                                CPXINT qrend, double *qzerotol_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLcallbackgetrelaxationstatus (CPXCALLBACKCONTEXTptr context,
                                    int *nodelpstat_p, CPXLONG flags);


CPXLIBAPI
int CPXPUBLIC
   CPXLcallbackmakebranch (CPXCALLBACKCONTEXTptr context,
                           CPXINT varcnt, CPXINT const *varind,
...
CPXLIBAPI
int CPXPUBLIC
   CPXLcallbackprunenode (CPXCALLBACKCONTEXTptr context);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLcallbackrejectcandidatelocal (CPXCALLBACKCONTEXTptr context,
                                     CPXINT rcnt, CPXLONG nzcnt,
                                     double const *rhs,
                                     char const *sense,
                                     CPXLONG const *rmatbeg,
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetconflictgroups (CPXCENVptr env, CPXCLPptr lp,
                          CPXLONG *concnt_p, double *grppref,
                          CPXLONG *grpbeg, CPXINT *grpind,
                          char *grptype, CPXLONG grpspace,
                          CPXLONG *surplus_p, CPXINT begin, CPXINT end);


CPXLIBAPI
CPXLONG CPXPUBLIC
   CPXLgetconflictnumgroups (CPXCENVptr env, CPXCLPptr lp);


CPXLIBAPI
CPXLONG CPXPUBLIC
   CPXLgetconflictnumpasses (CPXCENVptr env, CPXCLPptr lp);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLreadcopystartinfo (CPXCENVptr env, CPXLPptr lp,
                          char const *filename_str);
