...
class GifApplicationExtensionBlock(aspose.imaging.fileformats.gif.GifBlock):
    ...
    @overload
    def __init__(self, application_identifier: str, application_authentication_code: bytes, application_data: bytes):
        '''Initializes a new instance of the  class.
    ...
    @classmethod
    @property
    def EXTENSION_INTRODUCER(cls) -> byte:
        ...
    
    @property
    def application_authentication_code(self) -> bytes:
        ...
    
    @application_authentication_code.setter
    def application_authentication_code(self, value : bytes):
        ...
    ...
    def application_identifier(self, value : str):
        ...
    ...
    def application_data(self, value : bytes):
        ...
    
    @classmethod
    @property
    def BLOCK_HEADER_SIZE(cls) -> int:
        ...
    
    @classmethod
    @property
    def EXTENSION_LABEL(cls) -> byte:
        ...
    
    @classmethod
    @property
    def BLOCK_SIZE(cls) -> byte:
        ...
    
    @classmethod
    @property
    def APPLICATION_IDENTIFIER_SIZE(cls) -> int:
        ...
    
    @classmethod
    @property
    def APPLICATION_AUTHENTICATION_CODE_SIZE(cls) -> int:
        ...
...
class GifFrameBlock(aspose.imaging.RasterCachedImage):
    ...
    @overload
    def __init__(self, left: int, top: int, width: int, height: int, color_palette: aspose.imaging.IColorPalette, is_palette_sorted: bool, is_gif_frame_interlaced: bool, bits_per_pixel: byte):
        '''Initializes a new instance of the  class.
    ...
    @overload
    def __init__(self, image: aspose.imaging.RasterImage, left: int, top: int):
        '''Initializes a new instance of the  class.
    ...
    @overload
    def __init__(self, image: aspose.imaging.RasterImage, left: int, top: int, is_palette_sorted: bool, is_gif_frame_interlaced: bool, lzw_code_size: byte):
        '''Initializes a new instance of the  class.
    ...
    @overload
    def __init__(self, stream: io.RawIOBase, left: int, top: int):
        '''Initializes a new instance of the  class.
    ...
    @overload
    def __init__(self, stream: io.RawIOBase, left: int, top: int, is_palette_sorted: bool, is_gif_frame_interlaced: bool, lzw_code_size: byte):
        '''Initializes a new instance of the  class.
    ...
    @overload
    def __init__(self, path: str, left: int, top: int):
        '''Initializes a new instance of the  class.
    ...
    @overload
    def __init__(self, path: str, left: int, top: int, is_palette_sorted: bool, is_gif_frame_interlaced: bool, lzw_code_size: byte):
        '''Initializes a new instance of the  class.
    ...
    @overload
    def resize(self, new_width: int, new_height: int, image_resize_settings: aspose.imaging.ImageResizeSettings):
    ...
    @staticmethod
    def create_from_image_left_top_pal_sorted_interlaced_code_size(image: aspose.imaging.RasterImage, left: int, top: int, is_palette_sorted: bool, is_gif_frame_interlaced: bool, lzw_code_size: byte) -> aspose.imaging.fileformats.gif.blocks.GifFrameBlock:
        '''Initializes a new instance of the  class.
    ...
    @staticmethod
    def create_from_stream(stream: io.RawIOBase) -> aspose.imaging.fileformats.gif.blocks.GifFrameBlock:
        '''Initializes a new instance of the  class.
    ...
    @staticmethod
    def create_from_stream_left_top(stream: io.RawIOBase, left: int, top: int) -> aspose.imaging.fileformats.gif.blocks.GifFrameBlock:
        '''Initializes a new instance of the  class.
    ...
    @staticmethod
    def create_from_stream_left_top_pal_sorted_interlaced_code_size(stream: io.RawIOBase, left: int, top: int, is_palette_sorted: bool, is_gif_frame_interlaced: bool, lzw_code_size: byte) -> aspose.imaging.fileformats.gif.blocks.GifFrameBlock:
        '''Initializes a new instance of the  class.
    ...
    @staticmethod
    def create_from_file_left_top_pal_sorted_interlaced_code_size(path: str, left: int, top: int, is_palette_sorted: bool, is_gif_frame_interlaced: bool, lzw_code_size: byte) -> aspose.imaging.fileformats.gif.blocks.GifFrameBlock:
        '''Initializes a new instance of the  class.
    ...
    @staticmethod
    def create_flags(color_palette: aspose.imaging.IColorPalette, is_palette_sorted: bool, is_gif_frame_interlaced: bool) -> byte:
        '''Creates the flags.
    ...
    def interlaced(self, value : bool):
        '''Sets a value indicating whether this  is interlaced.'''
        ...
    ...
    @property
    def gif_frame_bits_per_pixel(self) -> byte:
        ...
    
    @gif_frame_bits_per_pixel.setter
    def gif_frame_bits_per_pixel(self, value : byte):
        ...
    ...
    @classmethod
    @property
    def EXTENSION_LABEL(cls) -> int:
        ...
    
    @classmethod
    @property
    def IMAGE_DESCRIPTOR_SIZE(cls) -> int:
        ...
...
class GifGraphicsControlBlock(aspose.imaging.fileformats.gif.GifBlock):
    ...
    @overload
    def __init__(self, flags: byte, delay_time: int, transparent_color_index: byte):
        '''Initializes a new instance of the  class.
    ...
    @overload
    def __init__(self, delay_time: int, has_transparent_color: bool, transparent_color_index: byte, requires_user_input: bool, disposal_method: aspose.imaging.fileformats.gif.DisposalMethod):
        '''Initializes a new instance of the  class.
    ...
    @staticmethod
    def create_flags(has_transparent_color: bool, requires_user_input: bool, disposal_method: aspose.imaging.fileformats.gif.DisposalMethod) -> byte:
        '''Creates the flags.
        
        :param has_transparent_color: if set to ``true`` the  has valid transparent color index.
        :param requires_user_input: if set to ``true`` the user input is expected.
        :param disposal_method: The disposal method.
    ...
    @property
    def transparent_color_index(self) -> byte:
        ...
    
    @transparent_color_index.setter
    def transparent_color_index(self, value : byte):
        ...
    ...
    def disposal_method(self, value : aspose.imaging.fileformats.gif.DisposalMethod):
        ...
    ...
    def user_input_expected(self, value : bool):
        ...
...
class GifPlainTextRenderingBlock(aspose.imaging.fileformats.gif.GifBlock):
    ...
    @overload
    def __init__(self, text_grid_left_position: int, text_grid_top_position: int, text_grid_width: int, text_grid_height: int, character_cell_width: byte, character_cell_height: byte, text_foreground_color_index: byte, text_background_color_index: byte, data: bytes):
        '''Initializes a new instance of the  class.
    ...
    @property
    def text_foreground_color_index(self) -> byte:
        ...
    
    @text_foreground_color_index.setter
    def text_foreground_color_index(self, value : byte):
        ...
    
    @property
    def text_background_color_index(self) -> byte:
        ...
    
    @text_background_color_index.setter
    def text_background_color_index(self, value : byte):
        ...
    
    @property
    def character_cell_width(self) -> byte:
        ...
    
    @character_cell_width.setter
    def character_cell_width(self, value : byte):
        ...
    
    @property
    def character_cell_height(self) -> byte:
        ...
    
    @character_cell_height.setter
    def character_cell_height(self, value : byte):
        ...
    ...
    def text_grid_left_position(self, value : int):
        ...
    ...
    def text_grid_top_position(self, value : int):
        ...
    ...
    def text_grid_width(self, value : int):
        ...
    ...
    def text_grid_height(self, value : int):
        ...
    
    @property
    def plain_text_data(self) -> bytes:
        ...
    
    @plain_text_data.setter
    def plain_text_data(self, value : bytes):
        ...
...
class GifUnknownExtensionBlock(aspose.imaging.fileformats.gif.GifBlock):
    ...
    @overload
    def __init__(self, extension_label: byte, data: bytes):
        '''Initializes a new instance of the  class.
    ...
    @property
    def extension_label(self) -> byte:
        ...
    
    @extension_label.setter
    def extension_label(self, value : byte):
        ...
    
    @property
    def unknown_data(self) -> bytes:
        ...
    
    @unknown_data.setter
    def unknown_data(self, value : bytes):
        ...
