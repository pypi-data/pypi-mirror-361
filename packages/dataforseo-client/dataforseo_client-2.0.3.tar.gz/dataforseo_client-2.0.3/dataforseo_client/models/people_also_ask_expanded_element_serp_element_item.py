...
class PeopleAlsoAskExpandedElementSerpElementItem(BasePeopleAlsoAskExpandedElementItem):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "rank_group", "rank_absolute", "position", "xpath", "featured_title", "url", "domain", "title", "description", "images", "timestamp", "table"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PeopleAlsoAskExpandedElementSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PeopleAlsoAskExpandedElementSerpElementItem from a dict"""
        if obj is None:
            return None
