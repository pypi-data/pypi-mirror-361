                                            ...
                                            if 'action' in message:
                                                if message['action']=="publish":
                                                    for deps in ['channel_name', 'name', 'content', 'hash']:
                                                        ...
                                                        channel = __main__.settings.orm.Channel.get(name=message['channel_name'])
                                                        if channel:
                                                            channel_id = channel.id
                                                        else:
                                                            logs(f"[{self.get_name_user()}] - Création du channel {message['channel_name']}", "success")
                                                            __main__.settings.orm.Channel(name=message['channel_name'], channel_hash=generate_unique_hash(), updated_at=datetime.now(), creator_id=self.user_id)
                                                            pony.commit()

                                                            channel = __main__.settings.orm.Channel.get(name=message['channel_name'])
                                                            channel_id = channel.id

                                                        pub_content = __main__.settings.orm.PubChannel.get(channel_id=channel_id , name=message['name'])
                                                        ...
                                                        if pub_content:
                                                            ...
                                                            publish_file = __main__.settings.orm.PubChannel(channel_id=channel_id , name=message['name'], content=message['content'], content_hash=message['hash'], updated_at=datetime.now())
                                                    ...
                                                    if 'list_files' in message:
                                                        ...
                                                        query = __main__.settings.orm.PubChannel.select(lambda p: p.channel_id == channel_id)
                                                        result = query[:]
                                                    ...
                                                    if channel:
                                                        ...
                                                        for element in ['path', 'force', 'purge']:
                                                    ...
                                                    query = __main__.settings.orm.Channel.select()
                                                    result = query[:]
