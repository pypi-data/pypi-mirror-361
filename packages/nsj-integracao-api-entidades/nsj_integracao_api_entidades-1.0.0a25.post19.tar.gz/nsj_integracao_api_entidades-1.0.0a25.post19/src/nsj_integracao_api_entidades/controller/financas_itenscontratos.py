...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/itenscontratos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/itenscontratos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/financas/itenscontratos/verificacao-integridade"
