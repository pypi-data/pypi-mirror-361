...
def objects():
    ...
    yield O("C'est ça l'important.", "That's what it depends on.",
            "Darauf kommt es an.", "Darauf kommt es sich an.")
    yield O("C'est à propos de la santé", "It's about health.",
            "Es geht um die Gesundheit.", "Es geht sich um die Gesundheit.")
