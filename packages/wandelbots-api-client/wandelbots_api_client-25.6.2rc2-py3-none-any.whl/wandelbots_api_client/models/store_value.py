...
STOREVALUE_ANY_OF_SCHEMAS = ["ArrayOutput", "Capture", "PointCloud", "PyjectoryDatatypesSerializerOrientation", "PyjectoryDatatypesSerializerPose", "PyjectoryDatatypesSerializerPosition", "bool", "bytearray", "float", "int", "str"]
...
class StoreValue(BaseModel):
    ...
    # data type: bytearray
    anyof_schema_5_validator: Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]] = None
    # data type: PyjectoryDatatypesSerializerPose
    anyof_schema_6_validator: Optional[PyjectoryDatatypesSerializerPose] = None
    # data type: PyjectoryDatatypesSerializerPosition
    anyof_schema_7_validator: Optional[PyjectoryDatatypesSerializerPosition] = None
    # data type: PyjectoryDatatypesSerializerOrientation
    anyof_schema_8_validator: Optional[PyjectoryDatatypesSerializerOrientation] = None
    # data type: Capture
    anyof_schema_9_validator: Optional[Capture] = None
    # data type: PointCloud
    anyof_schema_10_validator: Optional[PointCloud] = None
    # data type: ArrayOutput
    anyof_schema_11_validator: Optional[ArrayOutput] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[ArrayOutput, Capture, PointCloud, PyjectoryDatatypesSerializerOrientation, PyjectoryDatatypesSerializerPose, PyjectoryDatatypesSerializerPosition, bool, bytearray, float, int, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "ArrayOutput", "Capture", "PointCloud", "PyjectoryDatatypesSerializerOrientation", "PyjectoryDatatypesSerializerPose", "PyjectoryDatatypesSerializerPosition", "bool", "bytearray", "float", "int", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = StoreValue.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in StoreValue with anyOf schemas: ArrayOutput, Capture, PointCloud, PyjectoryDatatypesSerializerOrientation, PyjectoryDatatypesSerializerPose, PyjectoryDatatypesSerializerPosition, bool, bytearray, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into StoreValue with anyOf schemas: ArrayOutput, Capture, PointCloud, PyjectoryDatatypesSerializerOrientation, PyjectoryDatatypesSerializerPose, PyjectoryDatatypesSerializerPosition, bool, bytearray, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ArrayOutput, Capture, PointCloud, PyjectoryDatatypesSerializerOrientation, PyjectoryDatatypesSerializerPose, PyjectoryDatatypesSerializerPosition, bool, bytearray, float, int, str]]:
