from .directories import get_abtract_apis_path
ABSTRACT_LOGINS_FLASK_DIR = get_abtract_apis_path("abstract_logins")
CHARTS_FLASK_DIR = get_abtract_apis_path("charts")
THE_DAILY_DIALECTICS_FLASK_DIR = get_abtract_apis_path("daily_dialectics_flask")
JAMAIL_FLASK_DIR = get_abtract_apis_path("jamail")
JOBEN_FLASK_DIR = get_abtract_apis_path("joben")
MEDIA_FLASK_DIR = get_abtract_apis_path("media")
OLD_JAMAIL_FLASK_DIR = get_abtract_apis_path("old_jamail")
SERVICE_FILES_FLASK_DIR = get_abtract_apis_path("service_files")
TODO_FLASK_DIR = get_abtract_apis_path("todo")
TYPING_FLASK_DIR = get_abtract_apis_path("typings")
USURPIT_FLASK_DIR = get_abtract_apis_path("usurpit")
VIDEO_PLAYER_FLASK_DIR = get_abtract_apis_path("video_player")
WSGIS_DIR = get_abtract_apis_path("wsgis")
