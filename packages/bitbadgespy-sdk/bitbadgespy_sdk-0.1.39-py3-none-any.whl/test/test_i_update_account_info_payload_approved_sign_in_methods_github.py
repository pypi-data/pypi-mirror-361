...
class TestIUpdateAccountInfoPayloadApprovedSignInMethodsGithub(unittest.TestCase):
    """IUpdateAccountInfoPayloadApprovedSignInMethodsGithub unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateAccountInfoPayloadApprovedSignInMethodsGithub:
        """Test IUpdateAccountInfoPayloadApprovedSignInMethodsGithub
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateAccountInfoPayloadApprovedSignInMethodsGithub`
        """
        model = IUpdateAccountInfoPayloadApprovedSignInMethodsGithub()
        if include_optional:
            return IUpdateAccountInfoPayloadApprovedSignInMethodsGithub(
                scopes = [
    ...
    def testIUpdateAccountInfoPayloadApprovedSignInMethodsGithub(self):
        """Test IUpdateAccountInfoPayloadApprovedSignInMethodsGithub"""
