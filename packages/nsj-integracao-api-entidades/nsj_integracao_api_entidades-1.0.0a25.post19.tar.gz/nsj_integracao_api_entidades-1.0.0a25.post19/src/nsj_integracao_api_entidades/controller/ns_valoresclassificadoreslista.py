...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/valoresclassificadoreslista"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/valoresclassificadoreslista/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/valoresclassificadoreslista/verificacao-integridade"
