...
class ElevenLabsTurboV25QueryParameters(BaseModel):
...
class ElevenLabsTurboV25PathParameters(BaseModel):
    voice_id: str = Field(
        ...,
...
class ElevenLabsTurboV25Input(BaseModel):
    """Input schema for ElevenLabs Turbo V2.5 text-to-speech."""
    text: str = Field(
        ...,
...
class ElevenLabsTurboV25Output(BaseModel):
    """Output schema for ElevenLabs Turbo V2.5 text-to-speech."""
