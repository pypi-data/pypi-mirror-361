...
def main_cli():
    ...
    parser.add_argument("--bams", nargs="+", type=str, required=True, help="wildcard '*' is supported")
    parser.add_argument("--refs", nargs="+", type=str, help="if not provided. the alignment related metric will not output")
    parser.add_argument(
        "-f",
        action="store_true",
        default=False,
