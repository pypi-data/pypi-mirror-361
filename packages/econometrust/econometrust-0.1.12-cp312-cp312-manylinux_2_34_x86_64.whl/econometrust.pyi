...
class TSLS:
    ...
    -----
    TSLS requires:
    - At least as many instruments as regressors
    - Instruments must be correlated with regressors and uncorrelated with error term
    """
    ...
    def fit(
        ...
        ------
        ValueError
            If not enough instruments, samples, or mismatched dimensions.
        """
        ...
