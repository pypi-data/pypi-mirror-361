...
class ListPayloadsResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListPayloadsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListPayloadsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "payloads": [
                ...
                Payload.from_dict(_item) if hasattr(Payload, 'from_dict') else _item
                # <<< End modification
                for _item in obj["payloads"]
            ] if obj.get("payloads") is not None else None
        })
        return _obj
