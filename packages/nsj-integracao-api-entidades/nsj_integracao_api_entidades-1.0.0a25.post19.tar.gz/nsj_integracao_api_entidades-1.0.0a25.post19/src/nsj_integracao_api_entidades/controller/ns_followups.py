...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/followups"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/followups/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/ns/followups/verificacao-integridade"
