...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/configuracoes_aprovacoes"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/configuracoes_aprovacoes/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/pedidos/configuracoes_aprovacoes/verificacao-integridade"
