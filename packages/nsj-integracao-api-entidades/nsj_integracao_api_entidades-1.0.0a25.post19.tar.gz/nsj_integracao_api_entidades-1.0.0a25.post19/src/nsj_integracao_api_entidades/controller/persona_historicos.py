...
ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/historicos"
ID_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/historicos/<id>"
INTEGRITY_ROUTE = f"/{APP_NAME}/{MOPE_CODE}/persona/historicos/verificacao-integridade"
